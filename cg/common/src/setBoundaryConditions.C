...
//      dialog.setPushButtons( cmd, editBC, numRows ); 
    ...
    tbCommands[ntb]="apply interface conditions";         tbState[ntb]=dbase.get<int>("applyInterfaceBoundaryConditions");    ntb++;
    tbCommands[ntb]="apply champ interface conditions";   tbState[ntb]=dbase.get<int>("applyChampInterfaceConditions");       ntb++;
  ...
  for(int it=0; ; it++)
  {
    ...
    else if( dialog.getToggleValue(answer,"apply interface conditions",dbase.get<int>("applyInterfaceBoundaryConditions")) ){ }
