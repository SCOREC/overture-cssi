#
# cgmp:   INS + Elasticity: elastic piston 
#                ****** TEST CORNER FIX *****
# 
# Usage:
...
$ra=0.; $rb=1.; # ramp interval
# ----------------------------- get command line arguments ---------------------------------------
GetOptions( "g=s"=>\$grid,"tf=f"=>\$tFinal,"nu=f"=>\$nu,"muFluid=f"=>\$muFluid,"kappa=f"=>\$kappa, "bg=s"=>\$backGround,\
 "tp=f"=>\$tPlot, "solver=s"=>\$solver, "psolver=s"=>\$psolver,"useTP=i"=> \$useTP,"fluidSolidCornerFix=i"=> \$fluidSolidCornerFix,\
