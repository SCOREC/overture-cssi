...
#
# revisit: April 2021
# plotStuff plotShockMultiDisk.cmd -show=shockTwoElasticDisksG8.show -sMin=0 -sMax=7 -rMin=1 -rMax=5 -solution=6 -name=shockTwoDiskSpeedt0p5
# plotStuff plotShockMultiDisk.cmd -show=shockTwoElasticDisksG8.show -sMin=0 -sMax=7 -rMin=1 -rMax=5 -solution=11 -name=shockTwoDiskSpeedt1p0
# plotStuff plotShockMultiDisk.cmd -show=shockTwoElasticDisksG8.show -sMin=0 -sMax=7 -rMin=1 -rMax=5 -solution=16 -name=shockTwoDiskSpeedt1p5
# 
$wireFrame=0; $show="shockMultiDisk4g.show"; $name="shockMultiDisk"; $solution=1; 
$sMin=0.; $sMax=-1.; # max/min for speed in solids
$rMin=0.; $rMax=-1.; # max/min for rho in fluid
#
GetOptions( "show=s"=>\$show, "wireFrame=s"=>\$wireFrame,"sMin=f"=>\$sMin,"sMax=f"=>\$sMax,\
            "rMin=f"=>\$rMin,"rMax=f"=>\$rMax, "name=s"=>\$name, "solution=i"=>\$solution);
#
