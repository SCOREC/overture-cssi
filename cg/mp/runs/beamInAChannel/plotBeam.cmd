#
# Plot results from the solid beam in a INS fluid channel
#
# -- INS+SM
#    plotStuff plotBeam -show=bicInsG8.show
#    plotStuff plotBeam -show=bilcInsG8.show  [ long channel
#    plotStuff plotBeam -show=tbilcInsG16.show  [ thin beam
# 
#    plotStuff plotBeam -show=bicG8Scf100.show -option=sn [ ins , scf=100
#  
$show="deformingEllipse4.show"; $name="deformingEllipse4"; $root=""; 
$vMin=0.; $vMax=-1.;  $spMin=0.; $spMax=-1.; 
$res=1024; 
$option="sl"; # sl=streamlines, sn=stressNorm 
$movieName="sbic"; 
