#
# cgmp:   Incompressible flow past a bulk solid beam
# 
# Usage:
#    cgmp [-noplot] insSolidBeamInAChannel -g=<name> -method=[ins|cns] -nu=<> -mu=<> -kappa=<num> -tf=<tFinal> -tp=<tPlot> ...
...
$ic = "uniform flow\n p=0., u=0.";
$halfH=0.2; $cpn=1.;
# --- BC with ramped velocity at inflow:
