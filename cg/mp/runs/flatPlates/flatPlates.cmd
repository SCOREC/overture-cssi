...
$solver = "yale";
$go="halt"; $debug=0; 
$ts="pc"; $numberOfCorrections=1; $implicitFactor=.5; $coupled=1; $iTol=1.e-3; $iOmega=1.; $relaxCorrectionSteps=0; 
...
GetOptions("T_top=f"=>\$T_top,"T_bottom=f"=>\$T_bottom, "u_top=f"=>\$u_top, "T_bottom=f"=>\$T_bottom,"imp=f"=>\$implicitFactor,\
           ...
           "periodic=i"=>\$flatPlateIsPeriodic,"coupled=i"=>\$coupled,"relaxCorrectionSteps=i"=>\$relaxCorrectionSteps,\
...
#
  ...
  OBPDE:relax correction steps $relaxCorrectionSteps
*
  show file options
    compressed
      open
