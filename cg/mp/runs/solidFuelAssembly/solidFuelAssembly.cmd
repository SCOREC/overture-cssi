...
# Examples: 
# 
#  cgmp -noplot solidFuelAssembly.cmd -g="solidFuelAssemblyGrid1pinsi1.order2" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05  -tf=.2 -show="sfa.show"
#  cgmp solidFuelAssembly.cmd -g="solidFuelAssembly3pinsi1.order2" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05  
#
# parallel: 
#  mpirun -np 1 $cgmpp solidFuelAssembly.cmd -g="solidFuelAssemblyGrid1pinse1.5.order2" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05 -tf=.2 
#  srun -ppdebug -N2 -n2 $cgmpp -noplot solidFuelAssembly.cmd -g="solidFuelAssemblyGrid1pinse1.5.order2" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05 -tf=.2 -show="sfa.show" >! sfa1.out &
#  srun -ppdebug -N2 -n2 $cgmpp -noplot solidFuelAssembly.cmd -g="solidFuelAssemblyGrid3pinse1.order2" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05 -tf=.2 -show="sfa3.show" >! sfa3.out &
#  totalview srun -a -N1 -n2 -ppdebug $cgmpp -noplot solidFuelAssembly.cmd -g="solidFuelAssemblyGrid1pinse1.5.order2" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05 -tf=.2 -show="sfa.show" 
# 
# srun -ppdebug -N2 -n4 $cgmpp -noplot solidFuelAssembly.cmd -g="solidFuelAssemblyGrid3pinsl5e1" -solver=best -ts=imp -coupled=0 -nc=8 -dtMax=.05 -tp=.05 -tf=.2 -show="sfa3l5.show" >! sfa3l5.out &
# 
