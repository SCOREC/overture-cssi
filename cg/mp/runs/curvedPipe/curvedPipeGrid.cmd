...
#
#  Usage:
#    ogen -noplot curvedPipeGrid -factor=<> -interp=[e,i] -order=[2,4,6,8] -option=[hollow|solid] -angle=<> ...
...
#   ogen -noplot curvedPipeGrid -angle=22 -interp=e -factor=1
#   ogen -noplot curvedPipeGrid -angle=22 -interp=e -factor=2
#   ogen -noplot curvedPipeGrid -angle=22 -interp=e -factor=4
#
#   ogen -noplot curvedPipeGrid -startAngle=45 -angle=67 -interp=e -factor=1
#   ogen -noplot curvedPipeGrid -startAngle=45 -angle=67 -interp=e -factor=2
#   ogen -noplot curvedPipeGrid -startAngle=45 -angle=67 -interp=e -factor=4
#
#   ogen -noplot curvedPipeGrid -angle=45 -interp=e -factor=1
#   ogen -noplot curvedPipeGrid -angle=45 -interp=e -factor=2
#   ogen -noplot curvedPipeGrid -angle=45 -interp=e -factor=3
#   ogen -noplot curvedPipeGrid -angle=45 -interp=e -factor=4
#
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -factor=1
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -factor=2
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -factor=3
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -factor=4
#
#  -- for grid convergence use a fixed radial grid distance:
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -rgd=fixed -factor=1
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -rgd=fixed -factor=2
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -rgd=fixed -factor=3
#   ogen -noplot curvedPipeGrid -angle=90 -interp=e -rgd=fixed -factor=4
#
# ogen -noplot curvedPipeGrid -option=hollow -angle=90 -interp=e -factor=1
# ogen -noplot curvedPipeGrid -option=hollow -angle=90 -interp=e -factor=2
# ogen -noplot curvedPipeGrid -option=hollow -angle=90 -interp=e -factor=4
# 
# ogen -noplot curvedPipeGrid -option=solid -angle=90 -interp=e -factor=1 
# ogen -noplot curvedPipeGrid -option=solid -angle=90 -interp=e -factor=2 
# ogen -noplot curvedPipeGrid -option=solid -angle=90 -interp=e -factor=4 
# 
#**************************************************************************
$prefix = "curvedPipeGrid"; 
...
GetOptions( "order=i"=>\$order,"factor=f"=>\$factor,"xa=f"=> \$xa,"xb=f"=> \$xb,"ya=f"=> \$ya,"yb=f"=> \$yb,\
            ...
            "option=s"=> \$option,"rgd=s"=> \$rgd,"name=s"=> \$name,"prefix=s"=> \$prefix );
# 
...
# 
$suffix = ".order$order"; 
if( $option ne "" ){ $prefix = $option . "CurvedPipeGrid"; }
