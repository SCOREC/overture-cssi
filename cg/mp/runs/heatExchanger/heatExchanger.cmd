...
#  fluid: 
$nu=.025; $fluidThermalConductivity=.1; $fluidThermalDiffusivity=.025;  $thermalExpansivity=1.; 
# Solid: 
$solidThermalConductivity=1.; $solidThermalDiffusivity=.02;  
$pdebug=0; 
...
GetOptions( "g=s"=>\$grid,"tf=f"=>\$tFinal,"nu=f"=>\$nu,"kappa=f"=>\$kappa, "bg=s"=>\$backGround,\
 ...
 "show=s"=>\$show,"ts=s"=>\$ts,"coupled=i"=>\$coupled,"gravity=s"=>\$gravity,\
 "solidThermalDiffusivity=f"=>\$solidThermalDiffusivity,"solidThermalConductivity=f"=>\$solidThermalConductivity,\
 "fluidThermalDiffusivity=f"=>\$fluidThermalDiffusivity,"fluidThermalConductivity=f"=>\$fluidThermalConductivity,\
...
#
# $kThermal=$nu/$prandtl; # fluid thermal diffusivity
...
# 
# ------- Assign domains ----------
$domainName="solidDomain"; $solverName="solid"; $ktc=$solidThermalConductivity; $kappa=$solidThermalDiffusivity; 
...
#
$domainName="tubeDomain"; $solverName="fluid"; $Twall=0.; $ktc=$fluidThermalConductivity; $kThermal=$fluidThermalDiffusivity;
$bc = "bcNumber$bcInflow=inflowWithVelocityGiven, parabolic(d=.2,p=1.,u=0.,v=1.,T=0.)\n bcNumber$bcOutflow=outflow\n $iface100\n $iface101"; 
# $bc = "all=noSlipWall\n bcNumber$bcInflow=inflowWithVelocityGiven, parabolic(d=.2,p=1.,v=1.,T=0.)\n bcNumber$bcOutflow=outflow\n";
$ic="uniform flow\n" . "p=1., u=0, T=0.";  
$ts0=$ts; $ts=$ts . "\n project initial conditions";
# $ts=$ts0; # wdh March 31, 2021 turn on project IC
