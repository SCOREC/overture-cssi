#
# cgmp:   Incompressible flow past three deformings disks
# 
# Usage:
#    cgmp [-noplot] threeBodies -g=<name> -method=[ins|cns] -nu=<> -mu=<> -kappa=<num> -tf=<tFinal> -tp=<tPlot> ...
...
# 
$grid="deformingChannelGrid4.order2"; $domain1="fluidDomain"; $domain2="solidDomain1"; $domain3="solidDomain2"; $domain4="solidDomain3";
...
$scf1=1.; $scf2=1.; $scf3=1.;# solidScaleFactor : scale rho,mu and lambda by this amount 
