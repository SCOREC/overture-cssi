#
# cgmp:   Incompressible flow past FIVE bdoies
# 
# Usage:
#    cgmp [-noplot] fiveBodies -g=<name> -method=[ins|cns] -nu=<> -mu=<> -kappa=<num> -tf=<tFinal> -tp=<tPlot> ...
...
# 
$grid="deformingChannelGrid4.order2"; $domain1="fluidDomain"; $domain2="solidDomain1"; $domain3="solidDomain2"; $domain4="solidDomain3"; $domain5="solidDomain4"; $domain6="solidDomain5";
...
$scf1=1.; $scf2=1.; $scf3=1.; $scf4=1.; $scf5=1.; # solidScaleFactor : scale rho,mu and lambda by this amount 
...
GetOptions( "g=s"=>\$grid,"tf=f"=>\$tFinal,"nu=f"=>\$nu,"muFluid=f"=>\$muFluid,"kappa=f"=>\$kappa, "bg=s"=>\$backGround,\
 ...
 "show=s"=>\$show,"method=s"=>\$method,"ts=s"=>\$ts,"tsSM=s"=>\$tsSM,"noplot=s"=>\$noplot,"ktcFluid=f"=>\$ktcFluid,\
  ...
  "cfl=f"=>\$cfl,"rhoSolid=f"=>\$rhoSolid,"cnsVariation=s"=>\$cnsVariation,"diss=f"=>\$diss,"fic=s"=>\$fic,"go=s"=>\$go,\
   "smVariation=s"=>\$smVariation,"scf1=f"=>\$scf1,"scf2=f"=>\$scf2,"scf3=f"=>\$scf3,"scf4=f"=>\$scf4,"scf5=f"=>\$scf5,\
   "probeFile=s"=>\$probeFile,"pOffset=f"=>\$boundaryPressureOffset,\
...
$bc = "all=noSlipWall\n" . \
     ...
     "bcNumber1=inflowWithPressureAndTangentialVelocityGiven, userDefinedBoundaryData\n" . \
      ...
      "bcNumber100=noSlipWall\n bcNumber100=tractionInterface\n" . \
      "bcNumber101=noSlipWall\n bcNumber101=tractionInterface\n" . \
      "bcNumber102=noSlipWall\n bcNumber102=tractionInterface\n" . \
...
$rhoSolid0=$rhoSolid; 
$exponent=10.; $x0=.5; $y0=.5; $z0=.5;  $rhoSolid=$rhoSolid0*$scf1; $lambda=$lambdaSolid*$scf1; $mu=$muSolid*$scf1; 
...
$exponent=10.; $x0=.5; $y0=.5; $z0=.5;  $rhoSolid=$rhoSolid0*$scf2; $lambda=$lambdaSolid*$scf2; $mu=$muSolid*$scf2; 
$initialConditionCommands="zeroInitialCondition";
#
echo to terminal 0
include $ENV{CG}/mp/cmd/smDomain.h
echo to terminal 1
# 
# ------- specify elastic solid domain 3 ----------
#
$domainName=$domain4; $solverName="solid3"; 
$bcCommands="all=displacementBC\n bcNumber102=tractionBC\n bcNumber102=tractionInterface"; 
$exponent=10.; $x0=.5; $y0=.5; $z0=.5;  $rhoSolid=$rhoSolid0*$scf3; $lambda=$lambdaSolid*$scf3; $mu=$muSolid*$scf3; 
$initialConditionCommands="zeroInitialCondition";
#
echo to terminal 0
include $ENV{CG}/mp/cmd/smDomain.h
...
#
# 
# ------- specify elastic solid domain 4 ----------
#
$domainName=$domain5; $solverName="solid4"; 
$bcCommands="all=displacementBC\n bcNumber103=tractionBC\n bcNumber103=tractionInterface"; 
$exponent=10.; $x0=.5; $y0=.5; $z0=.5;  $rhoSolid=$rhoSolid0*$scf4; $lambda=$lambdaSolid*$scf4; $mu=$muSolid*$scf4; 
$initialConditionCommands="zeroInitialCondition";
#
echo to terminal 0
include $ENV{CG}/mp/cmd/smDomain.h
echo to terminal 1
# 
# ------- specify elastic solid domain 5 ----------
#
$domainName=$domain6; $solverName="solid5"; 
$bcCommands="all=displacementBC\n bcNumber104=tractionBC\n bcNumber104=tractionInterface"; 
$exponent=10.; $x0=.5; $y0=.5; $z0=.5;  $rhoSolid=$rhoSolid0*$scf5; $lambda=$lambdaSolid*$scf5; $mu=$muSolid*$scf5; 
$initialConditionCommands="zeroInitialCondition";
#
#
echo to terminal 0
