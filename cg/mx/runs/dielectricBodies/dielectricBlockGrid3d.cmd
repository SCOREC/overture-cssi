#
# Grid for a rectangular 3D dielectric block in a channel
#
#
# usage: ogen [noplot] dielectricBlockGrid3d -factor=<num> -order=[2/4/6/8] -interp=[e/i] -blf=<num> -ml=<>  -rgd=[fixed|var] ...
...
# 
# examples:
#     ogen -noplot dielectricBlockGrid3d -order=2 -interp=e -factor=2
#
#
#
$prefix="dielectricBlockGrid3d";  $rgd="var"; $angle=0.; 
$numGhost=-1;  # if this value is set, then use this number of ghost points
$width=1.;  # width of the block
$order=2; $factor=1; $interp="i"; $ml=0; # default values
$orderOfAccuracy = "second order"; $ng=2; $interpType = "implicit for all grids";
$name=""; $xa=-2.5; $xb=2.5; $ya=-.25; $yb=.25; $za=-.25; $zb=.25; 
$cx=0.;     # center of the block 
# 
