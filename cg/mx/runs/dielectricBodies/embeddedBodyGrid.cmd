#
#     Solid bodies in a channel
#
#
# usage: ogen [-noplot] embeddedBodyGrid -factor=<num> -order=[2/4/6/8] -interp=[e/i] ...
...
# Examples:
# 
#     ogen -noplot embeddedBodyGrid -shape=ellipse -prefix=ellipticalGrid -interp=e -factor=4
#     ogen -noplot embeddedBodyGrid -shape=ellipse -prefix=ellipticalGrid -interp=e -factor=8
#
#     ogen -noplot embeddedBodyGrid -shape=ellipse -prefix=ellipticalGrid -interp=e -order=4 -factor=8
# 
#  -- star-fish 
#     ogen -noplot embeddedBodyGrid -shape=starFish -prefix=starFishGrid -interp=e -order=2 -factor=64
#     ogen -noplot embeddedBodyGrid -shape=starFish -prefix=starFishGrid -interp=e -order=2 -factor=128
#
#  --- cross:
#   ogen -noplot embeddedBodyGrid -shape=cross -prefix=crossGrid -interp=e -order=2 -factor=16
#   ogen -noplot embeddedBodyGrid -shape=cross -prefix=crossGrid -interp=i -order=4 -factor=16
#
#  --- I-Beam
#   ogen -noplot embeddedBodyGrid -shape=IBeam -prefix=IBeamGrid -interp=e -order=2 -factor=8
#   ogen -noplot embeddedBodyGrid -shape=IBeam -prefix=IBeamGrid -interp=i -order=4 -factor=8
#
$shape="ellipse"; 
$prefix="embeddedBodyGrid";  $rgd="var"; $angle=0.; $branch=0; $per=1; 
$order=2; $factor=1; $interp="i"; $ml=0; # default values
$orderOfAccuracy = "second order"; $ng=2; $interpType = "implicit for all grids";
$name=""; $xa=-2.; $xb=2.; $ya=-1.5; $yb=1.5; 
...
rectangle
  ...
  mappingName
    backGround
exit
# -- refinement around body ---
rectangle
  $xar = -1.25; $xbr=1.25; $yar=-1; $ybr=1; 
  set corners
    $xar $xbr $yar $ybr
  lines
