#================================================================================================
#
#  cgmx example:  scattering from multiple material domains  (started from dieletricBodies.cmd)
#
echo to terminal 0
#
# Usage:
#   
#  cgmx [-noplot] multiDomain -g=<name> -tf=<tFinal> -tp=<tPlot> -kx=<num> -ky=<num> -kz=<num> ...
...
# RUN: cgmx multiDomain -g=diskInBoxYpe4.order4.hdf -backGround=outerSquare -kx=4 -eps1=11.9025 -eps2=1. -go=halt
#
#  ---- IBeam ---
#
#================================================================================================
...
#
@epsv = ( $eps0, $eps1, $eps2, $eps3, $eps4 );
@muv  = ( $mu0,  $mu1,  $mu2,  $mu3,  $mu4 );
$numDomains=5; 
@domainName = ( "outerDomain", "bigDiskDomain", "bigDiskCircleDomain", "mediumDiskDomain", "mediumDiskCircleDomain" ); 
$cmd="#";
...
# New: Jan,9 2019 
# ------------ Set GDM parameters on the bigDiskDomain domain -----------
GDM domain name: bigDiskDomain
  number of polarization vectors: $npv[0]
  # -- read material parameters from a file 
  material file: $dmFile[0]
#
# ------------ Set GDM parameters on the bigDiskCircleDomain domain -----------
GDM domain name: bigDiskCircleDomain
  number of polarization vectors: $npv[1]
  # -- read material parameters from a file 
  material file: $dmFile[1]
#
# ------------ Set GDM parameters on the mediumDiskDomain domain -----------
GDM domain name: mediumDiskDomain
  number of polarization vectors: $npv[2]
  # -- read material parameters from a file 
  material file: $dmFile[2]
#
# ------------ Set GDM parameters on the mediumDiskCircleDomain -----------
GDM domain name: mediumDiskCircleDomain
  number of polarization vectors: $npv[3]
  # -- read material parameters from a file 
  material file: $dmFile[3]
#
# *****************
