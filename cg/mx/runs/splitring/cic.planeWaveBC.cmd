...
#================================================================================================
# 
$tFinal=10.; $tPlot=.05; $diss=.1; $dissOrder=-1; $cfl=.9; $kx=.0; $ky=0.; $kz=3.; $method="NFDTD";
...
#
$useSosupDissipation=1; $sosupParameter=1.;  $sosupDissipationOption=1; $sosupDissipationFrequency=1;
