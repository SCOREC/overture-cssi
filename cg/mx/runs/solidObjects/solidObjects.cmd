#================================================================================================
#
#  Cgmx example:  scattering from multiple material domains 
#
echo to terminal 0
#
# Usage:
#   
#  cgmx [-noplot] solidObjects -g=<name> -tf=<tFinal> -tp=<tPlot> -kx=<num> -ky=<num> -kz=<num> ...
...
#                 -probeFileName=<s> -xLeftProbe=<f> -xRightProbe=<f> -option=[bodies|rpi] ...
...
# RUN: cgmx solidObjects -g=diskInBoxYpe4.order4.hdf -backGround=outerSquare -kx=4 -eps1=11.9025 -eps2=1. -go=halt
#
#  ---- IBeam ---
#
#================================================================================================
...
#
$numDomains=3; 
@domainName = ( "outerDomain", "iBeamDomain", "splitRingDomain" ); 
# --- RPI grid: 
if( $option eq "rpi" ){ $numDomains=4; @domainName=("fluidDomain","solidDomain1","solidDomain2","solidDomain3" );  }
# 
$cmd="#";
...
# 
# ------------ Set GDM parameters for the bodies -----------
$numBodies = $numDomains -1;
$cmd=""; 
...
#- #
#- # ------------ Set GDM parameters for domain 3 -----------
#- GDM domain name:  $domainName[3]
