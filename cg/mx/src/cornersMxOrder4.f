...
! ****************** done Hz extended fourth-order ********************
     ...
     & 12.*dsa)
                       ...
                       fw4=0.
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & is1,i2,i3,0),xy(i1-is1,i2,i3,1),t,uv0(0),uv0(1),uv0(2))
                         tdu10=a11m1*uv0(0)+a12m1*uv0(1)
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2-is2,i3,0),xy(i1,i2-is2,i3,1),t,uv0(0),uv0(1),uv0(2))
                         tdu01=a21zm1*uv0(0)+a22zm1*uv0(1)
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-2*
     & is1,i2,i3,0),xy(i1-2*is1,i2,i3,1),t,uv0(0),uv0(1),uv0(2))
                         tdu20=a11m2*uv0(0)+a12m2*uv0(1)
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2-2*is2,i3,0),xy(i1,i2-2*is2,i3,1),t,uv0(0),uv0(1),uv0(2))
     ...
     & i1,i2,i3,1),0.,t,ey, vss)
                         ...
                         ! Now compute forcing for Hz
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2,i3,0),xy(i1,i2,i3,1),t,uv0(0),uv0(1),uv0(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & is1,i2,i3,0),xy(i1-is1,i2,i3,1),t,uvm(0),uvm(1),uvm(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1+
     & is1,i2,i3,0),xy(i1+is1,i2,i3,1),t,uvp(0),uvp(1),uvp(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-2*
     & is1,i2,i3,0),xy(i1-2*is1,i2,i3,1),t,uvm2(0),uvm2(1),uvm2(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1+2*
     & is1,i2,i3,0),xy(i1+2*is1,i2,i3,1),t,uvp2(0),uvp2(1),uvp2(2))
     ...
     & i2,i3,0),xy(i1,i2,i3,1),t,uv0(0),uv0(1),uv0(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2-is2,i3,0),xy(i1,i2-is2,i3,1),t,uvm(0),uvm(1),uvm(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2+is2,i3,0),xy(i1,i2+is2,i3,1),t,uvp(0),uvp(1),uvp(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2-2*is2,i3,0),xy(i1,i2-2*is2,i3,1),t,uvm2(0),uvm2(1),uvm2(2))
                          call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2+2*is2,i3,0),xy(i1,i2+2*is2,i3,1),t,uvp2(0),uvp2(1),uvp2(2))
...
! ****************** done Hz extended fourth-order ********************
     ...
     & 1)
                         call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,i2-
     & is2,i3,0),xy(i1,i2-is2,i3,1),t,uv0(0),uv0(1),uv0(2))
     ...
     & i3,ey)-uv0(1)
                         call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,i2-
     & 2*is2,i3,0),xy(i1,i2-2*is2,i3,1),t,uv0(0),uv0(1),uv0(2))
     ...
     & vrrss + 4.*(2.*dra)*(2.*dsa)**3*vrsss + (2.*dsa)**4*vssss )
                        ...
                        ! check errors
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & is1,i2-is2,i3,0),xy(i1-is1,i2-is2,i3,1),t,uv0(0),uv0(1),uv0(2))
                          if( debug.gt.0 ) write(*,'(" 
     ...
     & ey)-uv0(1)
                          ...
                          if( setCornersToExact )then
                           ...
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & 2*is1,i2-is2,i3,0),xy(i1-2*is1,i2-is2,i3,1),t,uv0(0),uv0(1),
     & uv0(2))
                          if( debug.gt.0 ) write(*,'(" 
     ...
     & i2-is2,i3,ey)-uv0(1)
                          ...
                          if( setCornersToExact )then
                           ...
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & is1,i2-2*is2,i3,0),xy(i1-is1,i2-2*is2,i3,1),t,uv0(0),uv0(1),
     & uv0(2))
                          if( debug.gt.0 ) write(*,'(" 
     ...
     & i2-2*is2,i3,ey)-uv0(1)
                          ...
                          if( setCornersToExact )then
                           ...
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & 2*is1,i2-2*is2,i3,0),xy(i1-2*is1,i2-2*is2,i3,1),t,uv0(0),uv0(1)
     & ,uv0(2))
                          if( debug.gt.0 ) write(*,'(" 
     ...
     & u(i1-2*is1,i2-2*is2,i3,ey)-uv0(1)
                        ...
                        urss=0. !  (from ur(0,s)=0 and us(r,0)=0)
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & 1,i2-1,i3,0),xy(i1-1,i2-1,i3,1),t,uvmm(0),uvmm(1),uvmm(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2-1,i3,0),xy(i1,i2-1,i3,1),t,uvzm(0),uvzm(1),uvzm(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1+
     & 1,i2-1,i3,0),xy(i1+1,i2-1,i3,1),t,uvpm(0),uvpm(1),uvpm(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & 1,i2,i3,0),xy(i1-1,i2,i3,1),t,uvmz(0),uvmz(1),uvmz(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2,i3,0),xy(i1,i2,i3,1),t,uvzz(0),uvzz(1),uvzz(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1+
     & 1,i2,i3,0),xy(i1+1,i2,i3,1),t,uvpz(0),uvpz(1),uvpz(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1-
     & 1,i2+1,i3,0),xy(i1-1,i2+1,i3,1),t,uvmp(0),uvmp(1),uvmp(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1,
     & i2+1,i3,0),xy(i1,i2+1,i3,1),t,uvzp(0),uvzp(1),uvzp(2))
                           call ogf2dfo(ep,ex,ey,hz,fieldOption,xy(i1+
     & 1,i2+1,i3,0),xy(i1+1,i2+1,i3,1),t,uvpp(0),uvpp(1),uvpp(2))
                    ...
                    !     *wdh* 2015/07/11 
                     ...
                     do i1=n1a,n1b
                      ...
                      ii3=i3-js3+ms3
                        ...
                        u(i1-js1,i2-js2,i3-js3,ex)=(5.*u(ii1,ii2,ii3,
     & ex)-10.*u(ii1+ms1,ii2+ms2,ii3+ms3,ex)+10.*u(ii1+2*ms1,ii2+2*
     & ms2,ii3+2*ms3,ex)-5.*u(ii1+3*ms1,ii2+3*ms2,ii3+3*ms3,ex)+u(ii1+
     & 4*ms1,ii2+4*ms2,ii3+4*ms3,ex))
                        u(i1-js1,i2-js2,i3-js3,ey)=(5.*u(ii1,ii2,ii3,
     & ey)-10.*u(ii1+ms1,ii2+ms2,ii3+ms3,ey)+10.*u(ii1+2*ms1,ii2+2*
     & ms2,ii3+2*ms3,ey)-5.*u(ii1+3*ms1,ii2+3*ms2,ii3+3*ms3,ey)+u(ii1+
     & 4*ms1,ii2+4*ms2,ii3+4*ms3,ey))
                        u(i1-js1,i2-js2,i3-js3,ez)=(5.*u(ii1,ii2,ii3,
     & ez)-10.*u(ii1+ms1,ii2+ms2,ii3+ms3,ez)+10.*u(ii1+2*ms1,ii2+2*
     & ms2,ii3+2*ms3,ez)-5.*u(ii1+3*ms1,ii2+3*ms2,ii3+3*ms3,ez)+u(ii1+
     & 4*ms1,ii2+4*ms2,ii3+4*ms3,ez))
                     end do ! end do i1
                     end do ! end do i2
                     end do ! end do i3
                   else if( bc1.eq.dirichlet .or. bc2.eq.dirichlet )
     ...
     & .eq.perfectElectricalConductor) )then
                  ...
                  do m1=1,numberOfGhostPoints
                    ...
                    ii3=i3-js3+is3
                     ...
                     ! u(i1-js1,i2-js2,i3-js3,ey)=extrap5(u,i1,i2,i3,ey,js1,js2,js3)
                     ! u(i1-js1,i2-js2,i3-js3,ez)=extrap5(u,i1,i2,i3,ez,js1,js2,js3)
                     u(i1-js1,i2-js2,i3-js3,ex)=(5.*u(ii1,ii2,ii3,ex)-
     & 10.*u(ii1+is1,ii2+is2,ii3+is3,ex)+10.*u(ii1+2*is1,ii2+2*is2,
     & ii3+2*is3,ex)-5.*u(ii1+3*is1,ii2+3*is2,ii3+3*is3,ex)+u(ii1+4*
     & is1,ii2+4*is2,ii3+4*is3,ex))
                     u(i1-js1,i2-js2,i3-js3,ey)=(5.*u(ii1,ii2,ii3,ey)-
     & 10.*u(ii1+is1,ii2+is2,ii3+is3,ey)+10.*u(ii1+2*is1,ii2+2*is2,
     & ii3+2*is3,ey)-5.*u(ii1+3*is1,ii2+3*is2,ii3+3*is3,ey)+u(ii1+4*
     & is1,ii2+4*is2,ii3+4*is3,ey))
                     u(i1-js1,i2-js2,i3-js3,ez)=(5.*u(ii1,ii2,ii3,ez)-
     & 10.*u(ii1+is1,ii2+is2,ii3+is3,ez)+10.*u(ii1+2*is1,ii2+2*is2,
     & ii3+2*is3,ez)-5.*u(ii1+3*is1,ii2+3*is2,ii3+3*is3,ez)+u(ii1+4*
     & is1,ii2+4*is2,ii3+4*is3,ez))
                  end do ! end do m1
                  end do ! end do m2
                  end do ! end do m3
...
! **** Now assign the extended boundary points **** 
     ...
     & js1,i2-2*js2,i3-2*js3,0),xy(i1-2*js1,i2-2*js2,i3-2*js3,1),xy(
     & i1-2*js1,i2-2*js2,i3-2*js3,2),t,uvm2(0),uvm2(1),uvm2(2))
                          call ogf3dfo(ep,ex,ey,ez,fieldOption,xy(i1+2*
     & js1,i2+2*js2,i3+2*js3,0),xy(i1+2*js1,i2+2*js2,i3+2*js3,1),xy(
     & i1+2*js1,i2+2*js2,i3+2*js3,2),t,uvp2(0),uvp2(1),uvp2(2))
                        m1=i1-2*js1
                        m2=i2-2*js2
                        m3=i3-2*js3
     ...
     & i1-2*is1,i2-2*is2,i3-2*is3,2),t,uvm2(0),uvm2(1),uvm2(2))
                          call ogf3dfo(ep,ex,ey,ez,fieldOption,xy(i1+2*
     & is1,i2+2*is2,i3+2*is3,0),xy(i1+2*is1,i2+2*is2,i3+2*is3,1),xy(
     & i1+2*is1,i2+2*is2,i3+2*is3,2),t,uvp2(0),uvp2(1),uvp2(2))
                        m1=i1-2*is1
                        m2=i2-2*is2
                        m3=i3-2*is3
