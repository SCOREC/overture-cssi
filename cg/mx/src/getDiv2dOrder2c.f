! This file automatically generated from getDiv.bf with bpp.
       subroutine getDiv2dOrder2c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & )then
        ...
        if( method.ne.bamx )then
         ! --- Isotropic Maxwell ----
            if( t.lt.2*dt )then
              write(*,'("computeDiv dim=2 order=2 grid=curvilinear ... 
     & t=",e10.2)') t
            end if
            ...
            ! Loop bounds -- exclude absorbing layers ? 
              ...
              do i1=n1a,n1b
               ...
               ! --- 2D -----
                   divD(i1,i2,i3) = vx22(i1,i2,i3,ex) + vy22(i1,i2,i3,
     & ey)
