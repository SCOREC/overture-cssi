...
c============================================================================================
           ...
           ! ****************************************************************************
            ...
            if( useSosupDissipation.ne.0 )then
               if( t.le.3.*dt .and. debug.gt.1 )then
                 write(*,'("advMxUp>>>","advMxUp:FD44+upwind-
     ...
     & timeSteppingMethod.eq.modifiedEquationTimeStepping )then
       ...
       !$$$ loopsFCD2D($$getLapSq2dOrder2(),!$$$                  dtsq*f(i1,i2,i3,ex),dtsq*f(i1,i2,i3,ey),dtsq*f(i1,i2,i3,hz),!$$$                  un(i1,i2,i3,ex)=max2dc44me(i1,i2,i3,ex),!$$$                  un(i1,i2,i3,ey)=max2dc44me(i1,i2,i3,ey),!$$$                  un(i1,i2,i3,hz)=max2dc44me(i1,i2,i3,hz))
              ! do one at a time -- is this faster ? NO
       !$$$ loopsFCD2DA($$evalLapSq2dOrder2(ex),!$$$             dtsq*f(i1,i2,i3,ex),!$$$             un(i1,i2,i3,ex)=max2dc44me(i1,i2,i3,ex))
       !$$$
     ...
     & then
                 ! add forcing to the first 3 equations
                   if( useWhereMask.ne.0 )then
                    ...
                    do i1=n1a,n1b
                     if( mask(i1,i2,i3).gt.0 )then
                      un(i1,i2,i3,ex)=max2dc44me2(i1,i2,i3,ex)+dtsq*
     & f2dcme44(i1,i2,i3,ex)
                      un(i1,i2,i3,ey)=max2dc44me2(i1,i2,i3,ey)+dtsq*
     & f2dcme44(i1,i2,i3,ey)
                      un(i1,i2,i3,hz)=max2dc44me2(i1,i2,i3,hz)+dtsq*
     ...
     & f2dcme44(i1,i2,i3,hz)
                 ...
                 ! add dissipation to the first 3 equations
                   if( useWhereMask.ne.0 )then
                    ...
                    do i1=n1a,n1b
                     if( mask(i1,i2,i3).gt.0 )then
                      un(i1,i2,i3,ex)=max2dc44me2(i1,i2,i3,ex)+dis(i1,
     & i2,i3,ex)
                      un(i1,i2,i3,ey)=max2dc44me2(i1,i2,i3,ey)+dis(i1,
     & i2,i3,ey)
                      un(i1,i2,i3,hz)=max2dc44me2(i1,i2,i3,hz)+dis(i1,
     & i2,i3,hz)
     ...
     & then
                 ! add forcing to the first 3 equations
                   if( useWhereMask.ne.0 )then
                    ...
                    do i1=n1a,n1b
                     if( mask(i1,i2,i3).gt.0 )then
                      un(i1,i2,i3,ex)=max2dc44me2(i1,i2,i3,ex)+dtsq*f(
     & i1,i2,i3,ex)
                      un(i1,i2,i3,ey)=max2dc44me2(i1,i2,i3,ey)+dtsq*f(
     & i1,i2,i3,ey)
                      un(i1,i2,i3,hz)=max2dc44me2(i1,i2,i3,hz)+dtsq*f(
     & i1,i2,i3,hz)
     ...
     & i1,i2,i3,hz)+dis(i1,i2,i3,hz)
               ...
               ! add forcing to the first 3 equations
                 if( useWhereMask.ne.0 )then
                  ...
                  do i1=n1a,n1b
                   if( mask(i1,i2,i3).gt.0 )then
                    un(i1,i2,i3,ex)=mxdc2d4cEx(i1,i2,i3)+dtsq*f(i1,i2,
     & i3,ex)
                    un(i1,i2,i3,ey)=mxdc2d4cEy(i1,i2,i3)+dtsq*f(i1,i2,
     & i3,ey)
                    un(i1,i2,i3,hz)=max2dc44me2(i1,i2,i3,hz)+dtsq*f(i1,
     & i2,i3,hz)
     ...
     & i2,i3,hz)
               ...
               ! add dissipation to the first 3 equations
                 if( useWhereMask.ne.0 )then
                  ...
                  do i1=n1a,n1b
                   if( mask(i1,i2,i3).gt.0 )then
                    un(i1,i2,i3,ex)=mxdc2d4cEx(i1,i2,i3)+dis(i1,i2,i3,
     & ex)
                    un(i1,i2,i3,ey)=mxdc2d4cEy(i1,i2,i3)+dis(i1,i2,i3,
     & ey)
                    un(i1,i2,i3,hz)=max2dc44me2(i1,i2,i3,hz)+dis(i1,i2,
     & i3,hz)
                ...
                if( .not.addDissipation )then
                 if( nd.eq.2 )then
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,ex)=mxdc2d4cConsEx(i1,i2,i3)
                 ...
                 if( nd.eq.2 )then
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,ex)=mxdc2d4cConsEx(i1,i2,i3)+dis(i1,
     & i2,i3,ex)
                     un(i1,i2,i3,ey)=mxdc2d4cConsEy(i1,i2,i3)+dis(i1,
     & i2,i3,ey)
     ...
     & i2,i3,hz)
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                    un(i1,i2,i3,ex)=mxdc2d4cConsEx(i1,i2,i3)+dis(i1,i2,
     & i3,ex)
                    un(i1,i2,i3,ey)=mxdc2d4cConsEy(i1,i2,i3)+dis(i1,i2,
     & i3,ey)
     ...
     & i2,i3,hz)
                  ...
                  if( solveForE.ne.0 .and. solveForH.ne.0 )then
                    if( useWhereMask.ne.0 )then
                      ...
                      do i1=n1a,n1b
                        if( mask(i1,i2,i3).gt.0 )then
                          un(i1,i2,i3,ex)=mxdc2d4cConsEx(i1,i2,i3)+dis(
     & i1,i2,i3,ex)
                          un(i1,i2,i3,ey)=mxdc2d4cConsEy(i1,i2,i3)+dis(
     & i1,i2,i3,ey)
                          un(i1,i2,i3,ez)=maxwellc44me(i1,i2,i3,ez)+
     & dis(i1,i2,i3,ez)
