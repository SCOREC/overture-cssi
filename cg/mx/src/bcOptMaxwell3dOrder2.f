! This file automatically generated from bcOptMaxwell.bf with bpp.
        subroutine bcOptMaxwell3dOrder2( nd, nd1a,nd1b,nd2a,nd2b,nd3a,
...
! boundary conditions
     ...
     & is2,i3-is3)*tx(i1-is1,i2-is2,i3-is3)-sx(i1-is1,i2-is2,i3-is3)*
     & tz(i1-is1,i2-is2,i3-is3))+rz(i1-is1,i2-is2,i3-is3)*(sx(i1-is1,
     & i2-is2,i3-is3)*ty(i1-is1,i2-is2,i3-is3)-sy(i1-is1,i2-is2,i3-
     & is3)*tx(i1-is1,i2-is2,i3-is3)))
                    ...
                    det = (-tau12*a13m*tau21+a12m*tau13*tau21-a11m*
     & tau22*tau13+a13m*tau22*tau11+tau12*a11m*tau23-a12m*tau11*tau23)
                    jacp1=1./(rx(i1+is1,i2+is2,i3+is3)*(sy(i1+is1,i2+
     & is2,i3+is3)*tz(i1+is1,i2+is2,i3+is3)-sz(i1+is1,i2+is2,i3+is3)*
     & ty(i1+is1,i2+is2,i3+is3))+ry(i1+is1,i2+is2,i3+is3)*(sz(i1+is1,
     & i2+is2,i3+is3)*tx(i1+is1,i2+is2,i3+is3)-sx(i1+is1,i2+is2,i3+
     & is3)*tz(i1+is1,i2+is2,i3+is3))+rz(i1+is1,i2+is2,i3+is3)*(sx(i1+
     & is1,i2+is2,i3+is3)*ty(i1+is1,i2+is2,i3+is3)-sy(i1+is1,i2+is2,
     & i3+is3)*tx(i1+is1,i2+is2,i3+is3)))
                    ...
                    ! gx1=tau11*(2.*u(i1,i2,i3,ex)-u(i1+is1,i2+is2,i3+is3,ex))!    +tau12*(2.*u(i1,i2,i3,ey)-u(i1+is1,i2+is2,i3+is3,ey))!    +tau13*(2.*u(i1,i2,i3,ez)-u(i1+is1,i2+is2,i3+is3,ez))
                    ! gx2=tau21*(2.*u(i1,i2,i3,ex)-u(i1+is1,i2+is2,i3+is3,ex))!    +tau22*(2.*u(i1,i2,i3,ey)-u(i1+is1,i2+is2,i3+is3,ey))!    +tau23*(2.*u(i1,i2,i3,ez)-u(i1+is1,i2+is2,i3+is3,ez))
                    ! Use higher order ** 040120 **
                    gx1=tau11*(4.*u(i1,i2,i3,ex)-6.*u(i1+is1,i2+is2,i3+
     & is3,ex)+4.*u(i1+2*is1,i2+2*is2,i3+2*is3,ex)-u(i1+3*is1,i2+3*
     & is2,i3+3*is3,ex))+tau12*(4.*u(i1,i2,i3,ey)-6.*u(i1+is1,i2+is2,
     & i3+is3,ey)+4.*u(i1+2*is1,i2+2*is2,i3+2*is3,ey)-u(i1+3*is1,i2+3*
     & is2,i3+3*is3,ey))+tau13*(4.*u(i1,i2,i3,ez)-6.*u(i1+is1,i2+is2,
     & i3+is3,ez)+4.*u(i1+2*is1,i2+2*is2,i3+2*is3,ez)-u(i1+3*is1,i2+3*
     & is2,i3+3*is3,ez))
                    gx2=tau21*(4.*u(i1,i2,i3,ex)-6.*u(i1+is1,i2+is2,i3+
     & is3,ex)+4.*u(i1+2*is1,i2+2*is2,i3+2*is3,ex)-u(i1+3*is1,i2+3*
     & is2,i3+3*is3,ex))+tau22*(4.*u(i1,i2,i3,ey)-6.*u(i1+is1,i2+is2,
     & i3+is3,ey)+4.*u(i1+2*is1,i2+2*is2,i3+2*is3,ey)-u(i1+3*is1,i2+3*
     & is2,i3+3*is3,ey))+tau23*(4.*u(i1,i2,i3,ez)-6.*u(i1+is1,i2+is2,
     & i3+is3,ez)+4.*u(i1+2*is1,i2+2*is2,i3+2*is3,ez)-u(i1+3*is1,i2+3*
     & is2,i3+3*is3,ez))
     ...
     & js2,i3+js3)-sz(i1+js1,i2+js2,i3+js3)*ty(i1+js1,i2+js2,i3+js3))+
     & ry(i1+js1,i2+js2,i3+js3)*(sz(i1+js1,i2+js2,i3+js3)*tx(i1+js1,
     & i2+js2,i3+js3)-sx(i1+js1,i2+js2,i3+js3)*tz(i1+js1,i2+js2,i3+
     & js3))+rz(i1+js1,i2+js2,i3+js3)*(sx(i1+js1,i2+js2,i3+js3)*ty(i1+
     & js1,i2+js2,i3+js3)-sy(i1+js1,i2+js2,i3+js3)*tx(i1+js1,i2+js2,
     & i3+js3))))
                     a22zp1=(rsxy(i1+js1,i2+js2,i3+js3,axisp1,1)/(rx(
     & i1+js1,i2+js2,i3+js3)*(sy(i1+js1,i2+js2,i3+js3)*tz(i1+js1,i2+
     & js2,i3+js3)-sz(i1+js1,i2+js2,i3+js3)*ty(i1+js1,i2+js2,i3+js3))+
     & ry(i1+js1,i2+js2,i3+js3)*(sz(i1+js1,i2+js2,i3+js3)*tx(i1+js1,
     & i2+js2,i3+js3)-sx(i1+js1,i2+js2,i3+js3)*tz(i1+js1,i2+js2,i3+
     ...
     & js1,i2+js2,i3+js3)-sy(i1+js1,i2+js2,i3+js3)*tx(i1+js1,i2+js2,
     & i3+js3))))
                     a23zp1=(rsxy(i1+js1,i2+js2,i3+js3,axisp1,2)/(rx(
     & i1+js1,i2+js2,i3+js3)*(sy(i1+js1,i2+js2,i3+js3)*tz(i1+js1,i2+
     & js2,i3+js3)-sz(i1+js1,i2+js2,i3+js3)*ty(i1+js1,i2+js2,i3+js3))+
     & ry(i1+js1,i2+js2,i3+js3)*(sz(i1+js1,i2+js2,i3+js3)*tx(i1+js1,
     & i2+js2,i3+js3)-sx(i1+js1,i2+js2,i3+js3)*tz(i1+js1,i2+js2,i3+
     ...
     & js1,i2+js2,i3+js3)-sy(i1+js1,i2+js2,i3+js3)*tx(i1+js1,i2+js2,
     & i3+js3))))
                     a21zm1=(rsxy(i1-js1,i2-js2,i3-js3,axisp1,0)/(rx(
     & i1-js1,i2-js2,i3-js3)*(sy(i1-js1,i2-js2,i3-js3)*tz(i1-js1,i2-
     & js2,i3-js3)-sz(i1-js1,i2-js2,i3-js3)*ty(i1-js1,i2-js2,i3-js3))+
     & ry(i1-js1,i2-js2,i3-js3)*(sz(i1-js1,i2-js2,i3-js3)*tx(i1-js1,
     & i2-js2,i3-js3)-sx(i1-js1,i2-js2,i3-js3)*tz(i1-js1,i2-js2,i3-
     ...
     & js1,i2-js2,i3-js3)-sy(i1-js1,i2-js2,i3-js3)*tx(i1-js1,i2-js2,
     & i3-js3))))
                     a22zm1=(rsxy(i1-js1,i2-js2,i3-js3,axisp1,1)/(rx(
     & i1-js1,i2-js2,i3-js3)*(sy(i1-js1,i2-js2,i3-js3)*tz(i1-js1,i2-
     & js2,i3-js3)-sz(i1-js1,i2-js2,i3-js3)*ty(i1-js1,i2-js2,i3-js3))+
     & ry(i1-js1,i2-js2,i3-js3)*(sz(i1-js1,i2-js2,i3-js3)*tx(i1-js1,
     & i2-js2,i3-js3)-sx(i1-js1,i2-js2,i3-js3)*tz(i1-js1,i2-js2,i3-
     ...
     & js1,i2-js2,i3-js3)-sy(i1-js1,i2-js2,i3-js3)*tx(i1-js1,i2-js2,
     & i3-js3))))
                     a23zm1=(rsxy(i1-js1,i2-js2,i3-js3,axisp1,2)/(rx(
     & i1-js1,i2-js2,i3-js3)*(sy(i1-js1,i2-js2,i3-js3)*tz(i1-js1,i2-
     & js2,i3-js3)-sz(i1-js1,i2-js2,i3-js3)*ty(i1-js1,i2-js2,i3-js3))+
     & ry(i1-js1,i2-js2,i3-js3)*(sz(i1-js1,i2-js2,i3-js3)*tx(i1-js1,
     & i2-js2,i3-js3)-sx(i1-js1,i2-js2,i3-js3)*tz(i1-js1,i2-js2,i3-
     ...
     & js1,i2-js2,i3-js3)-sy(i1-js1,i2-js2,i3-js3)*tx(i1-js1,i2-js2,
     & i3-js3))))
                     a31zp1=(rsxy(i1+ks1,i2+ks2,i3+ks3,axisp2,0)/(rx(
     & i1+ks1,i2+ks2,i3+ks3)*(sy(i1+ks1,i2+ks2,i3+ks3)*tz(i1+ks1,i2+
     & ks2,i3+ks3)-sz(i1+ks1,i2+ks2,i3+ks3)*ty(i1+ks1,i2+ks2,i3+ks3))+
     & ry(i1+ks1,i2+ks2,i3+ks3)*(sz(i1+ks1,i2+ks2,i3+ks3)*tx(i1+ks1,
     & i2+ks2,i3+ks3)-sx(i1+ks1,i2+ks2,i3+ks3)*tz(i1+ks1,i2+ks2,i3+
     & ks3))+rz(i1+ks1,i2+ks2,i3+ks3)*(sx(i1+ks1,i2+ks2,i3+ks3)*ty(i1+
     & ks1,i2+ks2,i3+ks3)-sy(i1+ks1,i2+ks2,i3+ks3)*tx(i1+ks1,i2+ks2,
     & i3+ks3))))
                     a32zp1=(rsxy(i1+ks1,i2+ks2,i3+ks3,axisp2,1)/(rx(
     & i1+ks1,i2+ks2,i3+ks3)*(sy(i1+ks1,i2+ks2,i3+ks3)*tz(i1+ks1,i2+
     & ks2,i3+ks3)-sz(i1+ks1,i2+ks2,i3+ks3)*ty(i1+ks1,i2+ks2,i3+ks3))+
     & ry(i1+ks1,i2+ks2,i3+ks3)*(sz(i1+ks1,i2+ks2,i3+ks3)*tx(i1+ks1,
     & i2+ks2,i3+ks3)-sx(i1+ks1,i2+ks2,i3+ks3)*tz(i1+ks1,i2+ks2,i3+
     ...
     & ks1,i2+ks2,i3+ks3)-sy(i1+ks1,i2+ks2,i3+ks3)*tx(i1+ks1,i2+ks2,
     & i3+ks3))))
                     a33zp1=(rsxy(i1+ks1,i2+ks2,i3+ks3,axisp2,2)/(rx(
     & i1+ks1,i2+ks2,i3+ks3)*(sy(i1+ks1,i2+ks2,i3+ks3)*tz(i1+ks1,i2+
     & ks2,i3+ks3)-sz(i1+ks1,i2+ks2,i3+ks3)*ty(i1+ks1,i2+ks2,i3+ks3))+
     & ry(i1+ks1,i2+ks2,i3+ks3)*(sz(i1+ks1,i2+ks2,i3+ks3)*tx(i1+ks1,
     & i2+ks2,i3+ks3)-sx(i1+ks1,i2+ks2,i3+ks3)*tz(i1+ks1,i2+ks2,i3+
     ...
     & ks1,i2+ks2,i3+ks3)-sy(i1+ks1,i2+ks2,i3+ks3)*tx(i1+ks1,i2+ks2,
     & i3+ks3))))
                     a31zm1=(rsxy(i1-ks1,i2-ks2,i3-ks3,axisp2,0)/(rx(
     & i1-ks1,i2-ks2,i3-ks3)*(sy(i1-ks1,i2-ks2,i3-ks3)*tz(i1-ks1,i2-
     & ks2,i3-ks3)-sz(i1-ks1,i2-ks2,i3-ks3)*ty(i1-ks1,i2-ks2,i3-ks3))+
     & ry(i1-ks1,i2-ks2,i3-ks3)*(sz(i1-ks1,i2-ks2,i3-ks3)*tx(i1-ks1,
     & i2-ks2,i3-ks3)-sx(i1-ks1,i2-ks2,i3-ks3)*tz(i1-ks1,i2-ks2,i3-
     ...
     & ks1,i2-ks2,i3-ks3)-sy(i1-ks1,i2-ks2,i3-ks3)*tx(i1-ks1,i2-ks2,
     & i3-ks3))))
                     a32zm1=(rsxy(i1-ks1,i2-ks2,i3-ks3,axisp2,1)/(rx(
     & i1-ks1,i2-ks2,i3-ks3)*(sy(i1-ks1,i2-ks2,i3-ks3)*tz(i1-ks1,i2-
     & ks2,i3-ks3)-sz(i1-ks1,i2-ks2,i3-ks3)*ty(i1-ks1,i2-ks2,i3-ks3))+
     & ry(i1-ks1,i2-ks2,i3-ks3)*(sz(i1-ks1,i2-ks2,i3-ks3)*tx(i1-ks1,
     & i2-ks2,i3-ks3)-sx(i1-ks1,i2-ks2,i3-ks3)*tz(i1-ks1,i2-ks2,i3-
     ...
     & ks1,i2-ks2,i3-ks3)-sy(i1-ks1,i2-ks2,i3-ks3)*tx(i1-ks1,i2-ks2,
     & i3-ks3))))
                     a33zm1=(rsxy(i1-ks1,i2-ks2,i3-ks3,axisp2,2)/(rx(
     & i1-ks1,i2-ks2,i3-ks3)*(sy(i1-ks1,i2-ks2,i3-ks3)*tz(i1-ks1,i2-
     & ks2,i3-ks3)-sz(i1-ks1,i2-ks2,i3-ks3)*ty(i1-ks1,i2-ks2,i3-ks3))+
     & ry(i1-ks1,i2-ks2,i3-ks3)*(sz(i1-ks1,i2-ks2,i3-ks3)*tx(i1-ks1,
     & i2-ks2,i3-ks3)-sx(i1-ks1,i2-ks2,i3-ks3)*tz(i1-ks1,i2-ks2,i3-
     ...
     & i2+is2,i3+is3,ey)+a13p*u(i1+is1,i2+is2,i3+is3,ez)+ ( (a21zp1*u(
     & i1+js1,i2+js2,i3+js3,ex)+a22zp1*u(i1+js1,i2+js2,i3+js3,ey)+
     & a23zp1*u(i1+js1,i2+js2,i3+js3,ez))-(a21zm1*u(i1-js1,i2-js2,i3-
     & js3,ex)+a22zm1*u(i1-js1,i2-js2,i3-js3,ey)+a23zm1*u(i1-js1,i2-
     & js2,i3-js3,ez)))*dra/dsa + ( (a31zp1*u(i1+ks1,i2+ks2,i3+ks3,ex)
     & +a32zp1*u(i1+ks1,i2+ks2,i3+ks3,ey)+a33zp1*u(i1+ks1,i2+ks2,i3+
     & ks3,ez))-(a31zm1*u(i1-ks1,i2-ks2,i3-ks3,ex)+a32zm1*u(i1-ks1,i2-
     & ks2,i3-ks3,ey)+a33zm1*u(i1-ks1,i2-ks2,i3-ks3,ez)))*dra/dta
                    else
                      g1=a11p*u(i1+is1,i2+is2,i3+is3,ex)+a12p*u(i1+is1,
     ...
     & i1,i2,i3)-sy(i1,i2,i3)*tx(i1,i2,i3)))
                   ...
                   det=tau11*a13m*tau22-a11m*tau13*tau22-a13m*tau21*
     & tau12+a12m*tau21*tau13-tau11*a12m*tau23+a11m*tau12*tau23
                   u(i1-is1,i2-is2,i3-is3,ex) = -(-a12m*gx2*tau13+a12m*
     & tau23*gx1+a13m*tau12*gx2-a13m*gx1*tau22+g1*tau22*tau13-g1*
     & tau23*tau12)/det
                   u(i1-is1,i2-is2,i3-is3,ez) = -(-tau11*g1*tau22+
     & tau11*a12m*gx2-a11m*tau12*gx2+a11m*gx1*tau22-a12m*tau21*gx1+g1*
     & tau21*tau12)/det
     ...
     & ks1,i2-ks2,i3-ks3)-sy(i1-ks1,i2-ks2,i3-ks3)*tx(i1-ks1,i2-ks2,
     & i3-ks3))))
                     g1=( (a11p*u(i1+is1,i2+is2,i3+is3,ex)+a12p*u(i1+
     & is1,i2+is2,i3+is3,ey)+a13p*u(i1+is1,i2+is2,i3+is3,ez))-(a11m*u(
     & i1-is1,i2-is2,i3-is3,ex)+a12m*u(i1-is1,i2-is2,i3-is3,ey)+a13m*
     & u(i1-is1,i2-is2,i3-is3,ez)))/(2.*dra) + ( (a21zp1*u(i1+js1,i2+
     & js2,i3+js3,ex)+a22zp1*u(i1+js1,i2+js2,i3+js3,ey)+a23zp1*u(i1+
     & js1,i2+js2,i3+js3,ez))-(a21zm1*u(i1-js1,i2-js2,i3-js3,ex)+
     & a22zm1*u(i1-js1,i2-js2,i3-js3,ey)+a23zm1*u(i1-js1,i2-js2,i3-
     & js3,ez)))/(2.*dsa) + ( (a31zp1*u(i1+ks1,i2+ks2,i3+ks3,ex)+
     & a32zp1*u(i1+ks1,i2+ks2,i3+ks3,ey)+a33zp1*u(i1+ks1,i2+ks2,i3+
     & ks3,ez))-(a31zm1*u(i1-ks1,i2-ks2,i3-ks3,ex)+a32zm1*u(i1-ks1,i2-
     & ks2,i3-ks3,ey)+a33zm1*u(i1-ks1,i2-ks2,i3-ks3,ez)))/(2.*dta)
                   write(*,'(" bc2-3d: i=",3i4," divc=",e10.2," div=",
     & e10.2)') i1,i2,i3,g1,ux23(i1,i2,i3,ex)+uy23(i1,i2,i3,ey)+uz23(
     & i1,i2,i3,ez)
                   end do
                   end do
                   end do
