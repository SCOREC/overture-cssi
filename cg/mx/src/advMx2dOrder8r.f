          ...
          if( timeSteppingMethod.eq.modifiedEquationTimeStepping )then
              ...
              ! add forcing to the first 3 equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,ex)=maxwell2dr88me(i1,i2,i3,ex)+dtsq*f(
     & i1,i2,i3,ex)
                   un(i1,i2,i3,ey)=maxwell2dr88me(i1,i2,i3,ey)+dtsq*f(
     & i1,i2,i3,ey)
                   un(i1,i2,i3,hz)=maxwell2dr88me(i1,i2,i3,hz)+dtsq*f(
     & i1,i2,i3,hz)
     ...
     & i1,i2,i3,hz)
              ...
              ! add forcing to the first 3 equations
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   lap(ex)=csq*lap2d8(i1,i2,i3,ex)+f(i1,i2,i3,ex)
                   lap(ey)=csq*lap2d8(i1,i2,i3,ey)+f(i1,i2,i3,ey)
                   lap(hz)=csq*lap2d8(i1,i2,i3,hz)+f(i1,i2,i3,hz)
                   un(i1,i2,i3,ex)=maxwellr88(i1,i2,i3,ex)
                   un(i1,i2,i3,ey)=maxwellr88(i1,i2,i3,ey)
                   un(i1,i2,i3,hz)=maxwellr88(i1,i2,i3,hz)
                   ut7(i1,i2,i3,ex)=lap(ex)
