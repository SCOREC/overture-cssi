      ...
      // ********** Plane wave **********
            ...
            // -- dispersion model components --
              ...
              // eHat =(psir[iv]*ct-psii[iv]*st)*cx - (psir[iv]*st+psii[iv]*ct)*sx; // Phat 
                            eHat =(psir[iv]*ct-psii[iv]*st)*sx + (psir[iv]*st+psii[iv]*ct)*cx; // Phat 
                  ...
                  // *fix* me for numberOfPolarizationVectors>1 
                    ...
                    else  // --- 3D ----
                    {
                        ...
                        if( solveForMagneticField )
                        {
                            FOR_3D(i1,i2,i3,J1,J2,J3)
                            {
                                ERRHX(i1,i2,i3) = UHX(i1,i2,i3)-(UG(i1,i2,i3,hx)*cHr+UG(i1,i2,i3,hx+3)*cHi);
                                ERRHY(i1,i2,i3) = UHY(i1,i2,i3)-(UG(i1,i2,i3,hy)*cHr+UG(i1,i2,i3,hy+3)*cHi);
                                ERRHZ(i1,i2,i3) = UHZ(i1,i2,i3)-(UG(i1,i2,i3,hz)*cHr+UG(i1,i2,i3,hz+3)*cHi);
                            }
                        }
            // -- dispersion model components --
