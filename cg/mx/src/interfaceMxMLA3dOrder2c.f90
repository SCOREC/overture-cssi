! This file automatically generated from interfaceOpt.bf90 with bpp.
 subroutine interfaceMxMLA3dOrder2c( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange1, u1,u1n,u1m, wk1, mask1,rsxy1, xy1, p1,p1n,p1m, q1,q1n,q1m, boundaryCondition1, md1a,md1b,md2a,md2b,md3a,md3b,gridIndexRange2, u2,u2n,u2m, wk2, mask2,rsxy2, xy2, p2,p2n,p2m, q2,q2n,q2m, boundaryCondition2, ipar, rpar, aa2,aa4,aa8, ipvt2,ipvt4,ipvt8, ierr )
 ! ===================================================================================
 ...
 !............... end statement functions
           ...
           if( .false. )then
             ...
             if( dispersive.eq.0 )then
              ...
              ! Use Qing's unified interface macros
                if( t.le.3.*dt .and. debug.gt.0 )then
                  write(*,'("Interface>>>","23c-unified-dispersive")')
                end if
                 ...
                 if( mask1(i1,i2,i3).gt.0 .and. mask2(j1,j2,j3).gt.0 )then
                  ...
                  ! --- first evaluate the equations we want to solve with the wrong values at the ghost points:
                   ! NOTE: the jacobian derivatives can be computed once for all components
                    ...
                    aj1rxt = (-rsxy1(i1,i2,i3-1,0,0)+rsxy1(i1,i2,i3+1,0,0))/(2.*dr1(2))
                    ...
                    aj1sxt = (-rsxy1(i1,i2,i3-1,1,0)+rsxy1(i1,i2,i3+1,1,0))/(2.*dr1(2))
                    aj1tx = rsxy1(i1,i2,i3,2,0)
                    aj1txr = (-rsxy1(i1-1,i2,i3,2,0)+rsxy1(i1+1,i2,i3,2,0))/(2.*dr1(0))
                    aj1txs = (-rsxy1(i1,i2-1,i3,2,0)+rsxy1(i1,i2+1,i3,2,0))/(2.*dr1(1))
                    aj1txt = (-rsxy1(i1,i2,i3-1,2,0)+rsxy1(i1,i2,i3+1,2,0))/(2.*dr1(2))
                    ...
                    aj1ryt = (-rsxy1(i1,i2,i3-1,0,1)+rsxy1(i1,i2,i3+1,0,1))/(2.*dr1(2))
                    ...
                    aj1syt = (-rsxy1(i1,i2,i3-1,1,1)+rsxy1(i1,i2,i3+1,1,1))/(2.*dr1(2))
                    aj1ty = rsxy1(i1,i2,i3,2,1)
                    aj1tyr = (-rsxy1(i1-1,i2,i3,2,1)+rsxy1(i1+1,i2,i3,2,1))/(2.*dr1(0))
                    aj1tys = (-rsxy1(i1,i2-1,i3,2,1)+rsxy1(i1,i2+1,i3,2,1))/(2.*dr1(1))
                    aj1tyt = (-rsxy1(i1,i2,i3-1,2,1)+rsxy1(i1,i2,i3+1,2,1))/(2.*dr1(2))
                    aj1rz = rsxy1(i1,i2,i3,0,2)
                    aj1rzr = (-rsxy1(i1-1,i2,i3,0,2)+rsxy1(i1+1,i2,i3,0,2))/(2.*dr1(0))
                    aj1rzs = (-rsxy1(i1,i2-1,i3,0,2)+rsxy1(i1,i2+1,i3,0,2))/(2.*dr1(1))
                    aj1rzt = (-rsxy1(i1,i2,i3-1,0,2)+rsxy1(i1,i2,i3+1,0,2))/(2.*dr1(2))
                    aj1sz = rsxy1(i1,i2,i3,1,2)
                    aj1szr = (-rsxy1(i1-1,i2,i3,1,2)+rsxy1(i1+1,i2,i3,1,2))/(2.*dr1(0))
                    aj1szs = (-rsxy1(i1,i2-1,i3,1,2)+rsxy1(i1,i2+1,i3,1,2))/(2.*dr1(1))
                    aj1szt = (-rsxy1(i1,i2,i3-1,1,2)+rsxy1(i1,i2,i3+1,1,2))/(2.*dr1(2))
                    aj1tz = rsxy1(i1,i2,i3,2,2)
                    aj1tzr = (-rsxy1(i1-1,i2,i3,2,2)+rsxy1(i1+1,i2,i3,2,2))/(2.*dr1(0))
                    aj1tzs = (-rsxy1(i1,i2-1,i3,2,2)+rsxy1(i1,i2+1,i3,2,2))/(2.*dr1(1))
                    aj1tzt = (-rsxy1(i1,i2,i3-1,2,2)+rsxy1(i1,i2,i3+1,2,2))/(2.*dr1(2))
                    ...
                    aj1tzz = aj1rz*aj1tzr+aj1sz*aj1tzs+aj1tz*aj1tzt
                     ...
                     uu1rt = (-(-u1(i1-1,i2,i3-1,ex)+u1(i1-1,i2,i3+1,ex))/(2.*dr1(2))+(-u1(i1+1,i2,i3-1,ex)+u1(i1+1,i2,i3+1,ex))/(2.*dr1(2)))/(2.*dr1(0))
                     uu1st = (-(-u1(i1,i2-1,i3-1,ex)+u1(i1,i2-1,i3+1,ex))/(2.*dr1(2))+(-u1(i1,i2+1,i3-1,ex)+u1(i1,i2+1,i3+1,ex))/(2.*dr1(2)))/(2.*dr1(1))
                     uu1tt = (u1(i1,i2,i3-1,ex)-2.*u1(i1,i2,i3,ex)+u1(i1,i2,i3+1,ex))/(dr1(2)**2)
                      ...
                      t6 = aj1sx**2
                      t14 = aj1tx**2
                      u1xx = t1*uu1rr+2*aj1rx*aj1sx*uu1rs+t6*uu1ss+2*aj1rx*aj1tx*uu1rt+2*aj1sx*aj1tx*uu1st+t14*uu1tt+aj1rxx*uu1r+aj1sxx*uu1s+aj1txx*uu1t
                      t1 = aj1ry**2
                      t6 = aj1sy**2
                      t14 = aj1ty**2
                      u1yy = t1*uu1rr+2*aj1ry*aj1sy*uu1rs+t6*uu1ss+2*aj1ry*aj1ty*uu1rt+2*aj1sy*aj1ty*uu1st+t14*uu1tt+aj1ryy*uu1r+aj1syy*uu1s+aj1tyy*uu1t
                      t1 = aj1rz**2
                      t6 = aj1sz**2
                      t14 = aj1tz**2
                      u1zz = t1*uu1rr+2*aj1rz*aj1sz*uu1rs+t6*uu1ss+2*aj1rz*aj1tz*uu1rt+2*aj1sz*aj1tz*uu1st+t14*uu1tt+aj1rzz*uu1r+aj1szz*uu1s+aj1tzz*uu1t
                    u1Lap = u1xx+ u1yy+ u1zz
                     ...
                     vv1rt = (-(-u1(i1-1,i2,i3-1,ey)+u1(i1-1,i2,i3+1,ey))/(2.*dr1(2))+(-u1(i1+1,i2,i3-1,ey)+u1(i1+1,i2,i3+1,ey))/(2.*dr1(2)))/(2.*dr1(0))
                     vv1st = (-(-u1(i1,i2-1,i3-1,ey)+u1(i1,i2-1,i3+1,ey))/(2.*dr1(2))+(-u1(i1,i2+1,i3-1,ey)+u1(i1,i2+1,i3+1,ey))/(2.*dr1(2)))/(2.*dr1(1))
                     vv1tt = (u1(i1,i2,i3-1,ey)-2.*u1(i1,i2,i3,ey)+u1(i1,i2,i3+1,ey))/(dr1(2)**2)
                      ...
                      t6 = aj1sx**2
                      t14 = aj1tx**2
                      v1xx = t1*vv1rr+2*aj1rx*aj1sx*vv1rs+t6*vv1ss+2*aj1rx*aj1tx*vv1rt+2*aj1sx*aj1tx*vv1st+t14*vv1tt+aj1rxx*vv1r+aj1sxx*vv1s+aj1txx*vv1t
                      t1 = aj1ry**2
                      t6 = aj1sy**2
                      t14 = aj1ty**2
                      v1yy = t1*vv1rr+2*aj1ry*aj1sy*vv1rs+t6*vv1ss+2*aj1ry*aj1ty*vv1rt+2*aj1sy*aj1ty*vv1st+t14*vv1tt+aj1ryy*vv1r+aj1syy*vv1s+aj1tyy*vv1t
                      t1 = aj1rz**2
                      t6 = aj1sz**2
                      t14 = aj1tz**2
                      v1zz = t1*vv1rr+2*aj1rz*aj1sz*vv1rs+t6*vv1ss+2*aj1rz*aj1tz*vv1rt+2*aj1sz*aj1tz*vv1st+t14*vv1tt+aj1rzz*vv1r+aj1szz*vv1s+aj1tzz*vv1t
                    v1Lap = v1xx+ v1yy+ v1zz
                     ...
                     ww1rr = (u1(i1-1,i2,i3,ez)-2.*u1(i1,i2,i3,ez)+u1(i1+1,i2,i3,ez))/(dr1(0)**2)
                     ww1rs = (-(-u1(i1-1,i2-1,i3,ez)+u1(i1-1,i2+1,i3,ez))/(2.*dr1(1))+(-u1(i1+1,i2-1,i3,ez)+u1(i1+1,i2+1,i3,ez))/(2.*dr1(1)))/(2.*dr1(0))
                     ww1ss = (u1(i1,i2-1,i3,ez)-2.*u1(i1,i2,i3,ez)+u1(i1,i2+1,i3,ez))/(dr1(1)**2)
                     ww1rt = (-(-u1(i1-1,i2,i3-1,ez)+u1(i1-1,i2,i3+1,ez))/(2.*dr1(2))+(-u1(i1+1,i2,i3-1,ez)+u1(i1+1,i2,i3+1,ez))/(2.*dr1(2)))/(2.*dr1(0))
                     ww1st = (-(-u1(i1,i2-1,i3-1,ez)+u1(i1,i2-1,i3+1,ez))/(2.*dr1(2))+(-u1(i1,i2+1,i3-1,ez)+u1(i1,i2+1,i3+1,ez))/(2.*dr1(2)))/(2.*dr1(1))
                     ww1tt = (u1(i1,i2,i3-1,ez)-2.*u1(i1,i2,i3,ez)+u1(i1,i2,i3+1,ez))/(dr1(2)**2)
                      ...
                      t6 = aj1sx**2
                      t14 = aj1tx**2
                      w1xx = t1*ww1rr+2*aj1rx*aj1sx*ww1rs+t6*ww1ss+2*aj1rx*aj1tx*ww1rt+2*aj1sx*aj1tx*ww1st+t14*ww1tt+aj1rxx*ww1r+aj1sxx*ww1s+aj1txx*ww1t
                      t1 = aj1ry**2
                      t6 = aj1sy**2
                      t14 = aj1ty**2
                      w1yy = t1*ww1rr+2*aj1ry*aj1sy*ww1rs+t6*ww1ss+2*aj1ry*aj1ty*ww1rt+2*aj1sy*aj1ty*ww1st+t14*ww1tt+aj1ryy*ww1r+aj1syy*ww1s+aj1tyy*ww1t
                      t1 = aj1rz**2
                      t6 = aj1sz**2
                      t14 = aj1tz**2
                      w1zz = t1*ww1rr+2*aj1rz*aj1sz*ww1rs+t6*ww1ss+2*aj1rz*aj1tz*ww1rt+2*aj1sz*aj1tz*ww1st+t14*ww1tt+aj1rzz*ww1r+aj1szz*ww1s+aj1tzz*ww1t
                   ...
                   ! NOTE: the jacobian derivatives can be computed once for all components
                    ...
                    aj2rxt = (-rsxy2(j1,j2,j3-1,0,0)+rsxy2(j1,j2,j3+1,0,0))/(2.*dr2(2))
                    ...
                    aj2sxt = (-rsxy2(j1,j2,j3-1,1,0)+rsxy2(j1,j2,j3+1,1,0))/(2.*dr2(2))
                    aj2tx = rsxy2(j1,j2,j3,2,0)
                    aj2txr = (-rsxy2(j1-1,j2,j3,2,0)+rsxy2(j1+1,j2,j3,2,0))/(2.*dr2(0))
                    aj2txs = (-rsxy2(j1,j2-1,j3,2,0)+rsxy2(j1,j2+1,j3,2,0))/(2.*dr2(1))
                    aj2txt = (-rsxy2(j1,j2,j3-1,2,0)+rsxy2(j1,j2,j3+1,2,0))/(2.*dr2(2))
                    ...
                    aj2ryt = (-rsxy2(j1,j2,j3-1,0,1)+rsxy2(j1,j2,j3+1,0,1))/(2.*dr2(2))
                    ...
                    aj2syt = (-rsxy2(j1,j2,j3-1,1,1)+rsxy2(j1,j2,j3+1,1,1))/(2.*dr2(2))
                    aj2ty = rsxy2(j1,j2,j3,2,1)
                    aj2tyr = (-rsxy2(j1-1,j2,j3,2,1)+rsxy2(j1+1,j2,j3,2,1))/(2.*dr2(0))
                    aj2tys = (-rsxy2(j1,j2-1,j3,2,1)+rsxy2(j1,j2+1,j3,2,1))/(2.*dr2(1))
                    aj2tyt = (-rsxy2(j1,j2,j3-1,2,1)+rsxy2(j1,j2,j3+1,2,1))/(2.*dr2(2))
                    aj2rz = rsxy2(j1,j2,j3,0,2)
                    aj2rzr = (-rsxy2(j1-1,j2,j3,0,2)+rsxy2(j1+1,j2,j3,0,2))/(2.*dr2(0))
                    aj2rzs = (-rsxy2(j1,j2-1,j3,0,2)+rsxy2(j1,j2+1,j3,0,2))/(2.*dr2(1))
                    aj2rzt = (-rsxy2(j1,j2,j3-1,0,2)+rsxy2(j1,j2,j3+1,0,2))/(2.*dr2(2))
                    aj2sz = rsxy2(j1,j2,j3,1,2)
                    aj2szr = (-rsxy2(j1-1,j2,j3,1,2)+rsxy2(j1+1,j2,j3,1,2))/(2.*dr2(0))
                    aj2szs = (-rsxy2(j1,j2-1,j3,1,2)+rsxy2(j1,j2+1,j3,1,2))/(2.*dr2(1))
                    aj2szt = (-rsxy2(j1,j2,j3-1,1,2)+rsxy2(j1,j2,j3+1,1,2))/(2.*dr2(2))
                    aj2tz = rsxy2(j1,j2,j3,2,2)
                    aj2tzr = (-rsxy2(j1-1,j2,j3,2,2)+rsxy2(j1+1,j2,j3,2,2))/(2.*dr2(0))
                    aj2tzs = (-rsxy2(j1,j2-1,j3,2,2)+rsxy2(j1,j2+1,j3,2,2))/(2.*dr2(1))
                    aj2tzt = (-rsxy2(j1,j2,j3-1,2,2)+rsxy2(j1,j2,j3+1,2,2))/(2.*dr2(2))
                    ...
                    aj2tzz = aj2rz*aj2tzr+aj2sz*aj2tzs+aj2tz*aj2tzt
                     ...
                     uu2rt = (-(-u2(j1-1,j2,j3-1,ex)+u2(j1-1,j2,j3+1,ex))/(2.*dr2(2))+(-u2(j1+1,j2,j3-1,ex)+u2(j1+1,j2,j3+1,ex))/(2.*dr2(2)))/(2.*dr2(0))
                     uu2st = (-(-u2(j1,j2-1,j3-1,ex)+u2(j1,j2-1,j3+1,ex))/(2.*dr2(2))+(-u2(j1,j2+1,j3-1,ex)+u2(j1,j2+1,j3+1,ex))/(2.*dr2(2)))/(2.*dr2(1))
                     uu2tt = (u2(j1,j2,j3-1,ex)-2.*u2(j1,j2,j3,ex)+u2(j1,j2,j3+1,ex))/(dr2(2)**2)
                      ...
                      t6 = aj2sx**2
                      t14 = aj2tx**2
                      u2xx = t1*uu2rr+2*aj2rx*aj2sx*uu2rs+t6*uu2ss+2*aj2rx*aj2tx*uu2rt+2*aj2sx*aj2tx*uu2st+t14*uu2tt+aj2rxx*uu2r+aj2sxx*uu2s+aj2txx*uu2t
                      t1 = aj2ry**2
                      t6 = aj2sy**2
                      t14 = aj2ty**2
                      u2yy = t1*uu2rr+2*aj2ry*aj2sy*uu2rs+t6*uu2ss+2*aj2ry*aj2ty*uu2rt+2*aj2sy*aj2ty*uu2st+t14*uu2tt+aj2ryy*uu2r+aj2syy*uu2s+aj2tyy*uu2t
                      t1 = aj2rz**2
                      t6 = aj2sz**2
                      t14 = aj2tz**2
                      u2zz = t1*uu2rr+2*aj2rz*aj2sz*uu2rs+t6*uu2ss+2*aj2rz*aj2tz*uu2rt+2*aj2sz*aj2tz*uu2st+t14*uu2tt+aj2rzz*uu2r+aj2szz*uu2s+aj2tzz*uu2t
                    u2Lap = u2xx+ u2yy+ u2zz
                     ...
                     vv2rt = (-(-u2(j1-1,j2,j3-1,ey)+u2(j1-1,j2,j3+1,ey))/(2.*dr2(2))+(-u2(j1+1,j2,j3-1,ey)+u2(j1+1,j2,j3+1,ey))/(2.*dr2(2)))/(2.*dr2(0))
                     vv2st = (-(-u2(j1,j2-1,j3-1,ey)+u2(j1,j2-1,j3+1,ey))/(2.*dr2(2))+(-u2(j1,j2+1,j3-1,ey)+u2(j1,j2+1,j3+1,ey))/(2.*dr2(2)))/(2.*dr2(1))
                     vv2tt = (u2(j1,j2,j3-1,ey)-2.*u2(j1,j2,j3,ey)+u2(j1,j2,j3+1,ey))/(dr2(2)**2)
                      ...
                      t6 = aj2sx**2
                      t14 = aj2tx**2
                      v2xx = t1*vv2rr+2*aj2rx*aj2sx*vv2rs+t6*vv2ss+2*aj2rx*aj2tx*vv2rt+2*aj2sx*aj2tx*vv2st+t14*vv2tt+aj2rxx*vv2r+aj2sxx*vv2s+aj2txx*vv2t
                      t1 = aj2ry**2
                      t6 = aj2sy**2
                      t14 = aj2ty**2
                      v2yy = t1*vv2rr+2*aj2ry*aj2sy*vv2rs+t6*vv2ss+2*aj2ry*aj2ty*vv2rt+2*aj2sy*aj2ty*vv2st+t14*vv2tt+aj2ryy*vv2r+aj2syy*vv2s+aj2tyy*vv2t
                      t1 = aj2rz**2
                      t6 = aj2sz**2
                      t14 = aj2tz**2
                      v2zz = t1*vv2rr+2*aj2rz*aj2sz*vv2rs+t6*vv2ss+2*aj2rz*aj2tz*vv2rt+2*aj2sz*aj2tz*vv2st+t14*vv2tt+aj2rzz*vv2r+aj2szz*vv2s+aj2tzz*vv2t
                    v2Lap = v2xx+ v2yy+ v2zz
                     ...
                     ww2rr = (u2(j1-1,j2,j3,ez)-2.*u2(j1,j2,j3,ez)+u2(j1+1,j2,j3,ez))/(dr2(0)**2)
                     ww2rs = (-(-u2(j1-1,j2-1,j3,ez)+u2(j1-1,j2+1,j3,ez))/(2.*dr2(1))+(-u2(j1+1,j2-1,j3,ez)+u2(j1+1,j2+1,j3,ez))/(2.*dr2(1)))/(2.*dr2(0))
                     ww2ss = (u2(j1,j2-1,j3,ez)-2.*u2(j1,j2,j3,ez)+u2(j1,j2+1,j3,ez))/(dr2(1)**2)
                     ww2rt = (-(-u2(j1-1,j2,j3-1,ez)+u2(j1-1,j2,j3+1,ez))/(2.*dr2(2))+(-u2(j1+1,j2,j3-1,ez)+u2(j1+1,j2,j3+1,ez))/(2.*dr2(2)))/(2.*dr2(0))
                     ww2st = (-(-u2(j1,j2-1,j3-1,ez)+u2(j1,j2-1,j3+1,ez))/(2.*dr2(2))+(-u2(j1,j2+1,j3-1,ez)+u2(j1,j2+1,j3+1,ez))/(2.*dr2(2)))/(2.*dr2(1))
                     ww2tt = (u2(j1,j2,j3-1,ez)-2.*u2(j1,j2,j3,ez)+u2(j1,j2,j3+1,ez))/(dr2(2)**2)
                      ...
                      t6 = aj2sx**2
                      t14 = aj2tx**2
                      w2xx = t1*ww2rr+2*aj2rx*aj2sx*ww2rs+t6*ww2ss+2*aj2rx*aj2tx*ww2rt+2*aj2sx*aj2tx*ww2st+t14*ww2tt+aj2rxx*ww2r+aj2sxx*ww2s+aj2txx*ww2t
                      t1 = aj2ry**2
                      t6 = aj2sy**2
                      t14 = aj2ty**2
                      w2yy = t1*ww2rr+2*aj2ry*aj2sy*ww2rs+t6*ww2ss+2*aj2ry*aj2ty*ww2rt+2*aj2sy*aj2ty*ww2st+t14*ww2tt+aj2ryy*ww2r+aj2syy*ww2s+aj2tyy*ww2t
                      t1 = aj2rz**2
                      t6 = aj2sz**2
                      t14 = aj2tz**2
                      w2zz = t1*ww2rr+2*aj2rz*aj2sz*ww2rs+t6*ww2ss+2*aj2rz*aj2tz*ww2rt+2*aj2sz*aj2tz*ww2st+t14*ww2tt+aj2rzz*ww2r+aj2szz*ww2s+aj2tzz*ww2t
                    ...
                    if( twilightZone.eq.1 )then
                        ...
                        if( dispersionModel1.ne.noDispersion .and. nonlinearModel1 .ne. noNonlinearModel) then
                          ...
                          do n=0,nd-1
                            ...
                            pettSum1(n)=0.
                            call ogderiv(ep, 0,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, es(n)   ) 
                            call ogderiv(ep, 1,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, est(n)  )
                            call ogderiv(ep, 2,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, estt(n) )
                            call ogderiv(ep, 0,2,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, esxx(n) )
                            call ogderiv(ep, 0,0,2,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, esyy(n) )
                            call ogderiv(ep, 0,0,0,2, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, eszz(n) )
                            do jv=0,numberOfPolarizationVectors1-1
                              ! The TZ component is offset by pxc
                              pc = pxc + jv*nd
                              call ogderiv(ep, 0,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,pc+n, pe(n)   )
                              call ogderiv(ep, 1,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,pc+n, pet(n)  )
                              call ogderiv(ep, 2,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,pc+n, pett(n) )
                              ...
                              do na = 0,numberOfAtomicLevels1-1
                                call ogderiv(ep, 0,0,0,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t, nce+na, q0  )
                            ...
                            fev1(n) = estt(n) - c1**2*( esxx(n) + esyy(n) + eszz(n) ) + alphaP1*pettSum1(n)
                          end do
                          !--------------------------------
                          ! outside of dimension loop for N
                          !--------------------------------
                          do na=0,numberOfAtomicLevels1-1
                            ! na-th level
                            call ogderiv(ep, 1,0,0,0,xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t, nce+na, q0t )
                            call ogderiv(ep, 2,0,0,0,xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t, nce+na, q0tt)
                            ! initialize
                            ...
                            do jv=0,numberOfAtomicLevels1-1
                              call ogderiv(ep, 1,0,0,0,xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t, nce+jv, q0t )
                              call ogderiv(ep, 2,0,0,0,xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t, nce+jv, q0tt)
                        ...
                        elseif (dispersionModel1.eq.noDispersion .and. nonlinearModel1.eq.noNonlinearModel) then
                          do n=0,nd-1
                            ...
                            call ogderiv(ep, 0,0,2,0, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, esyy(n) )
                            call ogderiv(ep, 0,0,0,2, xy1(i1,i2,i3,0),xy1(i1,i2,i3,1),xy1(i1,i2,i3,2),t,ex+n, eszz(n) )
                            fev1(n) = estt(n) - c1**2*( esxx(n) + esyy(n) + eszz(n) )
                          end do
                        end if
                        !------------------------
                        ! nonlinear MLA
                        ...
                        if( dispersionModel2.ne.noDispersion .and. nonlinearModel2 .ne. noNonlinearModel) then
                          ...
                          do n=0,nd-1
                            fpSum2(n)=0.
                            pettSum2(n)=0.
                            call ogderiv(ep, 0,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, es(n)   ) 
                            call ogderiv(ep, 1,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, est(n)  )
                            call ogderiv(ep, 2,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, estt(n) )
                            call ogderiv(ep, 0,2,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, esxx(n) )
                            call ogderiv(ep, 0,0,2,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, esyy(n) )
                            call ogderiv(ep, 0,0,0,2, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, eszz(n) )
                            do jv=0,numberOfPolarizationVectors2-1
                              ! The TZ component is offset by pxc
                              pc = pxc + jv*nd
                              call ogderiv(ep, 0,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,pc+n, pe(n)   )
                              call ogderiv(ep, 1,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,pc+n, pet(n)  )
                              call ogderiv(ep, 2,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,pc+n, pett(n) )
                              ! Normal TZ forcing for P_{n,jv} equation: 
                              ...
                              do na = 0,numberOfAtomicLevels2-1
                                call ogderiv(ep, 0,0,0,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t, nce+na, q0  )
                            ...
                            fev2(n) = estt(n) - c2**2*( esxx(n) + esyy(n) + eszz(n) ) + alphaP2*pettSum2(n)
                          end do
                          !--------------------------------
                          ! outside of dimension loop for N
                          !--------------------------------
                          do na=0,numberOfAtomicLevels2-1
                            ! na-th level
                            call ogderiv(ep, 1,0,0,0,xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t, nce+na, q0t )
                            call ogderiv(ep, 2,0,0,0,xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t, nce+na, q0tt)
                            ! initialize
                            fnv2(na)  = q0t ! forcing for \partial_tN_\ell = alpha_{\ell,k}N_k+\beta_{\ell,m}E\cdot\partial_tP_k
                            fntv2(na) = q0tt ! next derivative
                            ! relaxation (alpha_{\ell,m})
                            do jv=0,numberOfAtomicLevels2-1
                              call ogderiv(ep, 1,0,0,0,xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t, nce+jv, q0t )
                              call ogderiv(ep, 2,0,0,0,xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t, nce+jv, q0tt)
                        ...
                        elseif (dispersionModel2.eq.noDispersion .and. nonlinearModel2.eq.noNonlinearModel) then
                          do n=0,nd-1
                            ...
                            call ogderiv(ep, 0,0,2,0, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, esyy(n) )
                            call ogderiv(ep, 0,0,0,2, xy2(j1,j2,j3,0),xy2(j1,j2,j3,1),xy2(j1,j2,j3,2),t,ex+n, eszz(n) )
                            fev2(n) = estt(n) - c2**2*( esxx(n) + esyy(n) + eszz(n) )
                          end do
                        end if
                    end if
      ...
      c2PttfP=(1.*d1+(-1.*a1*alpha-1.*b1)*dt)/d1
                  ...
                  betac2=beta2/epsmu2
                   ...
                   f(3)=( u1Lap*beta1/(epsmu1) + cem1*nDotLapE1*an1 - alphaP1*( fp1(0)-an1*nDotFp1) ) - ( u2Lap*beta2/(epsmu2) + cem2*nDotLapE2*an1 - alphaP2*( fp2(0)-an1*nDotFp2) )
                   f(4)=( v1Lap*beta1/(epsmu1) + cem1*nDotLapE1*an2 - alphaP1*( fp1(1)-an2*nDotFp1) ) - ( v2Lap*beta2/(epsmu2) + cem2*nDotLapE2*an2 - alphaP2*( fp2(1)-an2*nDotFp2) )
                   f(5)=( w1Lap*beta1/(epsmu1) + cem1*nDotLapE1*an3 - alphaP1*( fp1(2)-an3*nDotFp1) ) - ( w2Lap*beta2/(epsmu2) + cem2*nDotLapE2*an3 - alphaP2*( fp2(2)-an3*nDotFp2) )
                   ...
                   if( twilightZone.eq.1 )then
                     ...
                     f(3)= f(3) - ( ueLap*(beta1/epsmu1-beta2/epsmu2) + nDotLapEe*an1*(cem1-cem2) ) + alphaP1*( pettSum1(0) -an1*nDotPevttSum1 ) - alphaP2*( pettSum2(0) -an1*nDotPevttSum2 ) 
                     f(4)= f(4) - ( veLap*(beta1/epsmu1-beta2/epsmu2) + nDotLapEe*an2*(cem1-cem2) ) + alphaP1*( pettSum1(1) -an2*nDotPevttSum1 ) - alphaP2*( pettSum2(1) -an2*nDotPevttSum2 )
                     f(5)= f(5) - ( weLap*(beta1/epsmu1-beta2/epsmu2) + nDotLapEe*an3*(cem1-cem2) )  + alphaP1*( pettSum1(2) -an3*nDotPevttSum1 ) - alphaP2*( pettSum2(2) -an3*nDotPevttSum2 )
                  ...
                  clap1=(rsxy1(i1,i2,i3,axis1,0)**2+rsxy1(i1,i2,i3,axis1,1)**2+rsxy1(i1,i2,i3,axis1,2)**2)/(dr1(axis1)**2) -is*(rxx1(axis1,0,0)+rxx1(axis1,1,1)+rxx1(axis1,2,2))/(2.*dr1(axis1))
                  clap2=(rsxy2(j1,j2,j3,axis2,0)**2+rsxy2(j1,j2,j3,axis2,1)**2+rsxy2(j1,j2,j3,axis2,2)**2)/(dr2(axis2)**2) -js*(rxx2(axis2,0,0)+rxx2(axis2,1,1)+rxx2(axis2,2,2))/(2.*dr2(axis2)) 
                  ...
                  if( checkCoeff.eq.1 )then
                    numberOfEquations=6
                      ...
                      do n2=0,numberOfEquations-1
                        ...
                        if( .true. )then
                         if( numberOfEquations.eq.4 )then
                          write(*,'(" a6(*,",i1,")=",4(1pe10.2)," diff(*)=",4(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else if( numberOfEquations.eq.6 )then
                          write(*,'(" a6(*,",i1,")=",6(1pe10.2)," diff(*)=",6(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else if( numberOfEquations.eq.8 )then
                          write(*,'(" a6(*,",i1,")=",8(1pe10.2)," diff(*)=",8(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else if( numberOfEquations.eq.12 )then
                          write(*,'(" a6(*,",i1,")=",12(1pe10.2)," diff(*)=",12(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else 
                           stop 8181
                         end if
                        else
                         if( numberOfEquations.eq.4 )then
                          write(*,'(" a6(*,",i1,")=",4(1pe10.2)," f(*)=",4(1pe10.2)," diff(*)=",4(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(f(n1),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else if( numberOfEquations.eq.6 )then
                          write(*,'(" a6(*,",i1,")=",6(1pe10.2)," f(*)=",6(1pe10.2)," diff(*)=",6(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(f(n1),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else if( numberOfEquations.eq.8 )then
                          write(*,'(" a6(*,",i1,")=",8(1pe10.2)," f(*)=",8(1pe10.2)," diff(*)=",8(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(f(n1),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else if( numberOfEquations.eq.12 )then
                          write(*,'(" a6(*,",i1,")=",12(1pe10.2)," f(*)=",12(1pe10.2)," diff(*)=",12(1pe8.1) )') n2,(a6(n1,n2),n1=0,numberOfEquations-1),(f(n1),n1=0,numberOfEquations-1),(a6(n1,n2)-f(n1),n1=0,numberOfEquations-1)
                         else 
                           stop 8181
                         end if
                        end if
                      ...
                      ! restore 
                        ...
                        ! write(*,'("FINISH ME JUMP 3D GDM..., beta1,beta2=",2(1pe10.2)," nDotFp1,nDotFp2=",2(1pe10.2))') beta1,beta2,nDotFp1,nDotFp2
                    print *, 'Checked matrix coefficients for 3D order 2 unified dispersive'
                  end if
              ...
              !-    end if
               ...
               if( checkCoeff.eq.1 )then
                 write(*,'("+++++ unifiedDispersive23c: check coeff in interface: max(diff) = ",1pe8.2)') coeffDiff
               end if
               ...
               ! nonlinear model
                   if( t.le.3.*dt .and. debug.gt.0 )then
                     write(*,'("Interface>>>","23c-NonlinearDispersive-MLA")')
                   end if
                   ! write(*,'(" FINISH ME for non-zero GDM ")')
                   ! stop 9876
                   ! --- initialize some forcing functions ---
                    ...
                    if( mask1(i1,i2,i3).gt.0 .and. mask2(j1,j2,j3).gt.0 )then
                     ...
                     betac2=beta2/epsmu2
                      ...
                      if( twilightZone.eq.1 )then
                        ...
                        nDotPevttSum1 = an1*pettSum1(0) + an2*pettSum1(1) + an3*pettSum1(2)
                        nDotPevttSum2 = an1*pettSum2(0) + an2*pettSum2(1) + an3*pettSum2(2)
                        f(3)= f(3) - ( ueLap*(1./epsmu1-1./epsmu2) + nDotLapEe*an1*(cem1-cem2) ) + alphaP1*( pettSum1(0) -an1*nDotPevttSum1 ) - alphaP2*( pettSum2(0) -an1*nDotPevttSum2 ) 
                        f(4)= f(4) - ( veLap*(1./epsmu1-1./epsmu2) + nDotLapEe*an2*(cem1-cem2) ) + alphaP1*( pettSum1(1) -an2*nDotPevttSum1 ) - alphaP2*( pettSum2(1) -an2*nDotPevttSum2 )
                        f(5)= f(5) - ( weLap*(1./epsmu1-1./epsmu2) + nDotLapEe*an3*(cem1-cem2) )  + alphaP1*( pettSum1(2) -an3*nDotPevttSum1 ) - alphaP2*( pettSum2(2) -an3*nDotPevttSum2 )
                        ! For now we assume mu1=mu2 and TZ solutions are the same on both sides.
                        ! TZ forcing goes into equation (4)
                        !   (4) [ tv.(c^2*Delta(E) -alphaP*P_tt + fev) ] = 0 
                        !
