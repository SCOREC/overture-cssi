...
c============================================================================================
     ...
     & u(i1+4*is1,i2+4*is2,i3+4*is3,et1)
                    u(i1-4*is1,i2-4*is2,i3-4*is3,et2)=2.*u(i1,i2,i3,
     & et2)-u(i1+4*is1,i2+4*is2,i3+4*is3,et2)
                      call ogf3dfo(ep,ex,ey,ez,fieldOption,xy(i1-4*is1,
     & i2-4*is2,i3-4*is3,0),xy(i1-4*is1,i2-4*is2,i3-4*is3,1),xy(i1-4*
     & is1,i2-4*is2,i3-4*is3,2),t,uvm(ex),uvm(ey),uvm(ez))
                      call ogf3dfo(ep,ex,ey,ez,fieldOption,xy(i1,i2,i3,
     & 0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,uv0(ex),uv0(ey),uv0(ez))
                      call ogf3dfo(ep,ex,ey,ez,fieldOption,xy(i1+4*is1,
     & i2+4*is2,i3+4*is3,0),xy(i1+4*is1,i2+4*is2,i3+4*is3,1),xy(i1+4*
     & is1,i2+4*is2,i3+4*is3,2),t,uvp(ex),uvp(ey),uvp(ez))
                    u(i1-4*is1,i2-4*is2,i3-4*is3,en1)=u(i1-4*is1,i2-4*
     & is2,i3-4*is3,en1) + uvm(en1) - uvp(en1)
                    u(i1-4*is1,i2-4*is2,i3-4*is3,et1)=u(i1-4*is1,i2-4*
     & is2,i3-4*is3,et1) + uvm(et1) -2.*uv0(et1) + uvp(et1)
                    u(i1-4*is1,i2-4*is2,i3-4*is3,et2)=u(i1-4*is1,i2-4*
     & is2,i3-4*is3,et2) + uvm(et2) -2.*uv0(et2) + uvp(et2)
               end if ! mask
              end do
              end do
              end do
