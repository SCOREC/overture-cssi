...
! ------------------------------------------------------------------------
#beginMacro getUnifiedDispersiveForcingOrder2(k1,k2,k3, fp, fpv,fev,fnv,fntv, p,pn,pm,q,qn,qm,u,un,um, dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,alphaP,beta,pnec,prc,peptc,a0v,a1v,b0v,b1v)
  ! no dispersion
  do n=0,nd-1
    fp(n)=0.
  end do
...
!-------------------------------------------------------------------------------------------
#beginMacro evalTZforcingUnified(xy,i1,i2,i3,dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,c,alphaP,pnec,prc,peptc,a0v,a1v,b0v,b1v,fpv,fpSum,fev,pettSum,fnv,fntv)
  !------------------------
  ! nonlinear MLA
  !------------------------
  if( dispersionModel.ne.noDispersion .and. nonlinearModel .ne. noNonlinearModel) then
  ...
  elseif (dispersionModel.eq.noDispersion .and. nonlinearModel.eq.noNonlinearModel) then
    ...
    do n=0,nd-1
      ...
      fev(n) = estt(n) - c**2*( esxx(n) + esyy(n) )
    end do
...
!-------------------------------------------------------------------------------------------
#beginMacro getTZForcingUnified(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)

  if( twilightZone.eq.1 )then
    evalTZforcingUnified(xy1,i1,i2,i3,dispersionModel1,nonlinearModel1,numberOfPolarizationVectors1,numberOfAtomicLevels1,c1,alphaP1,pnec1,prc1,peptc1,a0v1,a1v1,b0v1,b1v1,fpv1,fpSum1,fev1,pettSum1,fnv1,fntv1)
    evalTZforcingUnified(xy2,j1,j2,j3,dispersionModel2,nonlinearModel2,numberOfPolarizationVectors2,numberOfAtomicLevels2,c2,alphaP2,pnec2,prc2,peptc2,a0v2,a1v2,b0v2,b1v2,fpv2,fpSum2,fev2,pettSum2,fnv2,fntv2)
  end if
...
!  fev(n)    : RHS to E_{n} equation
!-------------------------------------------------------------------------------------------
#beginMacro evalTZforcingUnified3d(xy,i1,i2,i3,dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,c,alphaP,pnec,prc,peptc,a0v,a1v,b0v,b1v,fpv,fpSum,fev,pettSum,fnv,fntv)
  ...
  elseif (dispersionModel.eq.noDispersion .and. nonlinearModel.eq.noNonlinearModel) then
    do n=0,nd-1
      ...
      fev(n) = estt(n) - c**2*( esxx(n) + esyy(n) + eszz(n) )
    end do
  end if
#endMacro
...
!    fev2(n)    : RHS to E_{n} equation on domain 2
!-------------------------------------------------------------------------------------------
#beginMacro getTZForcingUnified3d(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)

  if( twilightZone.eq.1 )then
    evalTZforcingUnified3d(xy1,i1,i2,i3,dispersionModel1,nonlinearModel1,numberOfPolarizationVectors1,numberOfAtomicLevels1,c1,alphaP1,pnec1,prc1,peptc1,a0v1,a1v1,b0v1,b1v1,fpv1,fpSum1,fev1,pettSum1,fnv1,fntv1)
    evalTZforcingUnified3d(xy2,j1,j2,j3,dispersionModel2,nonlinearModel2,numberOfPolarizationVectors2,numberOfAtomicLevels2,c2,alphaP2,pnec2,prc2,peptc2,a0v2,a1v2,b0v2,b1v2,fpv2,fpSum2,fev2,pettSum2,fnv2,fntv2)
  end if
...
! 
! -------------------------------------------------------------------------------------------
#beginMacro assignUnifiedInterfaceGhost22r()

 ! ****************************************************
 ! ***********  2D, ORDER=2, RECTANGULAR **************
 ! ****************************************************

INFO("22rectangle-unified-dispersive")
...
beginLoopsMask2d()
  ...
  getTZForcingUnified(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)

  ! eval dispersive forcings for domain 1
  getUnifiedDispersiveForcingOrder2(i1,i2,i3, fp1, fpv1,fev1,fnv1,fntv1,p1,p1n,p1m,q1,q1n,q1m, u1,u1n,u1m, dispersionModel1,nonlinearModel1,numberOfPolarizationVectors1,numberOfAtomicLevels1,alphaP1,beta1,pnec1,prc1,peptc1,a0v1,a1v1,b0v1,b1v1)

  ! eval dispersive forcings for domain 2
  getUnifiedDispersiveForcingOrder2(j1,j2,j3, fp2, fpv2,fev2,fnv2,fntv2,p2,p2n,p2m,q2,q2n,q2m, u2,u2n,u2m, dispersionModel2,nonlinearModel2,numberOfPolarizationVectors2,numberOfAtomicLevels2,alphaP2,beta2,pnec2,prc2,peptc2,a0v2,a1v2,b0v2,b1v2)

  eval2dJumpUnifiedOrder2()
...
!
! --------------------------------------------------------------------------------------------
#beginMacro eval2dJumpUnifiedOrder2()
 f(0)=(u1x+v1y) - \
      (u2x+v2y)
...
! ----------------------------------------------------------------------------------
#beginMacro evalUnifiedInterfaceEquations22c()
  evalInterfaceDerivatives2d()
  eval2dJumpUnifiedOrder2()
#endMacro
...
! 
! -------------------------------------------------------------------------------------------
#beginMacro assignUnifiedInterfaceGhost22c()

  ! ****************************************************
  ! ***********  2D, ORDER=2, CURVILINEAR **************
  ! ****************************************************

INFO("22curvilinear-unified-dispersive")
...
beginLoopsMask2d()
  ...
  if( checkCoeff.eq.1 )then
    numberOfEquations=4
    checkCoefficients(i1,i2,i3, j1,j2,j3,numberOfEquations,a4,evalUnifiedInterfaceEquations22c )
...
!
! --------------------------------------------------------------------------------------------
#beginMacro eval3dJumpUnifiedOrder2()
 ...
 if( twilightZone.eq.1 )then
   ...
   f(3)= f(3) - ( ueLap*(beta1/epsmu1-beta2/epsmu2) + nDotLapEe*an1*(cem1-cem2) ) \
              + alphaP1*( pettSum1(0) -an1*nDotPevttSum1 ) \
              - alphaP2*( pettSum2(0) -an1*nDotPevttSum2 ) 

   f(4)= f(4) - ( veLap*(beta1/epsmu1-beta2/epsmu2) + nDotLapEe*an2*(cem1-cem2) ) \
              + alphaP1*( pettSum1(1) -an2*nDotPevttSum1 ) \
              - alphaP2*( pettSum2(1) -an2*nDotPevttSum2 )

   f(5)= f(5) - ( weLap*(beta1/epsmu1-beta2/epsmu2) + nDotLapEe*an3*(cem1-cem2) )  \
...
!    Evaluate the interface equations for checking the coefficients
! ----------------------------------------------------------------------------------
#beginMacro evalUnifiedInterfaceEquations23c()

  evalInterfaceDerivatives3d()
  eval3dJumpUnifiedOrder2()
...
! --------------------------------------------------------------------------
#beginMacro assignUnifiedInterfaceGhost23c()

  INFO("23c-unified-dispersive")
...
if (nonlinearModel2 .ne. noNonlinearModel) then
  ...
  beginLoopsMask3d()
    ...
    getTZForcingUnified3d(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)
    ...
    if( checkCoeff.eq.1 )then
      numberOfEquations=6
      checkCoefficients(i1,i2,i3, j1,j2,j3,numberOfEquations,a6,evalUnifiedInterfaceEquations23c )
...
! ------------------------------------------------------------------------
#beginMacro getUnifiedDispersiveForcingOrder4(FACE,k1,k2,k3, fp, fpv,fev, p,pn,pm,q,qn,qm, u,un,um, \
...
! getDispersiveForcingOrder4(FACE,k1,k2,k3, fp, fpv,fev, p,pn,pm, u,un,um, dispersionModel,numberOfPolarizationVectors,alphaP,\
!             c2PttEsum,c2PttLEsum,c4PttLEsum,c4PttLLEsum,c2PttttLEsum,c2PttttLLEsum,a0v,a1v,\
!             b0v,b1v,LE,LLE,LEm,LfE,LfP,fEt,fEtt,fPt,fPtt,pevtt,pevttx,pevtty,pevtttt,evx,evy,evnx,evny,\
!             fevx,fevy,fpvx,fpvy,LEx,LEy,fPttx,fPtty,fLPtt,fPtttt)
  ...
  if( dispersionModel.ne.noDispersion .and. nonlinearModel.ne.noNonlinearModel) then
    ...
    do n=0,nd-1
      ...
      do jv=0,numberOfPolarizationVectors-1
        ...
        enddo
        ! time derivatives
        fLPtt(n) = fLPtt(n) + cSq*(LPn/(1.+.5*dt*b1v(jv)) - 2.*LP + LPm)/dtsq ! added c^2 to be consistence with GDM version
...
! -------------------------------------------------------------------------------
#beginMacro evalTZForcingUnifiedOrder4(xy,i1,i2,i3,dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,c,alphaP,pnec,prc,peptc,\
                                       a0v,a1v,b0v,b1v,fpv,fpSum,fev,\
                                       LfE,fEt,fEtt,LfP,fPt,fPtt,fnv,fntv,fnttv,fntttv,pevtt,pevttx,pevtty,pevttt,pevtttt,pevttL,fevx,fevy,fpvx,fpvy,\
                                       pevttSum,pevttxSum,pevttySum,pevttLSum,pevttttSum)
...
if( dispersionModel.ne.noDispersion .and. nonlinearModel.ne.noNonlinearModel) then
  ...
  do n=0,nd-1
    ...
    do jv=0,numberOfPolarizationVectors-1
      ...
      pevttL(n,jv) = pettL
      pevttLSum(n) = pevttLSum(n)  + c**2*pettL ! added c**2 to be consistence with GDM for eval jumps
    ...
    LfE(n) = esttL     - c**2*esLL  + alphaP*pevttLSum(n)/c**2 ! new: divided c**2
...
!    fev2(n)    : RHS to E_{n} equation on domain 2
!-------------------------------------------------------------------------------------------
#beginMacro getUnifiedDispersiveTZForcingOrder4(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)

  if( twilightZone.eq.1 )then
    evalTZForcingUnifiedOrder4(xy1,i1,i2,i3,dispersionModel1,nonlinearModel1,numberOfPolarizationVectors1,numberOfAtomicLevels1,c1,alphaP1,pnec1,prc1,peptc1,\
                               a0v1,a1v1,b0v1,b1v1,fpv1,fpSum1,fev1,\
                               LfE1,fEt1,fEtt1,LfP1,fPt1,fPtt1,fnv1,fntv1,fnttv1,fntttv1,pevtt1,pevttx1,pevtty1,pevttt1,pevtttt1,pevttL1,\
                               fevx1,fevy1,fpvx1,fpvy1,pevttSum1,pevttxSum1,pevttySum1,pevttLSum1,pevttttSum1)
    evalTZForcingUnifiedOrder4(xy2,j1,j2,j3,dispersionModel2,nonlinearModel2,numberOfPolarizationVectors2,numberOfAtomicLevels2,c2,alphaP2,pnec2,prc2,peptc2,\
                               a0v2,a1v2,b0v2,b1v2,fpv2,fpSum2,fev2,\
                               LfE2,fEt2,fEtt2,LfP2,fPt2,fPtt2,fnv2,fntv2,fnttv2,fntttv2,pevtt2,pevttx2,pevtty2,pevttt2,pevtttt2,pevttL2,\
                               fevx2,fevy2,fpvx2,fpvy2,pevttSum2,pevttxSum2,pevttySum2,pevttLSum2,pevttttSum2)
  end if
...
! --------------------------------------------------------------------------
#beginMacro eval2dJumpUnifiedOrder4()
  f(0)=(u1x+v1y) - \
       (u2x+v2y)
 ...
 !      (tau1*u2Lap+tau2*v2Lap)/eps2
  ...
  ! [ Delta( div(E) )*c^2 ] = 0 
  ! f(4)=(u1xxx+u1xyy+v1xxy+v1yyy)*c1**2/mu1- \
  !      (u2xxx+u2xyy+v2xxy+v2yyy)*c2**2/mu2
  ...
  ! else ! GDM
    ...
    f(6)= ( (an1*u1LapSq+an2*v1LapSq)*c1**2  -alphaP1*( an1*fLPtt1(0)+an2*fLPtt1(1) )*epsmu1  )/mu1 \
         -( (an1*u2LapSq+an2*v2LapSq)*c2**2  -alphaP2*( an1*fLPtt2(0)+an2*fLPtt2(1) )*epsmu2  )/mu2
  ! end if
  ...
  if( twilightZone.eq.1 )then
   ...
   !             - (alphaP2/mu2)*( pevttxSum2(1) - pevttySum2(0) )
    ...
    ! else ! GDM
    f(6) = f(6) - (an1*ueLapSq+an2*veLapSq)*( c1**2/mu1 - c2**2/mu2 ) \
    ...
    ! else ! GDM
    f(7) = f(7) - (tau1*ueLapSq+tau2*veLapSq)*( c1**4 - c2**4 ) \
...
#beginMacro evalDerivativesForDispersiveUnified2dOrder4()
...
! =============================================================================================
#beginMacro evaluateUnifiedInterfaceEquations2dOrder4()

 ! Evaluate TZ forcing for dispersive equations in 2D 
 getUnifiedDispersiveTZForcingOrder4(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)

 evalDerivs2dOrder4()

 evalDerivativesForDispersiveUnified2dOrder4() ! derivatives of E at two previous time steps

 ! eval nonlinear dispersive forcings for domain 1
 getUnifiedDispersiveForcingOrder4(LEFT,i1,i2,i3, fp1, fpv1,fev1,p1,p1n,p1m,q1,q1n,q1m, u1,u1n,u1m, \
 ...
 getUnifiedDispersiveForcingOrder4(RIGHT,j1,j2,j3, fp2, fpv2,fev2,p2,p2n,p2m,q2,q2n,q2m, u2,u2n,u2m, \
...
!    Evaluate the interface equations for checking the coefficients
! ----------------------------------------------------------------------------------
#beginMacro evalUnifiedInterfaceEquations24c()
 ...
 ! evalDerivativesForDispersiveUnified2dOrder4()
...
#beginMacro getUnifiedDispersiveForcing24c()
...
! --------------------------------------------------------------------------
#beginMacro assignUnifiedInterfaceGhost24c()

 ! ****************************************************************
 ! ***********  DISPERSIVE, 2D, ORDER=4, CURVILINEAR **************
 ! ****************************************************************

 INFO("24c-Unified-Dispersive")
...
if (nonlinearModel2 .ne. 0) then
 ...
 beginLoopsMask2d() 
   ...
   evaluateUnifiedInterfaceEquations2dOrder4()
...
! *new* Mar 18, 2021
! --------------------------------------------------------------------------
#beginMacro assignUnifiedInterfaceGhost24r()

 ! ****************************************************************
 ! ***********  Unified, 2D, ORDER=4, RECTANGULAR **************
 ! ****************************************************************

 INFO("24r-unified-dispersive")
