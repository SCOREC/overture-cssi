! This file automatically generated from getDiv.bf with bpp.
       subroutine getDiv3dOrder4r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & )then
        ...
        if( method.ne.bamx )then
         ! --- Isotropic Maxwell ----
            if( t.lt.2*dt )then
              write(*,'("computeDiv dim=3 order=4 grid=rectangular ... 
     & t=",e10.2)') t
            end if
            ...
            ! Loop bounds -- exclude absorbing layers ? 
              ...
              do i1=n1a,n1b
               ...
               ! --- 3D -----
                  divD(i1,i2,i3) = vx43r(i1,i2,i3,ex) + vy43r(i1,i2,i3,
     & ey) + vz43r(i1,i2,i3,ez)
     ...
     & 1,mr)*u(i1,i2,i3,1) + K03(m,2,mr)*u(i1,i2,i3,2)
                ...
                if( t.lt.2*dt )then
                  write(*,'("computeDiv (BA) dim=3 order=4 
