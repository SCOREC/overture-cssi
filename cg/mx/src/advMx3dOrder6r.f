! This file automatically generated from advOpt.bf with bpp.
        subroutine advMx3dOrder6r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & dtsq*f(i1,i2,i3,hz)
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,ex)=maxwell3dr66me(i1,i2,i3,ex)+dtsq*
     & f(i1,i2,i3,ex)
                     un(i1,i2,i3,ey)=maxwell3dr66me(i1,i2,i3,ey)+dtsq*
     & f(i1,i2,i3,ey)
                     un(i1,i2,i3,ez)=maxwell3dr66me(i1,i2,i3,ez)+dtsq*
     & f(i1,i2,i3,ez)
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                    un(i1,i2,i3,ex)=maxwell3dr66me(i1,i2,i3,ex)+dtsq*f(
     & i1,i2,i3,ex)
                    un(i1,i2,i3,ey)=maxwell3dr66me(i1,i2,i3,ey)+dtsq*f(
     & i1,i2,i3,ey)
                    un(i1,i2,i3,ez)=maxwell3dr66me(i1,i2,i3,ez)+dtsq*f(
     & i1,i2,i3,ez)
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,hx)=maxwell3dr66me(i1,i2,i3,hx)+dtsq*
     & f(i1,i2,i3,hx)
                     un(i1,i2,i3,hy)=maxwell3dr66me(i1,i2,i3,hy)+dtsq*
     & f(i1,i2,i3,hy)
                     un(i1,i2,i3,hz)=maxwell3dr66me(i1,i2,i3,hz)+dtsq*
     & f(i1,i2,i3,hz)
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                    un(i1,i2,i3,hx)=maxwell3dr66me(i1,i2,i3,hx)+dtsq*f(
     & i1,i2,i3,hx)
                    un(i1,i2,i3,hy)=maxwell3dr66me(i1,i2,i3,hy)+dtsq*f(
     & i1,i2,i3,hy)
                    un(i1,i2,i3,hz)=maxwell3dr66me(i1,i2,i3,hz)+dtsq*f(
     & i1,i2,i3,hz)
              ...
              ! add forcing to the equations
                if( solveForE.ne.0 .and. solveForH.ne.0 )then
                  if( useWhereMask.ne.0 )then
                    ...
                    do i1=n1a,n1b
                      if( mask(i1,i2,i3).gt.0 )then
                        lap(ex)=csq*lap3d6(i1,i2,i3,ex)+f(i1,i2,i3,ex)
                        lap(ey)=csq*lap3d6(i1,i2,i3,ey)+f(i1,i2,i3,ey)
                        lap(ez)=csq*lap3d6(i1,i2,i3,ez)+f(i1,i2,i3,ez)
                        un(i1,i2,i3,ex)=maxwellr66(i1,i2,i3,ex)
                        un(i1,i2,i3,ey)=maxwellr66(i1,i2,i3,ey)
                        un(i1,i2,i3,ez)=maxwellr66(i1,i2,i3,ez)
                        ut5(i1,i2,i3,ex)=lap(ex)
                        ut5(i1,i2,i3,ey)=lap(ey)
                        ut5(i1,i2,i3,ez)=lap(ez)
                        lap(hx)=csq*lap3d6(i1,i2,i3,hx)+f(i1,i2,i3,hx)
                        lap(hy)=csq*lap3d6(i1,i2,i3,hy)+f(i1,i2,i3,hy)
                        lap(hz)=csq*lap3d6(i1,i2,i3,hz)+f(i1,i2,i3,hz)
                        un(i1,i2,i3,hx)=maxwellr66(i1,i2,i3,hx)
                        un(i1,i2,i3,hy)=maxwellr66(i1,i2,i3,hy)
                        un(i1,i2,i3,hz)=maxwellr66(i1,i2,i3,hz)
                        ut5(i1,i2,i3,hx)=lap(hx)
