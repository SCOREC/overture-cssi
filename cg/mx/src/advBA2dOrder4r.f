...
c============================================================================================
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                          ...
                          ! --- 2D -----
                            curl(0) =                            etay(
     & i2)* uy42r(i1,i2,i3,hz)
                            curl(1) = -etax(i1)* ux42r(i1,i2,i3,hz)
                            curl(2) =-(etax(i1)* ux42r(i1,i2,i3,ey)-
     & etay(i2)* uy42r(i1,i2,i3,ex))
                           do m=0,2
                             un(i1,i2,i3,m)= Ki(m,0,mr)*(curl(0)+fv(0))
     &  + Ki(m,1,mr)*(curl(1)+fv(1)) + Ki(m,2,mr)*(curl(2)+fv(2))
                           end do
     ...
     & i2)* uy42r(i1,i2,i3,hz)
                            curl(1) = -etax(i1)* ux42r(i1,i2,i3,hz)
                            curl(2) = (etax(i1)* ux42r(i1,i2,i3,hy)-
     & etay(i2)* uy42r(i1,i2,i3,hx))
                            curl(3) =                           -etay(
     & i2)* uy42r(i1,i2,i3,ez)
                            curl(4) =  etax(i1)* ux42r(i1,i2,i3,ez)
                            curl(5) =-(etax(i1)* ux42r(i1,i2,i3,ey)-
     & etay(i2)* uy42r(i1,i2,i3,ex))
                         if( debug.gt.3 )then
                           write(*,'("----- i1,i2=",2i3)') i1,i2
                         end if
