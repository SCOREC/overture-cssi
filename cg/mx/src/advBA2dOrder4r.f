! This file automatically generated from advBA.bf with bpp.
       subroutine advBA2dOrder4r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
     & nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,rsxy,  um,u,un,f,fa, K0i, 
     & matMask, pm,p,pt,xy, ut5,ut6,ut7, bc, dis, varDis, ipar, rpar, 
     & ierr )
      !======================================================================
     ...
     & fprev
       integer ex,ey,ez, hx,hy,hz, solveForAllFields
...
c============================================================================================
     ...
     & i2-1,i3,c))     -(u(i1,i2+2,i3,c)+u(i1,i2-2,i3,c)) )*dysq12i
      ...
      !...........end   statement functions
       ...
       if( t.le.2*dt )then
         write(*,*) 'Inside advBA2dOrder4r...'
         write(*,'("addForcing=",i2, " solveForAllFields=",i2)') 
     & addForcing,solveForAllFields
     ...
     & ')
      ...
      !       **********************************************
          ...
          if( addDissipation )then
            if( t.le.3*dt )then
              write(*,'("advBA: 4=4: addDissipation=",l2," adc=",e10.2)
     & ') addDissipation,adc
            end if
            sigma1=adc
     ...
     & adxSosup(1)
              ...
              if( solveForAllFields.ne.0 ) then
                if( .false. )then
                  write(*,'("advBA: FOS 2D, Order 4, rect... t=",e10.2,
     & " addForcing=",i3)') t,addForcing
                end if
                if( .not.methodOfLines )then
                 ...
                 ! FINISH ME 
                   ...
                   un(i1,i2,i3,ex)=u(i1,i2,i3,ex) + (dt/eps)*uy42r(i1,
     & i2,i3,hz) +.5*cdtsq*lap2d4(i1,i2,i3,ex) + (cdtsq*dt/(6.*eps))*(
     &  uxxy22r(i1,i2,i3,hz) + uyyy22r(i1,i2,i3,hz) ) +  + (cdtsq*
     & cdtsq/24.)*lap2d2Pow2(i1,i2,i3,ex) + dt*fv(ex)
                   un(i1,i2,i3,ey)=u(i1,i2,i3,ey) - (dt/eps)*ux42r(i1,
     & i2,i3,hz) +.5*cdtsq*lap2d4(i1,i2,i3,ey) - (cdtsq*dt/(6.*eps))*(
     &  uxxx22r(i1,i2,i3,hz) + uxyy22r(i1,i2,i3,hz) ) + + (cdtsq*
     & cdtsq/24.)*lap2d2Pow2(i1,i2,i3,ey) + dt*fv(ey)
                   un(i1,i2,i3,ez)=u(i1,i2,i3,ez) - (dt/eps)*(uy42r(i1,
     & i2,i3,hx)-ux42r(i1,i2,i3,hy)) +.5*cdtsq*lap2d4(i1,i2,i3,ez) - (
     & cdtsq*dt/(6.*eps))*( (uxxy22r(i1,i2,i3,hx) + uyyy22r(i1,i2,i3,
     & hx)) -(uxxx22r(i1,i2,i3,hy) + uxyy22r(i1,i2,i3,hy)) ) + (cdtsq*
     & cdtsq/24.)*lap2d2Pow2(i1,i2,i3,ez) + dt*fv(ez)
                   un(i1,i2,i3,hx)=u(i1,i2,i3,hx) - (dt/mu )*uy42r(i1,
     & i2,i3,ez) +.5*cdtsq*lap2d4(i1,i2,i3,hx) - (cdtsq*dt/(6.*mu ))*(
     &  uxxy22r(i1,i2,i3,ez) + uyyy22r(i1,i2,i3,ez) ) +  + (cdtsq*
     & cdtsq/24.)*lap2d2Pow2(i1,i2,i3,hx) + dt*fv(hx)
                   un(i1,i2,i3,hy)=u(i1,i2,i3,hy) + (dt/mu )*ux42r(i1,
     & i2,i3,ez) +.5*cdtsq*lap2d4(i1,i2,i3,hy) + (cdtsq*dt/(6.*mu ))*(
     &  uxxx22r(i1,i2,i3,ez) + uxyy22r(i1,i2,i3,ez) ) + + (cdtsq*
     & cdtsq/24.)*lap2d2Pow2(i1,i2,i3,hy) + dt*fv(hy)
                   un(i1,i2,i3,hz)=u(i1,i2,i3,hz) + (dt/mu)*(uy42r(i1,
     & i2,i3,ex)-ux42r(i1,i2,i3,ey)) +.5*cdtsq*lap2d4(i1,i2,i3,hz) + (
     & cdtsq*dt/(6.*mu))*( (uxxy22r(i1,i2,i3,ex) + uyyy22r(i1,i2,i3,
     & ex)) -(uxxx22r(i1,i2,i3,ey) + uxyy22r(i1,i2,i3,ey)) ) + (cdtsq*
     & cdtsq/24.)*lap2d2Pow2(i1,i2,i3,hz) + dt*fv(hz)
                     end if
                   end do
                   end do
                   end do
                 ...
                 ! METHOD OF LINES
                   ...
                   un(i1,i2,i3,ex)= + (1./eps)*uy42r(i1,i2,i3,hz) + fv(
     & ex)
                   un(i1,i2,i3,ey)= - (1./eps)*ux42r(i1,i2,i3,hz) + fv(
     & ey)
                   un(i1,i2,i3,ez)= + (1./eps)*(ux42r(i1,i2,i3,hy)-
     & uy42r(i1,i2,i3,hx)) + fv(ez)
                   un(i1,i2,i3,hx)= + (1./mu)*( -uy42r(i1,i2,i3,ez) ) +
     &  fv(hx)
                   un(i1,i2,i3,hy)= + (1./mu)*(  ux42r(i1,i2,i3,ez) ) +
     &  fv(hy)
                   un(i1,i2,i3,hz)= + (1./mu)*(uy42r(i1,i2,i3,ex)-
     & ux42r(i1,i2,i3,ey))  + fv(hz)
                     end if
                   end do
                   end do
                   end do
     ...
     & ex)
                  un(i1,i2,i3,ey)= - (1./eps)*ux42r(i1,i2,i3,hz) + fv(
     & ey)
                  un(i1,i2,i3,hz)= + (1./mu)*(uy42r(i1,i2,i3,ex)-ux42r(
     & i1,i2,i3,ey)) + fv(hz)
                     end if
                   end do
                   end do
     ...
     & then  ! do this for now
                    ...
                    do m=0,5
                      un(i1,i2,i3,m)= K0i(m,0,mr)*curl(0) + K0i(m,1,mr)
     & *curl(1) + K0i(m,2,mr)*curl(2) + K0i(m,3,mr)*curl(3) + K0i(m,4,
     & mr)*curl(4) + K0i(m,5,mr)*curl(5) + fv(m)
                    end do
     ...
     & then  ! do this for now
                   ...
                   do m=0,2
                     un(i1,i2,i3,m)= Ki(m,0,mr)*curl(0) + Ki(m,1,mr)*
     & curl(1) + Ki(m,2,mr)*curl(2) + fv(m)
                   end do
                   ! un(i1,i2,i3,ex)= + (1./eps)*uy42r(i1,i2,i3,hz) + fv(ex)
                   ! un(i1,i2,i3,ey)= - (1./eps)*ux42r(i1,i2,i3,hz) + fv(ey)
                   ! un(i1,i2,i3,hz)= + (1./mu)*(uy42r(i1,i2,i3,ex)-ux42r(i1,i2,i3,ey)) + fv(hz)
                        ...
                        do k1=1,6
                          do k2=1,6
                            ...
                            do n=1,Np(k1,k2,mr)
                              ...
                              fp(pc) = pvt(pc) - pv(qc)
                              fp(qc) = pvt(qc) - (  a0*ev(ec) + a1*evt(
     & ec) - b0*pv(pc)- b1*pv(qc) )
                              pc=pc+2
                              qc=qc+2
                            end do
                          end do
     ...
     & qc)
                      ...
                      ! end if
                      do m=0,5
                        un(i1,i2,i3,m)= K0i(m,0,mr)*curl(0) + K0i(m,1,
     & mr)*curl(1) + K0i(m,2,mr)*curl(2) + K0i(m,3,mr)*curl(3) + K0i(
     & m,4,mr)*curl(4) + K0i(m,5,mr)*curl(5) + fv(m)
                        ! unv(m) = un(i1,i2,i3,m) ! didn't seem to help
                        ! uv(m)  = u(i1,i2,i3,ec)
                      end do
                      ! if( .false. )then
     ...
     & i1,i2,i3,ec) - b0*p(i1,i2,i3,pc)- b1*p(i1,i2,i3,qc) + fp(qc)
                  ...
                  if( .not.methodOfLines )then
                    stop 111
                     ...
                     un(i1,i2,i3,ex)=u(i1,i2,i3,ex) + (dt/eps)*uy22r(
     & i1,i2,i3,hz) +.5*cdtsq*lap2d2(i1,i2,i3,ex) + dt*fv(ex)
                     un(i1,i2,i3,ey)=u(i1,i2,i3,ey) - (dt/eps)*ux22r(
     & i1,i2,i3,hz) +.5*cdtsq*lap2d2(i1,i2,i3,ey) + dt*fv(ey)
                     un(i1,i2,i3,hz)=u(i1,i2,i3,hz) + (dt/mu)*(uy22r(
     & i1,i2,i3,ex)-ux22r(i1,i2,i3,ey)) +.5*cdtsq*lap2d2(i1,i2,i3,hz) 
     & + dt*fv(hz)
                        end if
                      end do
                      end do
