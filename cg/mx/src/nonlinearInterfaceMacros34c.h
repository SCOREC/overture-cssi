...
! ------------------------------------------------------------------------
#beginMacro getNonlinearDispersiveForcing3dOrder4(FACE,k1,k2,k3,fp,fpv,fev,p,pn,pm,q,qn,qm,u,un,um, \
            dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,alphaP,\
...
! -------------------------------------------------------------------------------
#beginMacro evalTZForcingMLA3dOrder4(xy,i1,i2,i3,dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,\
                                     c,alphaP,pnec,prc,peptc,b0v,b1v,fpv,fpSum,fev,\
...
!-------------------------------------------------------------------------------------------
#beginMacro getNonlinearDispersiveTZForcing3dOrder4(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)

  ! evalTZForcingMLA3dOrder4(xy,i1,i2,i3,dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,\
  !                                    c,alphaP,pnec,prc,peptc,b0v,b1v,fpv,fpSum,fev,\
  !                                    LfE,fEt,fEtt,LfP,fPt,fPtt,fnv,fntv,fnttv,fntttv,\
  !                                    pevtt,pevttx,pevtty,pevttz,pevttL,pevtttt,fevx,fevy,fevz,fpvx,fpvy,fpvz,\
  !                                    pevttSum,pevttxSum,pevttySum,pevttzSum,pevttLSum,pevttttSum)
  if( twilightZone.eq.1 )then
    evalTZForcingMLA3dOrder4(xy1,i1,i2,i3,dispersionModel1,nonlinearModel1,numberOfPolarizationVectors1,numberOfAtomicLevels1,\
                             c1,alphaP1,pnec1,prc1,peptc1,b0v1,b1v1,fpv1,fpSum1,fev1,\
    ...
    evalTZForcingMLA3dOrder4(xy2,j1,j2,j3,dispersionModel2,nonlinearModel2,numberOfPolarizationVectors2,numberOfAtomicLevels2,\
                             c2,alphaP2,pnec2,prc2,peptc2,b0v2,b1v2,fpv2,fpSum2,fev2,\
...
! --------------------------------------------------------------------------
#beginMacro eval3dJumpNonlinearDispersiveOrder4()
...
! ==========================================================================================
#beginMacro evaluateNonlinearInterfaceEquations3dOrder4()

 ! Evaluate TZ forcing for dispersive equations in 3D 
 getNonlinearDispersiveTZForcing3dOrder4(fpv1,fpv2,fev1,fev2,fnv1,fntv1,fnv2,fntv2)
 ...
 ! getNonlinearDispersiveForcing3dOrder4(FACE,k1,k2,k3,fp,fpv,fev,p,pn,pm,q,qn,qm,u,un,um, \
 !            dispersionModel,nonlinearModel,numberOfPolarizationVectors,numberOfAtomicLevels,alphaP,\
 !            pnec,prc,peptc,b0v,b1v,LE,LLE,LEm,LfE,LfP,fEt,fEtt,fPt,fPtt,fnv,fntv,\
 !            pevtt,pevttx,pevtty,pevttz,pevttL,pevtttt,evx,evy,evz,evnx,evny,evnz,\
 !            fevx,fevy,fevz,fpvx,fpvy,fpvz,LEx,LEy,LEz,fPttx,fPtty,fPttz,fLPtt,fPtttt)
 ! eval dispersive forcings for domain 1
 getNonlinearDispersiveForcing3dOrder4(LEFT,i1,i2,i3, fp1, fpv1,fev1,p1,p1n,p1m,q1,q1n,q1m,u1,u1n,u1m, \
              dispersionModel1,nonlinearModel1,numberOfPolarizationVectors1,numberOfAtomicLevels1,alphaP1,\
 ...
 getNonlinearDispersiveForcing3dOrder4(RIGHT,j1,j2,j3, fp2, fpv2,fev2,p2,p2n,p2m, q2,q2n,q2m,u2,u2n,u2m, \
              dispersionModel2,nonlinearModel2,numberOfPolarizationVectors2,numberOfAtomicLevels2,alphaP2,\
 ...
 eval3dJumpNonlinearDispersiveOrder4()
...
! ==========================================================================================
#beginMacro fillNonlinearDispersiveEquations3dOrder4a(e0,e1,e2,e3,e4,e5)
...
! ==========================================================================================
#beginMacro fillNonlinearDispersiveEquations3dOrder4b(e0,e1,e2,e3,e4,e5)
...
#beginMacro assignNonlinearInterfaceGhost3dOrder4()
  INFO("34c-MLA")
...
if (nonlinearModel2 .ne. 0) then
  ...
  beginLoopsMask3d()
    ...
    evaluateNonlinearInterfaceEquations3dOrder4()
   ...
   !  write(debugFile,'(" f(7)=",1pe10.2," curlfPttx2,nDotCurlfPtt2=",2(1pe10.2))') f(7),curlfPttx2,nDotCurlfPtt2
    ...
    ! fill equations 0,..,5
    fillNonlinearDispersiveEquations3dOrder4a(0,1,2,3,4,5)
    ...
    ! fill equations 6...11
    fillNonlinearDispersiveEquations3dOrder4b(6,7,8,9,10,11)
    ...
    if( checkCoeff.eq.1 .and. it.le.1 )then
      ...
      checkCoefficients(i1,i2,i3, j1,j2,j3,numberOfEquations,a12,evaluateNonlinearInterfaceEquations3dOrder4 )
    end if
