...
!............... end statement functions
                 ...
                 ! getForcingEM2(X,2,tm,is1,is2,forcex)
                  if( forcingOption.eq.twilightZoneForcing )then
                    ...
                    y=xy(i1,i2,i3,1)
                       ...
                       forcep(ex) = is1*utx - ( c1abcem2*uxx + 
     & c2abcem2*uyy )
                         call ogDeriv(ep, 1,1,0,0,x,y,z,tp,ey,utx)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                       forcep(ey) = is1*utx - ( c1abcem2*uxx + 
     & c2abcem2*uyy )
                         call ogDeriv(ep, 1,1,0,0,x,y,z,tp,hz,utx)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,tp,hz,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,tp,hz,uyy)
                       forcep(hz) = is1*utx - ( c1abcem2*uxx + 
     & c2abcem2*uyy )
                  ...
                  if( forcingOption.eq.twilightZoneForcing )then
                    ...
                    y=xy(i1,i2,i3,1)
                       ...
                       forcef(ex) = is1*utx - ( c1abcem2*uxx + 
     & c2abcem2*uyy )
                         call ogDeriv(ep, 1,1,0,0,x,y,z,t,ey,utx)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,t,ey,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,t,ey,uyy)
                       forcef(ey) = is1*utx - ( c1abcem2*uxx + 
     & c2abcem2*uyy )
                         call ogDeriv(ep, 1,1,0,0,x,y,z,t,hz,utx)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,t,hz,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,t,hz,uyy)
                       forcef(hz) = is1*utx - ( c1abcem2*uxx + 
     & c2abcem2*uyy )
                    ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
                  end if
                 do idir=0,2
                 ...
                 ! getForcingEM2(Y,2,tm,is1,is2,forcey)
                  if( forcingOption.eq.twilightZoneForcing )then
                    ...
                    y=xy(i1,i2,i3,1)
                         ...
                         call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ex,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ex,uyy)
                       forcep(ex) = is2*uty - ( c1abcem2*uyy + 
     & c2abcem2*uxx )
                       ! Values for forcep(ey) are currently needed at corners:
                         call ogDeriv(ep, 1,0,1,0,x,y,z,tp,ey,uty)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                       forcep(ey) = is2*uty - ( c1abcem2*uyy + 
     & c2abcem2*uxx )
                         call ogDeriv(ep, 1,0,1,0,x,y,z,tp,hz,uty)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,tp,hz,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,tp,hz,uyy)
                       forcep(hz) = is2*uty - ( c1abcem2*uyy + 
     & c2abcem2*uxx )
                    ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
                  end if
                  if( forcingOption.eq.twilightZoneForcing )then
                    ...
                    y=xy(i1,i2,i3,1)
                         ...
                         call ogDeriv(ep, 0,2,0,0,x,y,z,t,ex,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,t,ex,uyy)
                       forcef(ex) = is2*uty - ( c1abcem2*uyy + 
     & c2abcem2*uxx )
                       ! Values for forcef(ey) are currently needed at corners:
                         call ogDeriv(ep, 1,0,1,0,x,y,z,t,ey,uty)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,t,ey,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,t,ey,uyy)
                       forcef(ey) = is2*uty - ( c1abcem2*uyy + 
     & c2abcem2*uxx )
                         call ogDeriv(ep, 1,0,1,0,x,y,z,t,hz,uty)
                         call ogDeriv(ep, 0,2,0,0,x,y,z,t,hz,uxx)
                         call ogDeriv(ep, 0,0,2,0,x,y,z,t,hz,uyy)
                       forcef(hz) = is2*uty - ( c1abcem2*uyy + 
     & c2abcem2*uxx )
                    ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
                  end if
                 do idir=0,2
                 ...
                 r1 = isign1*(unx22r(i1,i2,i3,ex)-ux22r(i1,i2,i3,ex))/(
     & dt)- .5*( c1abcem2*unxx22r(i1,i2,i3,ex) + c2abcem2*unyy22r(i1,
     & i2,i3,ex) +c1abcem2* uxx22r(i1,i2,i3,ex) + c2abcem2* uyy22r(i1,
     & i2,i3,ex) ) - forcex(ex)
                 r2 = isign2*(uny22r(i1,i2,i3,ex)-uy22r(i1,i2,i3,ex))/(
     & dt)- .5*( c1abcem2*unyy22r(i1,i2,i3,ex) + c2abcem2*unxx22r(i1,
     & i2,i3,ex) +c1abcem2* uyy22r(i1,i2,i3,ex) + c2abcem2* uxx22r(i1,
     & i2,i3,ex) ) - forcey(ex)
                 ...
                 isign2=1-2*side2
                 ! first evaluate residuals in equations given current (wrong) values at A, B
                 r1 = isign1*(unx22r(i1,i2,i3,ey)-ux22r(i1,i2,i3,ey))/(
     & dt)- .5*( c1abcem2*unxx22r(i1,i2,i3,ey) + c2abcem2*unyy22r(i1,
     & i2,i3,ey) +c1abcem2* uxx22r(i1,i2,i3,ey) + c2abcem2* uyy22r(i1,
     & i2,i3,ey) ) - forcex(ey)
                 r2 = isign2*(uny22r(i1,i2,i3,ey)-uy22r(i1,i2,i3,ey))/(
     & dt)- .5*( c1abcem2*unyy22r(i1,i2,i3,ey) + c2abcem2*unxx22r(i1,
     & i2,i3,ey) +c1abcem2* uyy22r(i1,i2,i3,ey) + c2abcem2* uxx22r(i1,
     & i2,i3,ey) ) - forcey(ey)
                 a11 = -1./(2.*dt*dx(0))  - .5*c1abcem2/(dx(0)**2)
                 a12 = -.5*c2abcem2/(dx(1)**2)
                 a21 = -.5*c2abcem2/(dx(0)**2)
                 a22 = -1./(2.*dt*dx(1))  - .5*c1abcem2/(dx(1)**2)
                 det = a11*a22-a21*a12
                 uA = un(i1-isign1,i2,i3,ey)
                 uB = un(i1,i2-isign2,i3,ey)
                 f1 = a11*uA + a12*uB - r1
                 f2 = a21*uA + a22*uB - r2
                 ! Solve for A, B
                 un(i1-isign1,i2,i3,ey) = ( f1*a22 - f2*a12)/det
                 un(i1,i2-isign2,i3,ey) = (-f1*a21 + f2*a11)/det
                 ! At a corner there are two coupled equations we need to solve for ghost points A,B below
                 !                   |
                 !                 A +---+----
                 !                   B
                 ...
                 isign2=1-2*side2
                 ! first evaluate residuals in equations given current (wrong) values at A, B
                 r1 = isign1*(unx22r(i1,i2,i3,hz)-ux22r(i1,i2,i3,hz))/(
     & dt)- .5*( c1abcem2*unxx22r(i1,i2,i3,hz) + c2abcem2*unyy22r(i1,
     & i2,i3,hz) +c1abcem2* uxx22r(i1,i2,i3,hz) + c2abcem2* uyy22r(i1,
     & i2,i3,hz) ) - forcex(hz)
                 r2 = isign2*(uny22r(i1,i2,i3,hz)-uy22r(i1,i2,i3,hz))/(
     & dt)- .5*( c1abcem2*unyy22r(i1,i2,i3,hz) + c2abcem2*unxx22r(i1,
     & i2,i3,hz) +c1abcem2* uyy22r(i1,i2,i3,hz) + c2abcem2* uxx22r(i1,
     & i2,i3,hz) ) - forcey(hz)
                 a11 = -1./(2.*dt*dx(0))  - .5*c1abcem2/(dx(0)**2)
                 a12 = -.5*c2abcem2/(dx(1)**2)
                 a21 = -.5*c2abcem2/(dx(0)**2)
                 a22 = -1./(2.*dt*dx(1))  - .5*c1abcem2/(dx(1)**2)
                 det = a11*a22-a21*a12
                 uA = un(i1-isign1,i2,i3,hz)
                 uB = un(i1,i2-isign2,i3,hz)
                 f1 = a11*uA + a12*uB - r1
                 f2 = a21*uA + a22*uB - r2
                 ! Solve for A, B
                 un(i1-isign1,i2,i3,hz) = ( f1*a22 - f2*a12)/det
                 un(i1,i2-isign2,i3,hz) = (-f1*a21 + f2*a11)/det
              else
               ! *old* way          
                ...
                if( forcingOption.eq.twilightZoneForcing )then
                  ...
                  y=xy(i1,i2,i3,1)
                     ! Values for forcex(ex) are currently needed at corners:
                       ...
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ex,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ex,uyy)
                     forcex(ex) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                       call ogDeriv(ep, 1,1,0,0,x,y,z,tp,ey,utx)
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                     forcex(ey) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                       call ogDeriv(ep, 1,1,0,0,x,y,z,tp,hz,utx)
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,hz,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,hz,uyy)
                     forcex(hz) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                  ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
                end if
               ...
               ! *old* way
                if( forcingOption.eq.twilightZoneForcing )then
                  ...
                  y=xy(i1,i2,i3,1)
                       ...
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ex,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ex,uyy)
                     forcey(ex) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                     ! Values for forcey(ey) are currently needed at corners:
                       call ogDeriv(ep, 1,0,1,0,x,y,z,tp,ey,uty)
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                     forcey(ey) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                       call ogDeriv(ep, 1,0,1,0,x,y,z,tp,hz,uty)
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,hz,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,hz,uyy)
                     forcey(hz) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                  ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
                end if
     ...
     & is2,i3-is3,hz) )/cm1
             ...
             if( bc1.ne.symmetryBoundaryCondition )then
                 ...
                 if( extrapOrder.eq.3 )then
                   un(i1-ks1,i2-ks2,i3-ks3,ex)=(3.*un(i1,i2,i3,ex)-3.*
     & un(i1+ks1,i2+ks2,i3+ks3,ex)+un(i1+2*ks1,i2+2*ks2,i3+2*ks3,ex))
                   un(i1-ks1,i2-ks2,i3-ks3,ey)=(3.*un(i1,i2,i3,ey)-3.*
     & un(i1+ks1,i2+ks2,i3+ks3,ey)+un(i1+2*ks1,i2+2*ks2,i3+2*ks3,ey))
                   un(i1-ks1,i2-ks2,i3-ks3,hz)=(3.*un(i1,i2,i3,hz)-3.*
     & un(i1+ks1,i2+ks2,i3+ks3,hz)+un(i1+2*ks1,i2+2*ks2,i3+2*ks3,hz))
                 else if( extrapOrder.eq.5 )then
                   un(i1-ks1,i2-ks2,i3-ks3,ex)=(5.*un(i1,i2,i3,ex)-10.*
     & un(i1+ks1,i2+ks2,i3+ks3,ex)+10.*un(i1+2*ks1,i2+2*ks2,i3+2*ks3,
     & ex)-5.*un(i1+3*ks1,i2+3*ks2,i3+3*ks3,ex)+un(i1+4*ks1,i2+4*ks2,
     & i3+4*ks3,ex))
                   un(i1-ks1,i2-ks2,i3-ks3,ey)=(5.*un(i1,i2,i3,ey)-10.*
     & un(i1+ks1,i2+ks2,i3+ks3,ey)+10.*un(i1+2*ks1,i2+2*ks2,i3+2*ks3,
     & ey)-5.*un(i1+3*ks1,i2+3*ks2,i3+3*ks3,ey)+un(i1+4*ks1,i2+4*ks2,
     & i3+4*ks3,ey))
                   un(i1-ks1,i2-ks2,i3-ks3,hz)=(5.*un(i1,i2,i3,hz)-10.*
     & un(i1+ks1,i2+ks2,i3+ks3,hz)+10.*un(i1+2*ks1,i2+2*ks2,i3+2*ks3,
     & hz)-5.*un(i1+3*ks1,i2+3*ks2,i3+3*ks3,hz)+un(i1+4*ks1,i2+4*ks2,
     & i3+4*ks3,hz))
                 else
                   stop 1782
                 end if
     ...
     & i3+4*ks3,hz))
             ...
             ! ----------------------------------------
             if( orderOfAccuracy.eq.2 .and. (bc1.ge.abcEM2 .and. 
     & bc1.le.abc5) )then

               is1=1-2*side1
               if( gridType.eq.rectangular )then
                 un(i1-is1,i2,i3,ex)=un(i1+is1,i2,i3,ex)+ 2.*is1*dx(0)*
     & uny22r(i1,i2,i3,ey)
               else
                 ! *check me* 
                 axis=0
                 ...
                 un(i1-is1,i2-is2,i3,ex) = un(i1-is1,i2-is2,i3,ex) - 
     & div*ax/aSq
                 un(i1-is1,i2-is2,i3,ey) = un(i1-is1,i2-is2,i3,ey) - 
     & div*ay/aSq
               end if
             end if

             if( orderOfAccuracy.eq.2 .and. (bc2.ge.abcEM2 .and. 
     & bc2.le.abc5) )then
               ! set div(E)=0
               is2=1-2*side2
               if( gridType.eq.rectangular )then
                 un(i1,i2-is2,i3,ey)=un(i1,i2+is2,i3,ey) + 2.*is2*dx(1)
     & *unx22r(i1,i2,i3,ex)
               else
                 ! *check me* 
                 axis=1
...
!!$             un(i1-is1,i2-is2,i3-is3,hz)=extrap3(un,i1,i2,i3,hz,is1,is2,is3)
            ...
            do m1=0,numberOfGhostPoints
             ...
             if( mSum.gt.0 .and. mSum.ne.1 )then ! mSum=1 : these points have already been assigned
              ...
              if( orderOfAccuracy.eq.2 )then
                ...
                un(j1,j2,j3,ex)=(3.*un(j1+js1,j2+js2,j3+js3,ex)-3.*un(
     & j1+js1+js1,j2+js2+js2,j3+js3+js3,ex)+un(j1+js1+2*js1,j2+js2+2*
     & js2,j3+js3+2*js3,ex))
                un(j1,j2,j3,ey)=(3.*un(j1+js1,j2+js2,j3+js3,ey)-3.*un(
     & j1+js1+js1,j2+js2+js2,j3+js3+js3,ey)+un(j1+js1+2*js1,j2+js2+2*
     & js2,j3+js3+2*js3,ey))
                un(j1,j2,j3,hz)=(3.*un(j1+js1,j2+js2,j3+js3,hz)-3.*un(
     & j1+js1+js1,j2+js2+js2,j3+js3+js3,hz)+un(j1+js1+2*js1,j2+js2+2*
     & js2,j3+js3+2*js3,hz))
                ...
                if( m1.le.1 .and. m2.le.1 .and. m3.le.1 )then
                  ...
                  un(j1,j2,j3,ex)=(5.*un(j1+js1,j2+js2,j3+js3,ex)-10.*
     & un(j1+js1+js1,j2+js2+js2,j3+js3+js3,ex)+10.*un(j1+js1+2*js1,j2+
     & js2+2*js2,j3+js3+2*js3,ex)-5.*un(j1+js1+3*js1,j2+js2+3*js2,j3+
     & js3+3*js3,ex)+un(j1+js1+4*js1,j2+js2+4*js2,j3+js3+4*js3,ex))
                  un(j1,j2,j3,ey)=(5.*un(j1+js1,j2+js2,j3+js3,ey)-10.*
     & un(j1+js1+js1,j2+js2+js2,j3+js3+js3,ey)+10.*un(j1+js1+2*js1,j2+
     & js2+2*js2,j3+js3+2*js3,ey)-5.*un(j1+js1+3*js1,j2+js2+3*js2,j3+
     & js3+3*js3,ey)+un(j1+js1+4*js1,j2+js2+4*js2,j3+js3+4*js3,ey))
                  un(j1,j2,j3,hz)=(5.*un(j1+js1,j2+js2,j3+js3,hz)-10.*
     & un(j1+js1+js1,j2+js2+js2,j3+js3+js3,hz)+10.*un(j1+js1+2*js1,j2+
     & js2+2*js2,j3+js3+2*js3,hz)-5.*un(j1+js1+3*js1,j2+js2+3*js2,j3+
     & js3+3*js3,hz)+un(j1+js1+4*js1,j2+js2+4*js2,j3+js3+4*js3,hz))
               ...
               if( forcingOption.eq.twilightZoneForcing )then
                 ...
                 y=xy(i1,i2,i3,1)
                   ...
                   z=xy(i1,i2,i3,2)
                    ...
                    forcez(ex) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                      call ogDeriv(ep, 1,0,0,1,x,y,z,tp,ey,utz)
                      call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                      call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                      call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ey,uzz)
                    forcez(ey) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                      call ogDeriv(ep, 1,0,0,1,x,y,z,tp,ez,utz)
                      call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ez,uxx)
                      call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ez,uyy)
                      call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ez,uzz)
                    forcez(ez) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                 ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
               end if
     ...
     & uxx+uzz) )
                    ...
                    forcey(ey) = is2*uty - ( c1abcem2*uyy + c2abcem2*(
     & uxx+uzz) )
                      call ogDeriv(ep, 1,0,1,0,x,y,z,tp,ez,uty)
                      call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ez,uxx)
                      call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ez,uyy)
                      call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ez,uzz)
                    forcey(ez) = is2*uty - ( c1abcem2*uyy + c2abcem2*(
     & uxx+uzz) )
                 ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
               end if
     ...
     & 0,ez) )/cm1
             ...
             js2=0
             js3=is3
             un(i1-js1,i2-js2,i3-js3,ex)=(3.*un(i1,i2,i3,ex)-3.*un(i1+
     & js1,i2+js2,i3+js3,ex)+un(i1+2*js1,i2+2*js2,i3+2*js3,ex))
             un(i1-js1,i2-js2,i3-js3,ey)=(3.*un(i1,i2,i3,ey)-3.*un(i1+
     & js1,i2+js2,i3+js3,ey)+un(i1+2*js1,i2+2*js2,i3+2*js3,ey))
             un(i1-js1,i2-js2,i3-js3,ez)=(3.*un(i1,i2,i3,ez)-3.*un(i1+
     & js1,i2+js2,i3+js3,ez)+un(i1+2*js1,i2+2*js2,i3+2*js3,ez))
     ...
     & j1+js1+js1,j2+js2+js2,j3+js3+js3,ey)+un(j1+js1+2*js1,j2+js2+2*
     & js2,j3+js3+2*js3,ey))
                 un(j1,j2,j3,ez)=(3.*un(j1+js1,j2+js2,j3+js3,ez)-3.*un(
     & j1+js1+js1,j2+js2+js2,j3+js3+js3,ez)+un(j1+js1+2*js1,j2+js2+2*
     & js2,j3+js3+2*js3,ez))
                 ! un(j1,j2,j3,ex)=extrap2(un,j1+js1,j2+js2,j3+js3,ex,js1,js2,js3)
                 ! un(j1,j2,j3,ey)=extrap2(un,j1+js1,j2+js2,j3+js3,ey,js1,js2,js3)
     ...
     & js2+2*js2,j3+js3+2*js3,ey)-5.*un(j1+js1+3*js1,j2+js2+3*js2,j3+
     & js3+3*js3,ey)+un(j1+js1+4*js1,j2+js2+4*js2,j3+js3+4*js3,ey))
                   un(j1,j2,j3,ez)=(5.*un(j1+js1,j2+js2,j3+js3,ez)-10.*
     & un(j1+js1+js1,j2+js2+js2,j3+js3+js3,ez)+10.*un(j1+js1+2*js1,j2+
     & js2+2*js2,j3+js3+2*js3,ez)-5.*un(j1+js1+3*js1,j2+js2+3*js2,j3+
     & js3+3*js3,ez)+un(j1+js1+4*js1,j2+js2+4*js2,j3+js3+4*js3,ez))
                   !un(j1,j2,j3,ex)=extrap3(un,j1+js1,j2+js2,j3+js3,ex,js1,js2,js3)
                   !un(j1,j2,j3,ey)=extrap3(un,j1+js1,j2+js2,j3+js3,ey,js1,js2,js3)
     ...
     & uyy+uzz) )
                     ...
                     forcex(ey) = is1*utx - ( c1abcem2*uxx + c2abcem2*(
     & uyy+uzz) )
                       call ogDeriv(ep, 1,1,0,0,x,y,z,tp,ez,utx)
                       call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ez,uxx)
                       call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ez,uyy)
                       call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ez,uzz)
                     forcex(ez) = is1*utx - ( c1abcem2*uxx + c2abcem2*(
     & uyy+uzz) )
                  ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
                end if
              ...
              if( forcingOption.eq.twilightZoneForcing )then
                ...
                y=xy(i1,i2,i3,1)
                   ! Values for forcep(ex) are currently needed at corners:
                     ...
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ex,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ex,uyy)
                   forcep(ex) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                     call ogDeriv(ep, 1,1,0,0,x,y,z,tp,ey,utx)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                   forcep(ey) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                     call ogDeriv(ep, 1,1,0,0,x,y,z,tp,hz,utx)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,hz,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,hz,uyy)
                   forcep(hz) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
              if( forcingOption.eq.twilightZoneForcing )then
                ...
                y=xy(i1,i2,i3,1)
                   ! Values for forcef(ex) are currently needed at corners:
                     ...
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ex,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ex,uyy)
                   forcef(ex) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                     call ogDeriv(ep, 1,1,0,0,x,y,z,t,ey,utx)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ey,uyy)
                   forcef(ey) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                     call ogDeriv(ep, 1,1,0,0,x,y,z,t,hz,utx)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,hz,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,hz,uyy)
                   forcef(hz) = is1*utx - ( c1abcem2*uxx + c2abcem2*
     & uyy )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
             do idir=0,2
     ...
     & ey))/dx(1)**2+2.*forcex(ey)))/(1.+c1abcem2*dt/dxa))
           un(i1-is1,i2-is2,i3-is3,hz)=((un(i1+is1,i2+is2,i3+is3,hz)-(
     ...
     & hz))/dx(1)**2+2.*forcex(hz)))/(1.+c1abcem2*dt/dxa))
     ...
     & uny22r(i1,i2,i3,ey)
            ...
            if( .false. )then
              ...
              un(i1-is1,i2,i3,ex) = uGhost - ( (ux+vy) + alpha*(uxx+
     & vxy) )/aGhost
             ...
             ! getForcingEM2(Y,2,tm,is1,is2,forcey)
              if( forcingOption.eq.twilightZoneForcing )then
                ...
                y=xy(i1,i2,i3,1)
                     ...
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ex,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ex,uyy)
                   forcep(ex) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                   ! Values for forcep(ey) are currently needed at corners:
                     call ogDeriv(ep, 1,0,1,0,x,y,z,tp,ey,uty)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                   forcep(ey) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                     call ogDeriv(ep, 1,0,1,0,x,y,z,tp,hz,uty)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,hz,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,hz,uyy)
                   forcep(hz) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
              if( forcingOption.eq.twilightZoneForcing )then
                ...
                y=xy(i1,i2,i3,1)
                     ...
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ex,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ex,uyy)
                   forcef(ex) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                   ! Values for forcef(ey) are currently needed at corners:
                     call ogDeriv(ep, 1,0,1,0,x,y,z,t,ey,uty)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ey,uyy)
                   forcef(ey) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                     call ogDeriv(ep, 1,0,1,0,x,y,z,t,hz,uty)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,hz,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,hz,uyy)
                   forcef(hz) = is2*uty - ( c1abcem2*uyy + c2abcem2*
     & uxx )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
             do idir=0,2
     ...
     & ex))/dx(0)**2+2.*forcey(ex)))/(1.+c1abcem2*dt/dya))
     ...
     & hz))/dx(0)**2+2.*forcey(hz)))/(1.+c1abcem2*dt/dya))
     ...
     & uyy+uzz) )
                     ...
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ez,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ez,uzz)
                   forcep(ez) = is1*utx - ( c1abcem2*uxx + c2abcem2*(
     & uyy+uzz) )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
              if( forcingOption.eq.twilightZoneForcing )then
     ...
     & uyy+uzz) )
                     ...
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ey,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,t,ey,uzz)
                   forcef(ey) = is1*utx - ( c1abcem2*uxx + c2abcem2*(
     & uyy+uzz) )
                     call ogDeriv(ep, 1,1,0,0,x,y,z,t,ez,utx)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ez,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ez,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,t,ez,uzz)
                   forcef(ez) = is1*utx - ( c1abcem2*uxx + c2abcem2*(
     & uyy+uzz) )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
             do idir=0,2
     ...
     & un(i1,i2,i3,ey)+un(i1,i2,i3+1,ey))/dx(2)**2+2.*forcex(ey)))/(
     & 1.+c1abcem2*dt/dxa))
           un(i1-is1,i2-is2,i3-is3,ez)=((un(i1+is1,i2+is2,i3+is3,ez)-(
     ...
     & un(i1,i2,i3,ez)+un(i1,i2,i3+1,ez))/dx(2)**2+2.*forcex(ez)))/(
     & 1.+c1abcem2*dt/dxa))
     ...
     & uxx+uzz) )
                     ...
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ez,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ez,uzz)
                   forcep(ez) = is2*uty - ( c1abcem2*uyy + c2abcem2*(
     & uxx+uzz) )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
              if( forcingOption.eq.twilightZoneForcing )then
     ...
     & uxx+uzz) )
                   ...
                   forcef(ey) = is2*uty - ( c1abcem2*uyy + c2abcem2*(
     & uxx+uzz) )
                     call ogDeriv(ep, 1,0,1,0,x,y,z,t,ez,uty)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ez,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ez,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,t,ez,uzz)
                   forcef(ez) = is2*uty - ( c1abcem2*uyy + c2abcem2*(
     & uxx+uzz) )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
             do idir=0,2
     ...
     & un(i1,i2,i3,ex)+un(i1,i2,i3+1,ex))/dx(2)**2+2.*forcey(ex)))/(
     & 1.+c1abcem2*dt/dya))
     ...
     & un(i1,i2,i3,ez)+un(i1,i2,i3+1,ez))/dx(2)**2+2.*forcey(ez)))/(
     & 1.+c1abcem2*dt/dya))
              ...
              if( forcingOption.eq.twilightZoneForcing )then
                ...
                y=xy(i1,i2,i3,1)
                  ...
                  z=xy(i1,i2,i3,2)
                     ...
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ex,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ex,uzz)
                   forcep(ex) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                     call ogDeriv(ep, 1,0,0,1,x,y,z,tp,ey,utz)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ey,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ey,uzz)
                   forcep(ey) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                     call ogDeriv(ep, 1,0,0,1,x,y,z,tp,ez,utz)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,tp,ez,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,tp,ez,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,tp,ez,uzz)
                   forcep(ez) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
              if( forcingOption.eq.twilightZoneForcing )then
                ...
                y=xy(i1,i2,i3,1)
                  ...
                  z=xy(i1,i2,i3,2)
                     ...
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ex,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,t,ex,uzz)
                   forcef(ex) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                     call ogDeriv(ep, 1,0,0,1,x,y,z,t,ey,utz)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ey,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ey,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,t,ey,uzz)
                   forcef(ey) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                     call ogDeriv(ep, 1,0,0,1,x,y,z,t,ez,utz)
                     call ogDeriv(ep, 0,2,0,0,x,y,z,t,ez,uxx)
                     call ogDeriv(ep, 0,0,2,0,x,y,z,t,ez,uyy)
                     call ogDeriv(ep, 0,0,0,2,x,y,z,t,ez,uzz)
                   forcef(ez) = is3*utz - ( c1abcem2*uzz + c2abcem2*(
     & uxx+uyy) )
                ! write(*,'(" Apply abcEM2: add TZ forcing t,dt,utx,uxx,uyy=",5e10.3)') t,dt,utx,uxx,uyy
              end if
             do idir=0,2
     ...
     & i1,i2,i3,ex)+un(i1,i2+1,i3,ex))/dx(1)**2+2.*forcez(ex)))/(1.+
     & c1abcem2*dt/dza))
           un(i1-is1,i2-is2,i3-is3,ey)=((un(i1+is1,i2+is2,i3+is3,ey)-(
     ...
     & i1,i2,i3,ey)+un(i1,i2+1,i3,ey))/dx(1)**2+2.*forcez(ey)))/(1.+
     & c1abcem2*dt/dza))
     ...
     & ex))/dx(1)**2+2.*forcex(ex)))/(1.+c1abcem2*dt/dxa))
           un(i1-is1,i2-is2,i3-is3,ey)=((un(i1+is1,i2+is2,i3+is3,ey)-(
     & u(i1+is1,i2+is2,i3+is3,ey)-u(i1-is1,i2-is2,i3-is3,ey))-(dxa*dt)
     & *(c1abcem2*uxx22r(i1,i2,i3,ey)+c2abcem2*uyy22r(i1,i2,i3,ey)+
     & c1abcem2*(-2.*un(i1,i2,i3,ey)+un(i1+is1,i2,i3,ey))/dxa**2+
     ...
     & ey))/dx(0)**2+2.*forcey(ey)))/(1.+c1abcem2*dt/dya))
           un(i1-is1,i2-is2,i3-is3,hz)=((un(i1+is1,i2+is2,i3+is3,hz)-(
     & u(i1+is1,i2+is2,i3+is3,hz)-u(i1-is1,i2-is2,i3-is3,hz))-(dya*dt)
     & *(c1abcem2*uyy22r(i1,i2,i3,hz)+c2abcem2*uxx22r(i1,i2,i3,hz)+
     & c1abcem2*(-2.*un(i1,i2,i3,hz)+un(i1,i2+is2,i3,hz))/dya**2+
     ...
     & un(i1,i2,i3,ex)+un(i1,i2,i3+1,ex))/dx(2)**2+2.*forcex(ex)))/(
     & 1.+c1abcem2*dt/dxa))
           un(i1-is1,i2-is2,i3-is3,ey)=((un(i1+is1,i2+is2,i3+is3,ey)-(
     & u(i1+is1,i2+is2,i3+is3,ey)-u(i1-is1,i2-is2,i3-is3,ey))-(dxa*dt)
     & *(c1abcem2*uxx23r(i1,i2,i3,ey)+c2abcem2*(uyy23r(i1,i2,i3,ey)+
     ...
     & un(i1,i2,i3,ey)+un(i1,i2,i3+1,ey))/dx(2)**2+2.*forcey(ey)))/(
     & 1.+c1abcem2*dt/dya))
           un(i1-is1,i2-is2,i3-is3,ez)=((un(i1+is1,i2+is2,i3+is3,ez)-(
     & u(i1+is1,i2+is2,i3+is3,ez)-u(i1-is1,i2-is2,i3-is3,ez))-(dya*dt)
     & *(c1abcem2*uyy23r(i1,i2,i3,ez)+c2abcem2*(uxx23r(i1,i2,i3,ez)+
     ...
     & i1,i2,i3,ez)+un(i1,i2+1,i3,ez))/dx(1)**2+2.*forcez(ez)))/(1.+
     & c1abcem2*dt/dza))
