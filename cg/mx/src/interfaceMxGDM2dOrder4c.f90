! This file automatically generated from interfaceOpt.bf90 with bpp.
 subroutine interfaceMxGDM2dOrder4c( nd, nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange1, u1,u1n,u1m, wk1, mask1,rsxy1, xy1, p1,p1n,p1m, q1,q1n,q1m, boundaryCondition1, md1a,md1b,md2a,md2b,md3a,md3b,gridIndexRange2, u2,u2n,u2m, wk2, mask2,rsxy2, xy2, p2,p2n,p2m, q2,q2n,q2m, boundaryCondition2, ipar, rpar, aa2,aa4,aa8, ipvt2,ipvt4,ipvt8, ierr )
 ! ===================================================================================
 ...
 !............... end statement functions
      ...
      c2PttttfPtt=1.
                     ...
                     ! newer version with fixes for mu -- Feb 2021
                      ...
                      !  f(4)=(u1xxx - v1yyy)*c1**2/mu1 - !       (u2xxx - v2yyy)*c2**2/mu2
                      ! Dispersive:
                      ...
                      if( twilightZone.eq.1 )then
                       ...
                       f(5) = f(5) - ((vexxx+vexyy)-(uexxy+ueyyy))*(1./epsmu1-1./epsmu2) + (alphaP1/mu1)*( pevttxSum1(1) - pevttySum1(0) ) - (alphaP2/mu2)*( pevttxSum2(1) - pevttySum2(0) )
                       ! Includes fix for div
                       ! J4a: [ (u.x + v.y).xx ] -> [ (c^2/mu)( u.xxx - v.yyy) ] 
                       !  f(4) = f(4) - ( uexxx - veyyy )*(c1**2/mu1 - c2**2/mu2)
                       !  f(5) = f(5) - ((vexxx+ 2.*vexyy)-(      ueyyy))*(c1**2/mu1 - c2**2/mu2) !              + (alphaP1/mu1)*( pevttxSum1(1) - pevttySum1(0) ) !              - (alphaP2/mu2)*( pevttxSum2(1) - pevttySum2(0) )
                       ...
                       !   f(6) = f(6) - (an1*ueLapSq+an2*veLapSq)*(1./(epsmu1*mu1) - 1./(epsmu2*mu2) ) !                  + (alphaP1/mu1)*( an1*pevttLSum1(0) + an2*pevttLSum1(1) )*epsmu1 !                  - (alphaP2/mu2)*( an1*pevttLSum2(0) + an2*pevttLSum2(1) )*epsmu2 
                       ...
                       !   f(7) = f(7) - (tau1*ueLapSq+tau2*veLapSq)*(1./epsmu1**2 - 1./epsmu2**2) !                  + alphaP1*( ( tau1*pevttLSum1(0) + tau2*pevttLSum1(1) ) + tau1*pevttttSum1(0) + tau2*pevttttSum1(1) ) !                  - alphaP2*( ( tau1*pevttLSum2(0) + tau2*pevttLSum2(1) ) + tau1*pevttttSum2(0) + tau2*pevttttSum2(1) ) 
                      end if
