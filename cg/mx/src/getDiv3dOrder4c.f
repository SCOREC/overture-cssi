! This file automatically generated from getDiv.bf with bpp.
       subroutine getDiv3dOrder4c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & )then
        ...
        if( method.ne.bamx )then
         ! --- Isotropic Maxwell ----
            if( t.lt.2*dt )then
              write(*,'("computeDiv dim=3 order=4 grid=curvilinear ... 
     & t=",e10.2)') t
            end if
            ...
            ! Loop bounds -- exclude absorbing layers ? 
              ...
              do i1=n1a,n1b
               ...
               ! --- 3D -----
                  divD(i1,i2,i3) = vx43(i1,i2,i3,ex) + vy43(i1,i2,i3,
     & ey) + vz43(i1,i2,i3,ez)
