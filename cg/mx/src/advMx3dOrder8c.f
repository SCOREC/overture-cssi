! This file automatically generated from advOpt.bf with bpp.
        subroutine advMx3dOrder8c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
              ...
              if( .not.addDissipation )then
                ...
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,ex)=maxwellc88me(i1,i2,i3,ex)
               ...
               if( nd.eq.2 )then
                ...
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,ex)=maxwellc88me(i1,i2,i3,ex)+dis(i1,i2,
     & i3,ex)
                   un(i1,i2,i3,ey)=maxwellc88me(i1,i2,i3,ey)+dis(i1,i2,
     & i3,ey)


                   un(i1,i2,i3,hz)=maxwellc88me(i1,i2,i3,hz)+dis(i1,i2,
     & i3,hz)
     ...
     & i3,hz)
                ...
                if( solveForE.ne.0 .and. solveForH.ne.0 )then
                  if( useWhereMask.ne.0 )then
                    ...
                    do i1=n1a,n1b
                      if( mask(i1,i2,i3).gt.0 )then
                        un(i1,i2,i3,ex)=maxwellc88me(i1,i2,i3,ex)+dis(
     & i1,i2,i3,ex)
                        un(i1,i2,i3,ey)=maxwellc88me(i1,i2,i3,ey)+dis(
     & i1,i2,i3,ey)
                        un(i1,i2,i3,ez)=maxwellc88me(i1,i2,i3,ez)+dis(
     & i1,i2,i3,ez)



                        un(i1,i2,i3,hx)=maxwellc88me(i1,i2,i3,hx)+dis(
     & i1,i2,i3,hx)
                        un(i1,i2,i3,hy)=maxwellc88me(i1,i2,i3,hy)+dis(
     & i1,i2,i3,hy)
                        un(i1,i2,i3,hz)=maxwellc88me(i1,i2,i3,hz)+dis(
     & i1,i2,i3,hz)
     ...
     & i1,i2,i3,hz)
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,ex)=maxwellc88me(i1,i2,i3,ex)+dis(i1,
     & i2,i3,ex)
                     un(i1,i2,i3,ey)=maxwellc88me(i1,i2,i3,ey)+dis(i1,
     & i2,i3,ey)
                     un(i1,i2,i3,ez)=maxwellc88me(i1,i2,i3,ez)+dis(i1,
     & i2,i3,ez)
     ...
     & i2,i3,ez)
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,hx)=maxwellc88me(i1,i2,i3,hx)+dis(i1,
     & i2,i3,hx)
                     un(i1,i2,i3,hy)=maxwellc88me(i1,i2,i3,hy)+dis(i1,
     & i2,i3,hy)
                     un(i1,i2,i3,hz)=maxwellc88me(i1,i2,i3,hz)+dis(i1,
     & i2,i3,hz)
              ...
              if( .not.addDissipation )then
               if( nd.eq.2 )then
                ...
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,ex)=maxwellc88(i1,i2,i3,ex)
               ...
               if( nd.eq.2 )then
                ...
                if( useWhereMask.ne.0 )then
                 ...
                 do i1=n1a,n1b
                  if( mask(i1,i2,i3).gt.0 )then
                   un(i1,i2,i3,ex)=maxwellc88(i1,i2,i3,ex)+dis(i1,i2,
     & i3,ex)
                   un(i1,i2,i3,ey)=maxwellc88(i1,i2,i3,ey)+dis(i1,i2,
     & i3,ey)
                   ut7(i1,i2,i3,ex)=f(i1,i2,i3,ex)
                   ut7(i1,i2,i3,ey)=f(i1,i2,i3,ey)
                   un(i1,i2,i3,hz)=maxwellc88(i1,i2,i3,hz)+dis(i1,i2,
     & i3,hz)
                   ut7(i1,i2,i3,hz)=f(i1,i2,i3,hz)
                 ...
                 do i2=n2a,n2b
                 do i1=n1a,n1b
                  un(i1,i2,i3,ex)=maxwellc88(i1,i2,i3,ex)+dis(i1,i2,i3,
     & ex)
                  un(i1,i2,i3,ey)=maxwellc88(i1,i2,i3,ey)+dis(i1,i2,i3,
     & ey)
                  ut7(i1,i2,i3,ex)=f(i1,i2,i3,ex)
                  ut7(i1,i2,i3,ey)=f(i1,i2,i3,ey)
                  un(i1,i2,i3,hz)=maxwellc88(i1,i2,i3,hz)+dis(i1,i2,i3,
     & hz)
                  ut7(i1,i2,i3,hz)=f(i1,i2,i3,hz)
                ...
                if( solveForE.ne.0 .and. solveForH.ne.0 )then
                  if( useWhereMask.ne.0 )then
                    ...
                    do i1=n1a,n1b
                      if( mask(i1,i2,i3).gt.0 )then
                        un(i1,i2,i3,ex)=maxwellc88(i1,i2,i3,ex)+dis(i1,
     & i2,i3,ex)
                        un(i1,i2,i3,ey)=maxwellc88(i1,i2,i3,ey)+dis(i1,
     & i2,i3,ey)
                        un(i1,i2,i3,ez)=maxwellc88(i1,i2,i3,ez)+dis(i1,
     & i2,i3,ez)
                        ut7(i1,i2,i3,ex)=f(i1,i2,i3,ex)
                        ut7(i1,i2,i3,ey)=f(i1,i2,i3,ey)
                        ut7(i1,i2,i3,ez)=f(i1,i2,i3,ez)
                        un(i1,i2,i3,hx)=maxwellc88(i1,i2,i3,hx)+dis(i1,
     & i2,i3,hx)
                        un(i1,i2,i3,hy)=maxwellc88(i1,i2,i3,hy)+dis(i1,
     & i2,i3,hy)
                        un(i1,i2,i3,hz)=maxwellc88(i1,i2,i3,hz)+dis(i1,
     & i2,i3,hz)
                        ut7(i1,i2,i3,hx)=f(i1,i2,i3,hx)
                        ut7(i1,i2,i3,hy)=f(i1,i2,i3,hy)
                        ut7(i1,i2,i3,hz)=f(i1,i2,i3,hz)
     ...
     & i3,ex)
                     un(i1,i2,i3,ey)=maxwellc88(i1,i2,i3,ey)+dis(i1,i2,
     & i3,ey)
                     un(i1,i2,i3,ez)=maxwellc88(i1,i2,i3,ez)+dis(i1,i2,
     & i3,ez)
                     ut7(i1,i2,i3,ex)=f(i1,i2,i3,ex)
                     ut7(i1,i2,i3,ey)=f(i1,i2,i3,ey)
                     ut7(i1,i2,i3,ez)=f(i1,i2,i3,ez)
     ...
     & i3,ez)
                  ...
                  if( useWhereMask.ne.0 )then
                   ...
                   do i1=n1a,n1b
                    if( mask(i1,i2,i3).gt.0 )then
                     un(i1,i2,i3,hx)=maxwellc88(i1,i2,i3,hx)+dis(i1,i2,
     & i3,hx)
                     un(i1,i2,i3,hy)=maxwellc88(i1,i2,i3,hy)+dis(i1,i2,
     & i3,hy)
                     un(i1,i2,i3,hz)=maxwellc88(i1,i2,i3,hz)+dis(i1,i2,
     & i3,hz)
                     ut7(i1,i2,i3,hx)=f(i1,i2,i3,hx)
