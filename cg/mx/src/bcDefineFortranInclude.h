...
! boundary conditions
      integer dirichlet,perfectElectricalConductor,perfectMagneticConductor,planeWaveBoundaryCondition,\
        interfaceBC,symmetryBoundaryCondition,abcEM2,abcPML,abc3,abc4,abc5,rbcNonLocal,rbcLocal,\
        characteristic,absorbing,lastBC
      parameter( dirichlet=1,perfectElectricalConductor=2,perfectMagneticConductor=3,\
            ...
            abcEM2=7,abcPML=8,abc3=9,abc4=10,abc5=11,rbcNonLocal=12,rbcLocal=13,characteristic=14,\
            absorbing=15,lastBC=15 )
