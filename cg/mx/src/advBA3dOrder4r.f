...
c============================================================================================
     ...
     & u(i1,i2,i3-3,m)))*adxSosup(2)
            ...
            stop 7676
              ...
              if( t.lt.2*dt )then
                write(*,'("advBA: advance BI-ANISTROPIC 3D, 4th-order, 
     ...
     & mr)*curl(4) + K0i(m,5,mr)*curl(5) + fv(m)
                ...
                write(*,*) 'Finish me: BAMX 3D modified equation Order 
     & 4'
                stop 9367
              end if
          else
     ...
     & ec) - b0*pv(pc)- b1*pv(qc) )
                      ...
                      ! compute components of the curl(H) and -curl(E)
                       ! --- 3D -----
                        curl(0) =  uy43r(i1,i2,i3,hz)-uz43r(i1,i2,i3,
     & hy)
                        curl(1) =  uz43r(i1,i2,i3,hx)-ux43r(i1,i2,i3,
     & hz)
                        curl(2) =  ux43r(i1,i2,i3,hy)-uy43r(i1,i2,i3,
     & hx)
                        curl(3) =-(uy43r(i1,i2,i3,ez)-uz43r(i1,i2,i3,
     & ey))
                        curl(4) =-(uz43r(i1,i2,i3,ex)-ux43r(i1,i2,i3,
     & ez))
                        curl(5) =-(ux43r(i1,i2,i3,ey)-uy43r(i1,i2,i3,
     & ex))
                      if( debug.gt.3 )then
