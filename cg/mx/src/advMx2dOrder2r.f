...
c============================================================================================
     ...
     & then
               ...
               if( t.le.3.*dt )then
                 write(*,'("advOPT>>>","FD22r-UP...update-solution-and-
     & dissipation")')
               end if
     ...
     & i1,i2,i3,hz)+dis(i1,i2,i3,hz)
                 ...
                 ! advance to time n+1
               if( t.le.3.*dt )then
                 write(*,'("advOPT>>>","FD22r-UP...update-solution")')
               end if
               if( addForcing.eq.0 .and. .not.addDissipation )then
                 if( useWhereMask.ne.0 )then
                  do i3=n3a,n3b
     ...
     & then
                ...
                if( t.le.3.*dt )then
                  write(*,'("advOPT>>>","FD22r-UP...update-un-with-
     & dissipation-using-v")')
                end if
                if( useWhereMask.ne.0 )then
                  do i3=n3a,n3b
     ...
     & i3,hz)+DztU(i1,i2-2,i3,hz)))*adxSosup(1)
                ...
                if( t.le.3.*dt )then
                  write(*,'("advOPT>>>","FD22r-UP...update-u-with-
     & dissipation")')
                end if
                if( useWhereMask.ne.0 )then
                  do i3=n3a,n3b
     ...
     & DzstU(i1,i2+2,i3,hz)+DzstU(i1,i2-2,i3,hz)))*adxSosup(1)
                ...
                write(*,'("advOpt:FD22r-UP ERROR: unexpected option? 
