...
c============================================================================================
             ...
             if( dispersionModel.ne.noDispersion )then
               ...
               ! updateRectangular2dOrder4Dispersive()
                 if( t.le.3*dt )then
                   if( t.le.3.*dt )then
                     write(*,'("advOPT>>>","update-
     & dispersive_dim=2_order=4_gridType=rectangular")')
                   end if
                 end if
                 fe=0.
     ...
     & )then
                   ...
                   if( t.le.3.*dt )then
                     write(*,'("advOPT>>>","FD44r-UP...update-un-with-
     & dissipation-using-v")')
                   end if
                   if( useWhereMask.ne.0 )then
                     do i3=n3a,n3b
     ...
     & i1,i2-3,i3,hz)))*adxSosup(1)
                   ...
                   write(*,'("advOpt:FD44r-UP ERROR: unexpected 
     & option? sosupDissipationOption=",i2)') sosupDissipationOption
                ...
                if( combineDissipationWithAdvance.eq.0 )then
                 write(*,*) 'advOpt: 2d, rect, 4th-order fix-force 
     & modified equation'
                 if( addForcing.eq.0 .and. .not.addDissipation )then
                   if( useWhereMask.ne.0 )then
                    do i3=n3a,n3b
     ...
     & f2drme44(i1,i2,i3,hz)+dis(i1,i2,i3,hz)
                 ...
                 write(*,*) 'advOpt: 2d, rect, 4th-order, diss, fix-
