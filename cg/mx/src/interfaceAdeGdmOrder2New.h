      ...
      ! Et = 1/2*(-2*a0*alpha*dt^2+2*b1*dt+4)/dt/d1*E+1/2*(-2*b1*dt-4)/dt/d1*Em+1/2*(b1*dt^3+2*dt^2)/dt/d1*LE+1/2*(2*alpha*b0*dt^2+2*alpha*b1*dt)/dt/d1*P-b1*alpha/d1*Pm+1/2*(b1*dt^3+2*dt^2)/dt/d1*fE-alpha*dt*fP/d1
      ...
      c2EtPm=-1.*b1*alpha/d1
      c2EtfE=(.5*b1*dt**2+1.0*dt)/d1
      c2EtfP=-1.*alpha*dt/d1
      ...
      c2PttLE=1.*a1*dt/d1
      c2PttE=((-1.*alpha*a1-1.*b1)*a0*dt**2+d1*a0*dt+2.*a1)/dt/d1
      c2PttEm=-2.*a1/dt/d1
      c2PttP=(b0*(a1*alpha+b1)*dt**2-1.*d1*b0*dt-2.*b1)/dt/d1
      c2PttPm=2.*b1/dt/d1
      c2PttfE=1.*a1*dt/d1
      c2PttfP=(1.*d1+(-1.*alpha*a1-1.*b1)*dt)/d1
