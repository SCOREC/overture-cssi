...
c============================================================================================
             ...
             if( dispersionModel.eq.noDispersion )then
               if( useSuperGrid.eq.0  ) then
                   if( t.lt.2*dt .and. debug.gt.0 )then
                     write(*,'("advBA: advance BA dim=3, order=2 
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                        ...
                        ! --- 3D -----
                         curl(0) =   uy23r(i1,i2,i3,hz)- uz23r(i1,i2,
     & i3,hy)
                         curl(1) =   uz23r(i1,i2,i3,hx)- ux23r(i1,i2,
     & i3,hz)
                         curl(2) =   ux23r(i1,i2,i3,hy)- uy23r(i1,i2,
     & i3,hx)
                         curl(3) =-( uy23r(i1,i2,i3,ez)- uz23r(i1,i2,
     & i3,ey))
                         curl(4) =-( uz23r(i1,i2,i3,ex)- ux23r(i1,i2,
     & i3,ez))
                         curl(5) =-( ux23r(i1,i2,i3,ey)- uy23r(i1,i2,
     & i3,ex))
                         do m=0,5
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                              ...
                              ! --- 3D -----
                               curl(0) =  etay(i2)* uy23r(i1,i2,i3,hz)-
     & etaz(i3)* uz23r(i1,i2,i3,hy)
                               curl(1) =  etaz(i3)* uz23r(i1,i2,i3,hx)-
     & etax(i1)* ux23r(i1,i2,i3,hz)
                               curl(2) =  etax(i1)* ux23r(i1,i2,i3,hy)-
     & etay(i2)* uy23r(i1,i2,i3,hx)
                               curl(3) =-(etay(i2)* uy23r(i1,i2,i3,ez)-
     & etaz(i3)* uz23r(i1,i2,i3,ey))
                               curl(4) =-(etaz(i3)* uz23r(i1,i2,i3,ex)-
     & etax(i1)* ux23r(i1,i2,i3,ez))
                               curl(5) =-(etax(i1)* ux23r(i1,i2,i3,ey)-
     & etay(i2)* uy23r(i1,i2,i3,ex))
                               do m=0,5
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                              ...
                              ! --- 3D -----
                               curl(0) =  etay(i2)* uy23r(i1,i2,i3,hz)-
     &  uz23r(i1,i2,i3,hy)
                               curl(1) =   uz23r(i1,i2,i3,hx)-etax(i1)*
     &  ux23r(i1,i2,i3,hz)
                               curl(2) =  etax(i1)* ux23r(i1,i2,i3,hy)-
     & etay(i2)* uy23r(i1,i2,i3,hx)
                               curl(3) =-(etay(i2)* uy23r(i1,i2,i3,ez)-
     &  uz23r(i1,i2,i3,ey))
                               curl(4) =-( uz23r(i1,i2,i3,ex)-etax(i1)*
     &  ux23r(i1,i2,i3,ez))
                               curl(5) =-(etax(i1)* ux23r(i1,i2,i3,ey)-
     & etay(i2)* uy23r(i1,i2,i3,ex))
                               do m=0,5
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                              ...
                              ! --- 3D -----
                               curl(0) =   uy23r(i1,i2,i3,hz)-etaz(i3)*
     &  uz23r(i1,i2,i3,hy)
                               curl(1) =  etaz(i3)* uz23r(i1,i2,i3,hx)-
     & etax(i1)* ux23r(i1,i2,i3,hz)
                               curl(2) =  etax(i1)* ux23r(i1,i2,i3,hy)-
     &  uy23r(i1,i2,i3,hx)
                               curl(3) =-( uy23r(i1,i2,i3,ez)-etaz(i3)*
     &  uz23r(i1,i2,i3,ey))
                               curl(4) =-(etaz(i3)* uz23r(i1,i2,i3,ex)-
     & etax(i1)* ux23r(i1,i2,i3,ez))
                               curl(5) =-(etax(i1)* ux23r(i1,i2,i3,ey)-
     ...
     & etaz(i3)* uz23r(i1,i2,i3,hy)
                               curl(1) =  etaz(i3)* uz23r(i1,i2,i3,hx)-
     &  ux23r(i1,i2,i3,hz)
                               curl(2) =   ux23r(i1,i2,i3,hy)-etay(i2)*
     &  uy23r(i1,i2,i3,hx)
                               curl(3) =-(etay(i2)* uy23r(i1,i2,i3,ez)-
     & etaz(i3)* uz23r(i1,i2,i3,ey))
                               curl(4) =-(etaz(i3)* uz23r(i1,i2,i3,ex)-
     &  ux23r(i1,i2,i3,ez))
                               curl(5) =-( ux23r(i1,i2,i3,ey)-etay(i2)*
     &  uy23r(i1,i2,i3,ex))
                               do m=0,5
                                 un(i1,i2,i3,m)= K0i(m,0,mr)*(curl(0)+
     & fv(0)) + K0i(m,1,mr)*(curl(1)+fv(1)) + K0i(m,2,mr)*(curl(2)+fv(
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                              ...
                              ! --- 3D -----
                               curl(0) =   uy23r(i1,i2,i3,hz)- uz23r(
     & i1,i2,i3,hy)
                               curl(1) =   uz23r(i1,i2,i3,hx)-etax(i1)*
     &  ux23r(i1,i2,i3,hz)
                               curl(2) =  etax(i1)* ux23r(i1,i2,i3,hy)-
     &  uy23r(i1,i2,i3,hx)
                               curl(3) =-( uy23r(i1,i2,i3,ez)- uz23r(
     & i1,i2,i3,ey))
                               curl(4) =-( uz23r(i1,i2,i3,ex)-etax(i1)*
     &  ux23r(i1,i2,i3,ez))
                               curl(5) =-(etax(i1)* ux23r(i1,i2,i3,ey)-
     ...
     & mr.ge.numberOfMaterialRegions )then  ! do this for now
                              ...
                              ! --- 3D -----
                               curl(0) =  etay(i2)* uy23r(i1,i2,i3,hz)-
     &  uz23r(i1,i2,i3,hy)
                               curl(1) =   uz23r(i1,i2,i3,hx)- ux23r(
     & i1,i2,i3,hz)
                               curl(2) =   ux23r(i1,i2,i3,hy)-etay(i2)*
     &  uy23r(i1,i2,i3,hx)
                               curl(3) =-(etay(i2)* uy23r(i1,i2,i3,ez)-
     &  uz23r(i1,i2,i3,ey))
                               curl(4) =-( uz23r(i1,i2,i3,ex)- ux23r(
     & i1,i2,i3,ez))
                               curl(5) =-( ux23r(i1,i2,i3,ey)-etay(i2)*
     &  uy23r(i1,i2,i3,ex))
                               do m=0,5
     ...
     &  uz23r(i1,i2,i3,hy)
                               curl(1) =  etaz(i3)* uz23r(i1,i2,i3,hx)-
     &  ux23r(i1,i2,i3,hz)
                               curl(2) =   ux23r(i1,i2,i3,hy)- uy23r(
     & i1,i2,i3,hx)
                               curl(3) =-( uy23r(i1,i2,i3,ez)-etaz(i3)*
     &  uz23r(i1,i2,i3,ey))
                               curl(4) =-(etaz(i3)* uz23r(i1,i2,i3,ex)-
     &  ux23r(i1,i2,i3,ez))
                               curl(5) =-( ux23r(i1,i2,i3,ey)- uy23r(
     & i1,i2,i3,ex))
                               do m=0,5
                                 un(i1,i2,i3,m)= K0i(m,0,mr)*(curl(0)+
     & fv(0)) + K0i(m,1,mr)*(curl(1)+fv(1)) + K0i(m,2,mr)*(curl(2)+fv(
