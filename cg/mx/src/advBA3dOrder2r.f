! This file automatically generated from advBA.bf with bpp.
       subroutine advBA3dOrder2r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & 6.*u(i1,i2,i3,m)+4.*(u(i1,i2,i3+1,m)+u(i1,i2,i3-1,m))-(u(i1,i2,
     & i3+2,m)+u(i1,i2,i3-2,m)))*adxSosup(2)
              end do
                end if
              end do
              end do
             ...
             stop 3333
               ...
               if( t.lt.2*dt )then
                 write(*,'("advBA: advance BI-ANISTROPIC 3D, 2nd-order,
     ...
     & mr)*curl(4) + K0i(m,5,mr)*curl(5) + fv(m)
                 ...
                 write(*,*) 'Finish me: BAMX 3D modified equation 
     & Order 2'
                 stop 9367
               end if
           else
            if( useOpt )then
                if( t.lt.2*dt )then
                  write(*,'("advBA: advance BA GDM (*new*), dim=3, 
     ...
     & ec) - b0*pv(pc)- b1*pv(qc) )
                      ...
                      ! compute components of the curl(H) and -curl(E)
                       ! --- 3D -----
                        curl(0) =  uy23r(i1,i2,i3,hz)-uz23r(i1,i2,i3,
     & hy)
                        curl(1) =  uz23r(i1,i2,i3,hx)-ux23r(i1,i2,i3,
     & hz)
                        curl(2) =  ux23r(i1,i2,i3,hy)-uy23r(i1,i2,i3,
     & hx)
                        curl(3) =-(uy23r(i1,i2,i3,ez)-uz23r(i1,i2,i3,
     & ey))
                        curl(4) =-(uz23r(i1,i2,i3,ex)-ux23r(i1,i2,i3,
     & ez))
                        curl(5) =-(ux23r(i1,i2,i3,ey)-uy23r(i1,i2,i3,
     & ex))
                      if( debug.gt.3 )then
     ...
     & *curl(1) + Ki(m,2,mr)*curl(2) + fv(m)
                ...
                if( t.lt.2*dt )then
                  write(*,'("advBA: advance BA GDM, dim=3, order=2 
