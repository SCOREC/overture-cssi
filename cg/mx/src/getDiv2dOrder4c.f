! This file automatically generated from getDiv.bf with bpp.
       subroutine getDiv2dOrder4c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
     ...
     & )') n,(gdmPar(m,n,k1,k2,mr),m=1,4)
       ...
       if( t.eq.0. .and. dispersionModel.ne.noDispersion )then
        ...
        if( method.ne.bamx )then
         ! --- Isotropic Maxwell ----
            if( t.lt.2*dt )then
              write(*,'("computeDiv dim=2 order=4 grid=curvilinear ... 
     & t=",e10.2)') t
            end if
            ...
            ! Loop bounds -- exclude absorbing layers ? 
              ...
              do i1=n1a,n1b
               ...
               ! --- 2D -----
                   divD(i1,i2,i3) = vx42(i1,i2,i3,ex) + vy42(i1,i2,i3,
     & ey)
