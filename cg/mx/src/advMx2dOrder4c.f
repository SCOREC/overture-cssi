! This file automatically generated from advOptNew.bf with bpp.
        subroutine advMx2dOrder4c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,
...
c============================================================================================
     ...
     & useNewForcingMethod")')
                  ...
                  if( .not.(useCurvilinearOpt.eq.1 .and. 
     & useConservative.eq.0) )then
                    stop 7744
                  end if
                 fp=0.
                 fe=0.
                 if( .true. .and. numberOfPolarizationVectors.eq.1 )
     & then
                  ...
                  write(*,'(" DISPERSIVE: CURVILINEAR, 2D, ORDER 4: 
     & FINISH ME  ")')
                    do i3=n3a,n3b
                    do i2=n2a,n2b
                    do i1=n1a,n1b
     ...
     & ux42(i1,i2,i3,ey) -.5*umx42(i1,i2,i3,ey) -1.5*uy42(i1,i2,i3,ex)
     &  +.5*umy42(i1,i2,i3,ex) )
     ...
     & i1,i2,i3,1),0.,t, ex,ex0y )
                         ...
                         un(i1,i2,i3,hz) = un(i1,i2,i3,hz) + dt*f(i1,
     ...
     & i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t, pce,p0tt )
                              ...
                              fpv(iv) = dtsq*( p0tt + b1v(iv)*p0t + 
     & b0v(iv)*p0 - a0v(iv)*e0 - a1v(iv)*e0t )
                            end do
                     ...
                     ! pv = u(i1,i2,i3,pc)
                     ! pvm=um(i1,i2,i3,pc)
                     rhsE = max2dc44me2(i1,i2,i3,ec) + alphaP*(2.*pv0-
     & pvm0) + fe
                     rhsP = 2.*pv0-pvm0 + .5*dt*( b1*pvm0 -a1*evm ) + 
     & dt*dt*( -b0*pv0 + a0*ev ) + fp
                     deti = 1./(1.+.5*dt*(b1+alphaP*a1))
                     un(i1,i2,i3,ec) = ((1.+.5*dt*b1)*rhsE -alphaP*
     & rhsP)*deti
                     pn(i1,i2,i3,m)  = (.5*a1*dt*rhsE            + 
     & rhsP)*deti
                  ...
                  if( t.le.3.*dt )then
                    write(*,'("advOPT>>>","FD44c-dispersive-MULTI-PV")
     & ')
                  end if
                  write(*,'(" DISPERSIVE: CURVILINEAR, 2D, ORDER 4: 
     & FINISH ME  ")')
     ...
     & + fpv(iv)
                     ...
                     rhsE = max2dc44me2(i1,i2,i3,ec) + alphaP*( pSum - 
     & rhsP ) + fe
