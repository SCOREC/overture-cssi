! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINS23(nd,  n1a,n1b,n2a,n2b,n3a,n3b,
...
c============================================================================================
     ...
     & w0z**2+2.*(uy23r(i1,i2,i3,uc)*ux23r(i1,i2,i3,vc)+uz23r(i1,i2,
     & i3,uc)*ux23r(i1,i2,i3,wc)+uz23r(i1,i2,i3,vc)*uy23r(i1,i2,i3,wc)
            ...
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  ...
                  f(i1,i2,i3)=(-advectionCoefficient)*(u0x**2+v0y**2+
     & w0z**2+2.*(uy23(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+uz23(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)))+
     & divDamping(i1,i2,i3)*(u0x+v0y+w0z)
                end if
              end do
              end do
     ...
     & uzz23r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23r(i1,
     ...
     & .eq.noSlipWall .and. twilightZoneFlow.eq.0 )then
                           if( axisp.eq.0 )then
                             ...
                             do i1=n1a,n1b
                              ...
                              ! Here now is the statement where the ghost line value in the RHS is assigned.
                                  f(i1+is1,i2,i3)=(2*side-1)*( (nu*(
     & ulaplacian23r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & is2,i3+is3)+(2*side-1)*udf(i1,i2,i3,uc+axis)
                       ...
                       ! Use the curl-curl form of the equations
                         ...
                         do i1=n1a,n1b
                          ...
                          ! Artificial Dissipation  **todo** implicit-line, self-adjoint versions
                          ! Here now is the statement where the ghost line value in the RHS is assigned.
                              f(i1,i2+is2,i3)=(2*side-1)*( (nu*(uxx23r(
     & i1,i2,i3,vc)-uxy23r(i1,i2,i3,uc)-uyz23r(i1,i2,i3,wc)+uzz23r(i1,
     & i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,vc)+
     ...
     & ulaplacian23r(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & is2,i3+is3)+(2*side-1)*udf(i1,i2,i3,uc+axis)
                       ...
                       ! Use the curl-curl form of the equations
                         ...
                         do i1=n1a,n1b
                          ...
                          ! Artificial Dissipation  **todo** implicit-line, self-adjoint versions
                          ! Here now is the statement where the ghost line value in the RHS is assigned.
                              f(i1,i2,i3+is3)=(2*side-1)*( (nu*(uxx23r(
     & i1,i2,i3,wc)+uyy23r(i1,i2,i3,wc)-uxz23r(i1,i2,i3,uc)-uyz23r(i1,
     & i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23r(i1,i2,i3,wc)+
     ...
     & ulaplacian23r(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & i3,0)*( (nu*(-uxy23(i1,i2,i3,vc)-uxz23(i1,i2,i3,wc)+uyy23(i1,
     & i2,i3,uc)+uzz23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,uc)))  )+normal00(i1,i2,i3,1)*( (nu*(
     & uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+uzz23(
     & i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,vc)))  )+normal00(i1,i2,i3,2)*( (nu*(uxx23(i1,i2,i3,wc)+
     & uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)+uu(i1,i2,i3,vc)*
     & uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,wc)))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & i2,i3,0)*( (nu*(ulaplacian23(i1,i2,i3,uc)))-(advectCoeff*(uu(
     & i1,i2,i3,uc)*ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,
     & uc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal00(i1,i2,i3,1)
     & *( (nu*(ulaplacian23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,
     & i2,i3,wc)*uz23(i1,i2,i3,vc)))  )+normal00(i1,i2,i3,2)*( (nu*(
     & ulaplacian23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(
     ...
     & i2,i3,uc)+uzz23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,uc)))  )+normal10(i1,i2,i3,1)*( (nu*(
     & uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+uzz23(
     & i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,vc)))  )+normal10(i1,i2,i3,2)*( (nu*(uxx23(i1,i2,i3,wc)+
     & uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)+uu(i1,i2,i3,vc)*
     & uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,wc)))  )
                           end if
     ...
     & *( (nu*(ulaplacian23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,
     & i2,i3,wc)*uz23(i1,i2,i3,vc)))  )+normal10(i1,i2,i3,2)*( (nu*(
     & ulaplacian23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(
     & i1,i2,i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,wc)))  )
                               end if
     ...
     & i2,i3,uc)+uzz23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,uc)))  )+normal01(i1,i2,i3,1)*( (nu*(
     & uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+uzz23(
     & i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,vc)))  )+normal01(i1,i2,i3,2)*( (nu*(uxx23(i1,i2,i3,wc)+
     & uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)+uu(i1,i2,i3,vc)*
     & uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,wc)))  )
                           end if
     ...
     & *( (nu*(ulaplacian23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,
     & i2,i3,wc)*uz23(i1,i2,i3,vc)))  )+normal01(i1,i2,i3,2)*( (nu*(
     & ulaplacian23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(
     & i1,i2,i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,wc)))  )
                               end if
     ...
     & i2,i3,uc)+uzz23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,uc)))  )+normal11(i1,i2,i3,1)*( (nu*(
     & uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+uzz23(
     & i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,vc)))  )+normal11(i1,i2,i3,2)*( (nu*(uxx23(i1,i2,i3,wc)+
     & uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)+uu(i1,i2,i3,vc)*
     & uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,wc)))  )
                           end if
     ...
     & *( (nu*(ulaplacian23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,
     & i2,i3,wc)*uz23(i1,i2,i3,vc)))  )+normal11(i1,i2,i3,2)*( (nu*(
     & ulaplacian23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(
     & i1,i2,i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,wc)))  )
                               end if
     ...
     & i2,i3,uc)+uzz23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,uc)))  )+normal02(i1,i2,i3,1)*( (nu*(
     & uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+uzz23(
     & i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,vc)))  )+normal02(i1,i2,i3,2)*( (nu*(uxx23(i1,i2,i3,wc)+
     & uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)+uu(i1,i2,i3,vc)*
     & uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,wc)))  )
                           end if
     ...
     & *( (nu*(ulaplacian23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,
     & i2,i3,wc)*uz23(i1,i2,i3,vc)))  )+normal02(i1,i2,i3,2)*( (nu*(
     & ulaplacian23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(
     & i1,i2,i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,wc)))  )
                               end if
     ...
     & i2,i3,uc)+uzz23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,uc)))  )+normal12(i1,i2,i3,1)*( (nu*(
     & uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+uzz23(
     & i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,vc)+
     & uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*uz23(i1,i2,
     & i3,vc)))  )+normal12(i1,i2,i3,2)*( (nu*(uxx23(i1,i2,i3,wc)+
     & uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,i3,wc)+uu(i1,i2,i3,vc)*
     & uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(i1,i2,i3,wc)))  )
                           end if
     ...
     & *( (nu*(ulaplacian23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,
     & i2,i3,wc)*uz23(i1,i2,i3,vc)))  )+normal12(i1,i2,i3,2)*( (nu*(
     & ulaplacian23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(
     & i1,i2,i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,wc)))  )
                               end if
