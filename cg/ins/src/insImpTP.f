! This file automatically generated from insImpTP.bf with bpp.
! **************************************************************************************************
! 
!    --- Incompressible Two-Phase Flow Model ---
! 
!   Define the explicit method and full implicit matrix 
! 
! **************************************************************************************************
...
! ******************* Here we now define the subroutine insImpTP ****************************
      subroutine insImpTP(nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
...
!======================================================================
     ...
     & cw31zzm,cw32zzp,cw32zzz,cw32zzm
       real rho,rhoi,rhol,rholi,dtImpOverRho,adPsi,adPhi,adPsiDt
     ...
     & checkForInflowAtOutFlow)
      if( ok.eq.0 )then
        write(*,'("*** insImpTP:ERROR: checkForInflowAtOutFlow NOT 
     & FOUND")')
      else
        if( debug.gt.4 )then
         write(*,'("*** insImpTP:checkForInflowAtOutFlow=",i6)') 
     & checkForInflowAtOutFlow
        end if
      end if
      ok = getInt(pdb,'outflowOption',outflowOption)
      if( ok.eq.0 )then
        write(*,'("*** insImpTP:ERROR: outflowOption NOT FOUND")')
      else
        if( debug.gt.4 )then
         write(*,'("*** insImpTP:outflowOption=",i6)') outflowOption
        end if
      end if
      ok = getReal(pdb,'advectionCoefficient',advectionCoefficient)
      if( ok.eq.0 )then
        write(*,'("*** insImpTP:ERROR: advectionCoefficient NOT FOUND")
     & ')
      else
        if( debug.gt.4 )then
         write(*,'("*** insImpTP:advectionCoefficient=",f5.2)') 
     & advectionCoefficient
        end if
      end if
      ok = getInt(pdb,'vsc',vsc)
      if( ok.eq.0 )then
        write(*,'("*** insImpTP:ERROR: vsc NOT FOUND")')
      end if
     ...
     & fillCoefficientsScalarSystem)
      if( ok.eq.0 )then
        write(*,'("*** insImpTP:ERROR: fillCoefficientsScalarSystem 
     & NOT FOUND")')
      else
        if( debug.gt.4 )then
         write(*,'("*** insImpTP:fillCoefficientsScalarSystem=",i6)') 
     & fillCoefficientsScalarSystem
        end if
      end if
      if( orderOfAccuracy.ne.2 .and. orderOfAccuracy.ne.4 )then
        write(*,'("insImpTP:ERROR orderOfAccuracy=",i6)') 
     & orderOfAccuracy
        stop 1
      end if
      if( gridType.ne.rectangular .and. gridType.ne.curvilinear )then
        write(*,'("insImpTP:ERROR gridType=",i6)') gridType
        stop 2
      end if
      if( uc.lt.0 .or. vc.lt.0 .or. (nd.eq.3 .and. wc.lt.0) )then
        write(*,'("insImpTP:ERROR uc,vc,ws=",3i6)') uc,vc,wc
        stop 4
      end if
!      write(*,'("insImpTP: turbulenceModel=",2i6)') turbulenceModel
!      write(*,'("insImpTP: nd,uc,vc,wc,kc=",2i6)') nd,uc,vc,wc,kc
      if( turbulenceModel.eq.kEpsilon .and. (kc.lt.uc+nd .or. 
     & kc.gt.1000) )then
        write(*,'("insImpTP:ERROR in kc: nd,uc,vc,wc,kc=",2i6)') nd,uc,
     & vc,wc,kc
        stop 5
      end if
! *****************************************************************************************************8
     ...
     & halfWidth))
      ...
      if( use2ndOrderAD.ne.0 )then
        if( debug .gt.3 )then
          write(*,'(" insImpTP: INFO: 2nd order art-diss is on: ad21,
     & ad22=",2(e9.2,1x))') ad21,ad22
      ...
      if( pdeModel.eq.BoussinesqModel )then
        if( debug .gt.3 )then
          write(*,'(" insImpTP: INFO: Boussinesq: kThermal,
     ...
     & fillCoefficientsScalarSystem.le.fillCoeffW )then
      ...
      if( implicitVariation.eq.implicitViscous )then
        ...
        write(*,'(" insImpTP: ERROR: unexpected implicitVariation=",i6)
     & ') implicitVariation
        stop 7200
      end if
      ...
      ! The next macro is defined in insImpXX.bf and is used to look up parameters etc. 
       if( pdeModel.ne.twoPhaseFlowModel )then
         write(*,'("insImpTP:ERROR: pdeModel.ne.twoPhaseFlowModel")')
         stop 2276
       end if
       if( rc.lt.0 )then
         write(*,'("insImpTP:ERROR: rc<0")')
         stop 2277
       end if
       ok = getReal(pdb,'PdeParameters/twoPhaseArtDisPsi',adPsi)
       if( ok.eq.0 )then
         adPsi=.1 ! default value if not supplied
         write(*,'("*** insImpTP:ERROR: 
     & PdeParameters/twoPhaseArtDisPsi NOT FOUND")')
         ! ' 
       else
         if( debug.gt.4 )then
          write(*,'("*** insImpTP:twoPhaseArtDisPsi=",e8.2)') adPsi
         end if
       end if
     ...
     & PdeParameters/twoPhaseArtDisPhi NOT FOUND")')
         ...
         if( debug.gt.4 )then
          write(*,'("*** insImpTP:twoPhaseArtDisPhi=",e8.2)') adPhi
         end if
       end if
       adPsiDt = adPsi*dt*implicitFactor
      ...
      if( debug.gt.3 )then
        if( evalRightHandSide.eq.1 )then
          write(*,'("insImpTP: *EVAL RHS : implicitOption=",i2," (
     & 0=all,1=none,2=sep,3=all)")')  implicitOption
        endif
      endif
      if( debug.gt.7 )then
        if( evalRightHandSide.eq.1 )then
          write(*,'("insImpTP: ******** EVAL RHS **********")')
        end if
        if( evalResidual.eq.1 )then
          write(*,'("insImpTP: ******** EVAL RESIDUAL **********")')
        end if
        if( fillCoefficients.eq.1 )then
          write(*,'("insImpTP: ******** FILL COEFF **********")')
        end if
        ! ' 
        write(*,'("insImpTP: pdeModel,nonLinear,impVar=",3i4)') 
     & pdeModel,nonlinearTermsAreImplicit,implicitVariation
        if( fillCoefficients.eq.1 )then
          write(*,'("insImpTP: stencilSize,ncc=",2i4)') stencilSize,ncc
        end if
        write(*,'("insImpTP: aDt,bDt,nuDt=",3e10.2)') aDt,bDt,nuDt
        write(*,'("insImpTP: implicitFactor,nuImp,aImp=",f4.2,1x,
...
!   $STENCIL_WIDTH : stencil width of the local coeff-matrix (such as xCoeff, yCoeff, lapCoeff, ...)
       ...
       ! fill the coefficients:
        ...
        dtImp=dt*implicitFactor
         ...
         do i1=n1a,n1b
          ...
          ! parametric derivatives of q = VOF function? 
         ...
         rho=u(i1,i2,i3,rc)
         rhoi=1./rho
         ! get coefficients scaled by -dt*implicitFactor/rho: 
         dtImpOverRho=dtImp*rhoi
          ! ---------- 2D -----------
          ...
          ! v.t + u.grad(v) + p.y = Dx(   nu*v.x ) + Dy( 2*nu*v.y ) + Dx( nu*u.y )
            ...
            au11ph = 2.*nu0ph*dxvsqi(0)*(-dtImpOverRho)
            au11mh = 2.*nu0mh*dxvsqi(0)*(-dtImpOverRho)
            au22ph =    nu1ph*dxvsqi(1)*(-dtImpOverRho)
            au22mh =    nu1mh*dxvsqi(1)*(-dtImpOverRho)
            au12pzz=0.
            au12mzz=0.
            au21zpz=0.
            au21zmz=0.
            ...
            av12pzz=0.
            av12mzz=0.
            av21zpz=nuzpz/(4.*dx(0)*dx(1))*(-dtImpOverRho)
            av21zmz=nuzmz/(4.*dx(0)*dx(1))*(-dtImpOverRho)
            bv11ph =    nu0ph*dxvsqi(0)*(-dtImpOverRho)
            bv11mh =    nu0mh*dxvsqi(0)*(-dtImpOverRho)
            bv22ph = 2.*nu1ph*dxvsqi(1)*(-dtImpOverRho)
            bv22mh = 2.*nu1mh*dxvsqi(1)*(-dtImpOverRho)
            bv12pzz=0.
            bv12mzz=0.
            bv21zpz=0.
            bv21zmz=0.
            ...
            bu22ph=0.
            bu22mh=0.
            bu12pzz=nupzz/(4.*dx(0)*dx(1))*(-dtImpOverRho)
            bu12mzz=numzz/(4.*dx(0)*dx(1))*(-dtImpOverRho)
            bu21zpz=0.
            bu21zmz=0.
     ...
     & v0y) )
          ! Form : I - dtImp*div( nu(u).grad)/rho + aDt*u*Dx + aDt*v*Dy 
          ! **NOTE** we still need to linearize the terms involving rho 
     ...
     & m2,m3)))+(-adPsiDt*lapCoeff(ma2(m1,m2,m3)))+(adt*ugv*xCoeff(
     & ma2(m1,m2,m3)))+(adt*vgv*yCoeff(ma2(m1,m2,m3)))
           end do
           end do
           end do
           do m3=-halfWidth3,halfWidth3
     ...
     & rholi
             fe(i1,i2,i3,uc) = -ugv*u0x -vgv*u0y - p0x*rhoi +gravity(0)
     &  + divNuGradu - divNuGradul + (adCoeff-adCoeffl)*(u(i1-1,i2,i3,
     & uc)+u(i1,i2-1,i3,uc)+u(i1+1,i2,i3,uc)+u(i1,i2+1,i3,uc)-4.*u(i1,
     & i2,i3,uc))
             fe(i1,i2,i3,vc) = -ugv*v0x -vgv*v0y - p0y*rhoi +gravity(1)
     &  + divNuGradv - divNuGradvl + (adCoeff-adCoeffl)*(u(i1-1,i2,i3,
     ...
     & vc)+u(i1,i2-1,i3,vc)+u(i1+1,i2,i3,vc)+u(i1,i2+1,i3,vc)-4.*u(i1,
     & i2,i3,vc))
               fi(i1,i2,i3,qc) = adPsi*(q0xx+q0yy)
               if( nonlinearTermsAreImplicit.eq.1 )then
                 ! include linearized terms u0*ulx + ul*u0x 
     ...
     & rhoi +gravity(0) + divNuGradu + adCoeff*(u(i1-1,i2,i3,uc)+u(i1,
     & i2-1,i3,uc)+u(i1+1,i2,i3,uc)+u(i1,i2+1,i3,uc)-4.*u(i1,i2,i3,uc)
     & )
            fe(i1,i2,i3,vc) = fi(i1,i2,i3,vc) - ugv*v0x -vgv*v0y - p0y*
     & rhoi +gravity(1) + divNuGradv + adCoeff*(u(i1-1,i2,i3,vc)+u(i1,
     & i2-1,i3,vc)+u(i1+1,i2,i3,vc)+u(i1,i2+1,i3,vc)-4.*u(i1,i2,i3,vc)
     & )
     ...
     & 2.*nuzpz)*sy(i1,i2+1,i3)*ry(i1,i2+1,i3) )
           ...
           ! scaling factors: 
           dr0i = (-dtImpOverRho)/(ajzzz*dr(0)**2)
           dr1i = (-dtImpOverRho)/(ajzzz*dr(1)**2)
           dr0dr1 = (-dtImpOverRho)/(ajzzz*4.*dr(0)*dr(1))
            au11ph=au11ph*dr0i
            au11mh=au11mh*dr0i
            au22ph=au22ph*dr1i
            au22mh=au22mh*dr1i
     ...
     & 2)**2
         ...
         dtImpOverRho=dtImp*rhoi
          ...
          ! w.t + u.grad(w) + p.z = Dx(   nu*w.x ) + Dy(   nu*w.y ) + Dz( nu*w.z ) + Dx( nu*u.z )  + Dy( nu*v.z ) 
            ...
            au22ph =    nu1ph*dxvsqi(1)*(-dtImpOverRho)
            au22mh =    nu1mh*dxvsqi(1)*(-dtImpOverRho)
            au33ph =    nu2ph*dxvsqi(2)*(-dtImpOverRho)
            au33mh =    nu2mh*dxvsqi(2)*(-dtImpOverRho)
            au12pzz=0.
            au12mzz=0.
            au13pzz=0.
            au13mzz=0.
            ...
            aw23zpz=0.
            aw23zmz=0.
            aw31zzp=nuzzp/(4.*dx(0)*dx(2))*(-dtImpOverRho)
            aw31zzm=nuzzm/(4.*dx(0)*dx(2))*(-dtImpOverRho)
            aw32zzp=0.
            aw32zzm=0.
            ! equation for v 
            !     Dx( nu*u.y )
            ...
            bv22ph = 2.*nu1ph*dxvsqi(1)*(-dtImpOverRho)
            bv22mh = 2.*nu1mh*dxvsqi(1)*(-dtImpOverRho)
            bv33ph =    nu2ph*dxvsqi(2)*(-dtImpOverRho)
            bv33mh =    nu2mh*dxvsqi(2)*(-dtImpOverRho)
            bv12pzz=0.
            bv12mzz=0.
            bv13pzz=0.
            bv13mzz=0.
            ...
            bw31zzp=0.
            bw31zzm=0.
            bw32zzp=nuzzp/(4.*dx(1)*dx(2))*(-dtImpOverRho)
            bw32zzm=nuzzm/(4.*dx(1)*dx(2))*(-dtImpOverRho)
            ! equation for w 
            !    Dx( nu*u.z )
            cu11ph=0.
            cu11mh=0.
            ...
            cu12pzz=0.
            cu12mzz=0.
            cu13pzz=nupzz/(4.*dx(0)*dx(2))*(-dtImpOverRho)
            cu13mzz=numzz/(4.*dx(0)*dx(2))*(-dtImpOverRho)
            cu21zpz=0.
            cu21zmz=0.
            cu23zpz=0.
            cu23zmz=0.
            ...
            cv21zpz=0.
            cv21zmz=0.
            cv23zpz=nuzpz/(4.*dx(1)*dx(2))*(-dtImpOverRho)
            cv23zmz=nuzmz/(4.*dx(1)*dx(2))*(-dtImpOverRho)
            cv31zzp=0.
            cv31zzm=0.
            cv32zzp=0.
            cv32zzm=0.
            !   Dx( nu*w.x ) + Dy( nu*w.y ) + Dz( 2*nu*w.z )
            cw11ph =    nu0ph*dxvsqi(0)*(-dtImpOverRho)
            cw11mh =    nu0mh*dxvsqi(0)*(-dtImpOverRho)
            cw22ph =    nu1ph*dxvsqi(1)*(-dtImpOverRho)
            cw22mh =    nu1mh*dxvsqi(1)*(-dtImpOverRho)
            cw33ph = 2.*nu2ph*dxvsqi(2)*(-dtImpOverRho)
            cw33mh = 2.*nu2mh*dxvsqi(2)*(-dtImpOverRho)
            cw12pzz=0.
            cw12mzz=0.
            cw13pzz=0.
            cw13mzz=0.
     ...
     & m2,m3)))+(-adPsiDt*lapCoeff(ma3(m1,m2,m3)))+(adt*ugv*xCoeff(
     & ma3(m1,m2,m3)))+(adt*vgv*yCoeff(ma3(m1,m2,m3)))+(adt*wgv*
     & zCoeff(ma3(m1,m2,m3)))
           end do
           end do
           end do
     ...
     & abs(vlx)+abs(vly)+abs(vlz) + abs(wlx)+abs(wly)+abs(wlz) )
            if( gridIsImplicit.eq.0 )then
              ! explicit
              fe(i1,i2,i3,uc) = -ugv*u0x -vgv*u0y -wgv*u0z - p0x*rhoi +
     & gravity(0)+ divNuGradu + adCoeff*(u(i1-1,i2,i3,uc)+u(i1,i2-1,
     & i3,uc)+u(i1,i2,i3-1,uc)+u(i1+1,i2,i3,uc)+u(i1,i2+1,i3,uc)+u(i1,
     & i2,i3+1,uc)-6.*u(i1,i2,i3,uc))
              fe(i1,i2,i3,vc) = -ugv*v0x -vgv*v0y -wgv*v0z - p0y*rhoi +
     & gravity(1)+ divNuGradv + adCoeff*(u(i1-1,i2,i3,vc)+u(i1,i2-1,
     & i3,vc)+u(i1,i2,i3-1,vc)+u(i1+1,i2,i3,vc)+u(i1,i2+1,i3,vc)+u(i1,
     & i2,i3+1,vc)-6.*u(i1,i2,i3,vc))
              fe(i1,i2,i3,wc) = -ugv*w0x -vgv*w0y -wgv*w0z - p0z*rhoi +
     & gravity(2)+ divNuGradw + adCoeff*(u(i1-1,i2,i3,wc)+u(i1,i2-1,
     & i3,wc)+u(i1,i2,i3-1,wc)+u(i1+1,i2,i3,wc)+u(i1,i2+1,i3,wc)+u(i1,
     & i2,i3+1,wc)-6.*u(i1,i2,i3,wc))
              fe(i1,i2,i3,qc) = -ugv*q0x -vgv*q0y -wgv*q0z + adPsi*(
     & q0xx+q0yy+q0zz)
            else
             ! implicit method -- compute explicit part
             !     fe = f(u) - L(u,ul)
     ...
     & 1,i3,wc)+u(i1,i2,i3+1,wc)-6.*u(i1,i2,i3,wc))
                fi(i1,i2,i3,qc) = adPsi*(q0xx+q0yy+q0zz)
                if( nonlinearTermsAreImplicit.eq.1 )then
                  ! include linearized terms u0*ulx + ul*u0x 
                  fi(i1,i2,i3,uc) = fi(i1,i2,i3,uc) - aImp*( ulterm )
                  fi(i1,i2,i3,vc) = fi(i1,i2,i3,vc) - aImp*( vlterm )
     ...
     & u0z - p0x*rhoi +gravity(0) + divNuGradu + adCoeff*(u(i1-1,i2,
     & i3,uc)+u(i1,i2-1,i3,uc)+u(i1,i2,i3-1,uc)+u(i1+1,i2,i3,uc)+u(i1,
     & i2+1,i3,uc)+u(i1,i2,i3+1,uc)-6.*u(i1,i2,i3,uc))
             fe(i1,i2,i3,vc) = fi(i1,i2,i3,vc) -ugv*v0x -vgv*v0y -wgv*
     & v0z - p0y*rhoi +gravity(1) + divNuGradv + adCoeff*(u(i1-1,i2,
     & i3,vc)+u(i1,i2-1,i3,vc)+u(i1,i2,i3-1,vc)+u(i1+1,i2,i3,vc)+u(i1,
     & i2+1,i3,vc)+u(i1,i2,i3+1,vc)-6.*u(i1,i2,i3,vc))
             fe(i1,i2,i3,wc) = fi(i1,i2,i3,wc) -ugv*w0x -vgv*w0y -wgv*
     & w0z - p0z*rhoi +gravity(2) + divNuGradw + adCoeff*(u(i1-1,i2,
     & i3,wc)+u(i1,i2-1,i3,wc)+u(i1,i2,i3-1,wc)+u(i1+1,i2,i3,wc)+u(i1,
     & i2+1,i3,wc)+u(i1,i2,i3+1,wc)-6.*u(i1,i2,i3,wc))
             fe(i1,i2,i3,qc) = fi(i1,i2,i3,qc) -ugv*q0x -vgv*q0y -wgv*
     & q0z +adPsi*(q0xx+q0yy+q0zz)
     ...
     & 1)*sz(i1,i2,i3+1) )
           ...
           dr0i = (-dtImpOverRho)/(ajzzz*dr(0)**2)
           dr1i = (-dtImpOverRho)/(ajzzz*dr(1)**2)
           dr2i = (-dtImpOverRho)/(ajzzz*dr(2)**2)
           dr0dr1 = (-dtImpOverRho)/(ajzzz*4.*dr(0)*dr(1))
           dr0dr2 = (-dtImpOverRho)/(ajzzz*4.*dr(0)*dr(2))
           dr1dr2 = (-dtImpOverRho)/(ajzzz*4.*dr(1)*dr(2))
            au11ph=au11ph*dr0i
            au11mh=au11mh*dr0i
            au22ph=au22ph*dr1i
            au22mh=au22mh*dr1i
     ...
     & q0z +adPsi*(q0xx+q0yy+q0zz)
        ...
        write(*,'("insImpTP: ERROR - not implemented for 
