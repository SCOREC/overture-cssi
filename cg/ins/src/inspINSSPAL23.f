! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINSSPAL23(nd,  n1a,n1b,n2a,n2b,n3a,
...
c============================================================================================
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    nuTdd= 6*chi**2*cv1e3*(-chi3+2*cv1e3)/(chi3+cv1e3)*
     & *3/nu  ! this is really nuTdd/nu : from spal.maple
                    n0x=ux23r(i1,i2,i3,nc)
                    n0y=uy23r(i1,i2,i3,nc)
                    n0xx=uxx23r(i1,i2,i3,nc)
                    n0xy=uxy23r(i1,i2,i3,nc)
                    n0yy=uyy23r(i1,i2,i3,nc)
                    nuTx=n0x*nuTd
                    nuTy=n0y*nuTd
                  ...
                  !  write(*,'(" inspf:SPAL: chi,nuTx,nuTy,nuTxx,nuTxy,nuTyy=",10e10.2)') chi,nuTx,nuTy,nuTxx,nuTxy,nuTyy
                      n0z=uz23r(i1,i2,i3,nc)
                      n0xz=uxz23r(i1,i2,i3,nc)
                      n0yz=uyz23r(i1,i2,i3,nc)
                      n0zz=uzz23r(i1,i2,i3,nc)
                      nuTz=n0z*nuTd
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    nuTdd= 6*chi**2*cv1e3*(-chi3+2*cv1e3)/(chi3+cv1e3)*
     & *3/nu  ! this is really nuTdd/nu : from spal.maple
                    n0x=ux23(i1,i2,i3,nc)
                    n0y=uy23(i1,i2,i3,nc)
                    n0xx=uxx23(i1,i2,i3,nc)
                    n0xy=uxy23(i1,i2,i3,nc)
                    n0yy=uyy23(i1,i2,i3,nc)
                    nuTx=n0x*nuTd
                    nuTy=n0y*nuTd
                    nuTxx=n0xx*nuTd+n0x*n0x*nuTdd
                    nuTxy=n0xy*nuTd+n0x*n0y*nuTdd
                    nuTyy=n0yy*nuTd+n0y*n0y*nuTdd
                  !  write(*,'(" inspf:SPAL: chi,nuTx,nuTy,nuTxx,nuTxy,nuTyy=",10e10.2)') chi,nuTx,nuTy,nuTxx,nuTxy,nuTyy
                      n0z=uz23(i1,i2,i3,nc)
                      n0xz=uxz23(i1,i2,i3,nc)
                      n0yz=uyz23(i1,i2,i3,nc)
                      n0zz=uzz23(i1,i2,i3,nc)
                      nuTz=n0z*nuTd
                      nuTxz=n0xz*nuTd+n0x*n0z*nuTdd
                      nuTyz=n0yz*nuTd+n0y*n0z*nuTdd
                      nuTzz=n0zz*nuTd+n0z*n0z*nuTdd
                         ...
                         do i1=n1a,n1b
                          ...
                          ! By default there is no AD:
                            ! get nuT,nuTx,nuTy,nuTz
                                 chi=u(i1,i2,i3,nc)/nu
                                 chi3= chi**3
                                 nuT = nu+u(i1,i2,i3,nc)*chi3/(chi3+
     & cv1e3)
                                 nuTd= chi3*(chi3+4.*cv1e3)/(chi3+
     & cv1e3)**2
                                 n0x=ux23r(i1,i2,i3,nc)
                                 n0y=uy23r(i1,i2,i3,nc)
                                 nuTx=n0x*nuTd
     ...
     & uu(i1,i2,i3,wc)*uz23r(i1,i2,i3,uc)))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & uu(i1,i2,i3,wc)*uz23r(i1,i2,i3,vc)))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & uu(i1,i2,i3,wc)*uz23r(i1,i2,i3,wc)))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal00(i1,i2,i3,1)*( (
     & nuT*(uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+
     & uzz23(i1,i2,i3,vc))-2.*nuTy*(uz23(i1,i2,i3,wc)+ux23(i1,i2,i3,
     & uc))+nuTz*(uz23(i1,i2,i3,vc)+uy23(i1,i2,i3,wc))+nuTx*(ux23(i1,
     & i2,i3,vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux23(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,
     & i3,wc)*uz23(i1,i2,i3,vc)))  )+normal00(i1,i2,i3,2)*( (nuT*(
     & uxx23(i1,i2,i3,wc)+uyy23(i1,i2,i3,wc)-uxz23(i1,i2,i3,uc)-uyz23(
     & i1,i2,i3,vc))-2.*nuTz*(ux23(i1,i2,i3,uc)+uy23(i1,i2,i3,vc))+
     & nuTx*(ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,
     & wc)+uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,wc)))  )
                           end if
                         end do
                         end do
     ...
     & vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,vc)))  )+normal00(i1,i2,i3,2)*( (nuT*(
     & ulaplacian23(i1,i2,i3,wc))+2.*nuTz*(uz23(i1,i2,i3,wc))+nuTx*(
     & ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,wc)+
     & uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,
     & i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(
     & i1,i2,i3,wc)))  )
                               end if
                             end do
                             end do
     ...
     & uz23(i1,i2,i3,uc)+ux23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(
     & i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal10(i1,i2,i3,1)*( (
     & nuT*(uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+
     & uzz23(i1,i2,i3,vc))-2.*nuTy*(uz23(i1,i2,i3,wc)+ux23(i1,i2,i3,
     & uc))+nuTz*(uz23(i1,i2,i3,vc)+uy23(i1,i2,i3,wc))+nuTx*(ux23(i1,
     & i2,i3,vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,vc)))  )+normal10(i1,i2,i3,2)*( (nuT*(
     & ulaplacian23(i1,i2,i3,wc))+2.*nuTz*(uz23(i1,i2,i3,wc))+nuTx*(
     & ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,wc)+
     & uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,
     & i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(
     ...
     & uz23(i1,i2,i3,uc)+ux23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(
     & i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal01(i1,i2,i3,1)*( (
     & nuT*(uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+
     & uzz23(i1,i2,i3,vc))-2.*nuTy*(uz23(i1,i2,i3,wc)+ux23(i1,i2,i3,
     & uc))+nuTz*(uz23(i1,i2,i3,vc)+uy23(i1,i2,i3,wc))+nuTx*(ux23(i1,
     & i2,i3,vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,vc)))  )+normal01(i1,i2,i3,2)*( (nuT*(
     & ulaplacian23(i1,i2,i3,wc))+2.*nuTz*(uz23(i1,i2,i3,wc))+nuTx*(
     & ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,wc)+
     & uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,
     & i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(
     ...
     & uz23(i1,i2,i3,uc)+ux23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(
     & i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal11(i1,i2,i3,1)*( (
     & nuT*(uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+
     & uzz23(i1,i2,i3,vc))-2.*nuTy*(uz23(i1,i2,i3,wc)+ux23(i1,i2,i3,
     & uc))+nuTz*(uz23(i1,i2,i3,vc)+uy23(i1,i2,i3,wc))+nuTx*(ux23(i1,
     & i2,i3,vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,vc)))  )+normal11(i1,i2,i3,2)*( (nuT*(
     & ulaplacian23(i1,i2,i3,wc))+2.*nuTz*(uz23(i1,i2,i3,wc))+nuTx*(
     & ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,wc)+
     & uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,
     & i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(
     ...
     & uz23(i1,i2,i3,uc)+ux23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(
     & i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal02(i1,i2,i3,1)*( (
     & nuT*(uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+
     & uzz23(i1,i2,i3,vc))-2.*nuTy*(uz23(i1,i2,i3,wc)+ux23(i1,i2,i3,
     & uc))+nuTz*(uz23(i1,i2,i3,vc)+uy23(i1,i2,i3,wc))+nuTx*(ux23(i1,
     & i2,i3,vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,vc)))  )+normal02(i1,i2,i3,2)*( (nuT*(
     & ulaplacian23(i1,i2,i3,wc))+2.*nuTz*(uz23(i1,i2,i3,wc))+nuTx*(
     & ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,wc)+
     & uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,
     & i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(
     ...
     & uz23(i1,i2,i3,uc)+ux23(i1,i2,i3,wc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux23(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,uc)+uu(
     & i1,i2,i3,wc)*uz23(i1,i2,i3,uc)))  )+normal12(i1,i2,i3,1)*( (
     & nuT*(uxx23(i1,i2,i3,vc)-uxy23(i1,i2,i3,uc)-uyz23(i1,i2,i3,wc)+
     & uzz23(i1,i2,i3,vc))-2.*nuTy*(uz23(i1,i2,i3,wc)+ux23(i1,i2,i3,
     & uc))+nuTz*(uz23(i1,i2,i3,vc)+uy23(i1,i2,i3,wc))+nuTx*(ux23(i1,
     & i2,i3,vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     ...
     & vc)+uy23(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,
     & i2,i3,vc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,vc)+uu(i1,i2,i3,wc)*
     & uz23(i1,i2,i3,vc)))  )+normal12(i1,i2,i3,2)*( (nuT*(
     & ulaplacian23(i1,i2,i3,wc))+2.*nuTz*(uz23(i1,i2,i3,wc))+nuTx*(
     & ux23(i1,i2,i3,wc)+uz23(i1,i2,i3,uc))+nuTy*(uy23(i1,i2,i3,wc)+
     & uz23(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux23(i1,i2,
     & i3,wc)+uu(i1,i2,i3,vc)*uy23(i1,i2,i3,wc)+uu(i1,i2,i3,wc)*uz23(
