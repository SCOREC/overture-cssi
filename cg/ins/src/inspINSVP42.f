! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINSVP42(nd,  n1a,n1b,n2a,n2b,n3a,
...
c============================================================================================
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    u0Lap=ulaplacian42r(i1,i2,i3,uc)
                    v0Lap=ulaplacian42r(i1,i2,i3,vc)
                    nuT = u(i1,i2,i3,vsc)
                    nuTx=ux42r(i1,i2,i3,vsc)
                    nuTy=uy42r(i1,i2,i3,vsc)
                    nuTxx=uxx42r(i1,i2,i3,vsc)
                    nuTxy=uxy42r(i1,i2,i3,vsc)
                    nuTyy=uyy42r(i1,i2,i3,vsc)
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    u0Lap=ulaplacian42(i1,i2,i3,uc)
                    v0Lap=ulaplacian42(i1,i2,i3,vc)
                    nuT = u(i1,i2,i3,vsc)
                    nuTx=ux42(i1,i2,i3,vsc)
                    nuTy=uy42(i1,i2,i3,vsc)
                    nuTxx=uxx42(i1,i2,i3,vsc)
                    nuTxy=uxy42(i1,i2,i3,vsc)
                    nuTyy=uyy42(i1,i2,i3,vsc)
                 f(i1,i2,i3)=(-advectionCoefficient)*(u0x**2+2.*u0y*
     & v0x+v0y**2)+divDamping(i1,i2,i3)*(u0x+v0y)+2.*(nuTx*u0Lap+
     & nuTxx*u0x+nuTxy*u0y+nuTy*v0Lap+nuTxy*v0x+nuTyy*v0y)
     ...
     & uxy42r(i1,i2,i3,vc)+uyy42r(i1,i2,i3,uc))-2.*nuTx*(uy42r(i1,i2,
     & i3,vc))+nuTy*(uy42r(i1,i2,i3,uc)+ux42r(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)
     & *uy42r(i1,i2,i3,uc)))  )
                           end if
                         end do
                         end do
     ...
     & .eq.noSlipWall .and. twilightZoneFlow.eq.0 )then
                           if( axisp.eq.0 )then
                             ...
                             do i1=n1a,n1b
                              ...
                              ! Here now is the statement where the ghost line value in the RHS is assigned.
                                  f(i1+is1,i2,i3)=(2*side-1)*( (nuT*(
     & ulaplacian42r(i1,i2,i3,uc))+2.*nuTx*(ux42r(i1,i2,i3,uc))+nuTy*(
     & uy42r(i1,i2,i3,uc)+ux42r(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,uc))) 
     &  )
                               end if
                             end do
                             end do
     ...
     & uxx42r(i1,i2,i3,vc)-uxy42r(i1,i2,i3,uc))-2.*nuTy*(ux42r(i1,i2,
     & i3,uc))+nuTx*(ux42r(i1,i2,i3,vc)+uy42r(i1,i2,i3,uc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)
     & *uy42r(i1,i2,i3,vc)))  )
                           end if
                         end do
                         end do
     ...
     & .eq.noSlipWall .and. twilightZoneFlow.eq.0 )then
                           if( axisp.eq.0 )then
                             ...
                             do i1=n1a,n1b
                              ...
                              ! Here now is the statement where the ghost line value in the RHS is assigned.
                                  f(i1,i2+is2,i3)=(2*side-1)*( (nuT*(
     & ulaplacian42r(i1,i2,i3,vc))+2.*nuTy*(uy42r(i1,i2,i3,vc))+nuTx*(
     & ux42r(i1,i2,i3,vc)+uy42r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,vc))) 
     &  )
                               end if
                             end do
                             end do
     ...
     & ( (nuT*(-uxy42(i1,i2,i3,vc)+uyy42(i1,i2,i3,uc))-2.*nuTx*(uy42(
     & i1,i2,i3,vc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal00(i1,i2,i3,1)*( (nuT*(uxx42(i1,
     & i2,i3,vc)-uxy42(i1,i2,i3,uc))-2.*nuTy*(ux42(i1,i2,i3,uc))+nuTx*
     & (ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
     ...
     & i3,0)*( (nuT*(ulaplacian42(i1,i2,i3,uc))+2.*nuTx*(ux42(i1,i2,
     & i3,uc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal00(i1,i2,i3,1)*( (nuT*(
     & ulaplacian42(i1,i2,i3,vc))+2.*nuTy*(uy42(i1,i2,i3,vc))+nuTx*(
     & ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal10(i1,i2,i3,1)*( (nuT*(uxx42(i1,
     & i2,i3,vc)-uxy42(i1,i2,i3,uc))-2.*nuTy*(ux42(i1,i2,i3,uc))+nuTx*
     & (ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
     ...
     & i3,uc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal10(i1,i2,i3,1)*( (nuT*(
     & ulaplacian42(i1,i2,i3,vc))+2.*nuTy*(uy42(i1,i2,i3,vc))+nuTx*(
     & ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
     ...
     & i1,i2,i3,vc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal01(i1,i2,i3,1)*( (nuT*(uxx42(i1,
     & i2,i3,vc)-uxy42(i1,i2,i3,uc))-2.*nuTy*(ux42(i1,i2,i3,uc))+nuTx*
     & (ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
     ...
     & i3,uc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal01(i1,i2,i3,1)*( (nuT*(
     & ulaplacian42(i1,i2,i3,vc))+2.*nuTy*(uy42(i1,i2,i3,vc))+nuTx*(
     & ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
     ...
     & i1,i2,i3,vc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal11(i1,i2,i3,1)*( (nuT*(uxx42(i1,
     & i2,i3,vc)-uxy42(i1,i2,i3,uc))-2.*nuTy*(ux42(i1,i2,i3,uc))+nuTx*
     & (ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
     ...
     & i3,uc))+nuTy*(uy42(i1,i2,i3,uc)+ux42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,uc)))  )+normal11(i1,i2,i3,1)*( (nuT*(
     & ulaplacian42(i1,i2,i3,vc))+2.*nuTy*(uy42(i1,i2,i3,vc))+nuTx*(
     & ux42(i1,i2,i3,vc)+uy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,
     & i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
