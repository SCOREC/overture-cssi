! This file automatically generated from insdtKE.bf with bpp.
        subroutine insdtKE2dOrder2(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,
              ...
              do i1=n1a,n1b
               if( mask(i1,i2,i3).gt.0 )then
                 ! INS with k-epsilon turbulence model
                  ...
                  nuT = cMu*k0**2/e0
                  nuP=nu+nuT
                  k0x=ux22r(i1,i2,i3,kc)
                  e0x=ux22r(i1,i2,i3,ec)
                  nuTx=cMu*k0*( 2.*k0x*e0 - k0*e0x )/e0**2
                  k0y=uy22r(i1,i2,i3,kc)
                  e0y=uy22r(i1,i2,i3,ec)
                  nuTy=cMu*k0*( 2.*k0y*e0 - k0*e0y )/e0**2
                  prod = nuT*( 2.*(u0x**2+v0y**2) + (v0x+u0y)**2 )
                  ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)
     & *u0y-ux22r(i1,i2,i3,pc)+nuP*ulaplacian22r(i1,i2,i3,uc)+nuTx*(
     & 2.*u0x    ) +nuTy*(u0y+v0x)
                  ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)
     & *v0y-uy22r(i1,i2,i3,pc)+nuP*ulaplacian22r(i1,i2,i3,vc)+nuTx*(
     & u0y+v0x) +nuTy*(2.*v0y)
                  ut(i1,i2,i3,kc)= -uu(i1,i2,i3,uc)*k0x-uu(i1,i2,i3,vc)
     & *k0y +prod -u(i1,i2,i3,ec)+(nu+sigmaKI*nuT)*ulaplacian22r(i1,
     & i2,i3,kc)+sigmaKI*(nuTx*k0x+nuTy*k0y)
                  ut(i1,i2,i3,ec)= -uu(i1,i2,i3,uc)*e0x-uu(i1,i2,i3,vc)
     & *e0y+cEps1*(u(i1,i2,i3,ec)/u(i1,i2,i3,kc))*prod-cEps2*(u(i1,i2,
     & i3,ec)**2/u(i1,i2,i3,kc))+(nu+sigmaEpsI*nuT)*ulaplacian22r(i1,
     & i2,i3,ec)+sigmaEpsI*(nuTx*e0x+nuTy*e0y)
                ! end NO eq NO: 
               end if
              end do
              end do
              ...
              do i1=n1a,n1b
                ! INS with k-epsilon turbulence model
                 ...
                 prod = nuT*( 2.*(u0x**2+v0y**2) + (v0x+u0y)**2 )
                 ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)*
     & u0y-ux22r(i1,i2,i3,pc)+nuP*ulaplacian22r(i1,i2,i3,uc)+nuTx*(2.*
     & u0x    ) +nuTy*(u0y+v0x)
                 ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)*
     & v0y-uy22r(i1,i2,i3,pc)+nuP*ulaplacian22r(i1,i2,i3,vc)+nuTx*(
     & u0y+v0x) +nuTy*(2.*v0y)
                 ut(i1,i2,i3,kc)= -uu(i1,i2,i3,uc)*k0x-uu(i1,i2,i3,vc)*
     & k0y +prod -u(i1,i2,i3,ec)+(nu+sigmaKI*nuT)*ulaplacian22r(i1,i2,
     & i3,kc)+sigmaKI*(nuTx*k0x+nuTy*k0y)
                 ut(i1,i2,i3,ec)= -uu(i1,i2,i3,uc)*e0x-uu(i1,i2,i3,vc)*
     & e0y+cEps1*(u(i1,i2,i3,ec)/u(i1,i2,i3,kc))*prod-cEps2*(u(i1,i2,
     & i3,ec)**2/u(i1,i2,i3,kc))+(nu+sigmaEpsI*nuT)*ulaplacian22r(i1,
     & i2,i3,ec)+sigmaEpsI*(nuTx*e0x+nuTy*e0y)
              ...
              do i1=n1a,n1b
               if( mask(i1,i2,i3).gt.0 )then
                 ! INS with k-epsilon turbulence model
                  ...
                  nuT = cMu*k0**2/e0
                  nuP=nu+nuT
                  k0x=ux22(i1,i2,i3,kc)
                  e0x=ux22(i1,i2,i3,ec)
                  nuTx=cMu*k0*( 2.*k0x*e0 - k0*e0x )/e0**2
                  k0y=uy22(i1,i2,i3,kc)
                  e0y=uy22(i1,i2,i3,ec)
                  nuTy=cMu*k0*( 2.*k0y*e0 - k0*e0y )/e0**2
                  prod = nuT*( 2.*(u0x**2+v0y**2) + (v0x+u0y)**2 )
                  ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)
     & *u0y-ux22(i1,i2,i3,pc)+nuP*ulaplacian22(i1,i2,i3,uc)+nuTx*(2.*
     & u0x    ) +nuTy*(u0y+v0x)
                  ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)
     & *v0y-uy22(i1,i2,i3,pc)+nuP*ulaplacian22(i1,i2,i3,vc)+nuTx*(u0y+
     & v0x) +nuTy*(2.*v0y)
                  ut(i1,i2,i3,kc)= -uu(i1,i2,i3,uc)*k0x-uu(i1,i2,i3,vc)
     & *k0y +prod -u(i1,i2,i3,ec)+(nu+sigmaKI*nuT)*ulaplacian22(i1,i2,
     & i3,kc)+sigmaKI*(nuTx*k0x+nuTy*k0y)
                  ut(i1,i2,i3,ec)= -uu(i1,i2,i3,uc)*e0x-uu(i1,i2,i3,vc)
     & *e0y+cEps1*(u(i1,i2,i3,ec)/u(i1,i2,i3,kc))*prod-cEps2*(u(i1,i2,
     & i3,ec)**2/u(i1,i2,i3,kc))+(nu+sigmaEpsI*nuT)*ulaplacian22(i1,
     & i2,i3,ec)+sigmaEpsI*(nuTx*e0x+nuTy*e0y)
                ! end NO eq NO: 
               end if
              end do
