! This file automatically generated from insdtSPAL.bf with bpp.
        subroutine insdtSPAL2dOrder2(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,
...
c============================================================================================
     ...
     & *u0y-ux22r(i1,i2,i3,pc)+nuT*ulaplacian22r(i1,i2,i3,uc)+nuTx*(
     & 2.*u0x    ) +nuTy*(u0y+v0x)
                  ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)
     & *v0y-uy22r(i1,i2,i3,pc)+nuT*ulaplacian22r(i1,i2,i3,vc)+nuTx*(
     & u0y+v0x) +nuTy*(2.*v0y)
                  ut(i1,i2,i3,nc)= -uu(i1,i2,i3,uc)*n0x-uu(i1,i2,i3,vc)
     & *n0y + cb1*s*u(i1,i2,i3,nc) + sigmai*(nu+u(i1,i2,i3,nc))*(
     & ulaplacian22r(i1,i2,i3,nc))+ ((1.+cb2)*sigmai)*(n0x**2+n0y**2)-
     &  nSqBydSq
                ! end NO eq NO: 
               end if
              end do
              ...
              do i1=n1a,n1b
                ! INS with Spalart-Allmaras turbulence model
                 ...
                 nuTy=n0y*nuTd
                 ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)*
     & u0y-ux22r(i1,i2,i3,pc)+nuT*ulaplacian22r(i1,i2,i3,uc)+nuTx*(2.*
     & u0x    ) +nuTy*(u0y+v0x)
                 ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)*
     & v0y-uy22r(i1,i2,i3,pc)+nuT*ulaplacian22r(i1,i2,i3,vc)+nuTx*(
     & u0y+v0x) +nuTy*(2.*v0y)
              ...
              do i1=n1a,n1b
               if( mask(i1,i2,i3).gt.0 )then
                 ! INS with Spalart-Allmaras turbulence model
                  ...
                  nuTy=n0y*nuTd
                  ut(i1,i2,i3,uc)= -uu(i1,i2,i3,uc)*u0x-uu(i1,i2,i3,vc)
     & *u0y-ux22(i1,i2,i3,pc)+nuT*ulaplacian22(i1,i2,i3,uc)+nuTx*(2.*
     & u0x    ) +nuTy*(u0y+v0x)
                  ut(i1,i2,i3,vc)= -uu(i1,i2,i3,uc)*v0x-uu(i1,i2,i3,vc)
     & *v0y-uy22(i1,i2,i3,pc)+nuT*ulaplacian22(i1,i2,i3,vc)+nuTx*(u0y+
     & v0x) +nuTy*(2.*v0y)
                  ut(i1,i2,i3,nc)= -uu(i1,i2,i3,uc)*n0x-uu(i1,i2,i3,vc)
     & *n0y + cb1*s*u(i1,i2,i3,nc) + sigmai*(nu+u(i1,i2,i3,nc))*(
     & ulaplacian22(i1,i2,i3,nc))+ ((1.+cb2)*sigmai)*(n0x**2+n0y**2)- 
     & nSqBydSq
                ! end NO eq NO: 
               end if
              end do
