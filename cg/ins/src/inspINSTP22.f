! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINSTP22(nd,  n1a,n1b,n2a,n2b,n3a,
...
c============================================================================================
     ...
     & nuTxx*u0x+nuTxy*u0y+nuTy*v0Lap+nuTxy*v0x+nuTyy*v0y)/u(i1,i2,i3,
     & rc)
     ...
     & *uy22r(i1,i2,i3,uc))*u(i1,i2,i3,rc))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & *uy22r(i1,i2,i3,vc))*u(i1,i2,i3,rc))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & uy22(i1,i2,i3,uc))*u(i1,i2,i3,rc))  )+normal00(i1,i2,i3,1)*( (
     & nuT*(uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,
     & i2,i3,uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc))*u(i1,i2,i3,rc))  )
     ...
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,uc))*u(i1,i2,i3,rc))  )+normal00(i1,i2,i3,1)*( (
     & nuT*(ulaplacian22(i1,i2,i3,vc))+2.*nuTy*(uy22(i1,i2,i3,vc))+
     & nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-(advectCoeff*(uu(
     & i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,
     & vc))*u(i1,i2,i3,rc))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(v)=",e10.2)') i1,i2,vDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc))+nuTy*(uy22(i1,i2,i3,uc)+ux22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,uc))*u(i1,i2,i3,rc))  )+normal10(i1,i2,i3,1)*( (
     & nuT*(uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,
     & i2,i3,uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc))*u(i1,i2,i3,rc))  )
     ...
     & i1,i2,i3,vc))+nuTy*(uy22(i1,i2,i3,uc)+ux22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,uc))*u(i1,i2,i3,rc))  )+normal01(i1,i2,i3,1)*( (
     & nuT*(uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,
     & i2,i3,uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc))*u(i1,i2,i3,rc))  )
     ...
     & i1,i2,i3,vc))+nuTy*(uy22(i1,i2,i3,uc)+ux22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,uc))*u(i1,i2,i3,rc))  )+normal11(i1,i2,i3,1)*( (
     & nuT*(uxx22(i1,i2,i3,vc)-uxy22(i1,i2,i3,uc))-2.*nuTy*(ux22(i1,
     & i2,i3,uc))+nuTx*(ux22(i1,i2,i3,vc)+uy22(i1,i2,i3,uc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc))*u(i1,i2,i3,rc))  )
