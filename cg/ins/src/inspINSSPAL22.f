! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINSSPAL22(nd,  n1a,n1b,n2a,n2b,n3a,
...
c============================================================================================
     ...
     & *3/nu  ! this is really nuTdd/nu : from spal.maple
                    n0x=ux22r(i1,i2,i3,nc)
                    n0y=uy22r(i1,i2,i3,nc)
                    n0xx=uxx22r(i1,i2,i3,nc)
                    n0xy=uxy22r(i1,i2,i3,nc)
                    n0yy=uyy22r(i1,i2,i3,nc)
                    nuTx=n0x*nuTd
                    nuTy=n0y*nuTd
           ...
           if( useWhereMask.ne.0 )then
             ...
             do i1=n1a,n1b
               if( mask(i1,i2,i3).ne.0 )then
                    ...
                    nuTdd= 6*chi**2*cv1e3*(-chi3+2*cv1e3)/(chi3+cv1e3)*
     & *3/nu  ! this is really nuTdd/nu : from spal.maple
                    n0x=ux22(i1,i2,i3,nc)
                    n0y=uy22(i1,i2,i3,nc)
                    n0xx=uxx22(i1,i2,i3,nc)
                    n0xy=uxy22(i1,i2,i3,nc)
                    n0yy=uyy22(i1,i2,i3,nc)
                    nuTx=n0x*nuTd
                    nuTy=n0y*nuTd
                    nuTxx=n0xx*nuTd+n0x*n0x*nuTdd
                    nuTxy=n0xy*nuTd+n0x*n0y*nuTdd
