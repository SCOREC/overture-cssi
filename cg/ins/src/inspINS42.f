! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINS42(nd,  n1a,n1b,n2a,n2b,n3a,n3b,
...
c============================================================================================
            ...
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  ...
                  f(i1,i2,i3)=(-advectionCoefficient)*(u0x**2+2.*uy42r(
     & i1,i2,i3,uc)*ux42r(i1,i2,i3,vc)+v0y**2)+divDamping(i1,i2,i3)*(
     & u0x+v0y)
                ...
                do i1=n1a,n1b
                  if( mask(i1,i2,i3).ne.0 )then
                      ...
                      if( radiusInverse(i1,i2,i3).ne.0. )then
                        f(i1,i2,i3)=f(i1,i2,i3) + divDamping(i1,i2,i3)*
     & ( u(i1,i2,i3,vc)*radiusInverse(i1,i2,i3) )
                      else
                        f(i1,i2,i3)=f(i1,i2,i3) + divDamping(i1,i2,i3)*
     & ( uy42r(i1,i2,i3,vc) )
                      end if
     ...
     & 0)*ux42r(i1,i2,i3,tc)+gravity(1)*uy42r(i1,i2,i3,tc))
                end if
              end do
              end do
              end do
     ...
     & 0)*ux42r(i1,i2,i3,tc)+gravity(1)*uy42r(i1,i2,i3,tc))
         ...
         !!120224 kkc gets annoying after awhile  write(*,'(" *** inspf: add divergence of the body force to the pressure RHS ***")') 
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  f(i1,i2,i3)=f(i1,i2,i3)+udfx42r(i1,i2,i3,uc)+udfy42r(
     & i1,i2,i3,vc)
                end if
              end do
              end do
            ...
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  ...
                  f(i1,i2,i3)=(-advectionCoefficient)*(u0x**2+2.*uy42(
     & i1,i2,i3,uc)*ux42(i1,i2,i3,vc)+v0y**2)+divDamping(i1,i2,i3)*(
     & u0x+v0y)
     ...
     & pdeModel.eq.viscoPlasticModel )then
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  f(i1,i2,i3)=f(i1,i2,i3)-thermalExpansivity*(gravity(
     & 0)*ux42(i1,i2,i3,tc)+gravity(1)*uy42(i1,i2,i3,tc))
                end if
              end do
              end do
              end do
     ...
     & 0)*ux42(i1,i2,i3,tc)+gravity(1)*uy42(i1,i2,i3,tc))
         ...
         !!120224 kkc gets annoying after awhile  write(*,'(" *** inspf: add divergence of the body force to the pressure RHS ***")') 
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  f(i1,i2,i3)=f(i1,i2,i3)+udfx42(i1,i2,i3,uc)+udfy42(
     & i1,i2,i3,vc)
                end if
              end do
              end do
     ...
     & uxy42r(i1,i2,i3,vc)+uyy42r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux42r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,uc)
     & ))  )
                           end if
                         end do
                         end do
     ...
     & i3)+nu*an(0)*(uy42r(i1,i2,i3,uc)-ux42r(i1,i2,i3,vc))*
     & radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*an(0)*(uyy42r(i1,i2,i3,uc)-uxy42r(i1,i2,i3,vc))
                              end if
                                 end if
                               end do
                               end do
     ...
     & .eq.noSlipWall .and. twilightZoneFlow.eq.0 )then
                           if( axisp.eq.0 )then
                             ...
                             do i1=n1a,n1b
                              ...
                              ! Here now is the statement where the ghost line value in the RHS is assigned.
                                  f(i1+is1,i2,i3)=(2*side-1)*( (nu*(
     & ulaplacian42r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux42r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,uc)))  )
                               end if
                             end do
                             end do
                             end do
     ...
     & is2,i3+is3)+(2*side-1)*udf(i1,i2,i3,uc+axis)
                               ...
                               if( isAxisymmetric.eq.1 )then
                                   ...
                                   do i1=n1a,n1b
                                     if( mask(i1,i2,i3).ne.0 )then
                                   if( radiusInverse(i1,i2,i3).ne.0. )
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(an(0)*(uy42r(i1,i2,i3,uc)) +an(1)*( uy42r(i1,i2,i3,
     & vc)-u(i1,i2,i3,vc)*radiusInverse(i1,i2,i3) ))*radiusInverse(i1,
     & i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(an(0)*(uyy42r(i1,i2,i3,uc))+an(1)*(.5*uyy42r(i1,i2,
     & i3,vc)))
                                  end if
                                     end if
                                   end do
     ...
     & i3,vc)))
                       ...
                       ! Use the curl-curl form of the equations
                         ...
                         do i1=n1a,n1b
                          ...
                          ! Artificial Dissipation  **todo** implicit-line, self-adjoint versions
                          ! Here now is the statement where the ghost line value in the RHS is assigned.
                              f(i1,i2+is2,i3)=(2*side-1)*( (nu*(uxx42r(
     & i1,i2,i3,vc)-uxy42r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux42r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,vc)))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & ulaplacian42r(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux42r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy42r(i1,i2,i3,vc)))  )
                               end if
                             end do
                             end do
                             end do
     ...
     & ( (nu*(-uxy42(i1,i2,i3,vc)+uyy42(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,
     & i3,uc)))  )+normal00(i1,i2,i3,1)*( (nu*(uxx42(i1,i2,i3,vc)-
     & uxy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal00(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)-ux42(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal00(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc)-uxy42(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,uc)))
     &   )+normal00(i1,i2,i3,1)*( (nu*(ulaplacian42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(v)=",e10.2)') i1,i2,vDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal00(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)) +normal00(
     & i1,i2,i3,1)*( uy42(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal00(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc))+normal00(
     & i1,i2,i3,1)*(.5*uyy42(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
                                   end do
     ...
     & ( (nu*(-uxy42(i1,i2,i3,vc)+uyy42(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,
     & i3,uc)))  )+normal10(i1,i2,i3,1)*( (nu*(uxx42(i1,i2,i3,vc)-
     & uxy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal10(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)-ux42(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal10(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc)-uxy42(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,uc)))
     &   )+normal10(i1,i2,i3,1)*( (nu*(ulaplacian42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal10(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)) +normal10(
     & i1,i2,i3,1)*( uy42(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal10(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc))+normal10(
     & i1,i2,i3,1)*(.5*uyy42(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
     ...
     & ( (nu*(-uxy42(i1,i2,i3,vc)+uyy42(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,
     & i3,uc)))  )+normal01(i1,i2,i3,1)*( (nu*(uxx42(i1,i2,i3,vc)-
     & uxy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal01(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)-ux42(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal01(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc)-uxy42(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,uc)))
     &   )+normal01(i1,i2,i3,1)*( (nu*(ulaplacian42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal01(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)) +normal01(
     & i1,i2,i3,1)*( uy42(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal01(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc))+normal01(
     & i1,i2,i3,1)*(.5*uyy42(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
     ...
     & ( (nu*(-uxy42(i1,i2,i3,vc)+uyy42(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,
     & i3,uc)))  )+normal11(i1,i2,i3,1)*( (nu*(uxx42(i1,i2,i3,vc)-
     & uxy42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal11(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)-ux42(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal11(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc)-uxy42(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian42(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux42(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy42(i1,i2,i3,uc)))
     &   )+normal11(i1,i2,i3,1)*( (nu*(ulaplacian42(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux42(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy42(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal11(i1,i2,i3,0)*(uy42(i1,i2,i3,uc)) +normal11(
     & i1,i2,i3,1)*( uy42(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal11(i1,i2,i3,0)*(uyy42(i1,i2,i3,uc))+normal11(
     & i1,i2,i3,1)*(.5*uyy42(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
