! This file automatically generated from inspf.bf with bpp.
        subroutine assignPressureRhsINS22(nd,  n1a,n1b,n2a,n2b,n3a,n3b,
...
c============================================================================================
            ...
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  ...
                  f(i1,i2,i3)=(-advectionCoefficient)*(u0x**2+2.*uy22r(
     & i1,i2,i3,uc)*ux22r(i1,i2,i3,vc)+v0y**2)+divDamping(i1,i2,i3)*(
     & u0x+v0y)
            ...
            if( useWhereMask.ne.0 )then
              ...
              do i1=n1a,n1b
                if( mask(i1,i2,i3).ne.0 )then
                  ...
                  f(i1,i2,i3)=(-advectionCoefficient)*(u0x**2+2.*uy22(
     & i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+v0y**2)+divDamping(i1,i2,i3)*(
     & u0x+v0y)
     ...
     & uxy22r(i1,i2,i3,vc)+uyy22r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux22r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,uc)
     & ))  )
                           end if
                         end do
                         end do
     ...
     & i3)+nu*an(0)*(uy22r(i1,i2,i3,uc)-ux22r(i1,i2,i3,vc))*
     & radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*an(0)*(uyy22r(i1,i2,i3,uc)-uxy22r(i1,i2,i3,vc))
                              end if
                                 end if
                               end do
                               end do
     ...
     & .eq.noSlipWall .and. twilightZoneFlow.eq.0 )then
                           if( axisp.eq.0 )then
                             ...
                             do i1=n1a,n1b
                              ...
                              ! Here now is the statement where the ghost line value in the RHS is assigned.
                                  f(i1+is1,i2,i3)=(2*side-1)*( (nu*(
     & ulaplacian22r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux22r(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,uc)))  )
                               end if
                             end do
                             end do
                             end do
     ...
     & is2,i3)+nu*(an(0)*(uy22r(i1,i2,i3,uc)) +an(1)*( uy22r(i1,i2,i3,
     & vc)-u(i1,i2,i3,vc)*radiusInverse(i1,i2,i3) ))*radiusInverse(i1,
     & i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(an(0)*(uyy22r(i1,i2,i3,uc))+an(1)*(.5*uyy22r(i1,i2,
     & i3,vc)))
                                  end if
                                     end if
                                   end do
     ...
     & i3,vc)))
                       ...
                       ! Use the curl-curl form of the equations
                         ...
                         do i1=n1a,n1b
                          ...
                          ! Artificial Dissipation  **todo** implicit-line, self-adjoint versions
                          ! Here now is the statement where the ghost line value in the RHS is assigned.
                              f(i1,i2+is2,i3)=(2*side-1)*( (nu*(uxx22r(
     & i1,i2,i3,vc)-uxy22r(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,
     & uc)*ux22r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,vc)))  )
                           end if
                         end do
                         end do
                         end do
     ...
     & ulaplacian22r(i1,i2,i3,vc)))-(advectCoeff*(uu(i1,i2,i3,uc)*
     & ux22r(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*uy22r(i1,i2,i3,vc)))  )
                               end if
                             end do
                             end do
                             end do
     ...
     & ( (nu*(-uxy22(i1,i2,i3,vc)+uyy22(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,
     & i3,uc)))  )+normal00(i1,i2,i3,1)*( (nu*(uxx22(i1,i2,i3,vc)-
     & uxy22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,vc)))  )
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal00(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)-ux22(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal00(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc)-uxy22(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,uc)))
     &   )+normal00(i1,i2,i3,1)*( (nu*(ulaplacian22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(v)=",e10.2)') i1,i2,vDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal00(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)) +normal00(
     & i1,i2,i3,1)*( uy22(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal00(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc))+normal00(
     & i1,i2,i3,1)*(.5*uyy22(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
                                   end do
     ...
     & ( (nu*(-uxy22(i1,i2,i3,vc)+uyy22(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,
     & i3,uc)))  )+normal10(i1,i2,i3,1)*( (nu*(uxx22(i1,i2,i3,vc)-
     & uxy22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal10(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)-ux22(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal10(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc)-uxy22(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,uc)))
     &   )+normal10(i1,i2,i3,1)*( (nu*(ulaplacian22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal10(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)) +normal10(
     & i1,i2,i3,1)*( uy22(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal10(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc))+normal10(
     & i1,i2,i3,1)*(.5*uyy22(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
     ...
     & ( (nu*(-uxy22(i1,i2,i3,vc)+uyy22(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,
     & i3,uc)))  )+normal01(i1,i2,i3,1)*( (nu*(uxx22(i1,i2,i3,vc)-
     & uxy22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal01(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)-ux22(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal01(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc)-uxy22(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,uc)))
     &   )+normal01(i1,i2,i3,1)*( (nu*(ulaplacian22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal01(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)) +normal01(
     & i1,i2,i3,1)*( uy22(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal01(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc))+normal01(
     & i1,i2,i3,1)*(.5*uyy22(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
     ...
     & ( (nu*(-uxy22(i1,i2,i3,vc)+uyy22(i1,i2,i3,uc)))-(advectCoeff*(
     & uu(i1,i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,
     & i3,uc)))  )+normal11(i1,i2,i3,1)*( (nu*(uxx22(i1,i2,i3,vc)-
     & uxy22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,
     & i3,vc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,vc)))  )
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                              ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & i1,i2,i3,vc)
                           ...
                           if( isAxisymmetric.eq.1 )then
                             ...
                             ! See the CginsRef documentation for a description of where this comes from.
                               ...
                               if( radiusInverse(i1,i2,i3).ne.0. )then
                                   f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal11(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)-ux22(i1,i2,i3,
     & vc))*radiusInverse(i1,i2,i3)
                               else
                                  f(i1+is1,i2+is2,i3)=f(i1+is1,i2+is2,
     & i3)+nu*normal11(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc)-uxy22(i1,i2,i3,
     & vc))
                              end if
                                 end if
                               end do
     ...
     & i3,0)*( (nu*(ulaplacian22(i1,i2,i3,uc)))-(advectCoeff*(uu(i1,
     & i2,i3,uc)*ux22(i1,i2,i3,uc)+uu(i1,i2,i3,vc)*uy22(i1,i2,i3,uc)))
     &   )+normal11(i1,i2,i3,1)*( (nu*(ulaplacian22(i1,i2,i3,vc)))-(
     & advectCoeff*(uu(i1,i2,i3,uc)*ux22(i1,i2,i3,vc)+uu(i1,i2,i3,vc)*
     & uy22(i1,i2,i3,vc)))  )
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", f=",e10.2," adCoeff=",2e10.2)') i1,i2,f(i1+is1,i2+is2,i3),adCoeff2,adCoeff4
                                  ! write(*,'(" inspf: (i1,i2)=",2i3,", Delta(u)=",e10.2)') i1,i2,uDiffusion(i1,i2,i3)
     ...
     & then
                                       f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal11(i1,i2,i3,0)*(uy22(i1,i2,i3,uc)) +normal11(
     & i1,i2,i3,1)*( uy22(i1,i2,i3,vc)-u(i1,i2,i3,vc)*radiusInverse(
     & i1,i2,i3)) )*radiusInverse(i1,i2,i3)
                                   else
                                      f(i1+is1,i2+is2,i3)=f(i1+is1,i2+
     & is2,i3)+nu*(normal11(i1,i2,i3,0)*(uyy22(i1,i2,i3,uc))+normal11(
     & i1,i2,i3,1)*(.5*uyy22(i1,i2,i3,vc)) )
                                  end if
                                     end if
                                   end do
