#
# Cgins: cylindrical bubble under surface tension -- compare to exact solution
#
# Usage:
#   
#  cgins [-noplot] cylindricalBubble3d -g=<name> -pGrad=<f> -surfaceTension=<f> -tf=<tFinal> -tp=<tPlot> ...
...
# 
$grid="testFreeSurfaceCylindere2.order2.hdf"; $backGround="backGround"; $bcn="noSlipWall"; $pGrad=0.; 
$deformationType="free surface"; 
$deformingGrid="share=100"; # deforming grid is identified by a share value of 100 
# 
$tFinal=1.; $tPlot=.1; $cfl=.9; $nu=.1; $Prandtl=.72; $thermalExpansivity=.1; 
$gravity = "0. 0. 0."; 
...
# 
  boundary conditions
    ...
    # bcNumber4=slipWall
    # bcNumber5=slipWall
    bcNumber5=freeSurfaceBoundaryCondition
