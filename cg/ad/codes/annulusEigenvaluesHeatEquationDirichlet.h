...
//  cJ = amp*Yn(lambda*a), cY = -amp*Jn(lambda*a) 
 ...
 { // Roots for f(z,n) = Jn(a*z)*Yn(a*z) - Jn(b*z)*Yn(a*z), n=0
    ...
    2.51228463710507e+01,
    3.14079957854881e+01}, // end n=0
 { // Roots for f(z,n) = Jn(a*z)*Yn(a*z) - Jn(b*z)*Yn(a*z), n=1
    ...
    3.14397085388595e+01}, // end n=1
 { // Roots for f(z,n) = Jn(a*z)*Yn(a*z) - Jn(b*z)*Yn(a*z), n=2
    6.81384285313505e+00,
    1.28555318451921e+01,
    1.90457045399067e+01,
    2.52807623389876e+01,
    3.15346834515319e+01}, // end n=2
 { // Roots for f(z,n) = Jn(a*z)*Yn(a*z) - Jn(b*z)*Yn(a*z), n=3
    7.45774013605109e+00,
    1.32318425358893e+01,
    1.93044899993167e+01,
    2.54769681878510e+01,
    3.16924354259193e+01}, // end n=3
 { // Roots for f(z,n) = Jn(a*z)*Yn(a*z) - Jn(b*z)*Yn(a*z), n=4
    8.26673043536010e+00,
    1.37423280670890e+01,
    1.96617251190007e+01,
    2.57494901581589e+01,
    3.19121721096199e+01}, // end n=4
                               };
