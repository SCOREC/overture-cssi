  ...
  // const real beta  = champParameters(3);
    ...
    // For coefficients from Sijia: 
        ...
        ForBoundary(side,axis)
        {
            ...
            {
                printF("+++++ CHAMP BC: FILL MATRIX BC FOR (grid,side,axis)=(%d,%d,%d) order=%d, numGhost=%d (heatFluxInterface)\n",
                          grid,side,axis,orderOfAccuracy,numGhost );
        ...
        // const Real pr    = champParameters(1,side,axis,grid);    // optimized Scwartz Parameter for side 2
                ...
                printF("***** fillChampBC: (side,axis,grid)=(%d,%d,%d) : theta=Kleft/Kright=%g, beta=Dleft/Dright=%g, CHAMP parameter pl=%g ****\n",
            ...
            //#include "champ2InterfaceStencil.C"
                ...
                // Fill Ghost 2 -- extrapolation for now 
                    ...
                    // --- fill in the coefficients of the extrapolation formula ---
                          ...
                          if( maxDiff > REAL_EPSILON/(SQR(dxs)) )
                          {
              ...
              //                                   + cc(Ib1,Ib2,Ib3,5)*Nc;
                ...
                // Fill Ghost 2 -- extrapolation for now 
                    ...
                    // --- fill in the coefficients of the extrapolation formula ---
                          ...
                          if( maxDiff > 100.*REAL_EPSILON*maxCoeff )
                          {
