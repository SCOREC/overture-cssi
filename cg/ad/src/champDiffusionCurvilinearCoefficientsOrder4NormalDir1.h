...
#defineMacro diffa(u,i1,i2,i3,dr) diffr4(u,i1,i2,i3,dr)
#defineMacro diffaa(u,i1,i2,i3,dr) diffrr4(u,i1,i2,i3,dr)
#defineMacro diffaaa(u,i1,i2,i3,dr) diffrrr2(u,i1,i2,i3,dr)
#defineMacro diffaaaa(u,i1,i2,i3,dr) diffrrrr2(u,i1,i2,i3,dr)
...
FOR_3IJ(i1,i2,i3,Ib1,Ib2,Ib3,j1,j2,j3,Jb1,Jb2,Jb3)
{
  ...
  b1Lrr(i1,i2,i3) = diffrr2(b1L,i1,i2,i3,drL);
   b1Lr(i1,i2,i3) =  diffr2(b1L,i1,i2,i3,drL);
  b2Lrr(i1,i2,i3) = diffrr2(b2L,i1,i2,i3,drL);
   b2Lr(i1,i2,i3) =  diffr2(b2L,i1,i2,i3,drL);
...
{
 // tangential directives of b1,b2 only 
  b1Rrr(j1,j2,j3) = diffrr2(b1R,j1,j2,j3,drR);
   b1Rr(j1,j2,j3) =  diffr2(b1R,j1,j2,j3,drR);
  b2Rrr(j1,j2,j3) = diffrr2(b2R,j1,j2,j3,drR);
   b2Rr(j1,j2,j3) =  diffr2(b2R,j1,j2,j3,drR);
  // normal and tangential directives of c 
...
FOR_3IJ(i1,i2,i3,Ib1,Ib2,Ib3,j1,j2,j3,Jb1,Jb2,Jb3)
{
  ...
  L1rCoeffrr(i1,i2,i3) = diffaa2(L1rCoeff,i1,i2,i3,drL);
  L1sCoeffrr(i1,i2,i3) = diffaa2(L1sCoeff,i1,i2,i3,drL);
  L1ICoeffrr(i1,i2,i3) = diffaa2(L1ICoeff,i1,i2,i3,drL);
  // Compute tangential derivatives of L2
  L2rrCoeffr(i1,i2,i3) = diffa2(L2rrCoeff,i1,i2,i3,drL);
  L2rsCoeffr(i1,i2,i3) = diffa2(L2rsCoeff,i1,i2,i3,drL);
  L2ssCoeffr(i1,i2,i3) = diffa2(L2ssCoeff,i1,i2,i3,drL);
  L2rCoeffr(i1,i2,i3)  = diffa2(L2rCoeff, i1,i2,i3,drL);
  L2sCoeffr(i1,i2,i3)  = diffa2(L2sCoeff, i1,i2,i3,drL);
  L2ICoeffr(i1,i2,i3)  = diffa2(L2ICoeff, i1,i2,i3,drL);
...
{
  // Compute tangential derivatives of L1
  L1rCoeffrrr(i1,i2,i3) = diffaaa(L1rCoeff,i1,i2,i3,drL);
  L1sCoeffrrr(i1,i2,i3) = diffaaa(L1sCoeff,i1,i2,i3,drL);
  L1ICoeffrrr(i1,i2,i3) = diffaaa(L1ICoeff,i1,i2,i3,drL);
  // Compute tangential derivatives of L2
  L2rrCoeffrr(i1,i2,i3) = diffaa2(L2rrCoeff,i1,i2,i3,drL);
  L2rsCoeffrr(i1,i2,i3) = diffaa2(L2rsCoeff,i1,i2,i3,drL);
  L2ssCoeffrr(i1,i2,i3) = diffaa2(L2ssCoeff,i1,i2,i3,drL);
  L2rCoeffrr(i1,i2,i3)  = diffaa2(L2rCoeff, i1,i2,i3,drL);
  L2sCoeffrr(i1,i2,i3)  = diffaa2(L2sCoeff, i1,i2,i3,drL);
  L2ICoeffrr(i1,i2,i3)  = diffaa2(L2ICoeff, i1,i2,i3,drL);
  // Compute tangential derivatives of L3
  L3rrrCoeffr(i1,i2,i3) = diffa2(L3rrrCoeff,i1,i2,i3,drL);
  L3rrsCoeffr(i1,i2,i3) = diffa2(L3rrsCoeff,i1,i2,i3,drL);
  L3rssCoeffr(i1,i2,i3) = diffa2(L3rssCoeff,i1,i2,i3,drL);
  L3sssCoeffr(i1,i2,i3) = diffa2(L3sssCoeff,i1,i2,i3,drL);
  L3rrCoeffr(i1,i2,i3)  = diffa2(L3rrCoeff, i1,i2,i3,drL);
  L3rsCoeffr(i1,i2,i3)  = diffa2(L3rsCoeff, i1,i2,i3,drL);
  L3ssCoeffr(i1,i2,i3)  = diffa2(L3ssCoeff, i1,i2,i3,drL);
  L3rCoeffr(i1,i2,i3)   = diffa2(L3rCoeff,  i1,i2,i3,drL);
  L3sCoeffr(i1,i2,i3)   = diffa2(L3sCoeff,  i1,i2,i3,drL);
  L3ICoeffr(i1,i2,i3)   = diffa2(L3ICoeff,  i1,i2,i3,drL);
...
FOR_3IJ(i1,i2,i3,Ib1,Ib2,Ib3,j1,j2,j3,Jb1,Jb2,Jb3)
{
  ...
  getChampCoeffOrder4NormalDirection1()
