                      ...
                      if( av2.ne.0. .or. av4.ne.0. )then
                        ...
                        do axis=0,nd-1
                          ...
                          if( nd.eq.3 )then
                           ...
                           do i1=m1a,m1b
                           if( mask(i1,i2,i3).gt.0 )then
                            dp(i1,i2,i3,axis)=abs( ( p(i1+is(0),i2+is(
     & 1),i3+is(2))-2.*p(i1,i2,i3)+p(i1-is(0),i2-is(1),i3-is(2)) )/   
     &                     ( p(i1+is(0),i2+is(1),i3+is(2))+2.*p(i1,i2,
     & i3)+p(i1-is(0),i2-is(1),i3-is(2)) ) )
                            else
                              dp(i1,i2,i3,axis)=0.
                            end if
                           end do
...
c ...............................................
     ...
     & uu(i1,i2,i3,vc))/dx(1) ) +sqrt( cSq*( 1./dx(0)**2+1./dx(1)**2 )
     &  )
     ...
     & 0)**2 + 1./dx(1)**2 )
                        if( av2.ne.0. .or. av4.ne.0. )then
                          ...
                          do axis=0,nd-1
                            ...
                            is(2)=0
                            is(axis)=1
                            cc = sqrt( gamma*(p(i1,i2,i3)/u(i1,i2,i3,
     & rc)) )   ! speed of sound
                            alam= ( abs(u(i1,i2,i3,uc+axis))+cc )/dx(
     & axis)
                            wmax= max(dp(i1-is(0),i2-is(1),i3-is(2),
     & axis),max(dp(i1,i2,i3,axis),dp(i1+is(0),i2+is(1),i3+is(2),axis)
     & ))
...
c ...............................................
     ...
     & i3,vc)*sy(i1,i2,i3)
                          ! constant nu case
                            a1=a1 -nu*( rxx22(i1,i2,i3) + ryy22(i1,i2,
     & i3) )
                            a2=a2 -nu*( sxx22(i1,i2,i3) + syy22(i1,i2,
     & i3) )
                        ...
                        if( av2.ne.0. .or. av4.ne.0. )then
                          ...
                          do axis=0,nd-1
                            ...
                            is(axis)=1
                              ...
                              aj = rx(i1,i2,i3)*sy(i1,i2,i3)-ry(i1,i2,
     & i3)*sx(i1,i2,i3)  !  (dx(0)/dr(0))*(dx(1)/dr(1))
                              aj = 1./max(ajEps,abs(aj))
                              a1= rsxy(i1,i2,i3,axis,0)*aj
                              a2= rsxy(i1,i2,i3,axis,1)*aj
                              dist = sqrt(a1**2+a2**2)
                              vn = a1*u(i1,i2,i3,uc)+a2*u(i1,i2,i3,vc)
                            cc = sqrt( gamma*(p(i1,i2,i3)/u(i1,i2,i3,
     & rc)) )
                        ...
                        if( av2.ne.0. .or. av4.ne.0. )then
                          ...
                          do axis=0,nd-1
                            ...
                            if( nd.eq.3 )then
                             ...
                             do i1=m1a,m1b
                             if( mask(i1,i2,i3).gt.0 )then
                              dp(i1,i2,i3,axis)=abs( ( p(i1+is(0),i2+
     & is(1),i3+is(2))-2.*p(i1,i2,i3)+p(i1-is(0),i2-is(1),i3-is(2)) )
     & /                       ( p(i1+is(0),i2+is(1),i3+is(2))+2.*p(
     & i1,i2,i3)+p(i1-is(0),i2-is(1),i3-is(2)) ) )
                              else
                                dp(i1,i2,i3,axis)=0.
                              end if
                             end do
...
c ...............................................
     ...
     & abs(uu(i1,i2,i3,vc))/dx(1) ) +sqrt( cSq*( 1./dx(0)**2+1./dx(1)*
     & *2 ) )
...
c ...............................................
     ...
     & i2,i3,vc)*sy(i1,i2,i3)
                            ! constant nu case
                              a1=a1 -nu*( rxx22(i1,i2,i3) + ryy22(i1,
     & i2,i3) )
                              a2=a2 -nu*( sxx22(i1,i2,i3) + syy22(i1,
     & i2,i3) )
                              rePart = (mukt/u(i1,i2,i3,rc))*( ( rx(i1,
     & i2,i3)**2          + ry(i1,i2,i3)**2          )*(crr/(dr(0)*dr(
     & 0))) +abs( rx(i1,i2,i3)*sx(i1,i2,i3)+ry(i1,i2,i3)*sy(i1,i2,i3) 
     ...
     & i3)**2          )*(crr/(dr(1)*dr(1))) )
                              ...
                              if( abs(yy).gt.yEps )then
                                ...
                                ! u.yy 
                                rePart= rePart+nu*(  (                 
     &            ry(i1,i2,i3)**2          )*(crr/(dr(0)*dr(0))) +abs(
     &                            ry(i1,i2,i3)*sy(i1,i2,i3) )*( cr/(
     & dr(0)*dr(1))) +(                            sy(i1,i2,i3)**2    
     &       )*(crr/(dr(1)*dr(1))) )
                              end if
                            imPart=cr*(abs(a1)/dr(0)+abs(a2)/dr(1)) +
     & sqrt( cSq*( rx(i1,i2,i3)**2 *(1./(dr(0)**2))                 +
     & sy(i1,i2,i3)**2 *(1./(dr(1)**2)) ) )
                          if( av2.ne.0. .or. av4.ne.0. )then
                            ...
                            do axis=0,nd-1
                              ...
                              is(axis)=1
                                ! aj = | dx/dr | (centerJacobian)
                                aj = rx(i1,i2,i3)*sy(i1,i2,i3)-ry(i1,
     & i2,i3)*sx(i1,i2,i3)  !  (dx(0)/dr(0))*(dx(1)/dr(1))
                                aj = 1./max(ajEps,abs(aj))
                                a1= rsxy(i1,i2,i3,axis,0)*aj
                                a2= rsxy(i1,i2,i3,axis,1)*aj
                                dist = sqrt(a1**2+a2**2)
                                vn = a1*u(i1,i2,i3,uc)+a2*u(i1,i2,i3,
     & vc)
                              cc = sqrt( gamma*(p(i1,i2,i3)/u(i1,i2,i3,
     & rc)) )
                              alam= (abs(vn)+cc*dist)/dr(axis)
...
c ...............................................
                      ...
                      ! speed of sound squared:
                       cSq = gamma*Rg*u(i1,i2,i3,tc)
                          imPart= cr*( abs(uu(i1,i2,i3,uc))/dx(0) + 
     & abs(uu(i1,i2,i3,vc))/dx(1) + abs(uu(i1,i2,i3,wc))/dx(2) )+sqrt(
     &  cSq*( 1./dx(0)**2 +1./dx(1)**2 +1./dx(2)**2 ) )
                            rePart= crr*(mukt/u(i1,i2,i3,rc))*( 1./dx(
...
c ...............................................
     ...
     & 1)*dr(2))) )
                          imPart = cr*( abs(a1)/dr(0)+abs(a2)/dr(1)+
     & abs(a3)/dr(2) ) +sqrt( cSq*( rx(i1,i2,i3)**2 *(1./(dr(0)**2))  
     &                +sy(i1,i2,i3)**2 *(1./(dr(1)**2))               
     &   +tz(i1,i2,i3)**2 *(1./(dr(2)**2)) ) )
                        if( av2.ne.0. .or. av4.ne.0. )then
                          ...
                          do axis=0,nd-1
                            ...
                            is(2)=0
                            is(axis)=1
                              aj = (rx(i1,i2,i3)*sy(i1,i2,i3)-sx(i1,i2,
     & i3)*ry(i1,i2,i3) )*tz(i1,i2,i3)+(sx(i1,i2,i3)*ty(i1,i2,i3)-tx(
     & i1,i2,i3)*sy(i1,i2,i3) )*rz(i1,i2,i3)+(tx(i1,i2,i3)*ry(i1,i2,
     & i3)-rx(i1,i2,i3)*ty(i1,i2,i3) )*sz(i1,i2,i3)
                              aj = 1./max(ajEps,abs(aj))
                              a1= rsxy(i1,i2,i3,axis,0)*aj
                              a2= rsxy(i1,i2,i3,axis,1)*aj
     ...
     &   +tz(i1,i2,i3)**2 *(1./(dr(2)**2)) ) )
                          if( av2.ne.0. .or. av4.ne.0. )then
                            ...
                            do axis=0,nd-1
                              ...
                              is(2)=0
                              is(axis)=1
                                aj = (rx(i1,i2,i3)*sy(i1,i2,i3)-sx(i1,
     & i2,i3)*ry(i1,i2,i3) )*tz(i1,i2,i3)+(sx(i1,i2,i3)*ty(i1,i2,i3)-
     & tx(i1,i2,i3)*sy(i1,i2,i3) )*rz(i1,i2,i3)+(tx(i1,i2,i3)*ry(i1,
     & i2,i3)-rx(i1,i2,i3)*ty(i1,i2,i3) )*sz(i1,i2,i3)
                                aj = 1./max(ajEps,abs(aj))
                                a1= rsxy(i1,i2,i3,axis,0)*aj
                                a2= rsxy(i1,i2,i3,axis,1)*aj
                                a3= rsxy(i1,i2,i3,axis,2)*aj
...
c ...............................................
     ...
     &    ! u.yy
                           ...
                           if( av2.ne.0. .or. av4.ne.0. )then
                             ...
                             do axis=0,nd-1
                               ...
                               is(2)=0
                               is(axis)=1
                               cc = sqrt( gamma*(p(i1,i2,i3)/u(i1,i2,
     & i3,rc)) )   ! speed of sound
                               alam= ( abs(u(i1,i2,i3,uc+axis))+cc )
     & /dx(axis)
                               wmax= max(dp(i1-is(0),i2-is(1),i3-is(2),
     & axis),max(dp(i1,i2,i3,axis),dp(i1+is(0),i2+is(1),i3+is(2),axis)
     & ))
     ...
     & sqrt( imPart**2 + rePart**2 ) )
                           else
                             dtVar(i1,i2,i3)=1./sqrt( imPart**2 + 
...
c ...............................................
     ...
     & abs(                           ry(i1,i2,i3)*sy(i1,i2,i3) )*( 
     & cr/(dr(0)*dr(1))) +(                            sy(i1,i2,i3)**
     & 2          )*(crr/(dr(1)*dr(1))) )
                               end if
                             imPart=cr*(abs(a1)/dr(0)+abs(a2)/dr(1)) +
     & sqrt( cSq*( rx(i1,i2,i3)**2 *(1./(dr(0)**2))                 +
