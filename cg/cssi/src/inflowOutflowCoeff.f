! This file automatically generated from inflowOutflowCoeff.bf with bpp.
                  ...
                  do m3=-hwidth3,hwidth3
                     do m2=-hwidth, hwidth
                        do m1=-hwidth, hwidth
                           do c=0,ncmp-1
                              do e=rc,tc
                                coeff(icf(m1,m2,m3,e,c),i1g,i2g,i3g)
     & =0d0
                              end do
c     do e=uc,tc !max(vc,wc)
                              ...
                              if ( port.gt.0d0 ) then
                                coeff(icf(m1,m2,m3,tc,c),i1,i2,i3) = 
     & 0d0
                              endif
                           end do
                        end do
                     ...
                     do m3=-hwidth3,hwidth3
                        do m2=-hwidth, hwidth
                           do m1=-hwidth, hwidth
                            ...
                            coeff_u = coeff(icf(m1,m2,m3,uc,c),i1,i2,
     & i3)
                            coeff_v = coeff(icf(m1,m2,m3,vc,c),i1,i2,
     & i3)
...
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0) * u(rc)* u(uc) at the grid point offset by is1, is2, is3
                           coeff(icf((is1),(is2),(is3),eqn,rc),i1,i2,
     & i3) = coeff(icf((is1),(is2),(is3),eqn,rc),i1,i2,i3) + (rr*2d0*
     & aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0))*u(i1+(is1)+off(1),i2+
     & (is2)+off(2),i3+(is3)+off(3),uc)
                           coeff(icf((is1),(is2),(is3),eqn,uc),i1,i2,
     & i3) = coeff(icf((is1),(is2),(is3),eqn,uc),i1,i2,i3) + (rr*2d0*
     & aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0))*u(i1+(is1)+off(1),i2+
     & (is2)+off(2),i3+(is3)+off(3),rc)
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1) * u(rc)* u(vc) at the grid point offset by is1, is2, is3
                           coeff(icf((is1),(is2),(is3),eqn,rc),i1,i2,
     & i3) = coeff(icf((is1),(is2),(is3),eqn,rc),i1,i2,i3) + (rr*2d0*
     & aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1))*u(i1+(is1)+off(1),i2+
     & (is2)+off(2),i3+(is3)+off(3),vc)
                           coeff(icf((is1),(is2),(is3),eqn,vc),i1,i2,
     & i3) = coeff(icf((is1),(is2),(is3),eqn,vc),i1,i2,i3) + (rr*2d0*
     & aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1))*u(i1+(is1)+off(1),i2+
     & (is2)+off(2),i3+(is3)+off(3),rc)
                  endif
...
c     G_ghost - G_interior = 0 (symmetry, G is the tangential mass flux)
                  eqn = teq
                  a = mod(axis+1,ndim)
c      linearize terms like aj(i1g,i2g,i3g)*rsxy(i1g,i2g,i3g,a,0) * u(rc)* u(uc) at the grid point offset by 0, 0, 0
                        coeff(icf((0),(0),(0),eqn,rc),i1,i2,i3) = 
     & coeff(icf((0),(0),(0),eqn,rc),i1,i2,i3) + (aj(i1g,i2g,i3g)*
     & rsxy(i1g,i2g,i3g,a,0))*u(i1+(0)+off(1),i2+(0)+off(2),i3+(0)+
     & off(3),uc)
                        coeff(icf((0),(0),(0),eqn,uc),i1,i2,i3) = 
     & coeff(icf((0),(0),(0),eqn,uc),i1,i2,i3) + (aj(i1g,i2g,i3g)*
     & rsxy(i1g,i2g,i3g,a,0))*u(i1+(0)+off(1),i2+(0)+off(2),i3+(0)+
     & off(3),rc)
c      linearize terms like aj(i1g,i2g,i3g)*rsxy(i1g,i2g,i3g,a,1) * u(rc)* u(vc) at the grid point offset by 0, 0, 0
                        coeff(icf((0),(0),(0),eqn,rc),i1,i2,i3) = 
     & coeff(icf((0),(0),(0),eqn,rc),i1,i2,i3) + (aj(i1g,i2g,i3g)*
     & rsxy(i1g,i2g,i3g,a,1))*u(i1+(0)+off(1),i2+(0)+off(2),i3+(0)+
     & off(3),vc)
                        coeff(icf((0),(0),(0),eqn,vc),i1,i2,i3) = 
     & coeff(icf((0),(0),(0),eqn,vc),i1,i2,i3) + (aj(i1g,i2g,i3g)*
     & rsxy(i1g,i2g,i3g,a,1))*u(i1+(0)+off(1),i2+(0)+off(2),i3+(0)+
     & off(3),rc)
c      linearize terms like -aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,0) * u(rc)* u(uc) at the grid point offset by 2*is1, 2*is2, 2*is3
                        coeff(icf((2*is1),(2*is2),(2*is3),eqn,rc),i1,
     & i2,i3) = coeff(icf((2*is1),(2*is2),(2*is3),eqn,rc),i1,i2,i3) + 
     & (-aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,0))*u(i1+(2*is1)+off(1),
     & i2+(2*is2)+off(2),i3+(2*is3)+off(3),uc)
                        coeff(icf((2*is1),(2*is2),(2*is3),eqn,uc),i1,
     & i2,i3) = coeff(icf((2*is1),(2*is2),(2*is3),eqn,uc),i1,i2,i3) + 
     & (-aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,0))*u(i1+(2*is1)+off(1),
     & i2+(2*is2)+off(2),i3+(2*is3)+off(3),rc)
c      linearize terms like -aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,1) * u(rc)* u(vc) at the grid point offset by 2*is1, 2*is2, 2*is3
                        coeff(icf((2*is1),(2*is2),(2*is3),eqn,rc),i1,
     & i2,i3) = coeff(icf((2*is1),(2*is2),(2*is3),eqn,rc),i1,i2,i3) + 
     & (-aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,1))*u(i1+(2*is1)+off(1),
     & i2+(2*is2)+off(2),i3+(2*is3)+off(3),vc)
                        coeff(icf((2*is1),(2*is2),(2*is3),eqn,vc),i1,
     & i2,i3) = coeff(icf((2*is1),(2*is2),(2*is3),eqn,vc),i1,i2,i3) + 
     & (-aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,1))*u(i1+(2*is1)+off(1),
     & i2+(2*is2)+off(2),i3+(2*is3)+off(3),rc)
...
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0) * u(rc)* u(uc) at the grid point offset by is1, is2, is3
     ...
     & 2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0))*u(i1+(is1)+off(1)
     & ,i2+(is2)+off(2),i3+(is3)+off(3),rc)*u(i1+(is1)+off(1),i2+(is2)
     & +off(2),i3+(is3)+off(3),uc)
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1) * u(rc)* u(vc) at the grid point offset by is1, is2, is3
                           rhs(i1,i2,i3,eqn) = rhs(i1,i2,i3,eqn) + (rr*
     & 2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1))*u(i1+(is1)+off(1)
     & ,i2+(is2)+off(2),i3+(is3)+off(3),rc)*u(i1+(is1)+off(1),i2+(is2)
...
c      G_ghost - G_interior = 0 (symmetry, G is the tangential mass flux)
                  ...
                  rhs(i1g,i2g,i3g,eqn) = 0d0
c      linearize terms like aj(i1g,i2g,i3g)*rsxy(i1g,i2g,i3g,a,0) * u(rc)* u(uc) at the grid point offset by 0, 0, 0
                        rhs(i1,i2,i3,eqn) = rhs(i1,i2,i3,eqn) + (aj(
     & i1g,i2g,i3g)*rsxy(i1g,i2g,i3g,a,0))*u(i1+(0)+off(1),i2+(0)+off(
     & 2),i3+(0)+off(3),rc)*u(i1+(0)+off(1),i2+(0)+off(2),i3+(0)+off(
     & 3),uc)
c      linearize terms like aj(i1g,i2g,i3g)*rsxy(i1g,i2g,i3g,a,1) * u(rc)* u(vc) at the grid point offset by 0, 0, 0
                        rhs(i1,i2,i3,eqn) = rhs(i1,i2,i3,eqn) + (aj(
     & i1g,i2g,i3g)*rsxy(i1g,i2g,i3g,a,1))*u(i1+(0)+off(1),i2+(0)+off(
     & 2),i3+(0)+off(3),rc)*u(i1+(0)+off(1),i2+(0)+off(2),i3+(0)+off(
     & 3),vc)
c      linearize terms like -aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,0) * u(rc)* u(uc) at the grid point offset by 2*is1, 2*is2, 2*is3
                        rhs(i1,i2,i3,eqn) = rhs(i1,i2,i3,eqn) + (-aj(
     & i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,0))*u(i1+(2*is1)+off(1),i2+(2*
     & is2)+off(2),i3+(2*is3)+off(3),rc)*u(i1+(2*is1)+off(1),i2+(2*
     & is2)+off(2),i3+(2*is3)+off(3),uc)
c      linearize terms like -aj(i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,1) * u(rc)* u(vc) at the grid point offset by 2*is1, 2*is2, 2*is3
                        rhs(i1,i2,i3,eqn) = rhs(i1,i2,i3,eqn) + (-aj(
     & i1i,i2i,i3i)*rsxy(i1i,i2i,i3i,a,1))*u(i1+(2*is1)+off(1),i2+(2*
     & is2)+off(2),i3+(2*is3)+off(3),rc)*u(i1+(2*is1)+off(1),i2+(2*
     & is2)+off(2),i3+(2*is3)+off(3),vc)
c                UVCF(0,0,0,norm(1),rc,uc,RHS)
c                UVCF(0,0,0,norm(2),rc,vc,RHS)
...
c                         end do
     ...
     & i3)
                               ...
                               coeff(icf(m1,m2,m3,neq,c),i1,i2,i3) = 
     & 0d0
...
c                  endif
     ...
     &                    tang(1)*u(i1,i2,i3,uc)+tang(2)*u(i1,i2,i3,vc)
                     ...
                     do e=tc,tc
                        ...
                        coeff(icf(2*is1,2*is2,2*is3,e,e),i1g,i2g,i3g)=-
     & 1
                        endif
                     end do
...
c                rr = 2d0*side-1d0
                        rr = 1d0
                        if ( isaxi.gt.0 ) rr = rr*x(i1l,i2l,i3l,
     & radaxis)
c                        UVCF(is1,is2,is3,rr*2d0*norm(1),rc,uc,COEFF)
c                        UVCF(is1,is2,is3,rr*2d0*norm(2),rc,vc,COEFF)
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0) * u(rc)* u(uc) at the grid point offset by is1, is2, is3
                              coeff(icf((is1),(is2),(is3),eqn,rc),i1,
     & i2,i3) = coeff(icf((is1),(is2),(is3),eqn,rc),i1,i2,i3) + (rr*
     & 2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0))*u(i1+(is1)+off(1)
     & ,i2+(is2)+off(2),i3+(is3)+off(3),uc)
                              coeff(icf((is1),(is2),(is3),eqn,uc),i1,
     & i2,i3) = coeff(icf((is1),(is2),(is3),eqn,uc),i1,i2,i3) + (rr*
     & 2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0))*u(i1+(is1)+off(1)
     & ,i2+(is2)+off(2),i3+(is3)+off(3),rc)
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1) * u(rc)* u(vc) at the grid point offset by is1, is2, is3
                              coeff(icf((is1),(is2),(is3),eqn,rc),i1,
     & i2,i3) = coeff(icf((is1),(is2),(is3),eqn,rc),i1,i2,i3) + (rr*
     & 2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1))*u(i1+(is1)+off(1)
     & ,i2+(is2)+off(2),i3+(is3)+off(3),vc)
                              coeff(icf((is1),(is2),(is3),eqn,vc),i1,
     & i2,i3) = coeff(icf((is1),(is2),(is3),eqn,vc),i1,i2,i3) + (rr*
     & 2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1))*u(i1+(is1)+off(1)
     & ,i2+(is2)+off(2),i3+(is3)+off(3),rc)
                     endif
...
c                     print *,port,pdotn,prhs
     ...
     & =0d0
                                 ...
                                 do e=rc,rc
                                   coeff(icf(m1,m2,m3,e,c),i1,i2,i3)
     & =0d0
                                 end do
                              end do
                           end do
...
c                  endif
     ...
     &                    tang(2)
                  ...
                  coeff(icf(0,0,0,eqn,rc),i1,i2,i3)= port*u(i1,i2,i3,
     & tc)
                  coeff(icf(0,0,0,eqn,tc),i1,i2,i3)= port*u(i1,i2,i3,
     & rc)

c     coefficients for a  difference approximation to pdotn*u(i1l,i2l,i3l,tc)*norm(1) * u[rc]_X
c     r-part
                        coeff(icf(+1,0,0,eqn,rc),i1,i2,i3) = coeff(icf(
     & +1,0,0,eqn,rc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,tc)*norm(1))*
     & rx(i1+off(1),i2+off(2),i3+off(3),1,1)*dri2(1)
                        coeff(icf(-1,0,0,eqn,rc),i1,i2,i3) = coeff(icf(
     & -1,0,0,eqn,rc),i1,i2,i3) - (pdotn*u(i1l,i2l,i3l,tc)*norm(1))*
     & rx(i1+off(1),i2+off(2),i3+off(3),1,1)*dri2(1)
c     s-part
                        coeff(icf(0,+1,0,eqn,rc),i1,i2,i3) = coeff(icf(
     & 0,+1,0,eqn,rc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,tc)*norm(1))*
     & rx(i1+off(1),i2+off(2),i3+off(3),2,1)*dri2(2)
                        coeff(icf(0,-1,0,eqn,rc),i1,i2,i3) = coeff(icf(
     & 0,-1,0,eqn,rc),i1,i2,i3) - (pdotn*u(i1l,i2l,i3l,tc)*norm(1))*
     & rx(i1+off(1),i2+off(2),i3+off(3),2,1)*dri2(2)
c     coefficients for a  difference approximation to pdotn*u(i1l,i2l,i3l,tc)*norm(2) * u[rc]_X
c     r-part
                        coeff(icf(+1,0,0,eqn,rc),i1,i2,i3) = coeff(icf(
     & +1,0,0,eqn,rc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,tc)*norm(2))*
...
c     s-part
                        coeff(icf(0,+1,0,eqn,rc),i1,i2,i3) = coeff(icf(
     & 0,+1,0,eqn,rc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,tc)*norm(2))*
...
c     coefficients for a  difference approximation to pdotn*u(i1l,i2l,i3l,rc)*norm(1) * u[tc]_X
c     r-part
                           coeff(icf(+1,0,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(+1,0,0,eqn,tc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,rc)*norm(1)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),1,1)*dri2(1)
                           coeff(icf(-1,0,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(-1,0,0,eqn,tc),i1,i2,i3) - (pdotn*u(i1l,i2l,i3l,rc)*norm(1)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),1,1)*dri2(1)
c     s-part
                           coeff(icf(0,+1,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(0,+1,0,eqn,tc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,rc)*norm(1)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),2,1)*dri2(2)
                           coeff(icf(0,-1,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(0,-1,0,eqn,tc),i1,i2,i3) - (pdotn*u(i1l,i2l,i3l,rc)*norm(1)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),2,1)*dri2(2)
c     coefficients for a  difference approximation to pdotn*u(i1l,i2l,i3l,rc)*norm(2) * u[tc]_X
c     r-part
                           coeff(icf(+1,0,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(+1,0,0,eqn,tc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,rc)*norm(2)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),1,2)*dri2(1)
                           coeff(icf(-1,0,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(-1,0,0,eqn,tc),i1,i2,i3) - (pdotn*u(i1l,i2l,i3l,rc)*norm(2)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),1,2)*dri2(1)
c     s-part
                           coeff(icf(0,+1,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(0,+1,0,eqn,tc),i1,i2,i3) + (pdotn*u(i1l,i2l,i3l,rc)*norm(2)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),2,2)*dri2(2)
                           coeff(icf(0,-1,0,eqn,tc),i1,i2,i3) = coeff(
     & icf(0,-1,0,eqn,tc),i1,i2,i3) - (pdotn*u(i1l,i2l,i3l,rc)*norm(2)
     & )*rx(i1+off(1),i2+off(2),i3+off(3),2,2)*dri2(2)
...
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0) * u(rc)* u(uc) at the grid point offset by is1, is2, is3
     ...
     & rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,0))*u(i1+(is1)+
     & off(1),i2+(is2)+off(2),i3+(is3)+off(3),rc)*u(i1+(is1)+off(1),
     & i2+(is2)+off(2),i3+(is3)+off(3),uc)
c      linearize terms like rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1) * u(rc)* u(vc) at the grid point offset by is1, is2, is3
                              rhs(i1,i2,i3,eqn) = rhs(i1,i2,i3,eqn) + (
     & rr*2d0*aj(i1l,i2l,i3l)*rsxy(i1l,i2l,i3l,axis,1))*u(i1+(is1)+
     & off(1),i2+(is2)+off(2),i3+(is3)+off(3),rc)*u(i1+(is1)+off(1),
     & i2+(is2)+off(2),i3+(is3)+off(3),vc)
c                        UVCF(is1,is2,is3,rr*2d0*norm(1),rc,uc,RHS)
c                        UVCF(is1,is2,is3,rr*2d0*norm(2),rc,vc,RHS)
...
c            endif
            ...
            else if(bc(side,axis).eq.subsonicoutflow .and. .false. )
     & then
c               print *,"outflow ",i1,rho,uvel,scale
