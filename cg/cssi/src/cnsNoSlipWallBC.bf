...
c     LOCAL
      ...
      integer i,j
      real alpha,aa(0:2,0:2),jdet,jdetg,rtmp,aainv(0:2,0:2),den,rhs(0:2)
      real rr
...
c                  UXC(d, (u(i1,i2,i3,cc)), eqn)
                        UXC(d,-u(i1l,i2l,i3l,rc)*u(i1l,i2l,i3l,cc)*norm(1),uc)
                        UXC(d,-u(i1l,i2l,i3l,rc)*u(i1l,i2l,i3l,cc)*norm(2),vc)
...
c              u-momentum part
                     UXYC(1,1,(f43*oren*norm(1)),uc)
                     UXYC(2,2,(oren*norm(1)),uc)
                     UXYC(1,2,(f13*oren*norm(1)),vc)
                     if ( isaxi.gt.0 .and. x(i1,i2,i3,1).gt.0d0 ) then
                        UXC(2,(oren/x(i1l,i2l,i3l,1)*norm(1)),uc)
                        UXC(1,(f13*oren/x(i1l,i2l,i3l,1)*norm(1)),vc)
                     endif
                  
c              v-momentum part
                     UXYC(2,2,(f43*oren*norm(2)),vc)
                     UXYC(1,1,(oren*norm(2)),vc)
                     UXYC(2,1,(f13*oren*norm(2)),uc)
                     if ( isaxi.gt.0 .and. x(i1,i2,i3,1).gt.0d0 ) then
                        UXC(2,(f43*oren*norm(2)/x(i1l,i2l,i3l,1)),vc)
...
c                  UUXC(2,-gm2*norm(2),rc,tc)
                UXC(1,-gm2*u(i1l,i2l,i3l,tc)*norm(1),rc)
                UXC(2,-gm2*u(i1l,i2l,i3l,tc)*norm(2),rc)
                coeff(icf(0,0,0,eqn,tc),i1,i2,i3) =
     &              coeff(icf(0,0,0,eqn,tc),i1,i2,i3) -
     &               gm2*norm(1)*ux(i1l,i2l,i3l,rc,1) -
     &               gm2*norm(2)*ux(i1l,i2l,i3l,rc,2) 
                UXC(1,-gm2*u(i1l,i2l,i3l,rc)*norm(1),tc)
                UXC(2,-gm2*u(i1l,i2l,i3l,rc)*norm(2),tc)
                coeff(icf(0,0,0,eqn,rc),i1,i2,i3) =
     &              coeff(icf(0,0,0,eqn,rc),i1,i2,i3) -
