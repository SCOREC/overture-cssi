...
# Examples:
#
#      ogen noplot beam_in_channel_dynamic_with_beam_grid -interp=e -factor=2
...
#      ogen noplot beam_in_channel_dynamic_with_beam_grid -interp=e -factor=16 -beamThickness=0.001
#
#
$factor=1; $name="";
...
if( $name eq "" ){$name = "beam_in_channel_dynamic_with_beam_grid" . "$interp$factor" . ".hdf";}
create mappings 
  rectangle 
...
$name
beam_in_channel_dynamic_with_beam_grid
exit
