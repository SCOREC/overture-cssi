...
#
#
# usage: ogen [noplot] plateWithHolesGrid -numberOfHoles=<val> -factor=<num> -order=[2/4/6/8] -interp=[e/i]
# 
# examples:
#  ogen -noplot plateWithHolesGrid -numHoles1=2  -factor=2 
#  ogen -noplot plateWithHolesGrid -numHoles1=12 -factor=2 
#  ogen -noplot plateWithHolesGrid -numHoles1=12 -numHoles2=6 -interp=e -factor=2 
#  ogen -noplot plateWithHolesGrid -numHoles1=12 -factor=4 
# 
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -R3=2.25 -R4=.4 -theta2=15. -numHoles2=12 -factor=2
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -R3=2.25 -R4=.4 -theta2=15. -numHoles2=12 -factor=4
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -R3=2.25 -R4=.4 -theta2=15. -numHoles2=12 -factor=8
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -R3=2.25 -R4=.4 -theta2=15. -numHoles2=12 -factor=32
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -R3=2.25 -R4=.4 -theta2=15. -numHoles2=12 -factor=16
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -factor=8
#  ogen -noplot plateWithHolesGrid -interp=e -R1=3.4 -R2=.3 -numHoles1=24 -factor=16
#
...
# 
$suffix = ".order$order"; 
if( $name eq "" ){$name = "plateWith$numHoles1" . "HolesGrid" . "$interp$factor" . $suffix . ".hdf";}
# 
$ds=.1/$factor;
$pi=4.*atan2(1.,1.);
# 
