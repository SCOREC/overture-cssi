                                                          ...
                                                          realMappedGridFunction & uOld, int current )
{
  ...
  // printF("\n >>>>> assignBC-FOS: extrapolateInterpolationNeighbours=%d, useNewExtrapInterpNeighbours=%d\n",
  //       parameters.dbase.get<int >("extrapolateInterpolationNeighbours"),parameters.dbase.get<int>("useNewExtrapInterpNeighbours") );
