! This file automatically generated from pressureIsmOpt.bf90 with bpp.
      subroutine pressureIsm3dOrder2r( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,rsxy,xy,um,u,un,f,gridIndexRange,dimRange,isPeriodic,boundaryCondition,ipar,rpar,ierr )
     !======================================================================
...
! define interfaceType values for fortran routines
     ...
     !...........end   statement functions
      ! write(*,*) 'Inside pressureIsm3dOrder2r...'
      ...
      ! c2dtsq=c2*dtsq
      if( t<=2*dt )then
        write(*,'("## pressureIsm3dOrder2r: dt=",1pe12.4," u1c,u2c,u3c,pc=",4i3," t=",1pe12.3)') dt,u1c,u2c,u3c,pc,t
      ...
      if( dt>0. )then
        ...
        write(*,'("### pressureIsm3dOrder2r : ERROR: dt=",1pe12.4," is not greater than zero!")') dt
        stop 6666
      end if
       ...
       ! -- evaluate the divergence damping ---
         ...
         if( mask(i1,i2,i3).gt.0 )then
           f(i1,i2,i3)=cdvOverDtSq*(unx23r(i1,i2,i3,u1c)-ux23r(i1,i2,i3,u1c)+uny23r(i1,i2,i3,u2c)-uy23r(i1,i2,i3,u2c)+unz23r(i1,i2,i3,u3c)-uz23r(i1,i2,i3,u3c))
         end if
         end do
         end do
         end do
        ...
        do side=0,1
         ...
         if( boundaryCondition(side,axis) == dirichletBoundaryCondition )then
           ...
           !      vy = 0 
               ...
               if( mask(i1,i2,i3).ne.0 )then
                 if( axis==0 )then
                   f(i1,i2,i3) = 2.*mu*unx23r(i1,i2,i3,u1c)
                 else if( axis==1 )then
                   f(i1,i2,i3) = 2.*mu*uny23r(i1,i2,i3,u2c)
                 else
                     f(i1,i2,i3) = 2.*mu*unz23r(i1,i2,i3,u3c)
                 end if 
                 if( twilightZone.eq.1 )then
                     ! ----- 3D ----
                     call ogDeriv(ep,0,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,pc,pe)
               ...
               if( gridType.eq.rectangular )then
                 if( axis==0 ) then
                   ...
                   if( useCurlCurlBoundaryCondition.eq.1 )then
                       f(j1,j2,j3) =   is*mu*( unxy23r(i1,i2,i3,u2c) + unxz23r(i1,i2,i3,u3c) )
                   else
                     f(j1,j2,j3) =  -is*mu*unxx23r(i1,i2,i3,u1c)
                   end if
                   ! write(*,'("pressure BC: i1,i2=",2i3," is=",i2," vxy =",1pe12.4," uxx=",1pe12.4)') i1,i2,is,unxy22r(i1,i2,i3,u2c),unxx22r(i1,i2,i3,u1c)
                 else if( axis==1 )then
                   if( useCurlCurlBoundaryCondition.eq.1 )then
                       f(j1,j2,j3) =   is*mu*( unxy23r(i1,i2,i3,u1c) + unyz23r(i1,i2,i3,u3c) )
                   else
                     f(j1,j2,j3) =  -is*mu*unyy23r(i1,i2,i3,u2c)
                   end if
                 else
                    ! axis == 2 
                     if( useCurlCurlBoundaryCondition.eq.1 )then
                       f(j1,j2,j3) =   is*mu*( unxz23r(i1,i2,i3,u1c) + unyz23r(i1,i2,i3,u2c) )
                     else
                       f(j1,j2,j3) =  -is*mu*unzz23r(i1,i2,i3,u3c)
                     end if
                 end if
                 ...
                 if( useCurlCurlBoundaryCondition.eq.1 )then
                   ! Use curl-curl form of the BC:  NOTE: USE un
                     f(j1,j2,j3) = mu*( an1*(                       unyy23r(i1,i2,i3,u1c) + unzz23r(i1,i2,i3,u1c) - unxy23r(i1,i2,i3,u2c) - unxz23r(i1,i2,i3,u3c) ) + an2*(  unxx23r(i1,i2,i3,u2c)                      + unzz23r(i1,i2,i3,u2c) - unxy23r(i1,i2,i3,u1c) - unyz23r(i1,i2,i3,u3c) ) + an3*(  unxx23r(i1,i2,i3,u3c) + unyy23r(i1,i2,i3,u3c)                      - unxz23r(i1,i2,i3,u1c) - unyz23r(i1,i2,i3,u2c) )  )
                 else
                   !  p.n = n.( mu Delta( uv ) )
                     f(j1,j2,j3) = mu*( an1*( unxx23r(i1,i2,i3,u1c) + unyy23r(i1,i2,i3,u1c) + unzz23r(i1,i2,i3,u1c) ) + an2*( unxx23r(i1,i2,i3,u2c) + unyy23r(i1,i2,i3,u2c) + unzz23r(i1,i2,i3,u2c) ) + an3*( unxx23r(i1,i2,i3,u3c) + unyy23r(i1,i2,i3,u3c) + unzz23r(i1,i2,i3,u3c) ) )
                 end if
           ...
           write(*,'("pressureIsm3dOrder2r:fill RHS for pressure equation, unexpected boundaryCondition=",i4)') boundaryCondition(side,axis)
             stop 6666
         end if
        end do ! end side
        end do ! end axis
