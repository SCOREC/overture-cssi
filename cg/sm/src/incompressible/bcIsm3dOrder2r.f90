! This file automatically generated from bcOptIsm.bf90 with bpp.
        subroutine bcIsm3dOrder2r( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange,u,mask,rsxy,xy,ndMatProp,matIndex,matValpc,matVal,boundaryCondition,addBoundaryForcing,interfaceType,dim,bcf00,bcf10,bcf01,bcf11,bcf02,bcf12,bcf0,bcOffset,ipar,rpar,ierr )
       ! ===================================================================================
                        ...
                        ! w.x = -u.z    
                          ...
                          do ghost=1,numGhost
                            ...
                            !  u(-2)  = u(2) + (2 * 2*dx) ( ... )  
                              ...
                              u(i1-js1,i2-js2,i3-js3,u2c)=u(i1+js1,i2+js2,i3+js3,u2c) +js1*dx(0)*2.*( uy23r(i1,i2,i3,u1c) )
                              u(i1-js1,i2-js2,i3-js3,u3c)=u(i1+js1,i2+js2,i3+js3,u3c) +js1*dx(0)*2.*( uz23r(i1,i2,i3,u1c) )
                          end do
                      elseif( axis==1 )then 
                        ! u.y = - v.x  
                        ! v.y = - u.x - w.z 
                        ...
                        ! w.x = -u.z    
                          ...
                          do ghost=1,numGhost
                            js1 = ghost*is1; js2 = ghost*is2; j3 = ghost*is3;
                              ...
                              u(i1-js1,i2-js2,i3-js3,u3c)=u(i1+js1,i2+js2,i3+js3,u3c) +dx(0)*2.*( js1*uz23r(i1,i2,i3,u1c)             + (1./mu)*bcf(side,axis,i1,i2,i3,u3c) )              
                          end do
                      elseif( axis==1 )then 
                        ! u.y = - v.x  
                        ! v.y = - u.x - w.z 
                        ! w.y = - v.z 
                          ...
                          do ghost=1,numGhost
                            js1 = ghost*is1; js2 = ghost*is2; j3 = ghost*is3;
                              ...
                              u(i1-js1,i2-js2,i3,u3c)=u(i1+js1,i2+js2,i3,u3c) + dx(1)*2.*( js2*uz23r(i1,i2,i3,u2c)  +             (1./mu)*bcf(side,axis,i1,i2,i3,u3c))                
                          end do
                      else 
                        ! axis==2 
                        ! u.z = - w.x  
                        ...
                        ! w.z = - ( u.x + v.y )
                            ...
                            do ghost=1,numGhost
                              ...
                              u(i1-js1,i2-js2,i3-js3,u3c)=u(i1+js1,i2+js2,i3+js3,u3c) + dx(2)*2.*( js3*( ux23r(i1,i2,i3,u1c) + uy23r(i1,i2,i3,u2c) )   + bcf(side,axis,i1,i2,i3,u3c) )                
                            end do
                      end if  
                 end do
                 end do
                        ...
                        ! w.x = -u.z    
                          ...
                          do ghost=1,numGhost
                            js1 = ghost*is1; js2 = ghost*is2; j3 = ghost*is3;
                              ...
                              u(i1-js1,i2-js2,i3-js3,u3c)=u(i1+js1,i2+js2,i3+js3,u3c) + js1*dx(0)*2.*( uz23r(i1,i2,i3,u1c) - ( wx0 + uz0 ) ) 
                      ...
                      elseif( axis==1 )then 
                        ...
                        ! w.y = - v.z 
                          ...
                          do ghost=1,numGhost
                            js1 = ghost*is1; js2 = ghost*is2; j3 = ghost*is3;
                              ...
                              u(i1-js1,i2-js2,i3,u3c)=u(i1+js1,i2+js2,i3,u3c) +js2*dx(1)*2.*( uz23r(i1,i2,i3,u2c) - ( wy0 + vz0 ) )  
                        ...
                        ! w.z = - ( u.x + v.y )
                            ...
                            do ghost=1,numGhost
                              ...
                              js3 = ghost*is3                
                              ! *check me* added Sept 15, 2021                       
                              u(i1-js1,i2-js2,i3-js3,u1c)=u(i1+js1,i2+js2,i3+js3,u1c) +js3*dx(2)*2.*( ux23r(i1,i2,i3,u3c) - ( uz0 + wx0 ) )
                              u(i1-js1,i2-js2,i3-js3,u2c)=u(i1+js1,i2+js2,i3+js3,u2c) +js3*dx(2)*2.*( uy23r(i1,i2,i3,u3c) - ( vz0 + wy0 ) )               
                              u(i1-js1,i2-js2,i3-js3,u3c)=u(i1+js1,i2+js2,i3+js3,u3c) +js3*dx(2)*2.*( (ux23r(i1,i2,i3,u1c) + uy23r(i1,i2,i3,u2c)) - ( ux0 + vy0 + wz0 ) )                
                            end do 
                      end if  
                 end do
                 end do
