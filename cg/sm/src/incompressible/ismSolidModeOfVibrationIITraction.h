...
#beginMacro evalSolidMode2Traction(r,theta,phi, u1,u2,u3,p)
  ...
  { // r, phi and phip=Pi=phi are big
    u1 = -0.10e2 / 0.3e1 * (cos(theta) * (((double) (-6 * r * r * k * k + 15) * pow(cos(phi), 0.2e1) + (double) (3 * r * r * k * k) - 0.9e1) * sin((double) (k * r)) + (double) k * ((0.9e1 + (double) (r * r * k * k - 15) * pow(cos(phi), 0.2e1)) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * cos(0.2e1 * theta) + ((double) (-3 * r * r * k * k + 6) * sin((double) (k * r)) + (double) k * ((double) (r * r * k * k - 6) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * sin(theta) * sin(0.2e1 * theta)) * (cos(phi) + 0.1e1) * Lp * (cos(phi) - 0.1e1) * pow(sin(phi), -0.3e1) * (double)   pow((double) k, (double) (-5)) * (double)   pow((double) r, (double) (-4));
    u2 = -0.10e2 / 0.3e1 * ((((double) (-6 * r * r * k * k + 15) * pow(cos(phi), 0.2e1) + (double) (3 * r * r * k * k) - 0.9e1) * sin((double) (k * r)) + (double) k * ((0.9e1 + (double) (r * r * k * k - 15) * pow(cos(phi), 0.2e1)) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * sin(theta) * cos(0.2e1 * theta) - cos(theta) * ((double) (-3 * r * r * k * k + 6) * sin((double) (k * r)) + (double) k * ((double) (r * r * k * k - 6) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * sin(0.2e1 * theta)) * (cos(phi) + 0.1e1) * Lp * (cos(phi) - 0.1e1) * pow(sin(phi), -0.3e1) * (double)   pow((double) k, (double) (-5)) * (double)   pow((double) r, (double) (-4));
  ...
  { // small phi or phip but not small r -- series error is O(phi^3)
    ...
    { 
    u1 = -0.10e2 * (cos(theta) * ((double) (-3 * r * r * k * k + 6) * sin((double) (k * r)) + (double) k * ((double) (r * r * k * k - 6) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * cos(0.2e1 * theta) + ((double) (-3 * r * r * k * k + 6) * sin((double) (k * r)) + (double) k * ((double) (r * r * k * k - 6) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * sin(theta) * sin(0.2e1 * theta)) * (double)   pow((double) k, (double) (-5)) * (double)   pow((double) r, (double) (-4)) * phi;
    u2 = -0.10e2 * (((double) (-3 * r * r * k * k + 6) * sin((double) (k * r)) + (double) k * ((double) (r * r * k * k - 6) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * sin(theta) * cos(0.2e1 * theta) - cos(theta) * ((double) (-3 * r * r * k * k + 6) * sin((double) (k * r)) + (double) k * ((double) (r * r * k * k - 6) * cos((double) (k * r)) - 0.3e1 / 0.5e1 * (double) (k * k) * (double)   pow((double) r, (double) 4) * (double) OmegaFact) * (double) r) * sin(0.2e1 * theta)) * (double)   pow((double) k, (double) (-5)) * (double)   pow((double) r, (double) (-4)) * phi;
    ...
    u2 = 0.2e1 * pow(k, -0.5e1) * pow(r, -0.4e1) * (-0.3e1 * pow(k, 0.3e1) * pow(r, 0.5e1) * OmegaFact + 0.5e1 * cos(k * r) * pow(k, 0.3e1) * pow(r, 0.3e1) - 0.15e2 * sin(k * r) * k * k * r * r - 0.30e2 * cos(k * r) * k * r + 0.30e2 * sin(k * r)) * (sin(theta) * cos(0.2e1 * theta) - cos(theta) * sin(0.2e1 * theta)) * phip;
  ...
  { // small r, big phi, big phip -- series error is O(r^3) 
    u1 = 0.2e1 * pow(k, -0.2e1) * cos(theta) * (k * k + (double) (3 * OmegaFact)) * pow(cos(phi) + 0.1e1, 0.2e1) * pow(cos(phi) - 0.1e1, 0.2e1) * pow(sin(phi), -0.3e1) * r;
    u2 = -0.2e1 * pow(k, -0.2e1) * (k * k + (double) (3 * OmegaFact)) * sin(theta) * pow(cos(phi) + 0.1e1, 0.2e1) * pow(cos(phi) - 0.1e1, 0.2e1) * pow(sin(phi), -0.3e1) * r;
    u3  = 0;
