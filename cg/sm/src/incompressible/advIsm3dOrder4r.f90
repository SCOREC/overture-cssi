! This file automatically generated from advOptIsm.bf90 with bpp.
        subroutine advIsm3dOrder4r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,rsxy,xy,um,u,un,f,vt,vn,v,v1,v2,v3,v4,vt1,vt2,vt3,vt4,gridIndexRange,boundaryCondition,ipar,rpar,ierr )
       !======================================================================
      ...
      parameter( tractionInterface=2,tractionAndHeatFluxInterface=3 )
        ...
        call ovtime( time0 )
          ...
          ! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
           ...
           !       **********************************************
               ! ******** 3D *************
         ! write(*,*) 'Inside advIsm: order=4 dim=3'
         if( option==0 )then
           ...
           if( correction==0 )then
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   un(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - dtSqByRho*ux43r(i1,i2,i3,pc) + cdtSq*( ulaplacian43r(i1,i2,i3,u1c) )
                   un(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - dtSqByRho*uy43r(i1,i2,i3,pc) + cdtSq*( ulaplacian43r(i1,i2,i3,u2c) )
                   un(i1,i2,i3,u3c) = 2.*u(i1,i2,i3,u3c) - um(i1,i2,i3,u3c) - dtSqByRho*uz43r(i1,i2,i3,pc) + cdtSq*( ulaplacian43r(i1,i2,i3,u3c) )
                       ! *** 3D ****
             ...
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   uTemp(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - (.5*dtSqByRho)*(unx43r(i1,i2,i3,pc) + umx43r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian43r(i1,i2,i3,u1c) + umlaplacian43r(i1,i2,i3,u1c) )
                   uTemp(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - (.5*dtSqByRho)*(uny43r(i1,i2,i3,pc) + umy43r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian43r(i1,i2,i3,u2c) + umlaplacian43r(i1,i2,i3,u2c) )
                   uTemp(i1,i2,i3,u3c) = 2.*u(i1,i2,i3,u3c) - um(i1,i2,i3,u3c) - (.5*dtSqByRho)*(unz43r(i1,i2,i3,pc) + umz43r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian43r(i1,i2,i3,u3c) + umlaplacian43r(i1,i2,i3,u3c) )
                       ! *** 3D ****
                       call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uett)
                       call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uexx)
                       call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,ueyy)
                  ...
                  ! --- -FOURTH 4 ---
                    ! --- THREE DIMENSIONS ---
                      if( mask(i1,i2,i3)>0 )then
                        uTemp(i1,i2,i3,u1c)=un(i1,i2,i3,u1c)+(+20.*v(i1,i2,i3,u1c)-15.*(v(i1+1,i2,i3,u1c)+v(i1-1,i2,i3,u1c))+6.*(v(i1+2,i2,i3,u1c)+v(i1-2,i2,i3,u1c))-(v(i1+3,i2,i3,u1c)+v(i1-3,i2,i3,u1c)))*adxSosup(0)+(+20.*v(i1,i2,i3,u1c)-15.*(v(i1,i2+1,i3,u1c)+v(i1,i2-1,i3,u1c))+6.*(v(i1,i2+2,i3,u1c)+v(i1,i2-2,i3,u1c))-(v(i1,i2+3,i3,u1c)+v(i1,i2-3,i3,u1c)))*adxSosup(1)+(+20.*v(i1,i2,i3,u1c)-15.*(v(i1,i2,i3+1,u1c)+v(i1,i2,i3-1,u1c))+6.*(v(i1,i2,i3+2,u1c)+v(i1,i2,i3-2,u1c))-(v(i1,i2,i3+3,u1c)+v(i1,i2,i3-3,u1c)))*adxSosup(2)
                        uTemp(i1,i2,i3,u2c)=un(i1,i2,i3,u2c)+(+20.*v(i1,i2,i3,u2c)-15.*(v(i1+1,i2,i3,u2c)+v(i1-1,i2,i3,u2c))+6.*(v(i1+2,i2,i3,u2c)+v(i1-2,i2,i3,u2c))-(v(i1+3,i2,i3,u2c)+v(i1-3,i2,i3,u2c)))*adxSosup(0)+(+20.*v(i1,i2,i3,u2c)-15.*(v(i1,i2+1,i3,u2c)+v(i1,i2-1,i3,u2c))+6.*(v(i1,i2+2,i3,u2c)+v(i1,i2-2,i3,u2c))-(v(i1,i2+3,i3,u2c)+v(i1,i2-3,i3,u2c)))*adxSosup(1)+(+20.*v(i1,i2,i3,u2c)-15.*(v(i1,i2,i3+1,u2c)+v(i1,i2,i3-1,u2c))+6.*(v(i1,i2,i3+2,u2c)+v(i1,i2,i3-2,u2c))-(v(i1,i2,i3+3,u2c)+v(i1,i2,i3-3,u2c)))*adxSosup(2)
                        uTemp(i1,i2,i3,u3c)=un(i1,i2,i3,u3c)+(+20.*v(i1,i2,i3,u3c)-15.*(v(i1+1,i2,i3,u3c)+v(i1-1,i2,i3,u3c))+6.*(v(i1+2,i2,i3,u3c)+v(i1-2,i2,i3,u3c))-(v(i1+3,i2,i3,u3c)+v(i1-3,i2,i3,u3c)))*adxSosup(0)+(+20.*v(i1,i2,i3,u3c)-15.*(v(i1,i2+1,i3,u3c)+v(i1,i2-1,i3,u3c))+6.*(v(i1,i2+2,i3,u3c)+v(i1,i2-2,i3,u3c))-(v(i1,i2+3,i3,u3c)+v(i1,i2-3,i3,u3c)))*adxSosup(1)+(+20.*v(i1,i2,i3,u3c)-15.*(v(i1,i2,i3+1,u3c)+v(i1,i2,i3-1,u3c))+6.*(v(i1,i2,i3+2,u3c)+v(i1,i2,i3-2,u3c))-(v(i1,i2,i3+3,u3c)+v(i1,i2,i3-3,u3c)))*adxSosup(2)
                      end if
                 end do
                 end do
                 end do
                  ...
                  if( boundaryCondition(side,axis)==tractionBC )then
                    if( t.le.2*dt )then
                      ...
                      if( mask(i1,i2,i3)>0 )then
                        ! --- -FOURTH 4 ---
                          ! --- THREE DIMENSIONS ---
                            uTemp(i1,i2,i3,u1c)=un(i1,i2,i3,u1c)+(+6.*v(i1,i2,i3,u1c)-4.*(v(i1+1,i2,i3,u1c)+v(i1-1,i2,i3,u1c))+(v(i1+2,i2,i3,u1c)+v(i1-2,i2,i3,u1c)))*adxSosup(0)+(+6.*v(i1,i2,i3,u1c)-4.*(v(i1,i2+1,i3,u1c)+v(i1,i2-1,i3,u1c))+(v(i1,i2+2,i3,u1c)+v(i1,i2-2,i3,u1c)))*adxSosup(1)+(+6.*v(i1,i2,i3,u1c)-4.*(v(i1,i2,i3+1,u1c)+v(i1,i2,i3-1,u1c))+(v(i1,i2,i3+2,u1c)+v(i1,i2,i3-2,u1c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u2c)=un(i1,i2,i3,u2c)+(+6.*v(i1,i2,i3,u2c)-4.*(v(i1+1,i2,i3,u2c)+v(i1-1,i2,i3,u2c))+(v(i1+2,i2,i3,u2c)+v(i1-2,i2,i3,u2c)))*adxSosup(0)+(+6.*v(i1,i2,i3,u2c)-4.*(v(i1,i2+1,i3,u2c)+v(i1,i2-1,i3,u2c))+(v(i1,i2+2,i3,u2c)+v(i1,i2-2,i3,u2c)))*adxSosup(1)+(+6.*v(i1,i2,i3,u2c)-4.*(v(i1,i2,i3+1,u2c)+v(i1,i2,i3-1,u2c))+(v(i1,i2,i3+2,u2c)+v(i1,i2,i3-2,u2c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u3c)=un(i1,i2,i3,u3c)+(+6.*v(i1,i2,i3,u3c)-4.*(v(i1+1,i2,i3,u3c)+v(i1-1,i2,i3,u3c))+(v(i1+2,i2,i3,u3c)+v(i1-2,i2,i3,u3c)))*adxSosup(0)+(+6.*v(i1,i2,i3,u3c)-4.*(v(i1,i2+1,i3,u3c)+v(i1,i2-1,i3,u3c))+(v(i1,i2+2,i3,u3c)+v(i1,i2-2,i3,u3c)))*adxSosup(1)+(+6.*v(i1,i2,i3,u3c)-4.*(v(i1,i2,i3+1,u3c)+v(i1,i2,i3-1,u3c))+(v(i1,i2,i3+2,u3c)+v(i1,i2,i3-2,u3c)))*adxSosup(2)
                    end if ! mask > 0 
                      end do
                      end do
                      end do
               ...
               if( useLowerOrderUpwindingOnBoundaries )then
                 ...
                 do i1=nn1a,nn1b
                  ! --- -FOURTH 4 ---
                    ! --- THREE DIMENSIONS ---
                      if( mask(i1,i2,i3)>0 )then
                        uTemp(i1,i2,i3,u1c)=un(i1,i2,i3,u1c)+(+20.*Dztu(i1,i2,i3,u1c)-15.*(Dztu(i1+1,i2,i3,u1c)+Dztu(i1-1,i2,i3,u1c))+6.*(Dztu(i1+2,i2,i3,u1c)+Dztu(i1-2,i2,i3,u1c))-(Dztu(i1+3,i2,i3,u1c)+Dztu(i1-3,i2,i3,u1c)))*adxSosup(0)+(+20.*Dztu(i1,i2,i3,u1c)-15.*(Dztu(i1,i2+1,i3,u1c)+Dztu(i1,i2-1,i3,u1c))+6.*(Dztu(i1,i2+2,i3,u1c)+Dztu(i1,i2-2,i3,u1c))-(Dztu(i1,i2+3,i3,u1c)+Dztu(i1,i2-3,i3,u1c)))*adxSosup(1)+(+20.*Dztu(i1,i2,i3,u1c)-15.*(Dztu(i1,i2,i3+1,u1c)+Dztu(i1,i2,i3-1,u1c))+6.*(Dztu(i1,i2,i3+2,u1c)+Dztu(i1,i2,i3-2,u1c))-(Dztu(i1,i2,i3+3,u1c)+Dztu(i1,i2,i3-3,u1c)))*adxSosup(2)
                        uTemp(i1,i2,i3,u2c)=un(i1,i2,i3,u2c)+(+20.*Dztu(i1,i2,i3,u2c)-15.*(Dztu(i1+1,i2,i3,u2c)+Dztu(i1-1,i2,i3,u2c))+6.*(Dztu(i1+2,i2,i3,u2c)+Dztu(i1-2,i2,i3,u2c))-(Dztu(i1+3,i2,i3,u2c)+Dztu(i1-3,i2,i3,u2c)))*adxSosup(0)+(+20.*Dztu(i1,i2,i3,u2c)-15.*(Dztu(i1,i2+1,i3,u2c)+Dztu(i1,i2-1,i3,u2c))+6.*(Dztu(i1,i2+2,i3,u2c)+Dztu(i1,i2-2,i3,u2c))-(Dztu(i1,i2+3,i3,u2c)+Dztu(i1,i2-3,i3,u2c)))*adxSosup(1)+(+20.*Dztu(i1,i2,i3,u2c)-15.*(Dztu(i1,i2,i3+1,u2c)+Dztu(i1,i2,i3-1,u2c))+6.*(Dztu(i1,i2,i3+2,u2c)+Dztu(i1,i2,i3-2,u2c))-(Dztu(i1,i2,i3+3,u2c)+Dztu(i1,i2,i3-3,u2c)))*adxSosup(2)
                        uTemp(i1,i2,i3,u3c)=un(i1,i2,i3,u3c)+(+20.*Dztu(i1,i2,i3,u3c)-15.*(Dztu(i1+1,i2,i3,u3c)+Dztu(i1-1,i2,i3,u3c))+6.*(Dztu(i1+2,i2,i3,u3c)+Dztu(i1-2,i2,i3,u3c))-(Dztu(i1+3,i2,i3,u3c)+Dztu(i1-3,i2,i3,u3c)))*adxSosup(0)+(+20.*Dztu(i1,i2,i3,u3c)-15.*(Dztu(i1,i2+1,i3,u3c)+Dztu(i1,i2-1,i3,u3c))+6.*(Dztu(i1,i2+2,i3,u3c)+Dztu(i1,i2-2,i3,u3c))-(Dztu(i1,i2+3,i3,u3c)+Dztu(i1,i2-3,i3,u3c)))*adxSosup(1)+(+20.*Dztu(i1,i2,i3,u3c)-15.*(Dztu(i1,i2,i3+1,u3c)+Dztu(i1,i2,i3-1,u3c))+6.*(Dztu(i1,i2,i3+2,u3c)+Dztu(i1,i2,i3-2,u3c))-(Dztu(i1,i2,i3+3,u3c)+Dztu(i1,i2,i3-3,u3c)))*adxSosup(2)
                      end if
                 end do
                 end do
                 end do
                  ...
                  if( boundaryCondition(side,axis)==tractionBC )then
                    if( t.le.2*dt )then
                      ...
                      if( mask(i1,i2,i3)>0 )then
                        ! --- -FOURTH 4 ---
                          ! --- THREE DIMENSIONS ---
                            uTemp(i1,i2,i3,u1c)=un(i1,i2,i3,u1c)+(+6.*Dztu(i1,i2,i3,u1c)-4.*(Dztu(i1+1,i2,i3,u1c)+Dztu(i1-1,i2,i3,u1c))+(Dztu(i1+2,i2,i3,u1c)+Dztu(i1-2,i2,i3,u1c)))*adxSosup(0)+(+6.*Dztu(i1,i2,i3,u1c)-4.*(Dztu(i1,i2+1,i3,u1c)+Dztu(i1,i2-1,i3,u1c))+(Dztu(i1,i2+2,i3,u1c)+Dztu(i1,i2-2,i3,u1c)))*adxSosup(1)+(+6.*Dztu(i1,i2,i3,u1c)-4.*(Dztu(i1,i2,i3+1,u1c)+Dztu(i1,i2,i3-1,u1c))+(Dztu(i1,i2,i3+2,u1c)+Dztu(i1,i2,i3-2,u1c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u2c)=un(i1,i2,i3,u2c)+(+6.*Dztu(i1,i2,i3,u2c)-4.*(Dztu(i1+1,i2,i3,u2c)+Dztu(i1-1,i2,i3,u2c))+(Dztu(i1+2,i2,i3,u2c)+Dztu(i1-2,i2,i3,u2c)))*adxSosup(0)+(+6.*Dztu(i1,i2,i3,u2c)-4.*(Dztu(i1,i2+1,i3,u2c)+Dztu(i1,i2-1,i3,u2c))+(Dztu(i1,i2+2,i3,u2c)+Dztu(i1,i2-2,i3,u2c)))*adxSosup(1)+(+6.*Dztu(i1,i2,i3,u2c)-4.*(Dztu(i1,i2,i3+1,u2c)+Dztu(i1,i2,i3-1,u2c))+(Dztu(i1,i2,i3+2,u2c)+Dztu(i1,i2,i3-2,u2c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u3c)=un(i1,i2,i3,u3c)+(+6.*Dztu(i1,i2,i3,u3c)-4.*(Dztu(i1+1,i2,i3,u3c)+Dztu(i1-1,i2,i3,u3c))+(Dztu(i1+2,i2,i3,u3c)+Dztu(i1-2,i2,i3,u3c)))*adxSosup(0)+(+6.*Dztu(i1,i2,i3,u3c)-4.*(Dztu(i1,i2+1,i3,u3c)+Dztu(i1,i2-1,i3,u3c))+(Dztu(i1,i2+2,i3,u3c)+Dztu(i1,i2-2,i3,u3c)))*adxSosup(1)+(+6.*Dztu(i1,i2,i3,u3c)-4.*(Dztu(i1,i2,i3+1,u3c)+Dztu(i1,i2,i3-1,u3c))+(Dztu(i1,i2,i3+2,u3c)+Dztu(i1,i2,i3-2,u3c)))*adxSosup(2)
                    end if ! mask > 0 
                      end do
                      end do
                      end do
         ...
         elseif( option==2 )then
           ...
           if( twilightZone==1 )then
                 ...
                 do i2=n2a,n2b
                 do i1=n1a,n1b
                 vt(i1,i2,i3,u1c) =  -rhoi*ux43r(i1,i2,i3,pc) + cs*( ulaplacian43r(i1,i2,i3,u1c) )
                 vt(i1,i2,i3,u2c) =  -rhoi*uy43r(i1,i2,i3,pc) + cs*( ulaplacian43r(i1,i2,i3,u2c) )
                 vt(i1,i2,i3,u3c) = - rhoi*uz43r(i1,i2,i3,pc) + cs*( ulaplacian43r(i1,i2,i3,u3c) )
                     ! *** 3D ****
                     call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uett)
                     call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uexx)
                     call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,ueyy)
