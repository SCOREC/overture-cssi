! This file automatically generated from advOptIsm.bf90 with bpp.
        subroutine advIsm3dOrder2r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,rsxy,xy,um,u,un,f,vt,vn,v,v1,v2,v3,v4,vt1,vt2,vt3,vt4,gridIndexRange,boundaryCondition,ipar,rpar,ierr )
       !======================================================================
      ...
      parameter( tractionInterface=2,tractionAndHeatFluxInterface=3 )
        ...
        call ovtime( time0 )
          ...
          ! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
           ...
           !       **********************************************
               ! ******** 3D *************
         ! write(*,*) 'Inside advIsm: order=2 dim=3'
         if( option==0 )then
           ...
           if( correction==0 )then
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   un(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - dtSqByRho*ux23r(i1,i2,i3,pc) + cdtSq*( ulaplacian23r(i1,i2,i3,u1c) )
                   un(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - dtSqByRho*uy23r(i1,i2,i3,pc) + cdtSq*( ulaplacian23r(i1,i2,i3,u2c) )
                   un(i1,i2,i3,u3c) = 2.*u(i1,i2,i3,u3c) - um(i1,i2,i3,u3c) - dtSqByRho*uz23r(i1,i2,i3,pc) + cdtSq*( ulaplacian23r(i1,i2,i3,u3c) )
                       ! *** 3D ****
             ...
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   uTemp(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - (.5*dtSqByRho)*(unx23r(i1,i2,i3,pc) + umx23r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian23r(i1,i2,i3,u1c) + umlaplacian23r(i1,i2,i3,u1c) )
                   uTemp(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - (.5*dtSqByRho)*(uny23r(i1,i2,i3,pc) + umy23r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian23r(i1,i2,i3,u2c) + umlaplacian23r(i1,i2,i3,u2c) )
                   uTemp(i1,i2,i3,u3c) = 2.*u(i1,i2,i3,u3c) - um(i1,i2,i3,u3c) - (.5*dtSqByRho)*(unz23r(i1,i2,i3,pc) + umz23r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian23r(i1,i2,i3,u3c) + umlaplacian23r(i1,i2,i3,u3c) )
                       ! *** 3D ****
                       call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uett)
                       call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uexx)
                       call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,ueyy)
                  ...
                  if( boundaryCondition(side,axis)==tractionBC )then
                    if( t.le.2*dt )then
                      ...
                      do i1=nn1a,nn1b
                        ! --- SECOND 2 ---
                          ! --- THREE DIMENSIONS ---
                            uTemp(i1,i2,i3,u1c)=un(i1,i2,i3,u1c)+(+2.*v(i1,i2,i3,u1c)-(v(i1+1,i2,i3,u1c)+v(i1-1,i2,i3,u1c)))*adxSosup(0)+(+2.*v(i1,i2,i3,u1c)-(v(i1,i2+1,i3,u1c)+v(i1,i2-1,i3,u1c)))*adxSosup(1)+(+2.*v(i1,i2,i3,u1c)-(v(i1,i2,i3+1,u1c)+v(i1,i2,i3-1,u1c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u2c)=un(i1,i2,i3,u2c)+(+2.*v(i1,i2,i3,u2c)-(v(i1+1,i2,i3,u2c)+v(i1-1,i2,i3,u2c)))*adxSosup(0)+(+2.*v(i1,i2,i3,u2c)-(v(i1,i2+1,i3,u2c)+v(i1,i2-1,i3,u2c)))*adxSosup(1)+(+2.*v(i1,i2,i3,u2c)-(v(i1,i2,i3+1,u2c)+v(i1,i2,i3-1,u2c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u3c)=un(i1,i2,i3,u3c)+(+2.*v(i1,i2,i3,u3c)-(v(i1+1,i2,i3,u3c)+v(i1-1,i2,i3,u3c)))*adxSosup(0)+(+2.*v(i1,i2,i3,u3c)-(v(i1,i2+1,i3,u3c)+v(i1,i2-1,i3,u3c)))*adxSosup(1)+(+2.*v(i1,i2,i3,u3c)-(v(i1,i2,i3+1,u3c)+v(i1,i2,i3-1,u3c)))*adxSosup(2)
                      end do
                      end do
                      end do
                   end if ! end if bc==
                  ...
                  if( boundaryCondition(side,axis)==tractionBC )then
                    if( t.le.2*dt )then
                      ...
                      do i1=nn1a,nn1b
                        ! --- SECOND 2 ---
                          ! --- THREE DIMENSIONS ---
                            uTemp(i1,i2,i3,u1c)=un(i1,i2,i3,u1c)+(+2.*Dztu(i1,i2,i3,u1c)-(Dztu(i1+1,i2,i3,u1c)+Dztu(i1-1,i2,i3,u1c)))*adxSosup(0)+(+2.*Dztu(i1,i2,i3,u1c)-(Dztu(i1,i2+1,i3,u1c)+Dztu(i1,i2-1,i3,u1c)))*adxSosup(1)+(+2.*Dztu(i1,i2,i3,u1c)-(Dztu(i1,i2,i3+1,u1c)+Dztu(i1,i2,i3-1,u1c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u2c)=un(i1,i2,i3,u2c)+(+2.*Dztu(i1,i2,i3,u2c)-(Dztu(i1+1,i2,i3,u2c)+Dztu(i1-1,i2,i3,u2c)))*adxSosup(0)+(+2.*Dztu(i1,i2,i3,u2c)-(Dztu(i1,i2+1,i3,u2c)+Dztu(i1,i2-1,i3,u2c)))*adxSosup(1)+(+2.*Dztu(i1,i2,i3,u2c)-(Dztu(i1,i2,i3+1,u2c)+Dztu(i1,i2,i3-1,u2c)))*adxSosup(2)
                            uTemp(i1,i2,i3,u3c)=un(i1,i2,i3,u3c)+(+2.*Dztu(i1,i2,i3,u3c)-(Dztu(i1+1,i2,i3,u3c)+Dztu(i1-1,i2,i3,u3c)))*adxSosup(0)+(+2.*Dztu(i1,i2,i3,u3c)-(Dztu(i1,i2+1,i3,u3c)+Dztu(i1,i2-1,i3,u3c)))*adxSosup(1)+(+2.*Dztu(i1,i2,i3,u3c)-(Dztu(i1,i2,i3+1,u3c)+Dztu(i1,i2,i3-1,u3c)))*adxSosup(2)
                      end do
                      end do
                      end do
                   end if ! end if bc==
         ...
         elseif( option==2 )then
           ...
           if( twilightZone==1 )then
                 ...
                 do i2=n2a,n2b
                 do i1=n1a,n1b
                 vt(i1,i2,i3,u1c) =  -rhoi*ux23r(i1,i2,i3,pc) + cs*( ulaplacian23r(i1,i2,i3,u1c) )
                 vt(i1,i2,i3,u2c) =  -rhoi*uy23r(i1,i2,i3,pc) + cs*( ulaplacian23r(i1,i2,i3,u2c) )
                 vt(i1,i2,i3,u3c) = - rhoi*uz23r(i1,i2,i3,pc) + cs*( ulaplacian23r(i1,i2,i3,u3c) )
                     ! *** 3D ****
                     call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uett)
                     call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uexx)
                     call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,ueyy)
