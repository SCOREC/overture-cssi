! This file automatically generated from bcOptIsm.bf90 with bpp.
        subroutine bcIsm2dOrder4r( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange,u,mask,rsxy,xy,ndMatProp,matIndex,matValpc,matVal,boundaryCondition,addBoundaryForcing,interfaceType,dim,bcf00,bcf10,bcf01,bcf11,bcf02,bcf12,bcf0,bcOffset,ipar,rpar,ierr )
       ! ===================================================================================
             ...
             ! write(*,'("bcOptIsm: extrap ghost on displacementBC or tractionBC ")')
               ...
               ! beginLoops2d()
                 do ghost=1,numGhost
                   ...
                   j2 = i2 - ghost*is2
                   j3 = i3 - ghost*is3
                   u(j1,j2,j3,u1c)=(5.*u(j1+is1,j2+is2,j3+is3,u1c)-10.*u(j1+is1+is1,j2+is2+is2,j3+is3+is3,u1c)+10.*u(j1+is1+2*is1,j2+is2+2*is2,j3+is3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+is2+3*is2,j3+is3+3*is3,u1c)+u(j1+is1+4*is1,j2+is2+4*is2,j3+is3+4*is3,u1c))
                   u(j1,j2,j3,u2c)=(5.*u(j1+is1,j2+is2,j3+is3,u2c)-10.*u(j1+is1+is1,j2+is2+is2,j3+is3+is3,u2c)+10.*u(j1+is1+2*is1,j2+is2+2*is2,j3+is3+2*is3,u2c)-5.*u(j1+is1+3*is1,j2+is2+3*is2,j3+is3+3*is3,u2c)+u(j1+is1+4*is1,j2+is2+4*is2,j3+is3+4*is3,u2c))
                 end do
                end do
                end do
           end if
                   ...
                   !      u.x + v.y + w.z = 0
                     ...
                     ! u(i1-is1,i2-is2,i3,u2c)=extrap5(u,i1,i2,i3,u2c,is1,is2,is3)
                       ...
                       if( axis==0 )then
                         ...
                         f2 = u(j1,j2,j3,u1c) - (5.*u(j1+is1,j2,j3,u1c)-10.*u(j1+is1+is1,j2+is2,j3+is3,u1c)+10.*u(j1+is1+2*is1,j2+2*is2,j3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+3*is2,j3+3*is3,u1c)+u(j1+is1+4*is1,j2+4*is2,j3+4*is3,u1c));            ! extrapolate 2nd ghost 
                         ...
                         if( checkResiduals )then
                           ...
                           f2 = u(j1,j2,j3,u1c) - (5.*u(j1+is1,j2,j3,u1c)-10.*u(j1+is1+is1,j2+is2,j3+is3,u1c)+10.*u(j1+is1+2*is1,j2+2*is2,j3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+3*is2,j3+3*is3,u1c)+u(j1+is1+4*is1,j2+4*is2,j3+4*is3,u1c));  
                           res1 = abs(f1); 
                           res2 = abs(f2); 
                         ...
                         f2 = u(j1,j2,j3,u2c) - (5.*u(j1+is1,j2,j3,u2c)-10.*u(j1+is1+is1,j2+is2,j3+is3,u2c)+10.*u(j1+is1+2*is1,j2+2*is2,j3+2*is3,u2c)-5.*u(j1+is1+3*is1,j2+3*is2,j3+3*is3,u2c)+u(j1+is1+4*is1,j2+4*is2,j3+4*is3,u2c));            ! extrapolate u2
                         ...
                         if( checkResiduals )then
                           ! check residual
                           f1 = uxx42r(i1,i2,i3,u2c) - (1./mu)*uy42r(i1,i2,i3,pc)  - f1e;
                           f2 = u(j1,j2,j3,u2c) - (5.*u(j1+is1,j2,j3,u2c)-10.*u(j1+is1+is1,j2+is2,j3+is3,u2c)+10.*u(j1+is1+2*is1,j2+2*is2,j3+2*is3,u2c)-5.*u(j1+is1+3*is1,j2+3*is2,j3+3*is3,u2c)+u(j1+is1+4*is1,j2+4*is2,j3+4*is3,u2c));      
                           res1 = abs(f1); 
                           res2 = abs(f2); 
                           if( max(res1,res2)>resTol )then
                         ...
                         do ghost=3,numGhost 
                           ...
                           u(j1,j2,j3,u1c) = (5.*u(j1+is1,j2,j3,u1c)-10.*u(j1+is1+is1,j2+is2,j3+is3,u1c)+10.*u(j1+is1+2*is1,j2+2*is2,j3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+3*is2,j3+3*is3,u1c)+u(j1+is1+4*is1,j2+4*is2,j3+4*is3,u1c));
                           u(j1,j2,j3,u2c) = (5.*u(j1+is1,j2,j3,u2c)-10.*u(j1+is1+is1,j2+is2,j3+is3,u2c)+10.*u(j1+is1+2*is1,j2+2*is2,j3+2*is3,u2c)-5.*u(j1+is1+3*is1,j2+3*is2,j3+3*is3,u2c)+u(j1+is1+4*is1,j2+4*is2,j3+4*is3,u2c));
                         end do           
                       elseif( axis==1 )then
                    ...
                    ! write(*,'(" tractionBC: side,axis=",2i3," assignTwilightZone=",i2," numGhost=",i2)') side,axis,assignTwilightZone,numGhost
                      ...
                      if( axis==0 )then
                        ...
                        if( numGhost>2 )then
                          ...
                          f1 = (u(i1+3,i2,i3,u1c) - u(i1-3,i2,i3,u1c))/(6.*dx(axis)) - (dx(axis)**2/6.)*(uxx22r(i1+2,i2,i3,u1c) - uxx22r(i1-2,i2,i3,u1c))/(4.*dx(axis)) + uy42r(i1,i2,i3,u2c) - f1e;
                        ...
                        if( checkResiduals)then
                          ...
                          !   write(*,'(" error in u2 ghost=",2(1pe10.2)," err in pxy=",1pe10.2)') u(i1-  is1,i2-  is2,i3,u2c)-u0, u(i1-2*is1,i2-2*is2,i3,u2c)-v0,!           uxy42r(i1,i2,i3,pc)-pexy
                          ! end if
                        end if
                        if( numGhost>2 )then
                          ! get 3rd ghost line for upwinding
                 ...
                 if( boundaryCondition(side1,0).eq.tractionBC .and.boundaryCondition(side2,1).eq.tractionBC )then
                   ...
                   shift1(5) = -is1; shift2(5) = -is2; shift3(5) = 0; comp(5)=u2c;        
                     ...
                     if( numGhost==2 )then
                       ...
                       j1=i1-js1;       j2=i2-js2;
                       u(j1,j2,j3,u1c) = (5.*u(j1+is1,j2+is2,j3,u1c)-10.*u(j1+is1+is1,j2+is2+is2,j3+is3,u1c)+10.*u(j1+is1+2*is1,j2+is2+2*is2,j3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+is2+3*is2,j3+3*is3,u1c)+u(j1+is1+4*is1,j2+is2+4*is2,j3+4*is3,u1c))
                       ghost1=0;        ghost2=2; 
                       js1=is1*ghost1;  js2=is2*ghost2;
                       j1=i1-js1;       j2=i2-js2;
                       u(j1,j2,j3,u1c) = (5.*u(j1+is1,j2+is2,j3,u1c)-10.*u(j1+is1+is1,j2+is2+is2,j3+is3,u1c)+10.*u(j1+is1+2*is1,j2+is2+2*is2,j3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+is2+3*is2,j3+3*is3,u1c)+u(j1+is1+4*is1,j2+is2+4*is2,j3+4*is3,u1c))          
                   ...
                   do ghost1=startGhost,numGhost
                     ...
                     j1=i1-js1;       j2=i2-js2;
                     u(j1,j2,j3,u1c) = (5.*u(j1+is1,j2+is2,j3,u1c)-10.*u(j1+is1+is1,j2+is2+is2,j3+is3,u1c)+10.*u(j1+is1+2*is1,j2+is2+2*is2,j3+2*is3,u1c)-5.*u(j1+is1+3*is1,j2+is2+3*is2,j3+3*is3,u1c)+u(j1+is1+4*is1,j2+is2+4*is2,j3+4*is3,u1c))
                     u(j1,j2,j3,u2c) = (5.*u(j1+is1,j2+is2,j3,u2c)-10.*u(j1+is1+is1,j2+is2+is2,j3+is3,u2c)+10.*u(j1+is1+2*is1,j2+is2+2*is2,j3+2*is3,u2c)-5.*u(j1+is1+3*is1,j2+is2+3*is2,j3+3*is3,u2c)+u(j1+is1+4*is1,j2+is2+4*is2,j3+4*is3,u2c))
                   end do 
                   end do 
