! This file automatically generated from bcOptIsm.bf90 with bpp.
        subroutine bcIsm2dOrder2c( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange,u,mask,rsxy,xy,ndMatProp,matIndex,matValpc,matVal,boundaryCondition,addBoundaryForcing,interfaceType,dim,bcf00,bcf10,bcf01,bcf11,bcf02,bcf12,bcf0,bcOffset,ipar,rpar,ierr )
       ! ===================================================================================
               ...
               do side2=0,1
                 ...
                 if( boundaryCondition(side1,0).eq.tractionBC .and.boundaryCondition(side2,1).eq.tractionBC )then
                   ...
                   do ghost1=startGhost,numGhost
                     ...
                     j1=i1-js1;       j2=i2-js2;
                     u(j1,j2,j3,u1c) = (3.*u(j1+is1,j2+is2,j3,u1c)-3.*u(j1+is1+is1,j2+is2+is2,j3+is3,u1c)+u(j1+is1+2*is1,j2+is2+2*is2,j3+2*is3,u1c))
                     u(j1,j2,j3,u2c) = (3.*u(j1+is1,j2+is2,j3,u2c)-3.*u(j1+is1+is1,j2+is2+is2,j3+is3,u2c)+u(j1+is1+2*is1,j2+is2+2*is2,j3+2*is3,u2c))
                   end do 
                   end do 
