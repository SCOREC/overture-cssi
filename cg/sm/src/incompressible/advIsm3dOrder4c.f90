! This file automatically generated from advOptIsm.bf90 with bpp.
        subroutine advIsm3dOrder4c( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,rsxy,xy,um,u,un,f,vt,vn,v,v1,v2,v3,v4,vt1,vt2,vt3,vt4,gridIndexRange,boundaryCondition,ipar,rpar,ierr )
       !======================================================================
        ...
        call ovtime( time0 )
         ...
         if( option==0 )then
           ...
           if( correction==0 )then
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   un(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - dtSqByRho*ux43(i1,i2,i3,pc) + cdtSq*( ulaplacian43(i1,i2,i3,u1c) )
                   un(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - dtSqByRho*uy43(i1,i2,i3,pc) + cdtSq*( ulaplacian43(i1,i2,i3,u2c) )
                   un(i1,i2,i3,u3c) = 2.*u(i1,i2,i3,u3c) - um(i1,i2,i3,u3c) - dtSqByRho*uz43(i1,i2,i3,pc) + cdtSq*( ulaplacian43(i1,i2,i3,u3c) )
                       ! *** 3D ****
             ...
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   uTemp(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - (.5*dtSqByRho)*(unx43(i1,i2,i3,pc) + umx43(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian43(i1,i2,i3,u1c) + umlaplacian43(i1,i2,i3,u1c) )
                   uTemp(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - (.5*dtSqByRho)*(uny43(i1,i2,i3,pc) + umy43(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian43(i1,i2,i3,u2c) + umlaplacian43(i1,i2,i3,u2c) )
                   uTemp(i1,i2,i3,u3c) = 2.*u(i1,i2,i3,u3c) - um(i1,i2,i3,u3c) - (.5*dtSqByRho)*(unz43(i1,i2,i3,pc) + umz43(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian43(i1,i2,i3,u3c) + umlaplacian43(i1,i2,i3,u3c) )
                       ! *** 3D ****
                       call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uett)
                       call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uexx)
                       call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,ueyy)
         ...
         elseif( option==2 )then
           ...
           if( twilightZone==1 )then
                 ...
                 do i2=n2a,n2b
                 do i1=n1a,n1b
                 vt(i1,i2,i3,u1c) =  -rhoi*ux43(i1,i2,i3,pc) + cs*( ulaplacian43(i1,i2,i3,u1c) )
                 vt(i1,i2,i3,u2c) =  -rhoi*uy43(i1,i2,i3,pc) + cs*( ulaplacian43(i1,i2,i3,u2c) )
                 vt(i1,i2,i3,u3c) = - rhoi*uz43(i1,i2,i3,pc) + cs*( ulaplacian43(i1,i2,i3,u3c) )
                     ! *** 3D ****
                     call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uett)
                     call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,uexx)
                     call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),t,u1c,ueyy)
