! This file automatically generated from advOptIsm.bf90 with bpp.
        subroutine advIsm2dOrder2r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,rsxy,xy,um,u,un,f,vt,vn,v,v1,v2,v3,v4,vt1,vt2,vt3,vt4,gridIndexRange,boundaryCondition,ipar,rpar,ierr )
       !======================================================================
        ...
        call ovtime( time0 )
         ...
         if( option==0 )then
           ...
           if( correction==0 )then
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   un(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - dtSqByRho*ux22r(i1,i2,i3,pc) + cdtSq*( ulaplacian22r(i1,i2,i3,u1c) )
                   un(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - dtSqByRho*uy22r(i1,i2,i3,pc) + cdtSq*( ulaplacian22r(i1,i2,i3,u2c) )
             ...
             if( twilightZone==1 )then
                   ...
                   do i2=n2a,n2b
                   do i1=n1a,n1b
                   uTemp(i1,i2,i3,u1c) = 2.*u(i1,i2,i3,u1c) - um(i1,i2,i3,u1c) - (.5*dtSqByRho)*(unx22r(i1,i2,i3,pc) + umx22r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian22r(i1,i2,i3,u1c) + umlaplacian22r(i1,i2,i3,u1c) )
                   uTemp(i1,i2,i3,u2c) = 2.*u(i1,i2,i3,u2c) - um(i1,i2,i3,u2c) - (.5*dtSqByRho)*(uny22r(i1,i2,i3,pc) + umy22r(i1,i2,i3,pc)) + (.5*cdtSq)*( unlaplacian22r(i1,i2,i3,u2c) + umlaplacian22r(i1,i2,i3,u2c) )
                       call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u1c,uett)
                       call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u1c,uexx)
                       call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u1c,ueyy)
                       call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u2c,vett)
                  ...
                  ! --- SECOND 2 ---
                    ! --- TWO DIMENSIONS ---
                      ...
                      if( mask(i1,i2,i3)>0 )then      
                        ...
                        ! write(*,'(" add diss for i1,i2=",2i3," diss=",2(1pe12.4))') i1,i2,sosupDiss2d4(v,i1,i2,i3,u1c),sosupDiss2d4(v,i1,i2,i3,u2c)
                      end if
                  ...
                  ! --- SECOND 2 ---
                    ! --- TWO DIMENSIONS ---
                      ...
                      if( mask(i1,i2,i3)>0 )then      
                        ...
                        ! write(*,'(" add diss for i1,i2=",2i3," diss=",2(1pe12.4))') i1,i2,sosupDiss2d4(Dztu,i1,i2,i3,u1c),sosupDiss2d4(Dztu,i1,i2,i3,u2c)
                      end if
                     !  else if( mask(i1,i2,i3)>0 )then
                     !   ! this point must be next to an interp point
         ...
         elseif( option==2 )then
           ...
           if( twilightZone==1 )then
                 ...
                 do i2=n2a,n2b
                 do i1=n1a,n1b
                 vt(i1,i2,i3,u1c) =  -rhoi*ux22r(i1,i2,i3,pc) + cs*( ulaplacian22r(i1,i2,i3,u1c) )
                 vt(i1,i2,i3,u2c) =  -rhoi*uy22r(i1,i2,i3,pc) + cs*( ulaplacian22r(i1,i2,i3,u2c) )
                     call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u1c,uett)
                     call ogDeriv(ep,0,2,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u1c,uexx)
                     call ogDeriv(ep,0,0,2,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u1c,ueyy)
                     call ogDeriv(ep,2,0,0,0,xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t,u2c,vett)
