! This file automatically generated from bcOptIsm.bf90 with bpp.
        subroutine bcIsm2dOrder4c( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange,u,mask,rsxy,xy,ndMatProp,matIndex,matValpc,matVal,boundaryCondition,addBoundaryForcing,interfaceType,dim,bcf00,bcf10,bcf01,bcf11,bcf02,bcf12,bcf0,bcOffset,ipar,rpar,ierr )
       ! ===================================================================================
                       ...
                       ! -------- CURVILINEAR 4 4 ------
                         ...
                         ! eval coefficients in matrix a4 for ghost points by discrete delta
                           ...
                           ! First eval equartions with no pertutbation --> save in f0 
                              ...
                              f(2) = tn1*( mu*( uxx42(i1,i2,i3,u1c) + uyy42(i1,i2,i3,u1c) ) - ux42(i1,i2,i3,pc) ) + tn2*( mu*( uxx42(i1,i2,i3,u2c) + uyy42(i1,i2,i3,u2c) ) - uy42(i1,i2,i3,pc) )                           - fe(2);  
                              ! f(2) =  uxx42(i1,i2,i3,u2c) - fe(2)
                              f(3) = tn1*( u(i1-2*is1,i2-2*is2,i3,u1c) - ((5.*u(i1-is1,i2-is2,i3,u1c)-10.*u(i1-is1+is1,i2-is2+is2,i3+is3,u1c)+10.*u(i1-is1+2*is1,i2-is2+2*is2,i3+2*is3,u1c)-5.*u(i1-is1+3*is1,i2-is2+3*is2,i3+3*is3,u1c)+u(i1-is1+4*is1,i2-is2+4*is2,i3+4*is3,u1c))) ) + tn2*( u(i1-2*is1,i2-2*is2,i3,u2c) - ((5.*u(i1-is1,i2-is2,i3,u2c)-10.*u(i1-is1+is1,i2-is2+is2,i3+is3,u2c)+10.*u(i1-is1+2*is1,i2-is2+2*is2,i3+2*is3,u2c)-5.*u(i1-is1+3*is1,i2-is2+3*is2,i3+3*is3,u2c)+u(i1-is1+4*is1,i2-is2+4*is2,i3+4*is3,u2c))) ) 
                         ...
                         do n=0,numberOfEquations-1
                           f(n) = -f(n) + a4(n,0)*u(i1-  is1,i2-  is2,i3,u1c) + a4(n,1)*u(i1-  is1,i2-  is2,i3,u2c) + a4(n,2)*u(i1-2*is1,i2-2*is2,i3,u1c) + a4(n,3)*u(i1-2*is1,i2-2*is2,i3,u2c);
                         end do
                         ! solve for ghost
                         ...
                         if( .true. )then
                           ...
                           write(*,'("Displacement: i1,i2=",2i3," u1(-1)=",1pe12.4," err=",1pe10.2," u2(-1)=",1pe12.4," err=",1pe10.2)') i1,i2,f(0),f(0)-u1e,f(1),f(1)-u2e
                           ...
                           write(*,'("Displacement: i1,i2=",2i3," u1(-2)=",1pe12.4," err=",1pe10.2," u2(-2)=",1pe12.4," err=",1pe10.2)') i1,i2,f(2),f(2)-u1e,f(3),f(3)-u2e  
                  ...
                  ! #End
                    ...
                    !  --> evaluate with the wrong values in the ghost  
                      ...
                      !-------------------------------------------------------------------------------
                        ...
                        !   write(*,'("traction: i1,i2=",2i3," u1(-1)=",1pe12.4," err=",1pe10.2," u2(-1)=",1pe12.4," err=",1pe10.2)') !          i1,i2,f(0),f(0)-u1e,f(1),f(1)-u2e
                        ! end if
