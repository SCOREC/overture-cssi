...
// ========================================================================================
{
  ...
  // TZ forcing is done inside the incompressible advance Fortran routines
    if( compressibilityType==SmParameters::incompressibleSolid && forcingOption==twilightZoneForcing )
        return 0;
