...
int doubleGridCollectionFunction::
...
doubleGridCollectionFunction::RCData::
RCData()
{
...
//=================================================================================================
doubleGridCollectionFunction::RCData & doubleGridCollectionFunction::RCData::
operator=( const doubleGridCollectionFunction::RCData & rcData )  // deep copy
{
  if( this == &rcData )
    return *this;
  int i;
...
//\no function header:
// 
// The following enumerators are equivalent to the ones appearing in the {\ff doubleMappedGridFunction}.
// See the doubleMappedGridFunction documentation for futher details.
// /updateReturnValue:
...
//  {\ff doubleGridCollectionFunction} and a float, double, or int.
...
//     Range all;
//     GridCollection gc(...);
//     doubleGridCollectionFunction u(gc,all,all,all);
//   \end{verbatim}  
...
//
//        doubleGridCollectionFunction u(gc);                           //  --> u[grid](R1,R2,R3);
//
//        doubleGridCollectionFunction u(gc,all,all,all,1);             //  --> u[grid](R1,R2,R3,0:1);
//        doubleGridCollectionFunction u(gc,all,all,Range(1,1));        //  --> u[grid](R1,R2,1:1,R3);
//
//        doubleGridCollectionFunction u(gc,2,all);                     //  --> u[grid](0:2,R1,R2,R3);
//        doubleGridCollectionFunction u(gc,Range(0,2),all,all,all);    //  --> u[grid](0:2,R1,R2,R3);
//        doubleGridCollectionFunction u(gc,all,Range(3,3),all,all);    //  --> u[grid](R1,3:3,R2,R3);
//    
//    \end{verbatim}
//    }   
//    
...
//=============================================================================================
{
  ...
  for( grid=0; grid< numberOfGrids(); grid++ )
  {
    ...
    {
      doubleMappedGridFunction mgf((*gridCollection)[grid],type,
              component0,component1,component2,component3,component4);
      mappedGridFunctionList.addElement( mgf );
    }
    else
    {
      doubleMappedGridFunction mgf((*gridCollectionData)[grid],type,
           component0,component1,component2,component3,component4);
      mappedGridFunctionList.addElement( mgf );
    }
  }
...
//----------------------------------------------------------------------------------------------
void doubleGridCollectionFunction::
            ...
            const bool createMappedGridFunctionList /* = TRUE */ )
{
  ...
  if( createMappedGridFunctionList )
  {
    ...
    for( int grid=0; grid< numberOfGrids(); grid++ )
    {
      if( gridCollection ) // use the gridCollection if it is there
      {
	doubleMappedGridFunction mgf((*gridCollection)[grid],R0,R1,R2,R3,R4,R5,R6,R7);
	mappedGridFunctionList.addElement( mgf );
      }
      else
      {
	doubleMappedGridFunction mgf((*gridCollectionData)[grid],R0,R1,R2,R3,R4,R5,R6,R7);
	mappedGridFunctionList.addElement( mgf );
      }
    }
  }
...
//----------------------------------------------------------------------------------------------
doubleGridCollectionFunction::
doubleGridCollectionFunction( const doubleGridCollectionFunction & cgf, const CopyType copyType  )
  : doubleGenericGridCollectionFunction(cgf,copyType)
{
  rcData=NULL;
  switch( copyType )
  {
...
initialize()
{
  className="doubleGridCollectionFunction";
  if( rcData!=NULL )
  {
    printf("doubleGridCollectionFunction::ERROR:initialize: rcData!=NULL, something is wrong here\n");
...
//-----------------------------------------------------------------------------------------
{
  ...
  {
    doubleGridCollectionFunction cgf = *this;  // makes a deep copy
...
//==================================================================================
// /Description:
//   Return a new doubleGridCollectionFunction that is linked (using the {\tt link} function) to some specfied components
//   of the current doubleGridCollectionFunction. This is a convenient but 
//  {\bf inefficient} way to easily access certain components of a multi-component doubleGridCollectionFunction as in
//  the example:
// \begin{verbatim} 
//    GridCollection gc(...);
...
//==================================================================================
{
  doubleGridCollectionFunction result;
  result.link(*this,component0,component1,component2,component3,component4);
  return doubleGridCollectionFunction(result,SHALLOW);   // return a shallow copy so that we don't break the link
}
...
int doubleGridCollectionFunction::
dataCopy( const doubleGridCollectionFunction & gcf )
//==================================================================================
// /Description:
...
// *wdh 961212
  ...
  { // Delete gcf if it is a temporary
    doubleGridCollectionFunction *temp = (doubleGridCollectionFunction*) &gcf; 
    delete temp;                                                  
  }
  return 0;
}
...
//---------------------------------------------------------------------------------
// extern doubleGridCollectionFunction nullDoubleGridCollectionFunction;
...
//==================================================================================
{
  //  *this=nullDoubleGridCollectionFunction;
...
// *wdh 961212
  if( this->temporary )
  { // Delete gcf if it is a temporary
    doubleGridCollectionFunction *temp = (doubleGridCollectionFunction*) this;  // cast away const
    delete temp;                                                  
  }
}
...
doubleGridCollectionFunction
evaluate( doubleGridCollectionFunction & cgf ) 
//==================================================================================
// /Description:
...
//==================================================================================
{
  doubleGridCollectionFunction cgfn;
  cgfn.reference(cgf);
  cgfn.temporary=FALSE;
  if( cgf.temporary )
  { // Delete cgf if it is a temporary
    doubleGridCollectionFunction *temp = (doubleGridCollectionFunction*) &cgf; 
    delete temp;                                                  
  }
...
//==================================================================================
{
  ...
  dir.find(subDir,name,"doubleGridCollectionFunction");
...
aString doubleGridCollectionFunction::
getClassName() const 
//==================================================================================
// /Description:
...
//==================================================================================
{
  ...
  {
    cout << "doubleGridCollectionFunction::getComponentBase:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("doubleGridCollectionFunction::getComponentBase:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( component<0 || component>=maximumNumberOfComponents )
  {
    cout << "doubleGridCollectionFunction::getComponentBound:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("doubleGridCollectionFunction::getComponentBound:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( component<0 || component>=maximumNumberOfComponents )
  {
    cout << "doubleGridCollectionFunction::getComponentDimension:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("doubleGridCollectionFunction::getComponentDimension:ERROR invalid argument");
  }
  return rcData->R[positionOfComponent(component)].getBound()
...
//==================================================================================
{
  ...
  {
    cout << "doubleGridCollectionFunction::getCoordinateBase:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("doubleGridCollectionFunction::getCoordinateBase:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( coordinate<0 || coordinate>=3 )
  {
    cout << "doubleGridCollectionFunction::getCoordinateBound:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("doubleGridCollectionFunction::getCoordinateBound:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( coordinate<0 || coordinate>=3 )
  {
    cout << "doubleGridCollectionFunction::getCoordinateDimension:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("doubleGridCollectionFunction::getCoordinateDimension:ERROR invalid argument");
  }
  return rcData->R[positionOfCoordinate(coordinate)].getBound()
...
GridFunctionParameters::faceCenteringType doubleGridCollectionFunction:: 
...
//-----------------------------------------------------------------------------------------
{
  ...
  for( int grid=0; grid<numberOfGrids(); grid++ )
  {
    ...
    {
      cout << "doubleGridCollectionFunction::getFaceCentering:ERROR: the faceCenteringType for a gridCollection\n";
      cout << " is not equal to the faceCentering type for all the components!\n";
      Overture::abort("doubleGridCollectionFunction::getFaceCentering:ERROR:");
    }
    if( positionOfFaceCentering()!=mappedGridFunctionList[grid].positionOfFaceCentering() )
    {
      cout << "doubleGridCollectionFunction::getFaceCentering:ERROR: the positionOfFaceCentering for a gridCollection\n";
...
GridCollection* doubleGridCollectionFunction::
...
//==================================================================================
{
  ...
  {
    cout << "doubleGridCollectionFunction:getGridCollection:ERROR: The pointer to the gridCollection is NULL \n";
    Overture::abort("error");
  }
...
GridFunctionParameters::GridFunctionType doubleGridCollectionFunction::
...
//-----------------------------------------------------------------------------------------
{
  ...
  if( numberOfGrids()>0 )
  {
    ...
    for( int grid=1; grid< numberOfGrids(); grid++ )
    {
      ...
      {
	cout << "doubleGridCollectionFunction::getGridFunctionType:ERROR: gridFunctionType's are not\n";
...
GridFunctionParameters::GridFunctionTypeWithComponents doubleGridCollectionFunction:: 
...
//-----------------------------------------------------------------------------------------
{
  ...
  if( numberOfGrids()>0 )
  {
    ...
    for( int grid=1; grid< numberOfGrids(); grid++ )
    {
      ...
      {
	cout << "doubleGridCollectionFunction::getGridFunctionTypeWithComponents:ERROR: gridFunctionType's are not\n";
	cout << "the same on all the component grids! \n";
        break;
      }
    }
...
bool doubleGridCollectionFunction::
getIsACoefficientMatrix() const
{
  ...
  {
    printf("doubleGridCollectionFunction::getIsACoefficientMatrix(): WARNING: Not all mappedGridFunctions in this\n"
...
//     See the detail description with te doubleMappedGridFunction version of this function.
...
//-----------------------------------------------------------------------------------------
{
  ...
  if( mappedGridFunctionList.getLength()>0 )
  {
    ...
    for( int grid=1; grid<ng; grid++ ) // *wdh* 020806
    {
      ...
      {
	cout << "doubleGridCollectionFunction::getNumberOfComponents:ERROR: number of components are not\n";
	cout << "the same on all the component grids! \n";
...
GridCollectionOperators* doubleGridCollectionFunction::
getOperators() const
//==================================================================================
// /Description:
...
//-----------------------------------------------------------------------------------------
{
  ...
  {
    cout << "doubleGridCollectionFunction::interpolate:ERROR: Sorry but I cannot interpolate\n";
...
//	                                  const Range & C1,
//                                          const Range & C2)
   int doubleGridCollectionFunction::interpolate(Interpolant &, const Range &, const Range &, const Range &)
  //    int doubleGridCollectionFunction::interpolate(Interpolant &, const Range &, const Range &, const Range &)
{
  // return interpolant.interpolate( *this,C0,C1,C2 );
   cout << "doubleGridCollectionFunction::interpolate: sorry unable to interpolate\n"; return 1;
  //    cout << "doubleGridCollectionFunction::interpolate: sorry unable to interpolate\n"; return 1;
}
#else
 int doubleGridCollectionFunction::interpolate(Interpolant & interpolant,
...
//
// /Examples:
//    See the examples in the documentation for the doubleMappedGridFunction version of link.
//
...
//-----------------------------------------------------------------------------------------------
void doubleGridCollectionFunction::
link(const doubleGridCollectionFunction & gcf, const int componentToLinkTo, const int numberOfComponents )
{
...
doubleGridCollectionFunction &
multiply( const doubleGridCollectionFunction & a, const doubleGridCollectionFunction & coeff_ )
//==================================================================================
// /Description:
...
//==================================================================================
{
  doubleGridCollectionFunction & coeff = (doubleGridCollectionFunction &) coeff_; // cast away const (avoids compiler warnings)
  ...
  for( int grid=0; grid<cg.numberOfGrids(); grid++ )
  {
    ...
    {
      cout << "doubleGridCollectionFunction:multiply(a,coeff):ERROR: `a' should be a scalar grid function\n";
  ...
  { // Delete a if it is a temporary -- this would happen if "a" were an expression,
    ...
    doubleGridCollectionFunction *temp = (doubleGridCollectionFunction*) &a; 
    delete temp;                                                  
  }
  return coeff;
}
...
//\begin{>>GridCollectionFunctionInclude.tex}{\subsubsection{operator = doubleGridCollectionFunction}}
doubleGridCollectionFunction & doubleGridCollectionFunction::
...
//   doubleGridCollectionFunction's.
// \begin{verbatim}
//    CompositeGrid cg(...);
...
//======================================================================================================
{
  ...
  if( gridCollection!=0 && cgf.gridCollection!=0 )
  {
    ...
    {
      printf("doubleGridCollectionFunction:operator = : ERROR: trying to assign two grid functions that do not\n"
             "  have the same number of grids!\n");
      Overture::abort("doubleGridCollectionFunction:operator = : ERROR");
    }
    for( int grid=0; grid<numberOfGrids(); grid++ )
    {
  ...
  else if( cgf.gridCollection!=0 )
  {
    ...
    *rcData=*cgf.rcData; // deep copy
    ...
    // *wdh* 000411if( className=="doubleGridCollectionFunction" )
    if( getClassName()=="doubleGridCollectionFunction" )
    {
      // only copy these lists if we are a doubleGridCollectionFunction (i.e. not a CompositeGridFunction)
/* ----
...
---- */
  ...
  // *wdh* 000411  if( cgf.className=="doubleGridCollectionFunction" )
  if( cgf.getClassName()=="doubleGridCollectionFunction" )
  {
    if( cgf.temporary )
    { // Delete cgf if it is a temporary
      doubleGridCollectionFunction *temp = (doubleGridCollectionFunction*) &cgf; 
...
/* ---- this is inlined ---
//-----------------------------------------------------------------------------------------
// The [] operator returns a doubleMappedGridFunction
//-----------------------------------------------------------------------------------------
doubleMappedGridFunction & doubleGridCollectionFunction::
...
//==================================================================================
{
  ...
  dir.create(subDir,name,"doubleGridCollectionFunction");                      // create a sub-directory 
...
//-----------------------------------------------------------------------------------------
// /Description:
//   Use this function to reference one doubleGridCollectionFunction to another.
...
//==================================================================================
{
  ...
  {                                                                                                           
    cout << "doubleGridCollectionFunction:ERROR:trying to setBoundaryConditionValue without defining an BC routine\n";
  }                                                                                                           
}
...
// **** also change the version in compositeGridFunction ******
{
  if( numberOfGrids()==0 )
  {
    cout << "doubleGridCollectionFunction::setIsACoefficientMatrix:Warning: there are no grids in this collection\n";
    cout << "This call will have no effect, you should call setIsACoefficientMatrix after the providing\n";
    cout << "the doubleGridCollectionFunction with a GridCollection \n";
  }
  ...
  if( gc.computedGeometry() & GridCollection::THErefinementLevel )
  {
    ...
    {
      printf("doubleGridCollectionFunction::setIsACoefficientMatrix: consistency error. The number of refinement levels\n"
  ...
  if(  gc.computedGeometry() & GridCollection::THEmultigridLevel )
  {
    ...
    {
      printf("doubleGridCollectionFunction::setIsACoefficientMatrix: consistency error. The number of multigrid levels\n"
	     " in the grid =%i, but the number of levels in the grid function =%i. \n"
	     " Perhaps you need to call updateToMatchGrid for the grid function before calling setIsACoefficientMatrix\n",
                        ...
                        const int offset0 )
{
  if( numberOfGrids()==0 )
  {
    printF("doubleGridCollectionFunction::setIsACoefficientMatrix:Warning: there are no grids in this collection\n"
           "This call will have no effect, you should call setIsACoefficientMatrix after the providing\n"
           "the doubleGridCollectionFunction with a GridCollection \n");
  }
  ...
  for( l=0; l<gc.numberOfMultigridLevels(); l++ )
  {
    ...
    if( stencilSize.getBound(0)!=m.numberOfComponentGrids()-1 || stencilSize.getBound(1)!=gc.numberOfMultigridLevels()-1 )
    {
    ...
    for( i=0; i<maximumNumberOfComponents; i++ )
    {
      if( c[i]==defaultValue )
        c[i]=R[positionOfComponent(i)].getBase();
 	      ...
 	      c[i] > R[positionOfComponent(i)].getBound() )
      {
	printf("doubleGridCollectionFunction::setName:ERROR component%i=%i is invalid ! \n",i,c[i]);
...
//==================================================================================
{
  if( gridCollection==0 )
  {
    printf("doubleGridCollectionFunction::setOperators:WARNING: setting operators for a null doubleGridCollectionFunction\n"
...
//==================================================================================
{
  if( gridCollection!=NULL )
  {
    ...
    {  // update the refinement levels
      // cout << "doubleGridCollectionFunction:updateCollections...\n";
	...
	// *wdh* 001120 refinementLevel[level].initialize();  // initialize the gridCollectionFunction **already done**
      ...
      for( int grid=0; grid< gc.numberOfGrids(); grid++ )
      {
        ...
        doubleGridCollectionFunction & gcf = refinementLevel[level];
	...
	if( wasChanged(level) )
	{
          // cout << "doubleGridCollectionFunction:updateCollections...refinement was changed\n";
    ...
    {  
      ...
      // cout << "doubleGridCollectionFunction:update multigrid levels...\n";
      // keep track of which levels are changed
	...
	// *wdh* 001120 multigridLevel[level].initialize();  // initialize the gridCollectionFunction
      ...
      for( int grid=0; grid< gc.numberOfGrids(); grid++ )
      {
        ...
        doubleGridCollectionFunction & gcf = multigridLevel[level];
        if( gcf.mappedGridFunctionList.getLength()<gridNumber(level)+1 )
	{
          wasChanged(level)=TRUE;
  	  gcf.mappedGridFunctionList.addElement(mappedGridFunctionList[grid],gridNumber(level));
	...
	if( wasChanged(level) )
	{
          // cout << "doubleGridCollectionFunction:updateCollections...multigridLevel was changed\n";
	  gcf.constructor( gcf.gridCollection,gcf.gridCollection->rcData,
			   R[0],R[1],R[2],R[3],R[4],R[5],R[6],R[7],FALSE );
	}
      }
...
doubleGridCollectionFunction::updateReturnValue doubleGridCollectionFunction::
updateToMatchGrid()
//==================================================================================
//
//\end{GridCollectionFunctionInclude.tex} 
...
//=====================================================================================================
{
  ...
  {
    cout << "doubleGridCollectionFunction::updateToMatchGrid:ERROR: you must first associate a gridCollection "
      "with this grid before calling update!\n";
    Overture::abort("doubleGridCollectionFunction::updateToMatchGrid:ERROR");
  }
  ...
  for( grid=0; grid<min(length,numberOfGrids()); grid++ )
  {
           ...
           ((dataAllocationOption & 2) && gridCollectionData->multigridLevelNumber(grid)<gridCollectionData->numberOfMultigridLevels-1) ) )
    {
      ...
      doubleMappedGridFunction & mgf = mappedGridFunctionList[grid];
      mgf.mappedGrid = &mg;
  ...
  if( length < numberOfGrids() )
  {
    for( int grid=length; grid< numberOfGrids(); grid++ )
    {
      ...
      {
	// In this case do not allocate space for a rectangular grid
        //	doubleMappedGridFunction mgf( mg,0 );
        //        mgf.redim(0);  // ***

	doubleMappedGridFunction mgf; 
	...
	mappedGridFunctionList.addElement( mgf );
      ...
      {
	doubleMappedGridFunction mgf(mg,R0,R1,R2,R3,R4,R5,R6,R7);
	mappedGridFunctionList.addElement( mgf );
      }
    }
  }
...
//==================================================================================
{
  ...
  if( length < numberOfGrids() )
  {
    ...
    {
      returnValue&=2;
      doubleMappedGridFunction mgf(gridCollection0[grid],type,component0,component1,component2,component3,component4 );
      mappedGridFunctionList.addElement( mgf );
    }
  }
  else if( length > numberOfGrids() )
...
//=====================================================================================================
// /Purpose: Update the doubleGridCollectionFunction so that it has the correct
...
//=====================================================================================================
{
  ...
  if( length < numberOfGrids() )
  {
    ...
    {
      returnValue&=2;
      doubleMappedGridFunction mgf;  // add an empty gridFunction
      mappedGridFunctionList.addElement( mgf );
    }
  }
  else if( length > numberOfGrids() )
...
real doubleGridCollectionFunction::
...
// int doubleGridCollectionFunction::
// zeroUnusedPoints(doubleGridCollectionFunction & coeff, 
// 		 double value /* = 0 */,
// 		 const Index & component0 /* =nullIndex */,
// 		 const Index & component1 /* =nullIndex */,
// 		 const Index & component2 /* =nullIndex */,
...
//   doubleGridCollectionFunction & u = *this;
...
doubleGridCollectionFunction & 
fabs( const doubleGridCollectionFunction & cgf ) 
{
  doubleGridCollectionFunction *cgfn;
  if( cgf.temporary )
    cgfn=(doubleGridCollectionFunction*)&cgf;  // cgfn points to the temporary (cast away const)
  else
  {
    cgfn= new doubleGridCollectionFunction();
    (*cgfn).temporary=TRUE;
