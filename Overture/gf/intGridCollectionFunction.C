...
intGridCollectionFunction::RCData::
RCData()
{
...
//=================================================================================================
intGridCollectionFunction::RCData & intGridCollectionFunction::RCData::
operator=( const intGridCollectionFunction::RCData & rcData )  // deep copy
{
  if( this == &rcData )
    return *this;
  int i;
...
//\no function header:
// 
// The following enumerators are equivalent to the ones appearing in the {\ff intMappedGridFunction}.
// See the intMappedGridFunction documentation for futher details.
// /updateReturnValue:
...
//  {\ff intGridCollectionFunction} and a float, int, or int.
...
//     Range all;
//     GridCollection gc(...);
//     intGridCollectionFunction u(gc,all,all,all);
//   \end{verbatim}  
...
//
//        intGridCollectionFunction u(gc);                           //  --> u[grid](R1,R2,R3);
//
//        intGridCollectionFunction u(gc,all,all,all,1);             //  --> u[grid](R1,R2,R3,0:1);
//        intGridCollectionFunction u(gc,all,all,Range(1,1));        //  --> u[grid](R1,R2,1:1,R3);
//
//        intGridCollectionFunction u(gc,2,all);                     //  --> u[grid](0:2,R1,R2,R3);
//        intGridCollectionFunction u(gc,Range(0,2),all,all,all);    //  --> u[grid](0:2,R1,R2,R3);
//        intGridCollectionFunction u(gc,all,Range(3,3),all,all);    //  --> u[grid](R1,3:3,R2,R3);
//    
//    \end{verbatim}
//    }   
//    
...
//=============================================================================================
{
  ...
  for( grid=0; grid< numberOfGrids(); grid++ )
  {
    ...
    {
      intMappedGridFunction mgf((*gridCollection)[grid],type,
              component0,component1,component2,component3,component4);
      mappedGridFunctionList.addElement( mgf );
    }
    else
    {
      intMappedGridFunction mgf((*gridCollectionData)[grid],type,
           component0,component1,component2,component3,component4);
      mappedGridFunctionList.addElement( mgf );
    }
  }
            ...
            const bool createMappedGridFunctionList /* = TRUE */ )
{
  ...
  if( createMappedGridFunctionList )
  {
    ...
    for( int grid=0; grid< numberOfGrids(); grid++ )
    {
      if( gridCollection ) // use the gridCollection if it is there
      {
	intMappedGridFunction mgf((*gridCollection)[grid],R0,R1,R2,R3,R4,R5,R6,R7);
	mappedGridFunctionList.addElement( mgf );
      }
      else
      {
	intMappedGridFunction mgf((*gridCollectionData)[grid],R0,R1,R2,R3,R4,R5,R6,R7);
	mappedGridFunctionList.addElement( mgf );
      }
    }
  }
...
//----------------------------------------------------------------------------------------------
intGridCollectionFunction::
intGridCollectionFunction( const intGridCollectionFunction & cgf, const CopyType copyType  )
  : intGenericGridCollectionFunction(cgf,copyType)
{
  rcData=NULL;
  switch( copyType )
  {
...
initialize()
{
  className="intGridCollectionFunction";
  if( rcData!=NULL )
  {
    printf("intGridCollectionFunction::ERROR:initialize: rcData!=NULL, something is wrong here\n");
...
//-----------------------------------------------------------------------------------------
{
  ...
  {
    intGridCollectionFunction cgf = *this;  // makes a deep copy
...
//==================================================================================
// /Description:
//   Return a new intGridCollectionFunction that is linked (using the {\tt link} function) to some specfied components
//   of the current intGridCollectionFunction. This is a convenient but 
//  {\bf inefficient} way to easily access certain components of a multi-component intGridCollectionFunction as in
//  the example:
// \begin{verbatim} 
//    GridCollection gc(...);
...
//==================================================================================
{
  ...
  return intGridCollectionFunction(result,SHALLOW);   // return a shallow copy so that we don't break the link
}
...
int intGridCollectionFunction::
dataCopy( const intGridCollectionFunction & gcf )
//==================================================================================
// /Description:
...
// *wdh 961212
  ...
  { // Delete gcf if it is a temporary
    intGridCollectionFunction *temp = (intGridCollectionFunction*) &gcf; 
    delete temp;                                                  
  }
  return 0;
}
...
//---------------------------------------------------------------------------------
// extern intGridCollectionFunction nullIntGridCollectionFunction;
...
//==================================================================================
{
  //  *this=nullIntGridCollectionFunction;
...
// *wdh 961212
  if( this->temporary )
  { // Delete gcf if it is a temporary
    intGridCollectionFunction *temp = (intGridCollectionFunction*) this;  // cast away const
    delete temp;                                                  
  }
}
...
intGridCollectionFunction
evaluate( intGridCollectionFunction & cgf ) 
//==================================================================================
// /Description:
...
//==================================================================================
{
  ...
  dir.find(subDir,name,"intGridCollectionFunction");
...
aString intGridCollectionFunction::
getClassName() const 
//==================================================================================
// /Description:
...
//==================================================================================
{
  ...
  {
    cout << "intGridCollectionFunction::getComponentBase:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("intGridCollectionFunction::getComponentBase:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( component<0 || component>=maximumNumberOfComponents )
  {
    cout << "intGridCollectionFunction::getComponentBound:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("intGridCollectionFunction::getComponentBound:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( component<0 || component>=maximumNumberOfComponents )
  {
    cout << "intGridCollectionFunction::getComponentDimension:ERROR invalid argument, component = " 
         << component << endl;
    Overture::abort("intGridCollectionFunction::getComponentDimension:ERROR invalid argument");
  }
  return rcData->R[positionOfComponent(component)].getBound()
...
//==================================================================================
{
  ...
  {
    cout << "intGridCollectionFunction::getCoordinateBase:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("intGridCollectionFunction::getCoordinateBase:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( coordinate<0 || coordinate>=3 )
  {
    cout << "intGridCollectionFunction::getCoordinateBound:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("intGridCollectionFunction::getCoordinateBound:ERROR invalid argument");
  }
...
//==================================================================================
{
  if( coordinate<0 || coordinate>=3 )
  {
    cout << "intGridCollectionFunction::getCoordinateDimension:ERROR invalid argument, coordinate = " 
         << coordinate << endl;
    Overture::abort("intGridCollectionFunction::getCoordinateDimension:ERROR invalid argument");
  }
  return rcData->R[positionOfCoordinate(coordinate)].getBound()
...
GridFunctionParameters::faceCenteringType intGridCollectionFunction:: 
...
//-----------------------------------------------------------------------------------------
{
  ...
  for( int grid=0; grid<numberOfGrids(); grid++ )
  {
    ...
    {
      cout << "intGridCollectionFunction::getFaceCentering:ERROR: the faceCenteringType for a gridCollection\n";
      cout << " is not equal to the faceCentering type for all the components!\n";
      Overture::abort("intGridCollectionFunction::getFaceCentering:ERROR:");
    }
    if( positionOfFaceCentering()!=mappedGridFunctionList[grid].positionOfFaceCentering() )
    {
      cout << "intGridCollectionFunction::getFaceCentering:ERROR: the positionOfFaceCentering for a gridCollection\n";
...
GridCollection* intGridCollectionFunction::
...
//==================================================================================
{
  ...
  {
    cout << "intGridCollectionFunction:getGridCollection:ERROR: The pointer to the gridCollection is NULL \n";
    Overture::abort("error");
  }
...
GridFunctionParameters::GridFunctionType intGridCollectionFunction::
...
//-----------------------------------------------------------------------------------------
{
  ...
  if( numberOfGrids()>0 )
  {
    ...
    for( int grid=1; grid< numberOfGrids(); grid++ )
    {
      ...
      {
	cout << "intGridCollectionFunction::getGridFunctionType:ERROR: gridFunctionType's are not\n";
...
GridFunctionParameters::GridFunctionTypeWithComponents intGridCollectionFunction:: 
...
//-----------------------------------------------------------------------------------------
{
  ...
  if( numberOfGrids()>0 )
  {
    ...
    for( int grid=1; grid< numberOfGrids(); grid++ )
    {
      ...
      {
	cout << "intGridCollectionFunction::getGridFunctionTypeWithComponents:ERROR: gridFunctionType's are not\n";
	cout << "the same on all the component grids! \n";
        break;
      }
    }
...
bool intGridCollectionFunction::
getIsACoefficientMatrix() const
{
  ...
  {
    printf("intGridCollectionFunction::getIsACoefficientMatrix(): WARNING: Not all mappedGridFunctions in this\n"
...
//     See the detail description with te intMappedGridFunction version of this function.
...
//-----------------------------------------------------------------------------------------
{
  ...
  if( mappedGridFunctionList.getLength()>0 )
  {
    ...
    for( int grid=1; grid<ng; grid++ ) // *wdh* 020806
    {
      ...
      {
	cout << "intGridCollectionFunction::getNumberOfComponents:ERROR: number of components are not\n";
	cout << "the same on all the component grids! \n";
...
GridCollectionOperators* intGridCollectionFunction::
getOperators() const
//==================================================================================
// /Description:
...
//-----------------------------------------------------------------------------------------
{
  ...
  {
    cout << "intGridCollectionFunction::interpolate:ERROR: Sorry but I cannot interpolate\n";
...
//	                                  const Range & C1,
//                                          const Range & C2)
  // int intGridCollectionFunction::interpolate(Interpolant &, const Range &, const Range &, const Range &)
      int intGridCollectionFunction::interpolate(Interpolant &, const Range &, const Range &, const Range &)
{
  // return interpolant.interpolate( *this,C0,C1,C2 );
  // cout << "intGridCollectionFunction::interpolate: sorry unable to interpolate\n"; return 1;
      cout << "intGridCollectionFunction::interpolate: sorry unable to interpolate\n"; return 1;
}
#else
// int intGridCollectionFunction::interpolate(Interpolant & interpolant,
...
//
// /Examples:
//    See the examples in the documentation for the intMappedGridFunction version of link.
//
...
//-----------------------------------------------------------------------------------------------
void intGridCollectionFunction::
link(const intGridCollectionFunction & gcf, const int componentToLinkTo, const int numberOfComponents )
{
...
intGridCollectionFunction &
multiply( const intGridCollectionFunction & a, const intGridCollectionFunction & coeff_ )
//==================================================================================
// /Description:
...
//==================================================================================
{
  intGridCollectionFunction & coeff = (intGridCollectionFunction &) coeff_; // cast away const (avoids compiler warnings)
  ...
  for( int grid=0; grid<cg.numberOfGrids(); grid++ )
  {
    ...
    {
      cout << "intGridCollectionFunction:multiply(a,coeff):ERROR: `a' should be a scalar grid function\n";
  ...
  { // Delete a if it is a temporary -- this would happen if "a" were an expression,
    ...
    intGridCollectionFunction *temp = (intGridCollectionFunction*) &a; 
    delete temp;                                                  
  }
  return coeff;
}
...
//\begin{>>GridCollectionFunctionInclude.tex}{\subsubsection{operator = intGridCollectionFunction}}
intGridCollectionFunction & intGridCollectionFunction::
...
//======================================================================================================
{
  ...
  if( gridCollection!=0 && cgf.gridCollection!=0 )
  {
    ...
    {
      printf("intGridCollectionFunction:operator = : ERROR: trying to assign two grid functions that do not\n"
             "  have the same number of grids!\n");
      Overture::abort("intGridCollectionFunction:operator = : ERROR");
    }
    for( int grid=0; grid<numberOfGrids(); grid++ )
    {
      ...
      if( FALSE && cgf.temporary ) // if the rhs is a temporary we can just steal the data rather than copying it!
        ((intDistributedArray&)mappedGridFunctionList[grid]).reference((intDistributedArray &)cgf[grid]);   
      else
  ...
  else if( cgf.gridCollection!=0 )
  {
    ...
    *rcData=*cgf.rcData; // deep copy
    ...
    // *wdh* 000411if( className=="intGridCollectionFunction" )
    if( getClassName()=="intGridCollectionFunction" )
    {
      // only copy these lists if we are a intGridCollectionFunction (i.e. not a CompositeGridFunction)
/* ----
...
---- */
  ...
  // *wdh* 000411  if( cgf.className=="intGridCollectionFunction" )
  if( cgf.getClassName()=="intGridCollectionFunction" )
  {
    if( cgf.temporary )
    { // Delete cgf if it is a temporary
      intGridCollectionFunction *temp = (intGridCollectionFunction*) &cgf; 
...
/* ---- this is inlined ---
//-----------------------------------------------------------------------------------------
// The [] operator returns a intMappedGridFunction
//-----------------------------------------------------------------------------------------
intMappedGridFunction & intGridCollectionFunction::
...
//==================================================================================
{
  ...
  dir.create(subDir,name,"intGridCollectionFunction");                      // create a sub-directory 
...
//-----------------------------------------------------------------------------------------
// /Description:
//   Use this function to reference one intGridCollectionFunction to another.
...
//==================================================================================
{
  ...
  {                                                                                                           
    cout << "intGridCollectionFunction:ERROR:trying to setBoundaryConditionValue without defining an BC routine\n";
  }                                                                                                           
}
...
// **** also change the version in compositeGridFunction ******
{
  if( numberOfGrids()==0 )
  {
    cout << "intGridCollectionFunction::setIsACoefficientMatrix:Warning: there are no grids in this collection\n";
    cout << "This call will have no effect, you should call setIsACoefficientMatrix after the providing\n";
    cout << "the intGridCollectionFunction with a GridCollection \n";
  }
  ...
  if( gc.computedGeometry() & GridCollection::THErefinementLevel )
  {
    ...
    {
      printf("intGridCollectionFunction::setIsACoefficientMatrix: consistency error. The number of refinement levels\n"
  ...
  if(  gc.computedGeometry() & GridCollection::THEmultigridLevel )
  {
    ...
    {
      printf("intGridCollectionFunction::setIsACoefficientMatrix: consistency error. The number of multigrid levels\n"
	     " in the grid =%i, but the number of levels in the grid function =%i. \n"
	     " Perhaps you need to call updateToMatchGrid for the grid function before calling setIsACoefficientMatrix\n",
                        ...
                        const int offset0 )
{
  if( numberOfGrids()==0 )
  {
    printF("intGridCollectionFunction::setIsACoefficientMatrix:Warning: there are no grids in this collection\n"
           "This call will have no effect, you should call setIsACoefficientMatrix after the providing\n"
           "the intGridCollectionFunction with a GridCollection \n");
  }
...
//==================================================================================
{
  if( gridCollection==0 )
  {
    printf("intGridCollectionFunction::setOperators:WARNING: setting operators for a null intGridCollectionFunction\n"
...
//==================================================================================
{
  if( gridCollection!=NULL )
  {
    ...
    {  // update the refinement levels
      // cout << "intGridCollectionFunction:updateCollections...\n";
	...
	// *wdh* 001120 refinementLevel[level].initialize();  // initialize the gridCollectionFunction **already done**
      ...
      for( int grid=0; grid< gc.numberOfGrids(); grid++ )
      {
        ...
        intGridCollectionFunction & gcf = refinementLevel[level];
	...
	if( wasChanged(level) )
	{
          // cout << "intGridCollectionFunction:updateCollections...refinement was changed\n";
    ...
    {  
      ...
      // cout << "intGridCollectionFunction:update multigrid levels...\n";
      // keep track of which levels are changed
	...
	// *wdh* 001120 multigridLevel[level].initialize();  // initialize the gridCollectionFunction
      ...
      for( int grid=0; grid< gc.numberOfGrids(); grid++ )
      {
        ...
        intGridCollectionFunction & gcf = multigridLevel[level];
        if( gcf.mappedGridFunctionList.getLength()<gridNumber(level)+1 )
	{
          wasChanged(level)=TRUE;
  	  gcf.mappedGridFunctionList.addElement(mappedGridFunctionList[grid],gridNumber(level));
	...
	if( wasChanged(level) )
	{
          // cout << "intGridCollectionFunction:updateCollections...multigridLevel was changed\n";
	  gcf.constructor( gcf.gridCollection,gcf.gridCollection->rcData,
			   R[0],R[1],R[2],R[3],R[4],R[5],R[6],R[7],FALSE );
	}
      }
...
intGridCollectionFunction::updateReturnValue intGridCollectionFunction::
updateToMatchGrid()
//==================================================================================
//
//\end{GridCollectionFunctionInclude.tex} 
...
//=====================================================================================================
{
  ...
  {
    cout << "intGridCollectionFunction::updateToMatchGrid:ERROR: you must first associate a gridCollection "
      "with this grid before calling update!\n";
    Overture::abort("intGridCollectionFunction::updateToMatchGrid:ERROR");
  }
  ...
  for( grid=0; grid<min(length,numberOfGrids()); grid++ )
  {
           ...
           ((dataAllocationOption & 2) && gridCollectionData->multigridLevelNumber(grid)<gridCollectionData->numberOfMultigridLevels-1) ) )
    {
      ...
      intMappedGridFunction & mgf = mappedGridFunctionList[grid];
      mgf.mappedGrid = &mg;
  ...
  if( length < numberOfGrids() )
  {
    for( int grid=length; grid< numberOfGrids(); grid++ )
    {
      ...
      {
	// In this case do not allocate space for a rectangular grid
        //	intMappedGridFunction mgf( mg,0 );
        //        mgf.redim(0);  // ***

	intMappedGridFunction mgf; 
	...
	mappedGridFunctionList.addElement( mgf );
      ...
      {
	intMappedGridFunction mgf(mg,R0,R1,R2,R3,R4,R5,R6,R7);
	mappedGridFunctionList.addElement( mgf );
      }
    }
  }
...
//==================================================================================
{
  ...
  if( length < numberOfGrids() )
  {
    ...
    {
      returnValue&=2;
      intMappedGridFunction mgf(gridCollection0[grid],type,component0,component1,component2,component3,component4 );
      mappedGridFunctionList.addElement( mgf );
    }
  }
  else if( length > numberOfGrids() )
...
//=====================================================================================================
// /Purpose: Update the intGridCollectionFunction so that it has the correct
...
//=====================================================================================================
{
  ...
  if( length < numberOfGrids() )
  {
    ...
    {
      returnValue&=2;
      intMappedGridFunction mgf;  // add an empty gridFunction
      mappedGridFunctionList.addElement( mgf );
    }
  }
  else if( length > numberOfGrids() )
...
real intGridCollectionFunction::
...
// int intGridCollectionFunction::
// zeroUnusedPoints(intGridCollectionFunction & coeff, 
// 		 int value /* = 0 */,
// 		 const Index & component0 /* =nullIndex */,
// 		 const Index & component1 /* =nullIndex */,
// 		 const Index & component2 /* =nullIndex */,
...
//   intGridCollectionFunction & u = *this;
...
intGridCollectionFunction & 
abs( const intGridCollectionFunction & cgf ) 
{
  intGridCollectionFunction *cgfn;
  if( cgf.temporary )
    cgfn=(intGridCollectionFunction*)&cgf;  // cgfn points to the temporary (cast away const)
  else
  {
