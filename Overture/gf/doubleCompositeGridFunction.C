                        ...
                        const int offset0 )
{
  if( numberOfGrids()==0 )
  {
    printF("doubleCompositeGridFunction::setIsACoefficientMatrix:Warning: there are no grids in this collection\n"
           "This call will have no effect, you should call setIsACoefficientMatrix after the providing\n"
           "the doubleCompositeGridFunction with a CompositeGrid \n");
  }
