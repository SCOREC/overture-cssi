...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x3y2=x2y2*x1
      x3y3=x2y3*x1
      r(i1,i2,i3,n)=(c(0,0,3,n)*6.+c(0,1,3,n)*y1*6.+c(0,2,3,n)*y2*6.+c(
     & 0,3,3,n)*y3*6.+c(1,0,3,n)*x1*6.+c(1,1,3,n)*x1y1*6.+c(1,2,3,n)*
     & x1y2*6.+c(1,3,3,n)*x1y3*6.+c(2,0,3,n)*x2*6.+c(2,1,3,n)*x2y1*6.+
     & c(2,2,3,n)*x2y2*6.+c(2,3,3,n)*x2y3*6.+c(3,0,3,n)*x3*6.+c(3,1,3,
     & n)*x3y1*6.+c(3,2,3,n)*x3y2*6.+c(3,3,3,n)*x3y3*6.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x3y1=x2y1*x1
      x3y2=x2y2*x1
      r(i1,i2,i3,n)=(c(0,1,3,n)*6.+c(0,2,3,n)*y1*12.+c(0,3,3,n)*y2*18.+
     & c(1,1,3,n)*x1*6.+c(1,2,3,n)*x1y1*12.+c(1,3,3,n)*x1y2*18.+c(2,1,
     & 3,n)*x2*6.+c(2,2,3,n)*x2y1*12.+c(2,3,3,n)*x2y2*18.+c(3,1,3,n)*
     & x3*6.+c(3,2,3,n)*x3y1*12.+c(3,3,3,n)*x3y2*18.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x3=x2*x1
      x3y1=x2y1*x1
      r(i1,i2,i3,n)=(c(0,2,3,n)*12.+c(0,3,3,n)*y1*36.+c(1,2,3,n)*x1*
     & 12.+c(1,3,3,n)*x1y1*36.+c(2,2,3,n)*x2*12.+c(2,3,3,n)*x2y1*36.+
     & c(3,2,3,n)*x3*12.+c(3,3,3,n)*x3y1*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & 0,3,3,n)*z3*6.+c(1,3,0,n)*x1*6.+c(1,3,1,n)*x1z1*6.+c(1,3,2,n)*
     & x1z2*6.+c(1,3,3,n)*x1z3*6.+c(2,3,0,n)*x2*6.+c(2,3,1,n)*x2z1*6.+
     & c(2,3,2,n)*x2z2*6.+c(2,3,3,n)*x2z3*6.+c(3,3,0,n)*x3*6.+c(3,3,1,
     & n)*x3z1*6.+c(3,3,2,n)*x3z2*6.+c(3,3,3,n)*x3z3*6.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & c(1,3,1,n)*x1*6.+c(1,3,2,n)*x1z1*12.+c(1,3,3,n)*x1z2*18.+c(2,3,
     & 1,n)*x2*6.+c(2,3,2,n)*x2z1*12.+c(2,3,3,n)*x2z2*18.+c(3,3,1,n)*
     & x3*6.+c(3,3,2,n)*x3z1*12.+c(3,3,3,n)*x3z2*18.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x3=x2*x1
      x3z1=x2z1*x1
      r(i1,i2,i3,n)=(c(0,3,2,n)*12.+c(0,3,3,n)*z1*36.+c(1,3,2,n)*x1*
     & 12.+c(1,3,3,n)*x1z1*36.+c(2,3,2,n)*x2*12.+c(2,3,3,n)*x2z1*36.+
     & c(3,3,2,n)*x3*12.+c(3,3,3,n)*x3z1*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2=x1*x1
      x3=x2*x1
      r(i1,i2,i3,n)=(c(0,3,3,n)*36.+c(1,3,3,n)*x1*36.+c(2,3,3,n)*x2*
     & 36.+c(3,3,3,n)*x3*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2y2=x1y2*x1
      x2y3=x1y3*x1
      r(i1,i2,i3,n)=(c(1,0,3,n)*6.+c(1,1,3,n)*y1*6.+c(1,2,3,n)*y2*6.+c(
     & 1,3,3,n)*y3*6.+c(2,0,3,n)*x1*12.+c(2,1,3,n)*x1y1*12.+c(2,2,3,n)
     & *x1y2*12.+c(2,3,3,n)*x1y3*12.+c(3,0,3,n)*x2*18.+c(3,1,3,n)*
     & x2y1*18.+c(3,2,3,n)*x2y2*18.+c(3,3,3,n)*x2y3*18.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2y1=x1y1*x1
      x2y2=x1y2*x1
      r(i1,i2,i3,n)=(c(1,1,3,n)*6.+c(1,2,3,n)*y1*12.+c(1,3,3,n)*y2*18.+
     & c(2,1,3,n)*x1*12.+c(2,2,3,n)*x1y1*24.+c(2,3,3,n)*x1y2*36.+c(3,
     & 1,3,n)*x2*18.+c(3,2,3,n)*x2y1*36.+c(3,3,3,n)*x2y2*54.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2=x1*x1
      x2y1=x1y1*x1
      r(i1,i2,i3,n)=(c(1,2,3,n)*12.+c(1,3,3,n)*y1*36.+c(2,2,3,n)*x1*
     & 24.+c(2,3,3,n)*x1y1*72.+c(3,2,3,n)*x2*36.+c(3,3,3,n)*x2y1*108.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & 1,3,3,n)*z3*6.+c(2,3,0,n)*x1*12.+c(2,3,1,n)*x1z1*12.+c(2,3,2,n)
     & *x1z2*12.+c(2,3,3,n)*x1z3*12.+c(3,3,0,n)*x2*18.+c(3,3,1,n)*
     & x2z1*18.+c(3,3,2,n)*x2z2*18.+c(3,3,3,n)*x2z3*18.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & c(2,3,1,n)*x1*12.+c(2,3,2,n)*x1z1*24.+c(2,3,3,n)*x1z2*36.+c(3,
     & 3,1,n)*x2*18.+c(3,3,2,n)*x2z1*36.+c(3,3,3,n)*x2z2*54.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2=x1*x1
      x2z1=x1z1*x1
      r(i1,i2,i3,n)=(c(1,3,2,n)*12.+c(1,3,3,n)*z1*36.+c(2,3,2,n)*x1*
     & 24.+c(2,3,3,n)*x1z1*72.+c(3,3,2,n)*x2*36.+c(3,3,3,n)*x2z1*108.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1=xa(i1,i2,i3)
      x2=x1*x1
      r(i1,i2,i3,n)=(c(1,3,3,n)*36.+c(2,3,3,n)*x1*72.+c(3,3,3,n)*x2*
     & 108.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1y2=x1y1*y1
      x1y3=x1y2*y1
      r(i1,i2,i3,n)=(c(2,0,3,n)*12.+c(2,1,3,n)*y1*12.+c(2,2,3,n)*y2*
     & 12.+c(2,3,3,n)*y3*12.+c(3,0,3,n)*x1*36.+c(3,1,3,n)*x1y1*36.+c(
     & 3,2,3,n)*x1y2*36.+c(3,3,3,n)*x1y3*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1y1=x1*y1
      x1y2=x1y1*y1
      r(i1,i2,i3,n)=(c(2,1,3,n)*12.+c(2,2,3,n)*y1*24.+c(2,3,3,n)*y2*
     & 36.+c(3,1,3,n)*x1*36.+c(3,2,3,n)*x1y1*72.+c(3,3,3,n)*x1y2*108.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1=xa(i1,i2,i3)
      x1y1=x1*y1
      r(i1,i2,i3,n)=(c(2,2,3,n)*24.+c(2,3,3,n)*y1*72.+c(3,2,3,n)*x1*
     & 72.+c(3,3,3,n)*x1y1*216.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & 12.+c(2,3,3,n)*z3*12.+c(3,3,0,n)*x1*36.+c(3,3,1,n)*x1z1*36.+c(
     & 3,3,2,n)*x1z2*36.+c(3,3,3,n)*x1z3*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & 36.+c(3,3,1,n)*x1*36.+c(3,3,2,n)*x1z1*72.+c(3,3,3,n)*x1z2*108.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1=xa(i1,i2,i3)
      x1z1=x1*z1
      r(i1,i2,i3,n)=(c(2,3,2,n)*24.+c(2,3,3,n)*z1*72.+c(3,3,2,n)*x1*
     & 72.+c(3,3,3,n)*x1z1*216.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      x1=xa(i1,i2,i3)
      r(i1,i2,i3,n)=(c(2,3,3,n)*72.+c(3,3,3,n)*x1*216.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & c(3,1,1,n)*y1*6.+c(3,1,2,n)*y1z1*12.+c(3,1,3,n)*y1z2*18.+c(3,2,
     & 1,n)*y2*6.+c(3,2,2,n)*y2z1*12.+c(3,2,3,n)*y2z2*18.+c(3,3,1,n)*
     & y3*6.+c(3,3,2,n)*y3z1*12.+c(3,3,3,n)*y3z2*18.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      y3=y2*y1
      y3z1=y2z1*y1
      r(i1,i2,i3,n)=(c(3,0,2,n)*12.+c(3,0,3,n)*z1*36.+c(3,1,2,n)*y1*
     & 12.+c(3,1,3,n)*y1z1*36.+c(3,2,2,n)*y2*12.+c(3,2,3,n)*y2z1*36.+
     & c(3,3,2,n)*y3*12.+c(3,3,3,n)*y3z1*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      y2=y1*y1
      y3=y2*y1
      r(i1,i2,i3,n)=(c(3,0,3,n)*36.+c(3,1,3,n)*y1*36.+c(3,2,3,n)*y2*
     & 36.+c(3,3,3,n)*y3*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & 3,1,3,n)*z3*6.+c(3,2,0,n)*y1*12.+c(3,2,1,n)*y1z1*12.+c(3,2,2,n)
     & *y1z2*12.+c(3,2,3,n)*y1z3*12.+c(3,3,0,n)*y2*18.+c(3,3,1,n)*
     & y2z1*18.+c(3,3,2,n)*y2z2*18.+c(3,3,3,n)*y2z3*18.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & c(3,2,1,n)*y1*12.+c(3,2,2,n)*y1z1*24.+c(3,2,3,n)*y1z2*36.+c(3,
     & 3,1,n)*y2*18.+c(3,3,2,n)*y2z1*36.+c(3,3,3,n)*y2z2*54.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      y2=y1*y1
      y2z1=y1z1*y1
      r(i1,i2,i3,n)=(c(3,1,2,n)*12.+c(3,1,3,n)*z1*36.+c(3,2,2,n)*y1*
     & 24.+c(3,2,3,n)*y1z1*72.+c(3,3,2,n)*y2*36.+c(3,3,3,n)*y2z1*108.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      y1=ya(i1,i2,i3)
      y2=y1*y1
      r(i1,i2,i3,n)=(c(3,1,3,n)*36.+c(3,2,3,n)*y1*72.+c(3,3,3,n)*y2*
     & 108.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & 12.+c(3,2,3,n)*z3*12.+c(3,3,0,n)*y1*36.+c(3,3,1,n)*y1z1*36.+c(
     & 3,3,2,n)*y1z2*36.+c(3,3,3,n)*y1z3*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & 36.+c(3,3,1,n)*y1*36.+c(3,3,2,n)*y1z1*72.+c(3,3,3,n)*y1z2*108.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      y1=ya(i1,i2,i3)
      y1z1=y1*z1
      r(i1,i2,i3,n)=(c(3,2,2,n)*24.+c(3,2,3,n)*z1*72.+c(3,3,2,n)*y1*
     & 72.+c(3,3,3,n)*y1z1*216.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      y1=ya(i1,i2,i3)
      r(i1,i2,i3,n)=(c(3,2,3,n)*72.+c(3,3,3,n)*y1*216.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      z1=za(i1,i2,i3)
      r(i1,i2,i3,n)=(c(3,3,2,n)*72.+c(3,3,3,n)*z1*216.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i2=nsa,nsb
      do i1=nra,nrb
      r(i1,i2,i3,n)=(c(3,3,3,n)*216.)*time
! endLoops()
      end do
      end do
      end do
