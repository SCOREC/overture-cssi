...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2=x1*x1
      x3=x2*x1
      r(i1,i2,i3,n)=(c(0,3,0,n)*6.+c(1,3,0,n)*x1*6.+c(2,3,0,n)*x2*6.+c(
     & 3,3,0,n)*x3*6.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1=xa(i1,i2,i3)
      x2=x1*x1
      r(i1,i2,i3,n)=(c(1,3,0,n)*6.+c(2,3,0,n)*x1*12.+c(3,3,0,n)*x2*18.)
     & *time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      x1=xa(i1,i2,i3)
      r(i1,i2,i3,n)=(c(2,3,0,n)*12.+c(3,3,0,n)*x1*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      y1=ya(i1,i2,i3)
      r(i1,i2,i3,n)=(c(3,2,0,n)*12.+c(3,3,0,n)*y1*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i2=nsa,nsb
      do i1=nra,nrb
      r(i1,i2,i3,n)=(c(3,3,0,n)*36.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x4=x3*x1
      x4y1=x3y1*x1
      r(i1,i2,i3,n)=(c(0,3,0,n)*6.+c(0,4,0,n)*y1*24.+c(1,3,0,n)*x1*6.+
     & c(1,4,0,n)*x1y1*24.+c(2,3,0,n)*x2*6.+c(2,4,0,n)*x2y1*24.+c(3,3,
     & 0,n)*x3*6.+c(3,4,0,n)*x3y1*24.+c(4,3,0,n)*x4*6.+c(4,4,0,n)*
     & x4y1*24.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x3=x2*x1
      x4=x3*x1
      r(i1,i2,i3,n)=(c(0,4,0,n)*24.+c(1,4,0,n)*x1*24.+c(2,4,0,n)*x2*
     & 24.+c(3,4,0,n)*x3*24.+c(4,4,0,n)*x4*24.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x3=x2*x1
      x3y1=x2y1*x1
      r(i1,i2,i3,n)=(c(1,3,0,n)*6.+c(1,4,0,n)*y1*24.+c(2,3,0,n)*x1*12.+
     & c(2,4,0,n)*x1y1*48.+c(3,3,0,n)*x2*18.+c(3,4,0,n)*x2y1*72.+c(4,
     & 3,0,n)*x3*24.+c(4,4,0,n)*x3y1*96.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2=x1*x1
      x3=x2*x1
      r(i1,i2,i3,n)=(c(1,4,0,n)*24.+c(2,4,0,n)*x1*48.+c(3,4,0,n)*x2*
     & 72.+c(4,4,0,n)*x3*96.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x2=x1*x1
      x2y1=x1y1*x1
      r(i1,i2,i3,n)=(c(2,3,0,n)*12.+c(2,4,0,n)*y1*48.+c(3,3,0,n)*x1*
     & 36.+c(3,4,0,n)*x1y1*144.+c(4,3,0,n)*x2*72.+c(4,4,0,n)*x2y1*
     & 288.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1=xa(i1,i2,i3)
      x2=x1*x1
      r(i1,i2,i3,n)=(c(2,4,0,n)*48.+c(3,4,0,n)*x1*144.+c(4,4,0,n)*x2*
     & 288.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1y3=x1y2*y1
      r(i1,i2,i3,n)=(c(3,1,0,n)*6.+c(3,2,0,n)*y1*12.+c(3,3,0,n)*y2*18.+
     & c(3,4,0,n)*y3*24.+c(4,1,0,n)*x1*24.+c(4,2,0,n)*x1y1*48.+c(4,3,
     & 0,n)*x1y2*72.+c(4,4,0,n)*x1y3*96.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & 72.+c(4,2,0,n)*x1*48.+c(4,3,0,n)*x1y1*144.+c(4,4,0,n)*x1y2*
     & 288.)*time
! endLoops()
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      x1=xa(i1,i2,i3)
      x1y1=x1*y1
      r(i1,i2,i3,n)=(c(3,3,0,n)*36.+c(3,4,0,n)*y1*144.+c(4,3,0,n)*x1*
     & 144.+c(4,4,0,n)*x1y1*576.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      x1=xa(i1,i2,i3)
      r(i1,i2,i3,n)=(c(3,4,0,n)*144.+c(4,4,0,n)*x1*576.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i1=nra,nrb
      y1=ya(i1,i2,i3)
      r(i1,i2,i3,n)=(c(4,3,0,n)*144.+c(4,4,0,n)*y1*576.)*time
! endLoops()
      end do
      end do
      end do
...
! defineTime()
     ...
     & a(6,n)))))
      ...
      do i2=nsa,nsb
      do i1=nra,nrb
      r(i1,i2,i3,n)=(c(4,4,0,n)*576.)*time
! endLoops()
      end do
      end do
      end do
