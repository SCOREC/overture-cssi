...
#
#
# usage: ogen [noplot] sisArg -factor=<num> -order=[2/4/6/8] -interp=[e/i] -periodic=[|p|np|pn] -ml=<>
...
GetOptions( "order=i"=>\$order,"factor=i"=> \$factor,"interp=s"=> \$interp,"ml=i"=>\$ml,"numGhost=i"=>\$numGhost,"periodic=s"=>\$periodic);
# 
