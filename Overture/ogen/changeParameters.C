...
displayCompositeGridParameters( CompositeGrid & cg, FILE *file /* =stdout */ )
{
  ...
  // fPrintF(file,"matchGridsAcrossInterfaces =%d ( =1 : grids will be matched across interfaces).\n",matchGridsAcrossInterfaces);
...
//   }
  ...
  int & matchGridsAcrossInterfaces = dbase.get<int>("matchGridsAcrossInterfaces");
  ...
  aString tbCommands[] = {"improve quality of interpolation",
                          "match grids across interfaces",
                          ""};
  int tbState[10];
  tbState[0] = improveQualityOfInterpolation;
  tbState[1] = matchGridsAcrossInterfaces;
...
//       }
    ...
    else if( dialog.getToggleValue(answer,"match grids across interfaces",matchGridsAcrossInterfaces) )
    {
      if( matchGridsAcrossInterfaces )
        printF("Grids will be matched across interfaces (as required by some interface approximations).\n");
      else
        printF("Grids matching across interfaces is OFF. Grid will not necessarily match at interfaces.\n");
    }
