...
#
# Usage: 
#         ogen [noplot] solidFuelAssemblyGrid [options]
# where options are
...
# Examples: 
#
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=1 -factor=1 -zb=.5 -interp=e 
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=1 -factor=1.5 -interp=e -zb=.5  (solidFuelAssemblyGrid1pinse1.5.order2.hdf)
# 
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=1 -factor=1 -zb=2 -interp=e -name="solidFuelAssemblyGrid1pinsl2e1.hdf"
# 
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=.5     ->solidFuelAssemblyGrid3pinsi1.order2.hdf
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=.5 -interp=e
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1.5 -interp=e -zb=.5      (solidFuelAssemblyGrid3pinse1.5.order2.hdf)
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=2 -zb=1 -interp=e -name="solidFuelAssemblyGrid3pinsl2e2.hdf"
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=2 -zb=4 -interp=e -name="solidFuelAssemblyGrid3pinsl4e2.hdf"
# 
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=2 -interp=e -name="solidFuelAssemblyGrid3pinsl2e1.hdf"
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=4 -interp=e -name="solidFuelAssemblyGrid3pinsl4e1.hdf"
# 
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=5 -interp=e -name="solidFuelAssemblyGrid3pinsl5e1.hdf"
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=2 -zb=5 -interp=e -name="solidFuelAssemblyGrid3pinsl5e2.hdf"
# 
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=5 -factor=1 -zb=.5    
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=5 -factor=2 -zb=.5    
#      30M pts, 2.6G memory: 
#    ogen noplot solidFuelAssemblyGrid.cmd -npins=5 -factor=2 -zb=5.  -name="solidFuelAssemblyGrid5pinsi2z5.hdf"
# 
#    ogen -noplot solidFuelAssemblyGrid -factor=1 -npins=1 -name="temp.hdf"  ( -> solidFuelAssemblyGrid1pinsi1.order2.hdf)
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=2     ->solidFuelAssemblyGrid3pinsi1.order2.hdf
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=1 -zb=10 -name="solidFuelAssemblyGrid3pinsl10i1.hdf"
#    ogen -noplot solidFuelAssemblyGrid.cmd -npins=3 -factor=2 -zb=5   ( -> solidFuelAssemblyGrid3pins2i.order2.hdf )
# 
#    mpirun -np 2 ogen -noplot solidFuelAssemblyGrid.cmd -factor=2 -npins=3 -interp=e
#    srun -N1 -n2 -ppdebug -ogen noplot solidFuelAssemblyGrid.cmd -factor=2 -npins=3 -zb=2
#
#**************************************************************************
$prefix = "solidFuelAssemblyGrid";
...
# 
$suffix = ".order$order"; 
if( $name eq "" && $prefix eq "solidFuelAssemblyGrid" ){$name = $prefix . "$npins" ."pins" . "$interp$factor" . $suffix . ".hdf";}
if( $name eq "" && $prefix ne "solidFuelAssemblyGrid" ){$name = $prefix . "$interp$factor" . $suffix . ".hdf";}
# 
# domain parameters:  
