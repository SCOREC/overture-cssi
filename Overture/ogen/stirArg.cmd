#
# One or more stirring sticks in a channel
#
#
# usage: ogen [noplot] stirArg -factor=<num> -order=[2/4/6/8] -interp=[e/i] -blf=<num> -ml=<>  -rgd=[fixed|var] ...
...
# 
# examples:
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -factor=4
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -factor=8
# 
#     ogen -noplot stirArg -order=2 -blf=2 -interp=e -factor=4
#     ogen -noplot stirArg -order=2 -blf=2 -interp=e -factor=8
#
#  -- one stick:
#     ogen -noplot stirArg -xa=-1.5 -xb=1.5 -ya=-1.5 -yb=1.5 -order=2 -blf=4 -interp=e -tStretch=30. -numStir=1 -ml=1 -factor=2
# 
#     ogen -noplot stirArg -xa=-1.5 -xb=1.5 -ya=-1.5 -yb=1.5 -order=4 -blf=4 -interp=e -tStretch=40. -numStir=1 -factor=2
#     ogen -noplot stirArg -xa=-1.5 -xb=1.5 -ya=-1.5 -yb=1.5 -order=4 -blf=4 -interp=e -tStretch=40. -numStir=1 -factor=4
# 
#   -- multigrid
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=1 -factor=1
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=1 -factor=2
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=1 -factor=4 
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=2 -factor=8 
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=2 -factor=16
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=3 -factor=32
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=3 -factor=64  [3.6M]
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=3 -factor=128 [15M] 
# 
#   -- order=4
#     ogen -noplot stirArg -order=4 -blf=4 -interp=e -factor=3
#     ogen -noplot stirArg -order=4 -blf=4 -interp=e -ml=1 -factor=4 
#
# Initial angle: 
#     ogen -noplot stirArg -order=2 -blf=4 -interp=e -ml=2 -factor=8 -angle=54
# 
# rotated single stick: NOTE" blf=2 does not work so well with cgcssi -- poor quality at corners
#    ogen -noplot stirArg -xa=-1.5 -xb=1.5 -ya=-1.5 -yb=1.5 -order=2 -blf=4 -interp=e -tStretch=40. -numStir=1 -factor=2 -angle=45 -name=stirRotated45e2.order2.hdf
#    ogen -noplot stirArg -xa=-1.5 -xb=1.5 -ya=-1.5 -yb=1.5 -order=2 -blf=4 -interp=e -tStretch=40. -numStir=1 -factor=2 -angle=90 -name=stirRotated90e2.order2.hdf
#
#   -- long channel 
#     ogen noplot stirArg -order=2 -interp=e -xa=-2. -xb=10. -ya=-3.0 -yb=3.0 -ml=2 -factor=2  -blf=4 -name="stirLongChannele2.hdf"
#
$prefix="stir";  $rgd="var"; $angle=0.; 
$numStir=2;  # 2 stirring sticks by default
$order=2; $factor=1; $interp="i"; $ml=0; # default values
$orderOfAccuracy = "second order"; $ng=2; $interpType = "implicit for all grids";
$name=""; $xa=-1.; $xb=2.; $ya=-2.; $yb=1.; 
...
$tStretch=20.; # $tStretch=6.; $sharp=40.; 
# 
...
GetOptions( "order=i"=>\$order,"factor=f"=> \$factor,"xa=f"=>\$xa,"xb=f"=>\$xb,"ya=f"=>\$ya,"yb=f"=>\$yb,\
            ...
            "tStretch=f"=> \$tStretch,"sharp=f"=>\$sharp );
# 
...
* start on a side so that the polygon is symmetric
  ...
  share 
     0  0 0 0
   #  0  0 5 0  *wdh* 2012/02/22 -- we should not set a share value -- can mess up ogen after motion
  mappingName
    stir-noStretch
exit
#
...
#
convertToNurbs("stir1-orig","stir1",0.);
$commands
