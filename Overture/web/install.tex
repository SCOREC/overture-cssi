...
\begin{itemize}
  \item The primer example pwave is a good example of a small parallel code. Many of the
        ...
        parallel code.
  \item The cg solvers cgcssi, cgins, cgad, cgmx, cgsm, and cgmp run in parallel but not all options will work. 
...
% \begin{verbatim}
%            mpirun -np 2 cgcssi -readCollective -writeCollective cicShockg.cmd
% \end{verbatim}
\end{itemize}
