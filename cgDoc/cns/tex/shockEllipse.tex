...
\newcommand{\timeFrame}[6]{%
 \begin{scope}[xshift=#5cm,yshift=#6cm]
  ...
  % -- colour bar
  \draw (\xcb,\ycb) node[anchor=south west,xshift= +0pt,yshift=+0pt] {\trimfigcb{\cssiDocDir/fig/colourBarLines}{\cbHeight}};
...
%
  \draw ( 0,13.4) node[anchor=south west,xshift=-4pt,yshift=+0pt] {\trimfig{\cssiDocDir/fig/\schlierenName4}{\figWidth}};
  \draw ( 0, 6.7) node[anchor=south west,xshift=-4pt,yshift=+0pt] {\trimfig{\cssiDocDir/fig/\schlierenName6}{\figWidth}};
  \draw ( 0, 0) node[anchor=south west,xshift=-4pt,yshift=+0pt] {\trimfig{\cssiDocDir/fig/\schlierenName10}{\figWidth}};
%
  \timeFrame{\cssiDocDir/fig/\amrName4}{0.4}{.07}{4.3}{7}{13.4}
  \timeFrame{\cssiDocDir/fig/\amrName6}{0.6}{.12}{6.1}{7}{6.7}
  \timeFrame{\cssiDocDir/fig/\amrName10}{1.0}{.3}{4.6}{7}{0}
%
%- %
