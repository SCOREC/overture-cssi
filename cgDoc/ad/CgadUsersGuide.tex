...
on the Overture framework\cite{Brown97,Henshaw96a,iscope97}. 
...
Cgad can solve problems on moving and deforming domains.
Cgad can also be used with Cgmp to solve the heat equation in solid regions, when performing conjugate heat
transfer problems in conjuction with the Cgins flow solver (see Figure~\ref{fig:CgMpBlockDiagram}).



\input ../mp/tex/OvertureBlockDiagram

\input ../mp/tex/cgmpBlockDiagram
...
\begin{tikzpicture}[scale=1]
  ...
  \draw ( 0.0, 0) node[anchor=south west] {\trimfig{fig/cgadDeform_sinusoid0}{\figWidth}};
  \draw ( 5.7, 0) node[anchor=south west] {\trimfig{fig/cgadDeform_sinusoid1}{\figWidth}};
  \draw (11.4, 0) node[anchor=south west] {\trimfig{fig/cgadDeform_sinusoid2}{\figWidth}};
 % - labels
...
\begin{tikzpicture}[scale=1]
  \useasboundingbox (0,.5) rectangle (17,5.75);  % set the bounding box (so we have less surrounding white space)
  \draw ( 0.0, 0) node[anchor=south west] {\trimfig{fig/cgadDeform_concentration0}{\figWidth}};
  \draw ( 5.7, 0) node[anchor=south west] {\trimfig{fig/cgadDeform_concentration1}{\figWidth}};
  \draw (11.4, 0) node[anchor=south west] {\trimfig{fig/cgadDeform_concentration2}{\figWidth}};
 % - labels
 %   \draw (\txa,4.75) node[draw,fill=white,anchor=east] {\scriptsize $t=0.5$};
 %   \draw (\txb,4.75) node[draw,fill=white,anchor=east] {\scriptsize $t=1.0$};
 %   \draw (\txc,4.75) node[draw,fill=white,anchor=east] {\scriptsize $t=1.5$};
...
\begin{tikzpicture}[scale=1]
  ...
  \draw ( 0.0,4.0) node[anchor=south west] {\trimfig{fig/deformingEye0p0}{\figWidth}};
  \draw ( 8.0,4.0) node[anchor=south west] {\trimfig{fig/deformingEye0p1}{\figWidth}};
  \draw ( 0.0,  0) node[anchor=south west] {\trimfig{fig/deformingEye0p25}{\figWidth}};
  \draw ( 8.0,  0) node[anchor=south west] {\trimfig{fig/deformingEye0p5}{\figWidth}};
 % - labels
 %   \draw (\txa,4.75) node[draw,fill=white,anchor=east] {\scriptsize $t=0.5$};
 %   \draw (\txb,4.75) node[draw,fill=white,anchor=east] {\scriptsize $t=1.0$};
 %   \draw (\txc,4.75) node[draw,fill=white,anchor=east] {\scriptsize $t=1.5$};
